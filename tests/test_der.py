...
class Asn1ToolsDerTest(Asn1ToolsBaseTest):
    ...
    def test_integer(self):
        foo = asn1tools.compile_string(
            "Foo DEFINITIONS ::= BEGIN A ::= INTEGER END", "der"
        )
    ...
    def test_external(self):
        foo = asn1tools.compile_string(
            "Foo DEFINITIONS AUTOMATIC TAGS ::= BEGIN A ::= EXTERNAL END", "der"
        )
    ...
    def test_bit_string(self):
        ...
        datas = [
            ...
            ("E", {"a": (b"", 0), "b": (b"", 0), "c": (b"\x00\x50", 12)}, b"\x30\x00"),
        ]
    ...
    def test_octet_string(self):
        ...
        datas = [
            ...
            ("A", {"a": b"\xcc", "b": b"\xdd"}, b"\x30\x06\x80\x01\xcc\x81\x01\xdd"),
            ("B", {"a": b"", "b": b""}, b"\x30\x00"),
        ]
    ...
    def test_utf8_string(self):
        foo = asn1tools.compile_string(
            "Foo DEFINITIONS AUTOMATIC TAGS ::= BEGIN A ::= UTF8String END", "der"
        )
    ...
    def test_universal_string(self):
        foo = asn1tools.compile_string(
            "Foo DEFINITIONS AUTOMATIC TAGS ::= BEGIN A ::= UniversalString END", "der"
        )
    ...
    def test_utc_time(self):
        foo = asn1tools.compile_string(
            "Foo DEFINITIONS AUTOMATIC TAGS ::= BEGIN A ::= UTCTime END", "der"
        )
    ...
    def test_generalized_time(self):
        foo = asn1tools.compile_string(
            "Foo DEFINITIONS AUTOMATIC TAGS ::= BEGIN A ::= GeneralizedTime END", "der"
        )
        ...
        datas = [
            (
                ...
                b"\x18\x0f\x32\x30\x31\x38\x30\x31\x32\x32\x31\x33\x32\x39\x30\x30\x5a",
            ),
            (
                "A",
                datetime(2018, 1, 22, 13, 0),
                b"\x18\x0f\x32\x30\x31\x38\x30\x31\x32\x32\x31\x33\x30\x30\x30\x30\x5a",
            ),
            (
                "A",
                datetime(2000, 12, 31, 23, 59, 59),
                b"\x18\x0f\x32\x30\x30\x30\x31\x32\x33\x31\x32\x33\x35\x39\x35\x39\x5a",
            ),
        ]
    ...
    def test_all_types(self):
        ...
        datas = [
            ...
            ("Bmpstring", "bar", b"\x1e\x06\x00\x62\x00\x61\x00\x72"),
    ...
    def test_decode_length(self):
        ...
        datas = [b"0", b"", b"0\x84\x00\x00\x00"]
