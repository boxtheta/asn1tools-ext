EXPECTED = {
    "ITS-Container": {
        ...
        "types": {
            ...
            "ActionID": {
                "members": [
                    {"name": "originatingStationID", "type": "StationID"},
                    {"name": "sequenceNumber", "type": "SequenceNumber"},
                ],
                "type": "SEQUENCE",
            },
            ...
            "Altitude": {
                "members": [
                    {"name": "altitudeValue", "type": "AltitudeValue"},
                    {"name": "altitudeConfidence", "type": "AltitudeConfidence"},
                ],
                "type": "SEQUENCE",
            },
            "AltitudeConfidence": {
            ...
            "AltitudeValue": {
                ...
                "restricted-to": [(-100000, 800001)],
                "type": "INTEGER",
            },
            "CauseCode": {
                "members": [
                    {"name": "causeCode", "type": "CauseCodeType"},
                    {"name": "subCauseCode", "type": "SubCauseCodeType"},
                ],
                "type": "SEQUENCE",
            },
            "CauseCodeType": {
            ...
            "CenDsrcTollingZone": {
                "members": [
                    {"name": "protectedZoneLatitude", "type": "Latitude"},
                    {"name": "protectedZoneLongitude", "type": "Longitude"},
                    {
            ...
            "ClosedLanes": {
                "members": [
                    {
                        "name": "hardShoulderStatus",
                        "optional": True,
                        "type": "HardShoulderStatus",
                    },
                    {"name": "drivingLaneStatus", "type": "DrivingLaneStatus"},
                    None,
                ],
                "type": "SEQUENCE",
            },
            ...
            "Curvature": {
                "members": [
                    {"name": "curvatureValue", "type": "CurvatureValue"},
                    {"name": "curvatureConfidence", "type": "CurvatureConfidence"},
                ],
                "type": "SEQUENCE",
            },
            ...
            "DangerousGoodsExtended": {
                "members": [
                    {"name": "dangerousGoodsType", "type": "DangerousGoodsBasic"},
                    {
                        "name": "unNumber",
                        "restricted-to": [(0, 9999)],
                        "type": "INTEGER",
                    },
                    {"name": "elevatedTemperature", "type": "BOOLEAN"},
                    {"name": "tunnelsRestricted", "type": "BOOLEAN"},
                    {"name": "limitedQuantity", "type": "BOOLEAN"},
                    {
            ...
            "DeltaReferencePosition": {
                "members": [
                    {"name": "deltaLatitude", "type": "DeltaLatitude"},
                    {"name": "deltaLongitude", "type": "DeltaLongitude"},
                    {"name": "deltaAltitude", "type": "DeltaAltitude"},
                ],
                "type": "SEQUENCE",
            },
            "DriveDirection": {
                "type": "ENUMERATED",
                "values": [("forward", 0), ("backward", 1), ("unavailable", 2)],
            },
            "DrivingLaneStatus": {
                "named-bits": [
            ...
            "EventHistory": {
                "element": {"type": "EventPoint"},
                "size": [(1, 23)],
                "type": "SEQUENCE OF",
            },
            "EventPoint": {
                "members": [
                    {"name": "eventPosition", "type": "DeltaReferencePosition"},
                    {
                        "name": "eventDeltaTime",
                        "optional": True,
                        "type": "PathDeltaTime",
                    },
                    {"name": "informationQuality", "type": "InformationQuality"},
                ],
                "type": "SEQUENCE",
            },
            "ExteriorLights": {
            ...
            "Heading": {
                "members": [
                    {"name": "headingValue", "type": "HeadingValue"},
                    {"name": "headingConfidence", "type": "HeadingConfidence"},
                ],
                "type": "SEQUENCE",
            },
            "HeadingConfidence": {
            ...
            "HeightLonCarr": {
                "named-numbers": {"oneCentimeter": 1, "unavailable": 100},
                "restricted-to": [(1, 100)],
                "type": "INTEGER",
            },
            ...
            "InformationQuality": {
                "named-numbers": {"highest": 7, "lowest": 1, "unavailable": 0},
                "restricted-to": [(0, 7)],
                "type": "INTEGER",
            },
            "ItineraryPath": {
            ...
            "LightBarSirenInUse": {
                "named-bits": [("lightBarActivated", "0"), ("sirenActivated", "1")],
                "size": [2],
                "type": "BIT STRING",
            },
            "Longitude": {
            ...
            "LongitudinalAcceleration": {
                "members": [
                    {
                        "name": "longitudinalAccelerationValue",
            ...
            "NumberOfOccupants": {
                "named-numbers": {"oneOccupant": 1, "unavailable": 127},
                "restricted-to": [(0, 127)],
                "type": "INTEGER",
            },
            "PathDeltaTime": {
                "named-numbers": {"tenMilliSecondsInPast": 1},
                "restricted-to": [(1, 65535), None],
                "type": "INTEGER",
            },
            "PathHistory": {
                "element": {"type": "PathPoint"},
                "size": [(0, 40)],
                "type": "SEQUENCE OF",
            },
            "PathPoint": {
                "members": [
                    {"name": "pathPosition", "type": "DeltaReferencePosition"},
                    {
                        "name": "pathDeltaTime",
                        "optional": True,
                        "type": "PathDeltaTime",
            ...
            "PosCentMass": {
                "named-numbers": {"tenCentimeters": 1, "unavailable": 63},
                "restricted-to": [(1, 63)],
                "type": "INTEGER",
            },
            "PosConfidenceEllipse": {
                "members": [
                    {"name": "semiMajorConfidence", "type": "SemiAxisLength"},
                    {"name": "semiMinorConfidence", "type": "SemiAxisLength"},
                    {"name": "semiMajorOrientation", "type": "HeadingValue"},
                ],
                "type": "SEQUENCE",
            },
            "PosFrontAx": {
                "named-numbers": {"tenCentimeters": 1, "unavailable": 20},
                "restricted-to": [(1, 20)],
                "type": "INTEGER",
            },
            "PosLonCarr": {
                "named-numbers": {"oneCentimeter": 1, "unavailable": 127},
                "restricted-to": [(1, 127)],
                "type": "INTEGER",
            },
            "PosPillar": {
                "named-numbers": {"tenCentimeters": 1, "unavailable": 30},
                "restricted-to": [(1, 30)],
                "type": "INTEGER",
            },
            "PositionOfOccupants": {
            ...
            "ProtectedCommunicationZone": {
                "members": [
                    {"name": "protectedZoneType", "type": "ProtectedZoneType"},
                    {"name": "expiryTime", "optional": True, "type": "TimestampIts"},
                    {"name": "protectedZoneLatitude", "type": "Latitude"},
                    {"name": "protectedZoneLongitude", "type": "Longitude"},
                    {
            ...
            "ProtectedCommunicationZonesRSU": {
                "element": {"type": "ProtectedCommunicationZone"},
                "size": [(1, 16)],
                "type": "SEQUENCE OF",
            },
            "ProtectedZoneID": {"restricted-to": [(0, 134217727)], "type": "INTEGER"},
            "ProtectedZoneRadius": {
                "named-numbers": {"oneMeter": 1},
                "restricted-to": [(1, 255), None],
                "type": "INTEGER",
            },
            "ProtectedZoneType": {
                "type": "ENUMERATED",
                "values": [("cenDsrcTolling", 0), None],
            },
            "PtActivation": {
                "members": [
                    {"name": "ptActivationType", "type": "PtActivationType"},
                    {"name": "ptActivationData", "type": "PtActivationData"},
                ],
                "type": "SEQUENCE",
            },
            "PtActivationData": {"size": [(1, 20)], "type": "OCTET STRING"},
            "PtActivationType": {
                "named-numbers": {
                    "r09-16CodingType": 1,
            ...
            "SequenceNumber": {"restricted-to": [(0, 65535)], "type": "INTEGER"},
            ...
            "Speed": {
                "members": [
                    {"name": "speedValue", "type": "SpeedValue"},
                    {"name": "speedConfidence", "type": "SpeedConfidence"},
                ],
                "type": "SEQUENCE",
            },
            "SpeedConfidence": {
            ...
            "StationID": {"restricted-to": [(0, 4294967295)], "type": "INTEGER"},
            "StationType": {
                "named-numbers": {
                    "bus": 6,
                    "cyclist": 2,
            ...
            "SteeringWheelAngleValue": {
                ...
                "restricted-to": [(-511, 512)],
                "type": "INTEGER",
            },
            "SubCauseCodeType": {"restricted-to": [(0, 255)], "type": "INTEGER"},
            "Temperature": {
                "named-numbers": {
            ...
            "TimestampIts": {
                ...
                "restricted-to": [(0, 4398046511103)],
                "type": "INTEGER",
            },
            "Traces": {
                "element": {"type": "PathHistory"},
                "size": [(1, 7)],
                "type": "SEQUENCE OF",
            },
            ...
            "TransmissionInterval": {
                "named-numbers": {"oneMilliSecond": 1, "tenSeconds": 10000},
                "restricted-to": [(1, 10000)],
                "type": "INTEGER",
            },
            "TurningRadius": {
                "named-numbers": {"point4Meters": 1, "unavailable": 255},
                "restricted-to": [(1, 255)],
                "type": "INTEGER",
            },
            "VDS": {"size": [6], "type": "IA5String"},
            "ValidityDuration": {
                "named-numbers": {"oneSecondAfterDetection": 1, "timeOfDetection": 0},
            ...
            "VehicleIdentification": {
                "members": [
                    {"name": "wMInumber", "optional": True, "type": "WMInumber"},
                    {"name": "vDS", "optional": True, "type": "VDS"},
                    None,
                ],
                "type": "SEQUENCE",
            },
            "VehicleLength": {
                "members": [
                    {"name": "vehicleLengthValue", "type": "VehicleLengthValue"},
                    {
            ...
            "VehicleLengthValue": {
                ...
                "restricted-to": [(1, 1023)],
                "type": "INTEGER",
            },
            "VehicleMass": {
                "named-numbers": {"hundredKg": 1, "unavailable": 1024},
            ...
            "VerticalAcceleration": {
                "members": [
                    {
                        "name": "verticalAccelerationValue",
            ...
            "WMInumber": {"size": [(1, 3)], "type": "IA5String"},
            "WheelBaseVehicle": {
                "named-numbers": {"tenCentimeters": 1, "unavailable": 127},
                "restricted-to": [(1, 127)],
                "type": "INTEGER",
            },
            ...
            "YawRate": {
                "members": [
                    {"name": "yawRateValue", "type": "YawRateValue"},
                    {"name": "yawRateConfidence", "type": "YawRateConfidence"},
                ],
                "type": "SEQUENCE",
            },
            "YawRateConfidence": {
