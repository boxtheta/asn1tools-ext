EXPECTED = {
    "CAM-PDU-Descriptions": {
        ...
        "types": {
            "BasicContainer": {
                "members": [
                    {"name": "stationType", "type": "StationType"},
                    {"name": "referencePosition", "type": "ReferencePosition"},
                    None,
                ],
                "type": "SEQUENCE",
            },
            "BasicVehicleContainerHighFrequency": {
                "members": [
                    ...
                    {"name": "driveDirection", "type": "DriveDirection"},
                    {"name": "vehicleLength", "type": "VehicleLength"},
                    {"name": "vehicleWidth", "type": "VehicleWidth"},
                    {
                        "name": "longitudinalAcceleration",
                        "type": "LongitudinalAcceleration",
                    },
                    {"name": "curvature", "type": "Curvature"},
                    {
                        "name": "curvatureCalculationMode",
                        "type": "CurvatureCalculationMode",
                    },
                    {"name": "yawRate", "type": "YawRate"},
                    {
                        "name": "accelerationControl",
                        "optional": True,
                        "type": "AccelerationControl",
                    },
                    {"name": "lanePosition", "optional": True, "type": "LanePosition"},
                    {
            ...
            "BasicVehicleContainerLowFrequency": {
                "members": [
                    {"name": "vehicleRole", "type": "VehicleRole"},
                    {"name": "exteriorLights", "type": "ExteriorLights"},
                    {"name": "pathHistory", "type": "PathHistory"},
                ],
                "type": "SEQUENCE",
            },
            "CAM": {
                "members": [
                    {"name": "header", "type": "ItsPduHeader"},
                    {"name": "cam", "type": "CoopAwareness"},
                ],
                "type": "SEQUENCE",
            },
            "CamParameters": {
                "members": [
                    {"name": "basicContainer", "type": "BasicContainer"},
                    {
            ...
            "CoopAwareness": {
                "members": [
                    {"name": "generationDeltaTime", "type": "GenerationDeltaTime"},
                    {"name": "camParameters", "type": "CamParameters"},
                ],
                "type": "SEQUENCE",
            },
            "DangerousGoodsContainer": {
                "members": [
                    {"name": "dangerousGoodsBasic", "type": "DangerousGoodsBasic"}
                ],
                "type": "SEQUENCE",
            },
            "EmergencyContainer": {
                "members": [
                    {"name": "lightBarSirenInUse", "type": "LightBarSirenInUse"},
                    {
            ...
            "LowFrequencyContainer": {
                "members": [
                    {
                        "name": "basicVehicleContainerLowFrequency",
            ...
            "PublicTransportContainer": {
                "members": [
                    {"name": "embarkationStatus", "type": "EmbarkationStatus"},
                    {"name": "ptActivation", "optional": True, "type": "PtActivation"},
                ],
                "type": "SEQUENCE",
            },
            "RSUContainerHighFrequency": {
                "members": [
                    {
                        "name": "protectedCommunicationZonesRSU",
                        "optional": True,
            ...
            "RoadWorksContainerBasic": {
                "members": [
                    {
                        "name": "roadworksSubCauseCode",
                        "optional": True,
                        "type": "RoadworksSubCauseCode",
                    },
                    {"name": "lightBarSirenInUse", "type": "LightBarSirenInUse"},
                    {"name": "closedLanes", "optional": True, "type": "ClosedLanes"},
                ],
                "type": "SEQUENCE",
            },
            "SafetyCarContainer": {
                "members": [
                    ...
                    {"name": "trafficRule", "optional": True, "type": "TrafficRule"},
                    {"name": "speedLimit", "optional": True, "type": "SpeedLimit"},
                ],
                "type": "SEQUENCE",
            },
            "SpecialTransportContainer": {
                "members": [
                    {"name": "specialTransportType", "type": "SpecialTransportType"},
                    {"name": "lightBarSirenInUse", "type": "LightBarSirenInUse"},
                ],
                "type": "SEQUENCE",
            },
            "SpecialVehicleContainer": {
                "members": [
                    ...
                    {"name": "rescueContainer", "type": "RescueContainer"},
                    {"name": "emergencyContainer", "type": "EmergencyContainer"},
                    {"name": "safetyCarContainer", "type": "SafetyCarContainer"},
                    None,
                ],
                "type": "CHOICE",
            },
