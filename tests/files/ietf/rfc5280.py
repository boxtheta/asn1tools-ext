EXPECTED = {
    "PKIX1Explicit88": {
        ...
        "types": {
            ...
            "AlgorithmIdentifier": {
                "members": [
                    {"name": "algorithm", "type": "OBJECT IDENTIFIER"},
                    {
                        "choices": {},
                        "name": "parameters",
                        "optional": True,
            ...
            "AttributeTypeAndValue": {
                "members": [
                    {"name": "type", "type": "AttributeType"},
                    {"name": "value", "type": "AttributeValue"},
                ],
                "type": "SEQUENCE",
            },
            ...
            "BuiltInDomainDefinedAttributes": {
                "element": {"type": "BuiltInDomainDefinedAttribute"},
                "size": [(1, "ub-domain-defined-attributes")],
                "type": "SEQUENCE OF",
            },
            "BuiltInStandardAttributes": {
                "members": [
                    {"name": "country-name", "optional": True, "type": "CountryName"},
                    {
                    ...
                    },
                    {
                        ...
                        "optional": True,
                        "tag": {"kind": "IMPLICIT", "number": 4},
                        "type": "NumericUserIdentifier",
                    },
                    {
                        "name": "personal-name",
                        "optional": True,
                        "tag": {"kind": "IMPLICIT", "number": 5},
                        "type": "PersonalName",
                    },
                    {
                        "name": "organizational-unit-names",
                        "optional": True,
                        "tag": {"kind": "IMPLICIT", "number": 6},
            ...
            "Certificate": {
                "members": [
                    {"name": "tbsCertificate", "type": "TBSCertificate"},
                    {"name": "signatureAlgorithm", "type": "AlgorithmIdentifier"},
                    {"name": "signature", "type": "BIT STRING"},
                ],
                "type": "SEQUENCE",
            },
            "CertificateList": {
                "members": [
                    {"name": "tbsCertList", "type": "TBSCertList"},
                    {"name": "signatureAlgorithm", "type": "AlgorithmIdentifier"},
                    {"name": "signature", "type": "BIT STRING"},
                ],
                "type": "SEQUENCE",
            ...
            "DirectoryString": {
                "members": [
                    ...
                    {"name": "utf8String", "size": [(1, "MAX")], "type": "UTF8String"},
                    {"name": "bmpString", "size": [(1, "MAX")], "type": "BMPString"},
                ],
                "type": "CHOICE",
            },
            ...
            "Extension": {
                "members": [
                    {"name": "extnID", "type": "OBJECT IDENTIFIER"},
                    {"default": False, "name": "critical", "type": "BOOLEAN"},
                    {"name": "extnValue", "type": "OCTET STRING"},
                ],
                "type": "SEQUENCE",
            },
            "ExtensionAttribute": {
                "members": [
                    {
                        ...
                        "restricted-to": [(0, "ub-extension-attributes")],
                        "tag": {"kind": "IMPLICIT", "number": 0},
                        "type": "INTEGER",
                    },
                    {
            ...
            "ExtensionAttributes": {
                "element": {"type": "ExtensionAttribute"},
                "size": [(1, "ub-extension-attributes")],
                "type": "SET OF",
            },
            ...
            "Name": {
                "members": [{"name": "rdnSequence", "type": "RDNSequence"}],
                "type": "CHOICE",
            },
            ...
            "ORAddress": {
                "members": [
                    {
                        "name": "built-in-standard-attributes",
            ...
            "OrganizationalUnitNames": {
                "element": {"type": "OrganizationalUnitName"},
                "size": [(1, "ub-organizational-units")],
                "type": "SEQUENCE OF",
            },
            "PDSName": {"size": [(1, "ub-pds-name-length")], "type": "PrintableString"},
            "PDSParameter": {
                "members": [
                    {
                ...
                "members": [
                    {
                        "name": "pSelector",
                        "optional": True,
                        "tag": {"kind": "EXPLICIT", "number": 0},
                        "type": "OCTET STRING",
                    },
                    {
                        "name": "sSelector",
                        "optional": True,
                        "tag": {"kind": "EXPLICIT", "number": 1},
                        "type": "OCTET STRING",
                    },
                    {
                        "name": "tSelector",
                        "optional": True,
                        "tag": {"kind": "EXPLICIT", "number": 2},
                        "type": "OCTET STRING",
                    },
                    {
            ...
            "RDNSequence": {
                "element": {"type": "RelativeDistinguishedName"},
                "type": "SEQUENCE OF",
            },
            ...
            "SubjectPublicKeyInfo": {
                "members": [
                    ...
                    {"name": "subjectPublicKey", "type": "BIT STRING"},
                ],
                "type": "SEQUENCE",
            },
            "TBSCertList": {
                "members": [
                    {"name": "version", "optional": True, "type": "Version"},
                    {"name": "signature", "type": "AlgorithmIdentifier"},
                    {"name": "issuer", "type": "Name"},
                    {"name": "thisUpdate", "type": "Time"},
                    {"name": "nextUpdate", "optional": True, "type": "Time"},
                    {
                        "element": {
                            "members": [
                                {
            ...
            "TBSCertificate": {
                "members": [
                    ...
                    {"name": "serialNumber", "type": "CertificateSerialNumber"},
                    {"name": "signature", "type": "AlgorithmIdentifier"},
                    {"name": "issuer", "type": "Name"},
            ...
            "TeletexDomainDefinedAttributes": {
                "element": {"type": "TeletexDomainDefinedAttribute"},
                "size": [(1, "ub-domain-defined-attributes")],
                "type": "SEQUENCE OF",
            },
            ...
            "TeletexOrganizationalUnitNames": {
                "element": {"type": "TeletexOrganizationalUnitName"},
                "size": [(1, "ub-organizational-units")],
                "type": "SEQUENCE OF",
            },
            "TeletexPersonalName": {
            ...
            "TerminalType": {
                ...
                "restricted-to": [(0, "ub-integer-options")],
                "type": "INTEGER",
            },
            "Time": {
                "members": [
                    {"name": "utcTime", "type": "UTCTime"},
                    {"name": "generalTime", "type": "GeneralizedTime"},
                ],
                "type": "CHOICE",
            },
                ...
                "members": [
                    {
                        ...
                        "optional": True,
                        "size": [(1, "ub-pds-physical-address-lines")],
                        "type": "SEQUENCE OF",
                    },
                    {
                        "name": "teletex-string",
            ...
            "Validity": {
                "members": [
                    {"name": "notBefore", "type": "Time"},
                    {"name": "notAfter", "type": "Time"},
                ],
                "type": "SEQUENCE",
            },
            "Version": {
                "named-numbers": {"v1": 0, "v2": 1, "v3": 2},
                "type": "INTEGER",
            },
            "X121Address": {
            ...
            "X520countryName": {"size": [2], "type": "PrintableString"},
        ...
        "values": {
            "common-name": {"type": "INTEGER", "value": 1},
            "extended-network-address": {"type": "INTEGER", "value": 22},
            "extension-OR-address-components": {"type": "INTEGER", "value": 12},
            "extension-physical-delivery-address-components": {
                "type": "INTEGER",
                "value": 15,
            },
            "id-ad": {"type": "OBJECT IDENTIFIER", "value": ["id-pkix", 48]},
            "id-ad-caIssuers": {"type": "OBJECT IDENTIFIER", "value": ["id-ad", 2]},
            "id-ad-caRepository": {"type": "OBJECT IDENTIFIER", "value": ["id-ad", 5]},
            "id-ad-ocsp": {"type": "OBJECT IDENTIFIER", "value": ["id-ad", 1]},
            "id-ad-timeStamping": {"type": "OBJECT IDENTIFIER", "value": ["id-ad", 3]},
            "id-at": {
                "type": "OBJECT IDENTIFIER",
                "value": [("joint-iso-ccitt", 2), ("ds", 5), 4],
            },
            ...
            "id-emailAddress": {"type": "AttributeType", "value": None},
            "id-kp": {"type": "OBJECT IDENTIFIER", "value": ["id-pkix", 3]},
            "id-pe": {"type": "OBJECT IDENTIFIER", "value": ["id-pkix", 1]},
            "id-pkix": {
                "type": "OBJECT IDENTIFIER",
                "value": [
                    ("iso", 1),
            ...
            "id-qt": {"type": "OBJECT IDENTIFIER", "value": ["id-pkix", 2]},
            "id-qt-cps": {"type": "OBJECT IDENTIFIER", "value": ["id-qt", 1]},
            "id-qt-unotice": {"type": "OBJECT IDENTIFIER", "value": ["id-qt", 2]},
            "local-postal-attributes": {"type": "INTEGER", "value": 21},
            ...
            "terminal-type": {"type": "INTEGER", "value": 23},
            "ub-common-name": {"type": "INTEGER", "value": 64},
            "ub-common-name-length": {"type": "INTEGER", "value": 64},
            "ub-country-name-alpha-length": {"type": "INTEGER", "value": 2},
            "ub-country-name-numeric-length": {"type": "INTEGER", "value": 3},
            "ub-domain-defined-attribute-type-length": {"type": "INTEGER", "value": 8},
            "ub-domain-defined-attribute-value-length": {
                "type": "INTEGER",
                "value": 128,
            },
            "ub-domain-defined-attributes": {"type": "INTEGER", "value": 4},
            ...
            "ub-locality-name": {"type": "INTEGER", "value": 128},
            "ub-match": {"type": "INTEGER", "value": 128},
            "ub-name": {"type": "INTEGER", "value": 32768},
            "ub-numeric-user-id-length": {"type": "INTEGER", "value": 32},
            "ub-organization-name": {"type": "INTEGER", "value": 64},
            ...
            "ub-pseudonym": {"type": "INTEGER", "value": 128},
            "ub-serial-number": {"type": "INTEGER", "value": 64},
            "ub-state-name": {"type": "INTEGER", "value": 128},
            "ub-surname-length": {"type": "INTEGER", "value": 40},
            "ub-terminal-id-length": {"type": "INTEGER", "value": 24},
            "ub-title": {"type": "INTEGER", "value": 64},
            "ub-unformatted-address-length": {"type": "INTEGER", "value": 180},
            "ub-x121-address-length": {"type": "INTEGER", "value": 16},
            "unformatted-postal-address": {"type": "INTEGER", "value": 16},
            "unique-postal-name": {"type": "INTEGER", "value": 20},
        },
    },
    "PKIX1Implicit88": {
        "extensibility-implied": False,
        ...
        "types": {
            "AccessDescription": {
                "members": [
                    {"name": "accessMethod", "type": "OBJECT IDENTIFIER"},
                    {"name": "accessLocation", "type": "GeneralName"},
                ],
                "type": "SEQUENCE",
            },
            "AnotherName": {
                "members": [
                    {"name": "type-id", "type": "OBJECT IDENTIFIER"},
                    {
                        "choices": {},
                        "name": "value",
                        "tag": {"kind": "EXPLICIT", "number": 0},
            ...
            "AuthorityInfoAccessSyntax": {
                "element": {"type": "AccessDescription"},
                "size": [(1, "MAX")],
                "type": "SEQUENCE OF",
            },
            ...
            "BaseDistance": {"restricted-to": [(0, "MAX")], "type": "INTEGER"},
            "BasicConstraints": {
                "members": [
                    {"default": False, "name": "cA", "type": "BOOLEAN"},
                    {
            ...
            "CRLDistributionPoints": {
                "element": {"type": "DistributionPoint"},
                "size": [(1, "MAX")],
                "type": "SEQUENCE OF",
            },
            ...
            "CertificatePolicies": {
                "element": {"type": "PolicyInformation"},
                "size": [(1, "MAX")],
                "type": "SEQUENCE OF",
            },
            "DisplayText": {
                "members": [
                    {"name": "ia5String", "size": [(1, 200)], "type": "IA5String"},
                    {
                        "name": "visibleString",
                        "size": [(1, 200)],
                        "type": "VisibleString",
                    },
                    {"name": "bmpString", "size": [(1, 200)], "type": "BMPString"},
                    {"name": "utf8String", "size": [(1, 200)], "type": "UTF8String"},
                ],
                "type": "CHOICE",
            },
            "DistributionPoint": {
            ...
            "DistributionPointName": {
                "members": [
                    {"name": "fullName", "tag": {"number": 0}, "type": "GeneralNames"},
                    {
            ...
            "GeneralName": {
                "members": [
                    {"name": "otherName", "tag": {"number": 0}, "type": "AnotherName"},
                    {"name": "rfc822Name", "tag": {"number": 1}, "type": "IA5String"},
                    {"name": "dNSName", "tag": {"number": 2}, "type": "IA5String"},
                    {"name": "x400Address", "tag": {"number": 3}, "type": "ORAddress"},
                    {"name": "directoryName", "tag": {"number": 4}, "type": "Name"},
                    {
                        "name": "ediPartyName",
                        "tag": {"number": 5},
                        "type": "EDIPartyName",
            ...
            "GeneralNames": {
                "element": {"type": "GeneralName"},
                "size": [(1, "MAX")],
                "type": "SEQUENCE OF",
            },
            "GeneralSubtree": {
                "members": [
                    {"name": "base", "type": "GeneralName"},
                    {
                        "default": 0,
                        "name": "minimum",
                        "tag": {"number": 0},
            ...
            "GeneralSubtrees": {
                "element": {"type": "GeneralSubtree"},
                "size": [(1, "MAX")],
                "type": "SEQUENCE OF",
            },
            "HoldInstructionCode": {"type": "OBJECT IDENTIFIER"},
            ...
            "NoticeReference": {
                "members": [
                    {"name": "organization", "type": "DisplayText"},
                    {
            ...
            "PolicyInformation": {
                "members": [
                    {"name": "policyIdentifier", "type": "CertPolicyId"},
                    {
            ...
            "PolicyMappings": {
                "element": {
                    "members": [
                        {"name": "issuerDomainPolicy", "type": "CertPolicyId"},
                        {"name": "subjectDomainPolicy", "type": "CertPolicyId"},
                    ],
                    "type": "SEQUENCE",
                },
                "size": [(1, "MAX")],
            ...
            "PolicyQualifierId": {"type": "OBJECT IDENTIFIER"},
            "PolicyQualifierInfo": {
                "members": [
                    {"name": "policyQualifierId", "type": "PolicyQualifierId"},
                    {
                        "choices": {},
                        "name": "qualifier",
                        "type": "ANY DEFINED BY",
            ...
            "SkipCerts": {"restricted-to": [(0, "MAX")], "type": "INTEGER"},
            ...
            "UserNotice": {
                "members": [
                    {"name": "noticeRef", "optional": True, "type": "NoticeReference"},
                    {"name": "explicitText", "optional": True, "type": "DisplayText"},
                ],
                "type": "SEQUENCE",
            },
        },
        "values": {
            "anyExtendedKeyUsage": {
                "type": "OBJECT IDENTIFIER",
                "value": ["id-ce-extKeyUsage", 0],
            },
            "anyPolicy": {
                "type": "OBJECT IDENTIFIER",
                "value": ["id-ce-certificatePolicies", 0],
            },
            "holdInstruction": {
                "type": "OBJECT IDENTIFIER",
                "value": [
            ...
            "id-ce": {
                "type": "OBJECT IDENTIFIER",
                "value": [("joint-iso-ccitt", 2), ("ds", 5), 29],
            },
            ...
            "id-ce-cRLNumber": {"type": "OBJECT IDENTIFIER", "value": ["id-ce", 20]},
            ...
            "id-ce-extKeyUsage": {"type": "OBJECT IDENTIFIER", "value": ["id-ce", 37]},
            "id-ce-freshestCRL": {"type": "OBJECT IDENTIFIER", "value": ["id-ce", 46]},
            ...
            "id-ce-keyUsage": {"type": "OBJECT IDENTIFIER", "value": ["id-ce", 15]},
            ...
            "id-holdinstruction-callissuer": {
                "type": "OBJECT IDENTIFIER",
                "value": ["holdInstruction", 2],
            },
            "id-holdinstruction-none": {
                "type": "OBJECT IDENTIFIER",
                "value": ["holdInstruction", 1],
            },
            "id-holdinstruction-reject": {
                "type": "OBJECT IDENTIFIER",
                "value": ["holdInstruction", 3],
            },
            "id-kp-OCSPSigning": {"type": "OBJECT IDENTIFIER", "value": ["id-kp", 9]},
            "id-kp-clientAuth": {"type": "OBJECT IDENTIFIER", "value": ["id-kp", 2]},
            "id-kp-codeSigning": {"type": "OBJECT IDENTIFIER", "value": ["id-kp", 3]},
            "id-kp-emailProtection": {
                "type": "OBJECT IDENTIFIER",
                "value": ["id-kp", 4],
            },
            "id-kp-serverAuth": {"type": "OBJECT IDENTIFIER", "value": ["id-kp", 1]},
            "id-kp-timeStamping": {"type": "OBJECT IDENTIFIER", "value": ["id-kp", 8]},
