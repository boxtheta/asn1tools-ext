EXPECTED = {
    "ProtocolMessage": {
        ...
        "types": {
            ...
            "AsicType": {
                "named-numbers": {"nn1001": 1, "nn1002": 2, "nn1003": 3},
                "type": "INTEGER",
            },
            "BootCompleteNotification": {
                "members": [
                    {
                        "name": "asicStatus",
                        "named-numbers": {"asicExists": 0, "asicNotFound": 1},
                        "tag": {"number": 0},
                        "type": "INTEGER",
                    },
                    {
            ...
            "ErrorEntry": {
                "members": [
                    ...
                    {"name": "asic", "tag": {"number": 1}, "type": "AsicErrorEntry"},
                    {
            ...
            "ErrorFlags": {
                "named-bits": [("applicable", "0"), ("qualified", "1")],
                "type": "BIT STRING",
            },
            "ErrorInformation": {
                "members": [
                    ...
                    {
                        "element": {"tag": {"number": 0}, "type": "AsicInformation"},
                        "name": "asics",
                        "optional": True,
                        "tag": {"number": 1},
                        "type": "SEQUENCE OF",
            ...
            "ErrorThresholds": {
                "members": [
                    {
                        "element": {"tag": {"number": 0}, "type": "AsicThresholds"},
            ...
            "GestureNotification": {
                "members": [
                    {
                        "name": "gestureStatus",
                        "named-numbers": {"detection": 0, "stop": 2, "update": 1},
                        "tag": {"number": 0},
                        "type": "INTEGER",
                    },
                    {
            ...
            "Latency": {
                "tag": {"class": "APPLICATION", "number": 35},
                "type": "INTEGER",
            },
            "LedPdPlacement": {
                "named-numbers": {
            ...
            "Message": {
                "members": [
                    ...
                    },
                    {
                        "members": [
                            {
                                "element": {"type": "OpenShortInformation"},
                                "name": "openShortInfo",
                                "optional": True,
                                "tag": {"number": 0},
                                "type": "SEQUENCE OF",
                    ...
                    {
                        "name": "resultCode",
                        "named-numbers": {"fail": 1, "ok": 0},
                        "optional": True,
                        "tag": {"class": "APPLICATION", "number": 20},
                        "type": "INTEGER",
                    },
                    {
                        "members": [
                            {
                                "name": "numberOfTrackedTouches",
                                "optional": True,
                                "restricted-to": [(0, 255)],
                                "tag": {"number": 0},
                                "type": "INTEGER",
                    ...
                    },
                    {
                        "members": [
                            ...
                            },
                            {
                                ...
                                "named-numbers": {"disabled": 0, "enabled": 1},
                                "optional": True,
                                "tag": {"number": 2},
                                "type": "INTEGER",
                            },
                        ...
                        "optional": True,
                        "tag": {"class": "APPLICATION", "number": 21},
                        "type": "SEQUENCE",
                    },
                    {
                        "members": [
                            ...
                            {
                                "name": "operationType",
                                "named-numbers": {"delete": 2, "read": 0, "write": 1},
                                "tag": {"number": 1},
                                "type": "INTEGER",
                            },
                            {"name": "offset", "tag": {"number": 2}, "type": "INTEGER"},
                            {"name": "size", "tag": {"number": 3}, "type": "INTEGER"},
                            {
                                "name": "payload",
                                "optional": True,
                                "tag": {"number": 4},
                    ...
                    },
                    {
                        "name": "signalsLayout",
                        "optional": True,
                        "tag": {"class": "APPLICATION", "number": 18},
                        "type": "Vector",
                    },
                    {
                        "members": [
                            {
                                "name": "presenceBitMask",
                                "optional": True,
                                "tag": {"number": 0},
                                "type": "BIT STRING",
                            },
                        ...
                        "name": "lighting",
                        "optional": True,
                        "tag": {"class": "APPLICATION", "number": 26},
                        "type": "SEQUENCE",
                    },
                    {
                        "members": [
                        ...
                        "name": "lowSignal",
                        "optional": True,
                        "tag": {"class": "APPLICATION", "number": 28},
                        "type": "SEQUENCE",
                    },
                    {
                        "name": "errorCounterClear",
                        "optional": True,
                        "tag": {"class": "APPLICATION", "number": 31},
                        "type": "NULL",
                    },
                    {
                        "name": "errorInformation",
                        "optional": True,
                        "tag": {"class": "APPLICATION", "number": 32},
                        "type": "ErrorInformation",
                    },
                    {
                        "name": "errorLog",
                        "named-numbers": {"allSessions": -2, "currentSession": -1},
                        "optional": True,
                        "tag": {"class": "APPLICATION", "number": 33},
                        "type": "INTEGER",
                    },
                    {
                        "name": "errorThresholds",
                        "optional": True,
                        "tag": {"class": "APPLICATION", "number": 34},
            ...
            "Notification": {
                "members": [
                    ...
                    {
                        "members": [
                            {"name": "singleTouch", "type": "TouchNotification"},
                            {
                            ...
                            {
                                "name": "airSignals",
                                "tag": {"class": "APPLICATION", "number": 17},
                                "type": "Vector",
                            },
                            {
                                "name": "airMaximum",
            ...
            "OpenShortInformation": {
                "members": [
                    ...
                    {"name": "ledOpen", "tag": {"number": 1}, "type": "BIT STRING"},
                    {"name": "ledShort", "tag": {"number": 2}, "type": "BIT STRING"},
                    {
                        "name": "pdOpen",
                        "optional": True,
                        "tag": {"number": 3},
                    ...
                    {"name": "pdShort", "tag": {"number": 4}, "type": "BIT STRING"},
                ],
            ...
            "ProtocolMessage": {
                "members": [
                    {
                        "name": "request",
                        "tag": {"class": "PRIVATE", "number": 14},
                        "type": "Message",
                    },
                    {
                        "name": "response",
                        "tag": {"class": "PRIVATE", "number": 15},
                        "type": "Message",
                    },
                    {
                        "name": "notification",
                        "tag": {"class": "PRIVATE", "number": 16},
                        "type": "Notification",
                    },
                ],
                "type": "CHOICE",
            ...
            "RawData": {
                "element": {"type": "VariableSizeIntegerString"},
                "type": "SEQUENCE OF",
            },
            ...
            "StatusNotification": {
                ...
                "tag": {"class": "APPLICATION", "number": 27},
                "type": "SEQUENCE",
            },
            "StorageArea": {
                "members": [
                    ...
                    },
                    {
                        ...
                        "named-numbers": {"external": 1, "internal": 0, "removable": 2},
                        "optional": True,
                        "tag": {"number": 3},
                        "type": "INTEGER",
                    },
                    {"name": "storageSize", "tag": {"number": 4}, "type": "INTEGER"},
                ],
                "type": "SEQUENCE",
            },
            "StorageIdentifier": {"restricted-to": [(0, 127)], "type": "INTEGER"},
            ...
            "VariableSizeIntegerString": {
                "members": [
                    {"name": "uint8", "tag": {"number": 0}, "type": "OCTET STRING"},
                    {"name": "uint12", "tag": {"number": 1}, "type": "OCTET STRING"},
                    {"name": "uint16", "tag": {"number": 2}, "type": "OCTET STRING"},
                ],
                "type": "CHOICE",
            },
            "Vector": {
                "members": [
                    ...
                    {
                        "element": {"tag": {"number": 0}, "type": "INTEGER"},
                        "name": "shape",
                        "optional": True,
                        "tag": {"number": 1},
                        "type": "SEQUENCE OF",
            ...
            "VisibleLedDriverThresholds": {
                "members": [
                    {
                        "name": "visibleLedDriverIdentifier",
                        "optional": True,
                        "tag": {"number": 0},
                        "type": "INTEGER",
                    },
