...
class Asn1ToolsPerTest(Asn1ToolsBaseTest):
    ...
    def test_boolean(self):
        ...
        self.assertEqual(str(cm.exception), "A: out of data (At bit offset: 0)")
    ...
    def test_integer(self):
        ...
        datas = [
            ...
            ("S", {"a": True, "b": 0, "c": True}, b"\x90\x27\x10\x80"),
        ]
    ...
    def test_real(self):
        ...
        datas = [
            ...
            ("B", {"a": 1000000000}, b"\x00\x05\x80\x09\x1d\xcd\x65"),
        ]
    ...
    def test_bit_string(self):
        ...
        datas = [
            ...
            ("A", (2048 * b"\x55", 16384), b"\xc1" + 2048 * b"\x55" + b"\x00"),
    ...
    def test_octet_string(self):
        ...
        datas = [
            ...
            ("F", {"a": True, "b": b"\x12", "c": b"\x34\x56"}, b"\x89\x1a\x2b\x00"),
            ("G", {"a": True, "b": b"\x00\x01\x02"}, b"\x80\x00\x01\x02"),
            ("H", 32767 * b"\x01\x02" + b"\x01", 32767 * b"\x01\x02" + b"\x01"),
            ("I", 32768 * b"\x01\x02", b"\xc4" + 32768 * b"\x01\x02" + b"\x00"),
            (
                "A",
            ...
            (
                ...
                b"\xc1" + 4095 * b"\x00\x01\x02\x03" + b"\x00\x01\x02\x03" + b"\x00",
            ),
            (
                "A",
                4095 * b"\x00\x01\x02\x03" + b"\x00\x01\x02\x03\x00",
                b"\xc1"
                + 4095 * b"\x00\x01\x02\x03"
                + b"\x00\x01\x02\x03"
                + b"\x01"
                + b"\x00",
            ),
    ...
    def test_external(self):
        foo = asn1tools.compile_string(
            "Foo DEFINITIONS AUTOMATIC TAGS ::= BEGIN A ::= EXTERNAL END", "per"
        )

        datas = [("A", {"encoding": ("octet-aligned", b"\x12")}, b"\x08\x01\x12")]
    ...
    def test_enumerated(self):
        ...
        self.assertEqual(
            str(cm.exception), "C: Expected enumeration index 0, 1 or 2, but got 3."
        )
    ...
    def test_sequence(self):
        ...
        datas = [
            ...
            ("R", {"a": {"a": True, "b": True}, "b": 100}, b"\xc0\x40\x01\x80\x01\x64"),
            ("S", {"a": True, "b": {"a": True, "b": True}}, b"\xc0\x40\x01\x70"),
            ("T", {"a": [{}]}, b"\x80\x01\x00"),
        ...
        self.assertEqual(foo.decode("P", b"\x80\x80\x01\x40"), {"a": True, "b": True})
        ...
        self.assertEqual(
            foo.decode("Q", b"\xc0\x40\x01\x80\x01\x64"), {"a": {"a": True}, "b": 100}
        )
        ...
        self.assertEqual(str(cm.exception), "U.a.a: out of data (At bit offset: 32)")
        ...
        self.assertEqual(
            str(cm.exception), "K: Sequence member 'a' not found in {'b': True}."
        )
    ...
    def test_sequence_of(self):
        ...
        datas = [
            ...
            ("G", 6 * [1], b"\x80\x06\x01\x01\x01\x01\x01\x01\x01\x01\x01\x01\x01\x01"),
            ("H", [1], b"\x01\x01\x01"),
    ...
    def test_choice(self):
        ...
        self.assertEqual(
            str(cm.exception), "K: Expected choice index 0, 1 or 2, but got 3."
        )
        ...
        # Bad value.
        with self.assertRaises(asn1tools.EncodeError) as cm:
            foo.encode("A", ("b", True), check_types=False, check_constraints=False)
    ...
    def test_utf8_string(self):
        ...
        datas = [
            ...
            ("A", {"a": True, "b": "1", "c": "foo"}, b"\xc0\x01\x31\x03\x66\x6f\x6f"),
            ("A", {"a": True, "b": 300 * "1"}, b"\x40\x81\x2c" + 300 * b"\x31"),
            ...
            ("E", "1𐈃Q", b"\x06\x31\xf0\x90\x88\x83\x51"),
        ]
        ...
        self.assertEqual(
            str(cm.exception), "A.b: Bad length determinant fragmentation value 0xc5."
        )

        with self.assertRaises(asn1tools.DecodeError) as cm:
            foo.decode("A", b"\x40\xc1\x00\x00\x00\x00")

        self.assertEqual(str(cm.exception), "A.b: out of data (At bit offset: 16)")
    ...
    def test_printable_string(self):
        ...
        datas = [
            ...
            ("E", {"a": True, "b": "1", "c": True}, b"\x84\x31\x80"),
            ("F", {"a": True, "b": "123", "c": True}, b"\x80\x03\x31\x32\x33\x80"),
        ]
    ...
    def test_ia5_string(self):
        foo = asn1tools.compile_string(
            "Foo DEFINITIONS AUTOMATIC TAGS ::= BEGIN A ::= IA5String END", "per"
        )
    ...
    def test_visible_string(self):
        ...
        datas = [
            ...
            (
                ...
                + 17
                * (
                    b"\x48\x65\x6a\x48\x6f\x70\x70\x48\x61\x70"
    ...
    def test_bmp_string(self):
        ...
        datas = [
            ...
            ("B", {"a": False, "b": "K"}, b"\x00\x01\x00\x4b"),
            ("C", {"a": "123", "b": "123"}, b"\x04\x001\x002\x003\x02\x001\x002\x003"),
        ]
        ...
        self.assertEqual(
            str(cm.exception),
            "A: Expected a value in %s, but got %d."
            % (
                valid_chars,
                0xD800,
            ),
    ...
    def test_universal_string(self):
        ...
        datas = [
            ...
            ("B", {"a": False, "b": "K"}, b"\x00\x01\x00\x00\x00\x4b"),
        ]
    ...
    def test_foo(self):
        ...
        self.assertEqual(encoded, b"\x01\x01\x09\x49\x73\x20\x31\x2b\x31\x3d\x33\x3f")
    ...
    def test_bar(self):
        ...
        decoded = {
            "headerOnly": True,
            "lock": False,
            "acceptTypes": {"standardTypes": [(b"\x40", 2), (b"\x80", 1)]},
    ...
    def test_information_object(self):
        ...
        decoded_message = {"id": 0, "value": b"\x05", "comment": "item 0", "extra": 2}

        encoded_message = b"\x01\x00\x01\x05\x06\x69\x74\x65\x6d\x20\x30\x01\x02"
        ...
        decoded_message = {"id": 0, "value": True, "comment": "item 0", "extra": 2}

        encoded_message = b"\x01\x00\x01\x80\x06\x69\x74\x65\x6d\x20\x30\x01\x02"
        ...
        decoded_message = {
            "errorCategory": "A",
            "errors": [
                {"errorCode": 1, "errorInfo": 3},
                {"errorCode": 2, "errorInfo": True},
            ],
        }

        encoded_message = b"\x41\x02\x01\x01\x02\x01\x03\x01\x02\x01\x80"

        # ToDo: Constraints are not yet implemented.
        with self.assertRaises(TypeError):
            self.assert_encode_decode(
                information_object, "ErrorReturn", decoded_message, encoded_message
            )

        # Message 4 - C.
        decoded_message = {"a": 0}

        encoded_message = b"\x00\x01\x00"

        encoded = information_object.encode("C", decoded_message)
        self.assertEqual(encoded, encoded_message)

        # Message 5 - C.
        decoded_message = {"a": 0, "b": {"a": 0}}

        encoded_message = b"\x80\x01\x00\x03\x00\x01\x00"
        ...
        # Message 6 - C.
        decoded_message = {"a": 0, "b": {"a": 0, "b": {"a": 0, "b": {"a": 0}}}}
    ...
    def test_not_support_decode_with_length(self):
        foo = asn1tools.compile_string(
            "Foo DEFINITIONS AUTOMATIC TAGS ::= BEGIN A ::= OCTET STRING END", "oer"
        )
