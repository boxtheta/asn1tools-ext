...
class Asn1ToolsUtilsTest(unittest.TestCase):
    ...
    def test_utc_time(self):
        datas = [
            ...
            ("8201021200+0100", datetime(1982, 1, 2, 12, 0, tzinfo=tzinfo(1))),
            ("8201021200-0500", datetime(1982, 1, 2, 12, 0, tzinfo=tzinfo(-5))),
            ("180102120003+0000", datetime(2018, 1, 2, 12, 0, 3, tzinfo=tzinfo(0))),
        ]
    ...
    def test_restricted_utc_time(self):
        datas = [
            ...
            (datetime(2032, 12, 31), "321231000000Z", datetime(2032, 12, 31)),
        ]
    ...
    def test_generalized_time(self):
        datas = [
            ...
            ("19820102120023.5", datetime(1982, 1, 2, 12, 0, 23, 500000)),
            ("198201021222.5", datetime(1982, 1, 2, 12, 22, 0, 500000)),
            ("198201021200.5", datetime(1982, 1, 2, 12, 0, 0, 500000)),
            ("19820102120024Z", datetime(1982, 1, 2, 12, 0, 24, tzinfo=tzinfo(0))),
            ("198201021200Z", datetime(1982, 1, 2, 12, 0, 0, tzinfo=tzinfo(0))),
            (
                "19820102120025.1Z",
            ...
            ("198201021200-1000", datetime(1982, 1, 2, 12, 0, 0, tzinfo=tzinfo(-10))),
            (
    ...
    def test_restricted_generalized_time(self):
        datas = [
            ...
            (datetime(1932, 12, 31), "19321231000000Z", datetime(1932, 12, 31)),
            (
    ...
    def test_restricted_utc_time_errors(self):
        ...
        for utc_time in datas:
            ...
            self.assertEqual(
                str(cm.exception),
                "Expected a restricted UTC time string, but got '{}'.".format(utc_time),
            )
