...
class Asn1ToolsEncodeTypeCheckerTest(unittest.TestCase):
    ...
    def assert_good_bad(
        ...
        for data, bad_datas_string in zip(bad_datas, bad_datas_strings):
            ...
            self.assertEqual(
                str(cm.exception),
                "{}, but got {}.".format(expected_type_string, bad_datas_string),
            )

    def test_boolean(self):
        self.assert_good_bad(
            "BOOLEAN",
    ...
    def test_null(self):
        self.assert_good_bad(
            "NULL", "A: Expected None", good_datas=[None], bad_datas=["1.0", 1]
        )
    ...
    def test_choice(self):
        ...
        self.assert_good_bad(
            "CHOICE { a CHOICE { b CHOICE { c NULL } } }",
    ...
    def test_information_object(self):
        ...
        decoded = {"id": 0, "value": b"\x05", "comment": "item 0", "extra": 2}
        ...
        decoded = {"id": 0, "value": True, "comment": "item 0", "extra": 2}

        information_object["InformationObject"]["ItemWithConstraints"].encode(decoded)
        ...
        with self.assertRaises(AssertionError):
            ...
            self.assertEqual(
                str(cm.exception), "Expected data of type bool, but got b'\x05'."
            )
        ...
        information_object["InformationObject"]["ErrorReturn"].encode(decoded)
