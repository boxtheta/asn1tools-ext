...
class EUTRA_RRC_Definitions:
    ...
    _BCCH_BCH_Message_message = SEQ(
        name="message",
        mode=MODE_TYPE,
        tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "BCCH-BCH-MessageType")),
    )
    ...
    # -----< BCCH-BCH-MessageType >-----#
    BCCH_BCH_MessageType = SEQ(
        name="BCCH-BCH-MessageType",
        mode=MODE_TYPE,
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "MasterInformationBlock")),
    )

    # -----< BCCH-DL-SCH-Message >-----#
    BCCH_DL_SCH_Message = SEQ(name="BCCH-DL-SCH-Message", mode=MODE_TYPE)
    _BCCH_DL_SCH_Message_message = CHOICE(
        name="message",
        mode=MODE_TYPE,
        tag=(0, TAG_CONTEXT_SPEC, TAG_EXPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "BCCH-DL-SCH-MessageType")),
    )
    ...
    _BCCH_DL_SCH_MessageType_c1 = CHOICE(
        name="c1", mode=MODE_TYPE, tag=(0, TAG_CONTEXT_SPEC, TAG_EXPLICIT)
    )
    __BCCH_DL_SCH_MessageType_c1_systemInformation = SEQ(
        name="systemInformation",
        mode=MODE_TYPE,
        tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "SystemInformation")),
    )
    __BCCH_DL_SCH_MessageType_c1_systemInformationBlockType1 = SEQ(
        name="systemInformationBlockType1",
        mode=MODE_TYPE,
        tag=(1, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "SystemInformationBlockType1")),
    )
    ...
    _BCCH_DL_SCH_MessageType_messageClassExtension = SEQ(
    ...
    _PCCH_Message_message = CHOICE(
        name="message",
        mode=MODE_TYPE,
        tag=(0, TAG_CONTEXT_SPEC, TAG_EXPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "PCCH-MessageType")),
    )
    ...
    _PCCH_MessageType_c1 = CHOICE(
        name="c1", mode=MODE_TYPE, tag=(0, TAG_CONTEXT_SPEC, TAG_EXPLICIT)
    )
    __PCCH_MessageType_c1_paging = SEQ(
        name="paging",
        mode=MODE_TYPE,
        tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "Paging")),
    )
    ...
    _PCCH_MessageType_messageClassExtension = SEQ(
        name="messageClassExtension",
        mode=MODE_TYPE,
        tag=(1, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
    )
    ...
    _DL_CCCH_Message_message = CHOICE(
        name="message",
        mode=MODE_TYPE,
        tag=(0, TAG_CONTEXT_SPEC, TAG_EXPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "DL-CCCH-MessageType")),
    )
    ...
    _DL_CCCH_MessageType_c1 = CHOICE(
        name="c1", mode=MODE_TYPE, tag=(0, TAG_CONTEXT_SPEC, TAG_EXPLICIT)
    )
    __DL_CCCH_MessageType_c1_rrcConnectionReestablishment = SEQ(
        name="rrcConnectionReestablishment",
        mode=MODE_TYPE,
        tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "RRCConnectionReestablishment")),
    )
    __DL_CCCH_MessageType_c1_rrcConnectionReestablishmentReject = SEQ(
        name="rrcConnectionReestablishmentReject",
        mode=MODE_TYPE,
        tag=(1, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(
            ("EUTRA-RRC-Definitions", "RRCConnectionReestablishmentReject")
        ),
    )
    __DL_CCCH_MessageType_c1_rrcConnectionReject = SEQ(
        name="rrcConnectionReject",
        mode=MODE_TYPE,
        tag=(2, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "RRCConnectionReject")),
    )
    __DL_CCCH_MessageType_c1_rrcConnectionSetup = SEQ(
        name="rrcConnectionSetup",
        mode=MODE_TYPE,
        tag=(3, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "RRCConnectionSetup")),
    )
    ...
    _DL_CCCH_MessageType_messageClassExtension = SEQ(
        name="messageClassExtension",
        mode=MODE_TYPE,
        tag=(1, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
    )
    ...
    _DL_DCCH_Message_message = CHOICE(
        name="message",
        mode=MODE_TYPE,
        tag=(0, TAG_CONTEXT_SPEC, TAG_EXPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "DL-DCCH-MessageType")),
    )
    ...
    _DL_DCCH_MessageType_c1 = CHOICE(
        name="c1", mode=MODE_TYPE, tag=(0, TAG_CONTEXT_SPEC, TAG_EXPLICIT)
    )
    __DL_DCCH_MessageType_c1_csfbParametersResponseCDMA2000 = SEQ(
        name="csfbParametersResponseCDMA2000",
        mode=MODE_TYPE,
        tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(
            ("EUTRA-RRC-Definitions", "CSFBParametersResponseCDMA2000")
        ),
    )
    __DL_DCCH_MessageType_c1_dlInformationTransfer = SEQ(
        name="dlInformationTransfer",
        mode=MODE_TYPE,
        tag=(1, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "DLInformationTransfer")),
    )
    __DL_DCCH_MessageType_c1_handoverFromEUTRAPreparationRequest = SEQ(
        name="handoverFromEUTRAPreparationRequest",
        mode=MODE_TYPE,
        tag=(2, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(
            ("EUTRA-RRC-Definitions", "HandoverFromEUTRAPreparationRequest")
        ),
    )
    __DL_DCCH_MessageType_c1_mobilityFromEUTRACommand = SEQ(
        name="mobilityFromEUTRACommand",
        mode=MODE_TYPE,
        tag=(3, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "MobilityFromEUTRACommand")),
    )
    __DL_DCCH_MessageType_c1_rrcConnectionReconfiguration = SEQ(
        name="rrcConnectionReconfiguration",
        mode=MODE_TYPE,
        tag=(4, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "RRCConnectionReconfiguration")),
    )
    __DL_DCCH_MessageType_c1_rrcConnectionRelease = SEQ(
        name="rrcConnectionRelease",
        mode=MODE_TYPE,
        tag=(5, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "RRCConnectionRelease")),
    )
    __DL_DCCH_MessageType_c1_securityModeCommand = SEQ(
        name="securityModeCommand",
        mode=MODE_TYPE,
        tag=(6, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "SecurityModeCommand")),
    )
    __DL_DCCH_MessageType_c1_ueCapabilityEnquiry = SEQ(
        name="ueCapabilityEnquiry",
        mode=MODE_TYPE,
        tag=(7, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "UECapabilityEnquiry")),
    )
    __DL_DCCH_MessageType_c1_counterCheck = SEQ(
        name="counterCheck",
        mode=MODE_TYPE,
        tag=(8, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "CounterCheck")),
    )
    __DL_DCCH_MessageType_c1_spare7 = NULL(
        name="spare7", mode=MODE_TYPE, tag=(9, TAG_CONTEXT_SPEC, TAG_IMPLICIT)
    )
    __DL_DCCH_MessageType_c1_spare6 = NULL(
        name="spare6", mode=MODE_TYPE, tag=(10, TAG_CONTEXT_SPEC, TAG_IMPLICIT)
    )
    __DL_DCCH_MessageType_c1_spare5 = NULL(
        name="spare5", mode=MODE_TYPE, tag=(11, TAG_CONTEXT_SPEC, TAG_IMPLICIT)
    )
    __DL_DCCH_MessageType_c1_spare4 = NULL(
        name="spare4", mode=MODE_TYPE, tag=(12, TAG_CONTEXT_SPEC, TAG_IMPLICIT)
    )
    __DL_DCCH_MessageType_c1_spare3 = NULL(
        name="spare3", mode=MODE_TYPE, tag=(13, TAG_CONTEXT_SPEC, TAG_IMPLICIT)
    )
    __DL_DCCH_MessageType_c1_spare2 = NULL(
        name="spare2", mode=MODE_TYPE, tag=(14, TAG_CONTEXT_SPEC, TAG_IMPLICIT)
    )
    __DL_DCCH_MessageType_c1_spare1 = NULL(
        name="spare1", mode=MODE_TYPE, tag=(15, TAG_CONTEXT_SPEC, TAG_IMPLICIT)
    )
    ...
    _DL_DCCH_MessageType_messageClassExtension = SEQ(
        name="messageClassExtension",
        mode=MODE_TYPE,
        tag=(1, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
    )
    ...
    _UL_CCCH_Message_message = CHOICE(
        name="message",
        mode=MODE_TYPE,
        tag=(0, TAG_CONTEXT_SPEC, TAG_EXPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "UL-CCCH-MessageType")),
    )
    ...
    _UL_CCCH_MessageType_c1 = CHOICE(
        name="c1", mode=MODE_TYPE, tag=(0, TAG_CONTEXT_SPEC, TAG_EXPLICIT)
    )
    __UL_CCCH_MessageType_c1_rrcConnectionReestablishmentRequest = SEQ(
        name="rrcConnectionReestablishmentRequest",
        mode=MODE_TYPE,
        tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(
            ("EUTRA-RRC-Definitions", "RRCConnectionReestablishmentRequest")
        ),
    )
    __UL_CCCH_MessageType_c1_rrcConnectionRequest = SEQ(
        name="rrcConnectionRequest",
        mode=MODE_TYPE,
        tag=(1, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "RRCConnectionRequest")),
    )
    ...
    _UL_CCCH_MessageType_messageClassExtension = SEQ(
        name="messageClassExtension",
        mode=MODE_TYPE,
        tag=(1, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
    )
    ...
    _UL_DCCH_Message_message = CHOICE(
        name="message",
        mode=MODE_TYPE,
        tag=(0, TAG_CONTEXT_SPEC, TAG_EXPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "UL-DCCH-MessageType")),
    )
    ...
    _UL_DCCH_MessageType_c1 = CHOICE(
        name="c1", mode=MODE_TYPE, tag=(0, TAG_CONTEXT_SPEC, TAG_EXPLICIT)
    )
    __UL_DCCH_MessageType_c1_csfbParametersRequestCDMA2000 = SEQ(
        name="csfbParametersRequestCDMA2000",
        mode=MODE_TYPE,
        tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "CSFBParametersRequestCDMA2000")),
    )
    __UL_DCCH_MessageType_c1_measurementReport = SEQ(
        name="measurementReport",
        mode=MODE_TYPE,
        tag=(1, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "MeasurementReport")),
    )
    __UL_DCCH_MessageType_c1_rrcConnectionReconfigurationComplete = SEQ(
        name="rrcConnectionReconfigurationComplete",
        mode=MODE_TYPE,
        tag=(2, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(
            ("EUTRA-RRC-Definitions", "RRCConnectionReconfigurationComplete")
        ),
    )
    __UL_DCCH_MessageType_c1_rrcConnectionReestablishmentComplete = SEQ(
        name="rrcConnectionReestablishmentComplete",
        mode=MODE_TYPE,
        tag=(3, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(
            ("EUTRA-RRC-Definitions", "RRCConnectionReestablishmentComplete")
        ),
    )
    __UL_DCCH_MessageType_c1_rrcConnectionSetupComplete = SEQ(
        name="rrcConnectionSetupComplete",
        mode=MODE_TYPE,
        tag=(4, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "RRCConnectionSetupComplete")),
    )
    __UL_DCCH_MessageType_c1_securityModeComplete = SEQ(
        name="securityModeComplete",
        mode=MODE_TYPE,
        tag=(5, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "SecurityModeComplete")),
    )
    __UL_DCCH_MessageType_c1_securityModeFailure = SEQ(
        name="securityModeFailure",
        mode=MODE_TYPE,
        tag=(6, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "SecurityModeFailure")),
    )
    __UL_DCCH_MessageType_c1_ueCapabilityInformation = SEQ(
        name="ueCapabilityInformation",
        mode=MODE_TYPE,
        tag=(7, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "UECapabilityInformation")),
    )
    __UL_DCCH_MessageType_c1_ulHandoverPreparationTransfer = SEQ(
        name="ulHandoverPreparationTransfer",
        mode=MODE_TYPE,
        tag=(8, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "ULHandoverPreparationTransfer")),
    )
    __UL_DCCH_MessageType_c1_ulInformationTransfer = SEQ(
        name="ulInformationTransfer",
        mode=MODE_TYPE,
        tag=(9, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "ULInformationTransfer")),
    )
    __UL_DCCH_MessageType_c1_counterCheckResponse = SEQ(
        name="counterCheckResponse",
        mode=MODE_TYPE,
        tag=(10, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "CounterCheckResponse")),
    )
    __UL_DCCH_MessageType_c1_spare5 = NULL(
        name="spare5", mode=MODE_TYPE, tag=(11, TAG_CONTEXT_SPEC, TAG_IMPLICIT)
    )
    __UL_DCCH_MessageType_c1_spare4 = NULL(
        name="spare4", mode=MODE_TYPE, tag=(12, TAG_CONTEXT_SPEC, TAG_IMPLICIT)
    )
    __UL_DCCH_MessageType_c1_spare3 = NULL(
        name="spare3", mode=MODE_TYPE, tag=(13, TAG_CONTEXT_SPEC, TAG_IMPLICIT)
    )
    __UL_DCCH_MessageType_c1_spare2 = NULL(
        name="spare2", mode=MODE_TYPE, tag=(14, TAG_CONTEXT_SPEC, TAG_IMPLICIT)
    )
    __UL_DCCH_MessageType_c1_spare1 = NULL(
        name="spare1", mode=MODE_TYPE, tag=(15, TAG_CONTEXT_SPEC, TAG_IMPLICIT)
    )
    ...
    _UL_DCCH_MessageType_messageClassExtension = SEQ(
        name="messageClassExtension",
        mode=MODE_TYPE,
        tag=(1, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
    )
    ...
    _CounterCheck_rrc_TransactionIdentifier = INT(
        name="rrc-TransactionIdentifier",
        mode=MODE_TYPE,
        tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "RRC-TransactionIdentifier")),
    )
    _CounterCheck_criticalExtensions = CHOICE(
        name="criticalExtensions",
        mode=MODE_TYPE,
        tag=(1, TAG_CONTEXT_SPEC, TAG_EXPLICIT),
    )
    __CounterCheck_criticalExtensions_c1 = CHOICE(
        name="c1", mode=MODE_TYPE, tag=(0, TAG_CONTEXT_SPEC, TAG_EXPLICIT)
    )
    ___CounterCheck_criticalExtensions_c1_counterCheck_r8 = SEQ(
        name="counterCheck-r8",
        mode=MODE_TYPE,
        tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "CounterCheck-r8-IEs")),
    )
    ___CounterCheck_criticalExtensions_c1_spare3 = NULL(
        name="spare3", mode=MODE_TYPE, tag=(1, TAG_CONTEXT_SPEC, TAG_IMPLICIT)
    )
    ___CounterCheck_criticalExtensions_c1_spare2 = NULL(
        name="spare2", mode=MODE_TYPE, tag=(2, TAG_CONTEXT_SPEC, TAG_IMPLICIT)
    )
    ___CounterCheck_criticalExtensions_c1_spare1 = NULL(
        name="spare1", mode=MODE_TYPE, tag=(3, TAG_CONTEXT_SPEC, TAG_IMPLICIT)
    )
    ...
    __CounterCheck_criticalExtensions_criticalExtensionsFuture = SEQ(
    ...
    _CounterCheck_r8_IEs_drb_CountMSB_InfoList = SEQ_OF(
        name="drb-CountMSB-InfoList",
        mode=MODE_TYPE,
        tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "DRB-CountMSB-InfoList")),
    )
    _CounterCheck_r8_IEs_nonCriticalExtension = SEQ(
    ...
    _DRB_CountMSB_InfoList__item_ = SEQ(
        name="_item_",
        mode=MODE_TYPE,
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "DRB-CountMSB-Info")),
    )
    DRB_CountMSB_InfoList._cont = _DRB_CountMSB_InfoList__item_
    DRB_CountMSB_InfoList._const_sz = ASN1Set(
        rv=[], rr=[ASN1RangeInt(lb=1, ub=11)], ev=None, er=[]
    )

    # -----< DRB-CountMSB-Info >-----#
    DRB_CountMSB_Info = SEQ(name="DRB-CountMSB-Info", mode=MODE_TYPE)
    _DRB_CountMSB_Info_drb_Identity = INT(
        name="drb-Identity",
        mode=MODE_TYPE,
        tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "DRB-Identity")),
    )
    _DRB_CountMSB_Info_countMSB_Uplink = INT(
        name="countMSB-Uplink", mode=MODE_TYPE, tag=(1, TAG_CONTEXT_SPEC, TAG_IMPLICIT)
    )
    _DRB_CountMSB_Info_countMSB_Uplink._const_val = ASN1Set(
        rv=[], rr=[ASN1RangeInt(lb=0, ub=33554431)], ev=None, er=[]
    )
    _DRB_CountMSB_Info_countMSB_Downlink = INT(
        name="countMSB-Downlink",
        mode=MODE_TYPE,
        tag=(2, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
    )
    _DRB_CountMSB_Info_countMSB_Downlink._const_val = ASN1Set(
        rv=[], rr=[ASN1RangeInt(lb=0, ub=33554431)], ev=None, er=[]
    )
    ...
    _CounterCheckResponse_rrc_TransactionIdentifier = INT(
        name="rrc-TransactionIdentifier",
        mode=MODE_TYPE,
        tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "RRC-TransactionIdentifier")),
    )
    _CounterCheckResponse_criticalExtensions = CHOICE(
        name="criticalExtensions",
        mode=MODE_TYPE,
        tag=(1, TAG_CONTEXT_SPEC, TAG_EXPLICIT),
    )
    __CounterCheckResponse_criticalExtensions_counterCheckResponse_r8 = SEQ(
        name="counterCheckResponse-r8",
        mode=MODE_TYPE,
        tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "CounterCheckResponse-r8-IEs")),
    )
    __CounterCheckResponse_criticalExtensions_criticalExtensionsFuture = SEQ(
        name="criticalExtensionsFuture",
        mode=MODE_TYPE,
        tag=(1, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
    )
    ...
    # -----< CounterCheckResponse-r8-IEs >-----#
    CounterCheckResponse_r8_IEs = SEQ(
        name="CounterCheckResponse-r8-IEs", mode=MODE_TYPE
    )
    _CounterCheckResponse_r8_IEs_drb_CountInfoList = SEQ_OF(
        name="drb-CountInfoList",
        mode=MODE_TYPE,
        tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "DRB-CountInfoList")),
    )
    _CounterCheckResponse_r8_IEs_nonCriticalExtension = SEQ(
        name="nonCriticalExtension",
        mode=MODE_TYPE,
        tag=(1, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        opt=True,
    ...
    _DRB_CountInfoList__item_ = SEQ(
        name="_item_",
        mode=MODE_TYPE,
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "DRB-CountInfo")),
    )
    DRB_CountInfoList._cont = _DRB_CountInfoList__item_
    DRB_CountInfoList._const_sz = ASN1Set(
        rv=[], rr=[ASN1RangeInt(lb=0, ub=11)], ev=None, er=[]
    )

    # -----< DRB-CountInfo >-----#
    DRB_CountInfo = SEQ(name="DRB-CountInfo", mode=MODE_TYPE)
    _DRB_CountInfo_drb_Identity = INT(
        name="drb-Identity",
        mode=MODE_TYPE,
        tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "DRB-Identity")),
    )
    _DRB_CountInfo_count_Uplink = INT(
        name="count-Uplink", mode=MODE_TYPE, tag=(1, TAG_CONTEXT_SPEC, TAG_IMPLICIT)
    )
    _DRB_CountInfo_count_Uplink._const_val = ASN1Set(
        rv=[], rr=[ASN1RangeInt(lb=0, ub=4294967295)], ev=None, er=[]
    )
    _DRB_CountInfo_count_Downlink = INT(
        name="count-Downlink", mode=MODE_TYPE, tag=(2, TAG_CONTEXT_SPEC, TAG_IMPLICIT)
    )
    _DRB_CountInfo_count_Downlink._const_val = ASN1Set(
        rv=[], rr=[ASN1RangeInt(lb=0, ub=4294967295)], ev=None, er=[]
    )
    ...
    # -----< CSFBParametersRequestCDMA2000 >-----#
    CSFBParametersRequestCDMA2000 = SEQ(
        name="CSFBParametersRequestCDMA2000", mode=MODE_TYPE
    )
    _CSFBParametersRequestCDMA2000_criticalExtensions = CHOICE(
        name="criticalExtensions",
        mode=MODE_TYPE,
        tag=(0, TAG_CONTEXT_SPEC, TAG_EXPLICIT),
    )
    __CSFBParametersRequestCDMA2000_criticalExtensions_csfbParametersRequestCDMA2000_r8 = SEQ(
        name="csfbParametersRequestCDMA2000-r8",
        mode=MODE_TYPE,
        tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(
            ("EUTRA-RRC-Definitions", "CSFBParametersRequestCDMA2000-r8-IEs")
        ),
    )
    __CSFBParametersRequestCDMA2000_criticalExtensions_criticalExtensionsFuture = SEQ(
        name="criticalExtensionsFuture",
        mode=MODE_TYPE,
        tag=(1, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
    )
    ...
    __CSFBParametersRequestCDMA2000_criticalExtensions_criticalExtensionsFuture._ext = (
        None
    )
    ...
    # -----< CSFBParametersRequestCDMA2000-r8-IEs >-----#
    CSFBParametersRequestCDMA2000_r8_IEs = SEQ(
        name="CSFBParametersRequestCDMA2000-r8-IEs", mode=MODE_TYPE
    )
    _CSFBParametersRequestCDMA2000_r8_IEs_nonCriticalExtension = SEQ(
        name="nonCriticalExtension",
        mode=MODE_TYPE,
        tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        opt=True,
    ...
    # -----< CSFBParametersResponseCDMA2000 >-----#
    CSFBParametersResponseCDMA2000 = SEQ(
        name="CSFBParametersResponseCDMA2000", mode=MODE_TYPE
    )
    _CSFBParametersResponseCDMA2000_rrc_TransactionIdentifier = INT(
        name="rrc-TransactionIdentifier",
        mode=MODE_TYPE,
        tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "RRC-TransactionIdentifier")),
    )
    _CSFBParametersResponseCDMA2000_criticalExtensions = CHOICE(
        name="criticalExtensions",
        mode=MODE_TYPE,
        tag=(1, TAG_CONTEXT_SPEC, TAG_EXPLICIT),
    )
    __CSFBParametersResponseCDMA2000_criticalExtensions_csfbParametersResponseCDMA2000_r8 = SEQ(
        name="csfbParametersResponseCDMA2000-r8",
        mode=MODE_TYPE,
        tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(
            ("EUTRA-RRC-Definitions", "CSFBParametersResponseCDMA2000-r8-IEs")
        ),
    )
    __CSFBParametersResponseCDMA2000_criticalExtensions_criticalExtensionsFuture = SEQ(
        name="criticalExtensionsFuture",
        mode=MODE_TYPE,
        tag=(1, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
    )
    ...
    # -----< CSFBParametersResponseCDMA2000-r8-IEs >-----#
    CSFBParametersResponseCDMA2000_r8_IEs = SEQ(
        name="CSFBParametersResponseCDMA2000-r8-IEs", mode=MODE_TYPE
    )
    _CSFBParametersResponseCDMA2000_r8_IEs_rand = BIT_STR(
        name="rand",
        mode=MODE_TYPE,
        tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "RAND-CDMA2000")),
    )
    _CSFBParametersResponseCDMA2000_r8_IEs_mobilityParameters = OCT_STR(
        name="mobilityParameters",
        mode=MODE_TYPE,
        tag=(1, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "MobilityParametersCDMA2000")),
    )
    _CSFBParametersResponseCDMA2000_r8_IEs_nonCriticalExtension = SEQ(
        name="nonCriticalExtension",
        mode=MODE_TYPE,
        tag=(2, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        opt=True,
    ...
    _DLInformationTransfer_rrc_TransactionIdentifier = INT(
        name="rrc-TransactionIdentifier",
        mode=MODE_TYPE,
        tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "RRC-TransactionIdentifier")),
    )
    _DLInformationTransfer_criticalExtensions = CHOICE(
        name="criticalExtensions",
        mode=MODE_TYPE,
        tag=(1, TAG_CONTEXT_SPEC, TAG_EXPLICIT),
    )
    __DLInformationTransfer_criticalExtensions_c1 = CHOICE(
        name="c1", mode=MODE_TYPE, tag=(0, TAG_CONTEXT_SPEC, TAG_EXPLICIT)
    )
    ___DLInformationTransfer_criticalExtensions_c1_dlInformationTransfer_r8 = SEQ(
        name="dlInformationTransfer-r8",
        mode=MODE_TYPE,
        tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "DLInformationTransfer-r8-IEs")),
    )
    ___DLInformationTransfer_criticalExtensions_c1_spare3 = NULL(
        name="spare3", mode=MODE_TYPE, tag=(1, TAG_CONTEXT_SPEC, TAG_IMPLICIT)
    )
    ___DLInformationTransfer_criticalExtensions_c1_spare2 = NULL(
        name="spare2", mode=MODE_TYPE, tag=(2, TAG_CONTEXT_SPEC, TAG_IMPLICIT)
    )
    ___DLInformationTransfer_criticalExtensions_c1_spare1 = NULL(
        name="spare1", mode=MODE_TYPE, tag=(3, TAG_CONTEXT_SPEC, TAG_IMPLICIT)
    )
    ...
    __DLInformationTransfer_criticalExtensions_criticalExtensionsFuture = SEQ(
        name="criticalExtensionsFuture",
        mode=MODE_TYPE,
        tag=(1, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
    )
    __DLInformationTransfer_criticalExtensions_criticalExtensionsFuture._cont = (
        ASN1Dict([])
    )
    ...
    # -----< DLInformationTransfer-r8-IEs >-----#
    DLInformationTransfer_r8_IEs = SEQ(
        name="DLInformationTransfer-r8-IEs", mode=MODE_TYPE
    )
    _DLInformationTransfer_r8_IEs_dedicatedInfoType = CHOICE(
        name="dedicatedInfoType",
        mode=MODE_TYPE,
        tag=(0, TAG_CONTEXT_SPEC, TAG_EXPLICIT),
    )
    __DLInformationTransfer_r8_IEs_dedicatedInfoType_dedicatedInfoNAS = OCT_STR(
        name="dedicatedInfoNAS",
        mode=MODE_TYPE,
        tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "DedicatedInfoNAS")),
    )
    __DLInformationTransfer_r8_IEs_dedicatedInfoType_dedicatedInfoCDMA2000_1XRTT = (
        OCT_STR(
            ...
            mode=MODE_TYPE,
            tag=(1, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
            typeref=ASN1RefType(("EUTRA-RRC-Definitions", "DedicatedInfoCDMA2000")),
        )
    )
    ...
    _DLInformationTransfer_r8_IEs_nonCriticalExtension = SEQ(
        name="nonCriticalExtension",
        mode=MODE_TYPE,
        tag=(1, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        opt=True,
    ...
    # -----< HandoverFromEUTRAPreparationRequest >-----#
    HandoverFromEUTRAPreparationRequest = SEQ(
        name="HandoverFromEUTRAPreparationRequest", mode=MODE_TYPE
    )
    _HandoverFromEUTRAPreparationRequest_rrc_TransactionIdentifier = INT(
        name="rrc-TransactionIdentifier",
        mode=MODE_TYPE,
        tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "RRC-TransactionIdentifier")),
    )
    _HandoverFromEUTRAPreparationRequest_criticalExtensions = CHOICE(
        name="criticalExtensions",
        mode=MODE_TYPE,
        tag=(1, TAG_CONTEXT_SPEC, TAG_EXPLICIT),
    )
    __HandoverFromEUTRAPreparationRequest_criticalExtensions_c1 = CHOICE(
        name="c1", mode=MODE_TYPE, tag=(0, TAG_CONTEXT_SPEC, TAG_EXPLICIT)
    )
    ___HandoverFromEUTRAPreparationRequest_criticalExtensions_c1_handoverFromEUTRAPreparationRequest_r8 = SEQ(
        name="handoverFromEUTRAPreparationRequest-r8",
        mode=MODE_TYPE,
        tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(
            ("EUTRA-RRC-Definitions", "HandoverFromEUTRAPreparationRequest-r8-IEs")
        ),
    )
    ___HandoverFromEUTRAPreparationRequest_criticalExtensions_c1_spare3 = NULL(
        name="spare3", mode=MODE_TYPE, tag=(1, TAG_CONTEXT_SPEC, TAG_IMPLICIT)
    )
    ___HandoverFromEUTRAPreparationRequest_criticalExtensions_c1_spare2 = NULL(
        name="spare2", mode=MODE_TYPE, tag=(2, TAG_CONTEXT_SPEC, TAG_IMPLICIT)
    )
    ___HandoverFromEUTRAPreparationRequest_criticalExtensions_c1_spare1 = NULL(
        name="spare1", mode=MODE_TYPE, tag=(3, TAG_CONTEXT_SPEC, TAG_IMPLICIT)
    )
    ...
    __HandoverFromEUTRAPreparationRequest_criticalExtensions_criticalExtensionsFuture = SEQ(
        name="criticalExtensionsFuture",
        mode=MODE_TYPE,
        tag=(1, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
    )
    ...
    # -----< HandoverFromEUTRAPreparationRequest-r8-IEs >-----#
    HandoverFromEUTRAPreparationRequest_r8_IEs = SEQ(
        name="HandoverFromEUTRAPreparationRequest-r8-IEs", mode=MODE_TYPE
    )
    _HandoverFromEUTRAPreparationRequest_r8_IEs_cdma2000_Type = ENUM(
        name="cdma2000-Type",
        mode=MODE_TYPE,
        tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "CDMA2000-Type")),
    )
    _HandoverFromEUTRAPreparationRequest_r8_IEs_rand = BIT_STR(
        name="rand",
        mode=MODE_TYPE,
        tag=(1, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "RAND-CDMA2000")),
    ...
    _HandoverFromEUTRAPreparationRequest_r8_IEs_mobilityParameters = OCT_STR(
        name="mobilityParameters",
        mode=MODE_TYPE,
        tag=(2, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "MobilityParametersCDMA2000")),
    ...
    _HandoverFromEUTRAPreparationRequest_r8_IEs_nonCriticalExtension = SEQ(
        name="nonCriticalExtension",
        mode=MODE_TYPE,
        tag=(3, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        opt=True,
    ...
    _MasterInformationBlock_dl_Bandwidth = ENUM(
        name="dl-Bandwidth", mode=MODE_TYPE, tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT)
    )
    _MasterInformationBlock_dl_Bandwidth._cont = ASN1Dict(
        [("n6", 0), ("n15", 1), ("n25", 2), ("n50", 3), ("n75", 4), ("n100", 5)]
    )
    _MasterInformationBlock_dl_Bandwidth._ext = None
    _MasterInformationBlock_phich_Config = SEQ(
        name="phich-Config",
        mode=MODE_TYPE,
        tag=(1, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "PHICH-Config")),
    )
    _MasterInformationBlock_systemFrameNumber = BIT_STR(
        name="systemFrameNumber",
        mode=MODE_TYPE,
        tag=(2, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
    )
    _MasterInformationBlock_systemFrameNumber._const_sz = ASN1Set(
        rv=[8], rr=[], ev=None, er=[]
    )
    _MasterInformationBlock_spare = BIT_STR(
        name="spare", mode=MODE_TYPE, tag=(3, TAG_CONTEXT_SPEC, TAG_IMPLICIT)
    )
    ...
    _MeasurementReport_criticalExtensions = CHOICE(
        name="criticalExtensions",
        mode=MODE_TYPE,
        tag=(0, TAG_CONTEXT_SPEC, TAG_EXPLICIT),
    )
    __MeasurementReport_criticalExtensions_c1 = CHOICE(
        name="c1", mode=MODE_TYPE, tag=(0, TAG_CONTEXT_SPEC, TAG_EXPLICIT)
    )
    ___MeasurementReport_criticalExtensions_c1_measurementReport_r8 = SEQ(
        name="measurementReport-r8",
        mode=MODE_TYPE,
        tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "MeasurementReport-r8-IEs")),
    )
    ___MeasurementReport_criticalExtensions_c1_spare7 = NULL(
        name="spare7", mode=MODE_TYPE, tag=(1, TAG_CONTEXT_SPEC, TAG_IMPLICIT)
    )
    ___MeasurementReport_criticalExtensions_c1_spare6 = NULL(
        name="spare6", mode=MODE_TYPE, tag=(2, TAG_CONTEXT_SPEC, TAG_IMPLICIT)
    )
    ___MeasurementReport_criticalExtensions_c1_spare5 = NULL(
        name="spare5", mode=MODE_TYPE, tag=(3, TAG_CONTEXT_SPEC, TAG_IMPLICIT)
    )
    ___MeasurementReport_criticalExtensions_c1_spare4 = NULL(
        name="spare4", mode=MODE_TYPE, tag=(4, TAG_CONTEXT_SPEC, TAG_IMPLICIT)
    )
    ___MeasurementReport_criticalExtensions_c1_spare3 = NULL(
        name="spare3", mode=MODE_TYPE, tag=(5, TAG_CONTEXT_SPEC, TAG_IMPLICIT)
    )
    ___MeasurementReport_criticalExtensions_c1_spare2 = NULL(
        name="spare2", mode=MODE_TYPE, tag=(6, TAG_CONTEXT_SPEC, TAG_IMPLICIT)
    )
    ___MeasurementReport_criticalExtensions_c1_spare1 = NULL(
        name="spare1", mode=MODE_TYPE, tag=(7, TAG_CONTEXT_SPEC, TAG_IMPLICIT)
    )
    ...
    __MeasurementReport_criticalExtensions_criticalExtensionsFuture = SEQ(
        name="criticalExtensionsFuture",
        mode=MODE_TYPE,
        tag=(1, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
    )
    ...
    _MeasurementReport_r8_IEs_measResults = SEQ(
        name="measResults",
        mode=MODE_TYPE,
        tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "MeasResults")),
    )
    _MeasurementReport_r8_IEs_nonCriticalExtension = SEQ(
        name="nonCriticalExtension",
        mode=MODE_TYPE,
        tag=(1, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        opt=True,
    ...
    _MobilityFromEUTRACommand_rrc_TransactionIdentifier = INT(
        name="rrc-TransactionIdentifier",
        mode=MODE_TYPE,
        tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "RRC-TransactionIdentifier")),
    )
    _MobilityFromEUTRACommand_criticalExtensions = CHOICE(
        name="criticalExtensions",
        mode=MODE_TYPE,
        tag=(1, TAG_CONTEXT_SPEC, TAG_EXPLICIT),
    )
    __MobilityFromEUTRACommand_criticalExtensions_c1 = CHOICE(
        name="c1", mode=MODE_TYPE, tag=(0, TAG_CONTEXT_SPEC, TAG_EXPLICIT)
    )
    ___MobilityFromEUTRACommand_criticalExtensions_c1_mobilityFromEUTRACommand_r8 = SEQ(
        name="mobilityFromEUTRACommand-r8",
        mode=MODE_TYPE,
        tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(
            ("EUTRA-RRC-Definitions", "MobilityFromEUTRACommand-r8-IEs")
        ),
    )
    ___MobilityFromEUTRACommand_criticalExtensions_c1_spare3 = NULL(
        name="spare3", mode=MODE_TYPE, tag=(1, TAG_CONTEXT_SPEC, TAG_IMPLICIT)
    )
    ___MobilityFromEUTRACommand_criticalExtensions_c1_spare2 = NULL(
        name="spare2", mode=MODE_TYPE, tag=(2, TAG_CONTEXT_SPEC, TAG_IMPLICIT)
    )
    ___MobilityFromEUTRACommand_criticalExtensions_c1_spare1 = NULL(
        name="spare1", mode=MODE_TYPE, tag=(3, TAG_CONTEXT_SPEC, TAG_IMPLICIT)
    )
    ...
    __MobilityFromEUTRACommand_criticalExtensions_criticalExtensionsFuture = SEQ(
        name="criticalExtensionsFuture",
        mode=MODE_TYPE,
        tag=(1, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
    )
    __MobilityFromEUTRACommand_criticalExtensions_criticalExtensionsFuture._cont = (
        ASN1Dict([])
    )
    ...
    # -----< MobilityFromEUTRACommand-r8-IEs >-----#
    MobilityFromEUTRACommand_r8_IEs = SEQ(
        name="MobilityFromEUTRACommand-r8-IEs", mode=MODE_TYPE
    )
    _MobilityFromEUTRACommand_r8_IEs_cs_FallbackIndicator = BOOL(
        name="cs-FallbackIndicator",
        mode=MODE_TYPE,
        tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
    )
    _MobilityFromEUTRACommand_r8_IEs_purpose = CHOICE(
        name="purpose", mode=MODE_TYPE, tag=(1, TAG_CONTEXT_SPEC, TAG_EXPLICIT)
    )
    __MobilityFromEUTRACommand_r8_IEs_purpose_handover = SEQ(
        name="handover",
        mode=MODE_TYPE,
        tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "Handover")),
    )
    __MobilityFromEUTRACommand_r8_IEs_purpose_cellChangeOrder = SEQ(
        name="cellChangeOrder",
        mode=MODE_TYPE,
        tag=(1, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "CellChangeOrder")),
    )
    ...
    _MobilityFromEUTRACommand_r8_IEs_nonCriticalExtension = SEQ(
        name="nonCriticalExtension",
        mode=MODE_TYPE,
        tag=(2, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        opt=True,
    ...
    _Handover_targetRAT_Type = ENUM(
        name="targetRAT-Type", mode=MODE_TYPE, tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT)
    )
    _Handover_targetRAT_Type._cont = ASN1Dict(
        [
            ("utra", 0),
            ("geran", 1),
            ("cdma2000-1XRTT", 2),
    ...
    _Handover_targetRAT_MessageContainer = OCT_STR(
        name="targetRAT-MessageContainer",
        mode=MODE_TYPE,
        tag=(1, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
    )
    _Handover_nas_SecurityParamFromEUTRA = OCT_STR(
        name="nas-SecurityParamFromEUTRA",
        mode=MODE_TYPE,
        tag=(2, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        opt=True,
    )
    _Handover_nas_SecurityParamFromEUTRA._const_sz = ASN1Set(
        rv=[1], rr=[], ev=None, er=[]
    )
    _Handover_systemInformation = CHOICE(
        name="systemInformation",
        mode=MODE_TYPE,
        tag=(3, TAG_CONTEXT_SPEC, TAG_EXPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "SI-OrPSI-GERAN")),
        opt=True,
    )
    ...
    _CellChangeOrder_t304 = ENUM(
        name="t304", mode=MODE_TYPE, tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT)
    )
    _CellChangeOrder_t304._cont = ASN1Dict(
        [
            ("ms100", 0),
            ("ms200", 1),
            ("ms500", 2),
    ...
    _CellChangeOrder_targetRAT_Type = CHOICE(
        name="targetRAT-Type", mode=MODE_TYPE, tag=(1, TAG_CONTEXT_SPEC, TAG_EXPLICIT)
    )
    __CellChangeOrder_targetRAT_Type_geran = SEQ(
        name="geran", mode=MODE_TYPE, tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT)
    )
    ___CellChangeOrder_targetRAT_Type_geran_physCellId = SEQ(
        name="physCellId",
        mode=MODE_TYPE,
        tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "PhysCellIdGERAN")),
    )
    ___CellChangeOrder_targetRAT_Type_geran_carrierFreq = SEQ(
        name="carrierFreq",
        mode=MODE_TYPE,
        tag=(1, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "CarrierFreqGERAN")),
    )
    ___CellChangeOrder_targetRAT_Type_geran_networkControlOrder = BIT_STR(
        name="networkControlOrder",
        mode=MODE_TYPE,
        tag=(2, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        opt=True,
    )
    ___CellChangeOrder_targetRAT_Type_geran_networkControlOrder._const_sz = ASN1Set(
        rv=[2], rr=[], ev=None, er=[]
    )
    ___CellChangeOrder_targetRAT_Type_geran_systemInformation = CHOICE(
        name="systemInformation",
        mode=MODE_TYPE,
        tag=(3, TAG_CONTEXT_SPEC, TAG_EXPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "SI-OrPSI-GERAN")),
    ...
    _SI_OrPSI_GERAN_si = SEQ_OF(
        name="si",
        mode=MODE_TYPE,
        tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "SystemInfoListGERAN")),
    )
    _SI_OrPSI_GERAN_psi = SEQ_OF(
        name="psi",
        mode=MODE_TYPE,
        tag=(1, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "SystemInfoListGERAN")),
    ...
    _SystemInfoListGERAN__item_._const_sz = ASN1Set(
        rv=[], rr=[ASN1RangeInt(lb=1, ub=23)], ev=None, er=[]
    )
    SystemInfoListGERAN._cont = _SystemInfoListGERAN__item_
    SystemInfoListGERAN._const_sz = ASN1Set(
        rv=[], rr=[ASN1RangeInt(lb=1, ub=10)], ev=None, er=[]
    )

    # -----< Paging >-----#
    Paging = SEQ(name="Paging", mode=MODE_TYPE)
    _Paging_pagingRecordList = SEQ_OF(
        name="pagingRecordList",
        mode=MODE_TYPE,
        tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "PagingRecordList")),
        opt=True,
    )
    _Paging_systemInfoModification = ENUM(
    ...
    _Paging_nonCriticalExtension = SEQ(
        name="nonCriticalExtension",
        mode=MODE_TYPE,
        tag=(3, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        opt=True,
    ...
    _PagingRecordList__item_ = SEQ(
        name="_item_",
        mode=MODE_TYPE,
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "PagingRecord")),
    )
    PagingRecordList._cont = _PagingRecordList__item_
    PagingRecordList._const_sz = ASN1Set(
        rv=[], rr=[ASN1RangeInt(lb=1, ub=16)], ev=None, er=[]
    )

    # -----< PagingRecord >-----#
    PagingRecord = SEQ(name="PagingRecord", mode=MODE_TYPE)
    _PagingRecord_ue_Identity = CHOICE(
        name="ue-Identity",
        mode=MODE_TYPE,
        tag=(0, TAG_CONTEXT_SPEC, TAG_EXPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "PagingUE-Identity")),
    )
    _PagingRecord_cn_Domain = ENUM(
        name="cn-Domain", mode=MODE_TYPE, tag=(1, TAG_CONTEXT_SPEC, TAG_IMPLICIT)
    )
    ...
    _PagingUE_Identity_s_TMSI = SEQ(
        name="s-TMSI",
        mode=MODE_TYPE,
        tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "S-TMSI")),
    )
    _PagingUE_Identity_imsi = SEQ_OF(
        name="imsi",
        mode=MODE_TYPE,
        tag=(1, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "IMSI")),
    )
    ...
    _IMSI__item_ = INT(
        name="_item_",
        mode=MODE_TYPE,
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "IMSI-Digit")),
    )
    ...
    IMSI_Digit._const_val = ASN1Set(
        rv=[], rr=[ASN1RangeInt(lb=0, ub=9)], ev=None, er=[]
    )

    # -----< RRCConnectionReconfiguration >-----#
    RRCConnectionReconfiguration = SEQ(
        name="RRCConnectionReconfiguration", mode=MODE_TYPE
    )
    _RRCConnectionReconfiguration_rrc_TransactionIdentifier = INT(
        name="rrc-TransactionIdentifier",
        mode=MODE_TYPE,
        tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "RRC-TransactionIdentifier")),
    )
    _RRCConnectionReconfiguration_criticalExtensions = CHOICE(
        name="criticalExtensions",
        mode=MODE_TYPE,
        tag=(1, TAG_CONTEXT_SPEC, TAG_EXPLICIT),
    )
    __RRCConnectionReconfiguration_criticalExtensions_c1 = CHOICE(
        name="c1", mode=MODE_TYPE, tag=(0, TAG_CONTEXT_SPEC, TAG_EXPLICIT)
    )
    ___RRCConnectionReconfiguration_criticalExtensions_c1_rrcConnectionReconfiguration_r8 = SEQ(
        name="rrcConnectionReconfiguration-r8",
        mode=MODE_TYPE,
        tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(
            ("EUTRA-RRC-Definitions", "RRCConnectionReconfiguration-r8-IEs")
        ),
    )
    ___RRCConnectionReconfiguration_criticalExtensions_c1_spare7 = NULL(
        name="spare7", mode=MODE_TYPE, tag=(1, TAG_CONTEXT_SPEC, TAG_IMPLICIT)
    )
    ___RRCConnectionReconfiguration_criticalExtensions_c1_spare6 = NULL(
        name="spare6", mode=MODE_TYPE, tag=(2, TAG_CONTEXT_SPEC, TAG_IMPLICIT)
    )
    ___RRCConnectionReconfiguration_criticalExtensions_c1_spare5 = NULL(
        name="spare5", mode=MODE_TYPE, tag=(3, TAG_CONTEXT_SPEC, TAG_IMPLICIT)
    )
    ___RRCConnectionReconfiguration_criticalExtensions_c1_spare4 = NULL(
        name="spare4", mode=MODE_TYPE, tag=(4, TAG_CONTEXT_SPEC, TAG_IMPLICIT)
    )
    ___RRCConnectionReconfiguration_criticalExtensions_c1_spare3 = NULL(
        name="spare3", mode=MODE_TYPE, tag=(5, TAG_CONTEXT_SPEC, TAG_IMPLICIT)
    )
    ___RRCConnectionReconfiguration_criticalExtensions_c1_spare2 = NULL(
        name="spare2", mode=MODE_TYPE, tag=(6, TAG_CONTEXT_SPEC, TAG_IMPLICIT)
    )
    ___RRCConnectionReconfiguration_criticalExtensions_c1_spare1 = NULL(
        name="spare1", mode=MODE_TYPE, tag=(7, TAG_CONTEXT_SPEC, TAG_IMPLICIT)
    )
    ...
    __RRCConnectionReconfiguration_criticalExtensions_criticalExtensionsFuture = SEQ(
        name="criticalExtensionsFuture",
        mode=MODE_TYPE,
        tag=(1, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
    )
    __RRCConnectionReconfiguration_criticalExtensions_criticalExtensionsFuture._cont = (
        ASN1Dict([])
    )
    __RRCConnectionReconfiguration_criticalExtensions_criticalExtensionsFuture._ext = (
        None
    )
    ...
    # -----< RRCConnectionReconfiguration-r8-IEs >-----#
    RRCConnectionReconfiguration_r8_IEs = SEQ(
        name="RRCConnectionReconfiguration-r8-IEs", mode=MODE_TYPE
    )
    _RRCConnectionReconfiguration_r8_IEs_measConfig = SEQ(
        name="measConfig",
        mode=MODE_TYPE,
        tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "MeasConfig")),
        opt=True,
    )
    _RRCConnectionReconfiguration_r8_IEs_mobilityControlInfo = SEQ(
        name="mobilityControlInfo",
        mode=MODE_TYPE,
        tag=(1, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "MobilityControlInfo")),
        opt=True,
    )
    _RRCConnectionReconfiguration_r8_IEs_dedicatedInfoNASList = SEQ_OF(
        name="dedicatedInfoNASList",
        mode=MODE_TYPE,
        tag=(2, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        opt=True,
    )
    __RRCConnectionReconfiguration_r8_IEs_dedicatedInfoNASList__item_ = OCT_STR(
        name="_item_",
        mode=MODE_TYPE,
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "DedicatedInfoNAS")),
    )
    _RRCConnectionReconfiguration_r8_IEs_dedicatedInfoNASList._cont = (
        __RRCConnectionReconfiguration_r8_IEs_dedicatedInfoNASList__item_
    )
    _RRCConnectionReconfiguration_r8_IEs_dedicatedInfoNASList._const_sz = ASN1Set(
        rv=[], rr=[ASN1RangeInt(lb=1, ub=11)], ev=None, er=[]
    )
    _RRCConnectionReconfiguration_r8_IEs_radioResourceConfigDedicated = SEQ(
        name="radioResourceConfigDedicated",
        mode=MODE_TYPE,
        tag=(3, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "RadioResourceConfigDedicated")),
        opt=True,
    )
    _RRCConnectionReconfiguration_r8_IEs_securityConfigHO = SEQ(
        name="securityConfigHO",
        mode=MODE_TYPE,
        tag=(4, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "SecurityConfigHO")),
        opt=True,
    )
    _RRCConnectionReconfiguration_r8_IEs_nonCriticalExtension = SEQ(
        name="nonCriticalExtension",
        mode=MODE_TYPE,
        tag=(5, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        opt=True,
    ...
    _SecurityConfigHO_handoverType = CHOICE(
        name="handoverType", mode=MODE_TYPE, tag=(0, TAG_CONTEXT_SPEC, TAG_EXPLICIT)
    )
    __SecurityConfigHO_handoverType_intraLTE = SEQ(
        name="intraLTE", mode=MODE_TYPE, tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT)
    )
    ___SecurityConfigHO_handoverType_intraLTE_securityAlgorithmConfig = SEQ(
        name="securityAlgorithmConfig",
        mode=MODE_TYPE,
        tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "SecurityAlgorithmConfig")),
        opt=True,
    )
    ___SecurityConfigHO_handoverType_intraLTE_keyChangeIndicator = BOOL(
        name="keyChangeIndicator",
        mode=MODE_TYPE,
        tag=(1, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
    )
    ___SecurityConfigHO_handoverType_intraLTE_nextHopChainingCount = INT(
        name="nextHopChainingCount",
        mode=MODE_TYPE,
        tag=(2, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "NextHopChainingCount")),
    )
    ...
    __SecurityConfigHO_handoverType_interRAT = SEQ(
        name="interRAT", mode=MODE_TYPE, tag=(1, TAG_CONTEXT_SPEC, TAG_IMPLICIT)
    )
    ___SecurityConfigHO_handoverType_interRAT_securityAlgorithmConfig = SEQ(
        name="securityAlgorithmConfig",
        mode=MODE_TYPE,
        tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "SecurityAlgorithmConfig")),
    )
    ___SecurityConfigHO_handoverType_interRAT_nas_SecurityParamToEUTRA = OCT_STR(
        name="nas-SecurityParamToEUTRA",
        mode=MODE_TYPE,
        tag=(1, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
    )
    ___SecurityConfigHO_handoverType_interRAT_nas_SecurityParamToEUTRA._const_sz = (
        ASN1Set(rv=[6], rr=[], ev=None, er=[])
    )
    ...
    # -----< RRCConnectionReconfigurationComplete >-----#
    RRCConnectionReconfigurationComplete = SEQ(
        name="RRCConnectionReconfigurationComplete", mode=MODE_TYPE
    )
    _RRCConnectionReconfigurationComplete_rrc_TransactionIdentifier = INT(
        name="rrc-TransactionIdentifier",
        mode=MODE_TYPE,
        tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "RRC-TransactionIdentifier")),
    )
    _RRCConnectionReconfigurationComplete_criticalExtensions = CHOICE(
        name="criticalExtensions",
        mode=MODE_TYPE,
        tag=(1, TAG_CONTEXT_SPEC, TAG_EXPLICIT),
    )
    __RRCConnectionReconfigurationComplete_criticalExtensions_rrcConnectionReconfigurationComplete_r8 = SEQ(
        name="rrcConnectionReconfigurationComplete-r8",
        mode=MODE_TYPE,
        tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(
            ("EUTRA-RRC-Definitions", "RRCConnectionReconfigurationComplete-r8-IEs")
        ),
    )
    __RRCConnectionReconfigurationComplete_criticalExtensions_criticalExtensionsFuture = SEQ(
        name="criticalExtensionsFuture",
        mode=MODE_TYPE,
        tag=(1, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
    )
    ...
    # -----< RRCConnectionReconfigurationComplete-r8-IEs >-----#
    RRCConnectionReconfigurationComplete_r8_IEs = SEQ(
        name="RRCConnectionReconfigurationComplete-r8-IEs", mode=MODE_TYPE
    )
    _RRCConnectionReconfigurationComplete_r8_IEs_nonCriticalExtension = SEQ(
        name="nonCriticalExtension",
        mode=MODE_TYPE,
        tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        opt=True,
    ...
    # -----< RRCConnectionReestablishment >-----#
    RRCConnectionReestablishment = SEQ(
        name="RRCConnectionReestablishment", mode=MODE_TYPE
    )
    _RRCConnectionReestablishment_rrc_TransactionIdentifier = INT(
        name="rrc-TransactionIdentifier",
        mode=MODE_TYPE,
        tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "RRC-TransactionIdentifier")),
    )
    _RRCConnectionReestablishment_criticalExtensions = CHOICE(
        name="criticalExtensions",
        mode=MODE_TYPE,
        tag=(1, TAG_CONTEXT_SPEC, TAG_EXPLICIT),
    )
    __RRCConnectionReestablishment_criticalExtensions_c1 = CHOICE(
        name="c1", mode=MODE_TYPE, tag=(0, TAG_CONTEXT_SPEC, TAG_EXPLICIT)
    )
    ___RRCConnectionReestablishment_criticalExtensions_c1_rrcConnectionReestablishment_r8 = SEQ(
        name="rrcConnectionReestablishment-r8",
        mode=MODE_TYPE,
        tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(
            ("EUTRA-RRC-Definitions", "RRCConnectionReestablishment-r8-IEs")
        ),
    )
    ___RRCConnectionReestablishment_criticalExtensions_c1_spare7 = NULL(
        name="spare7", mode=MODE_TYPE, tag=(1, TAG_CONTEXT_SPEC, TAG_IMPLICIT)
    )
    ___RRCConnectionReestablishment_criticalExtensions_c1_spare6 = NULL(
        name="spare6", mode=MODE_TYPE, tag=(2, TAG_CONTEXT_SPEC, TAG_IMPLICIT)
    )
    ___RRCConnectionReestablishment_criticalExtensions_c1_spare5 = NULL(
        name="spare5", mode=MODE_TYPE, tag=(3, TAG_CONTEXT_SPEC, TAG_IMPLICIT)
    )
    ___RRCConnectionReestablishment_criticalExtensions_c1_spare4 = NULL(
        name="spare4", mode=MODE_TYPE, tag=(4, TAG_CONTEXT_SPEC, TAG_IMPLICIT)
    )
    ___RRCConnectionReestablishment_criticalExtensions_c1_spare3 = NULL(
        name="spare3", mode=MODE_TYPE, tag=(5, TAG_CONTEXT_SPEC, TAG_IMPLICIT)
    )
    ___RRCConnectionReestablishment_criticalExtensions_c1_spare2 = NULL(
        name="spare2", mode=MODE_TYPE, tag=(6, TAG_CONTEXT_SPEC, TAG_IMPLICIT)
    )
    ___RRCConnectionReestablishment_criticalExtensions_c1_spare1 = NULL(
        name="spare1", mode=MODE_TYPE, tag=(7, TAG_CONTEXT_SPEC, TAG_IMPLICIT)
    )
    ...
    __RRCConnectionReestablishment_criticalExtensions_criticalExtensionsFuture = SEQ(
        name="criticalExtensionsFuture",
        mode=MODE_TYPE,
        tag=(1, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
    )
    __RRCConnectionReestablishment_criticalExtensions_criticalExtensionsFuture._cont = (
        ASN1Dict([])
    )
    __RRCConnectionReestablishment_criticalExtensions_criticalExtensionsFuture._ext = (
        None
    )
    ...
    # -----< RRCConnectionReestablishment-r8-IEs >-----#
    RRCConnectionReestablishment_r8_IEs = SEQ(
        name="RRCConnectionReestablishment-r8-IEs", mode=MODE_TYPE
    )
    _RRCConnectionReestablishment_r8_IEs_radioResourceConfigDedicated = SEQ(
        name="radioResourceConfigDedicated",
        mode=MODE_TYPE,
        tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "RadioResourceConfigDedicated")),
    )
    _RRCConnectionReestablishment_r8_IEs_nextHopChainingCount = INT(
        name="nextHopChainingCount",
        mode=MODE_TYPE,
        tag=(1, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "NextHopChainingCount")),
    )
    _RRCConnectionReestablishment_r8_IEs_nonCriticalExtension = SEQ(
        name="nonCriticalExtension",
        mode=MODE_TYPE,
        tag=(2, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        opt=True,
    ...
    # -----< RRCConnectionReestablishmentComplete >-----#
    RRCConnectionReestablishmentComplete = SEQ(
        name="RRCConnectionReestablishmentComplete", mode=MODE_TYPE
    )
    _RRCConnectionReestablishmentComplete_rrc_TransactionIdentifier = INT(
        name="rrc-TransactionIdentifier",
        mode=MODE_TYPE,
        tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "RRC-TransactionIdentifier")),
    )
    _RRCConnectionReestablishmentComplete_criticalExtensions = CHOICE(
        name="criticalExtensions",
        mode=MODE_TYPE,
        tag=(1, TAG_CONTEXT_SPEC, TAG_EXPLICIT),
    )
    __RRCConnectionReestablishmentComplete_criticalExtensions_rrcConnectionReestablishmentComplete_r8 = SEQ(
        name="rrcConnectionReestablishmentComplete-r8",
        mode=MODE_TYPE,
        tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(
            ("EUTRA-RRC-Definitions", "RRCConnectionReestablishmentComplete-r8-IEs")
        ),
    )
    __RRCConnectionReestablishmentComplete_criticalExtensions_criticalExtensionsFuture = SEQ(
        name="criticalExtensionsFuture",
        mode=MODE_TYPE,
        tag=(1, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
    )
    ...
    # -----< RRCConnectionReestablishmentComplete-r8-IEs >-----#
    RRCConnectionReestablishmentComplete_r8_IEs = SEQ(
        name="RRCConnectionReestablishmentComplete-r8-IEs", mode=MODE_TYPE
    )
    _RRCConnectionReestablishmentComplete_r8_IEs_nonCriticalExtension = SEQ(
        name="nonCriticalExtension",
        mode=MODE_TYPE,
        tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        opt=True,
    ...
    # -----< RRCConnectionReestablishmentReject >-----#
    RRCConnectionReestablishmentReject = SEQ(
        name="RRCConnectionReestablishmentReject", mode=MODE_TYPE
    )
    _RRCConnectionReestablishmentReject_criticalExtensions = CHOICE(
        name="criticalExtensions",
        mode=MODE_TYPE,
        tag=(0, TAG_CONTEXT_SPEC, TAG_EXPLICIT),
    )
    __RRCConnectionReestablishmentReject_criticalExtensions_rrcConnectionReestablishmentReject_r8 = SEQ(
        name="rrcConnectionReestablishmentReject-r8",
        mode=MODE_TYPE,
        tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(
            ("EUTRA-RRC-Definitions", "RRCConnectionReestablishmentReject-r8-IEs")
        ),
    )
    ...
    # -----< RRCConnectionReestablishmentReject-r8-IEs >-----#
    RRCConnectionReestablishmentReject_r8_IEs = SEQ(
        name="RRCConnectionReestablishmentReject-r8-IEs", mode=MODE_TYPE
    )
    _RRCConnectionReestablishmentReject_r8_IEs_nonCriticalExtension = SEQ(
        name="nonCriticalExtension",
        mode=MODE_TYPE,
        tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        opt=True,
    ...
    # -----< RRCConnectionReestablishmentRequest >-----#
    RRCConnectionReestablishmentRequest = SEQ(
        name="RRCConnectionReestablishmentRequest", mode=MODE_TYPE
    )
    _RRCConnectionReestablishmentRequest_criticalExtensions = CHOICE(
        name="criticalExtensions",
        mode=MODE_TYPE,
        tag=(0, TAG_CONTEXT_SPEC, TAG_EXPLICIT),
    )
    __RRCConnectionReestablishmentRequest_criticalExtensions_rrcConnectionReestablishmentRequest_r8 = SEQ(
        name="rrcConnectionReestablishmentRequest-r8",
        mode=MODE_TYPE,
        tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(
            ("EUTRA-RRC-Definitions", "RRCConnectionReestablishmentRequest-r8-IEs")
        ),
    )
    __RRCConnectionReestablishmentRequest_criticalExtensions_criticalExtensionsFuture = SEQ(
        name="criticalExtensionsFuture",
        mode=MODE_TYPE,
        tag=(1, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
    )
    ...
    # -----< RRCConnectionReestablishmentRequest-r8-IEs >-----#
    RRCConnectionReestablishmentRequest_r8_IEs = SEQ(
        name="RRCConnectionReestablishmentRequest-r8-IEs", mode=MODE_TYPE
    )
    _RRCConnectionReestablishmentRequest_r8_IEs_ue_Identity = SEQ(
        name="ue-Identity",
        mode=MODE_TYPE,
        tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "ReestabUE-Identity")),
    )
    _RRCConnectionReestablishmentRequest_r8_IEs_reestablishmentCause = ENUM(
        name="reestablishmentCause",
        mode=MODE_TYPE,
        tag=(1, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "ReestablishmentCause")),
    )
    _RRCConnectionReestablishmentRequest_r8_IEs_spare = BIT_STR(
        name="spare", mode=MODE_TYPE, tag=(2, TAG_CONTEXT_SPEC, TAG_IMPLICIT)
    )
    _RRCConnectionReestablishmentRequest_r8_IEs_spare._const_sz = ASN1Set(
        rv=[2], rr=[], ev=None, er=[]
    )
    ...
    _ReestabUE_Identity_c_RNTI = BIT_STR(
        name="c-RNTI",
        mode=MODE_TYPE,
        tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "C-RNTI")),
    )
    _ReestabUE_Identity_physCellId = INT(
        name="physCellId",
        mode=MODE_TYPE,
        tag=(1, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "PhysCellId")),
    )
    _ReestabUE_Identity_shortMAC_I = BIT_STR(
        name="shortMAC-I",
        mode=MODE_TYPE,
        tag=(2, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "ShortMAC-I")),
    )
    ...
    ReestablishmentCause._cont = ASN1Dict(
        [
    ...
    _RRCConnectionReject_criticalExtensions = CHOICE(
        name="criticalExtensions",
        mode=MODE_TYPE,
        tag=(0, TAG_CONTEXT_SPEC, TAG_EXPLICIT),
    )
    __RRCConnectionReject_criticalExtensions_c1 = CHOICE(
        name="c1", mode=MODE_TYPE, tag=(0, TAG_CONTEXT_SPEC, TAG_EXPLICIT)
    )
    ___RRCConnectionReject_criticalExtensions_c1_rrcConnectionReject_r8 = SEQ(
        name="rrcConnectionReject-r8",
        mode=MODE_TYPE,
        tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "RRCConnectionReject-r8-IEs")),
    )
    ___RRCConnectionReject_criticalExtensions_c1_spare3 = NULL(
        name="spare3", mode=MODE_TYPE, tag=(1, TAG_CONTEXT_SPEC, TAG_IMPLICIT)
    )
    ___RRCConnectionReject_criticalExtensions_c1_spare2 = NULL(
        name="spare2", mode=MODE_TYPE, tag=(2, TAG_CONTEXT_SPEC, TAG_IMPLICIT)
    )
    ___RRCConnectionReject_criticalExtensions_c1_spare1 = NULL(
        name="spare1", mode=MODE_TYPE, tag=(3, TAG_CONTEXT_SPEC, TAG_IMPLICIT)
    )
    ...
    __RRCConnectionReject_criticalExtensions_criticalExtensionsFuture = SEQ(
        name="criticalExtensionsFuture",
        mode=MODE_TYPE,
        tag=(1, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
    )
    ...
    _RRCConnectionReject_r8_IEs_waitTime = INT(
        name="waitTime", mode=MODE_TYPE, tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT)
    )
    _RRCConnectionReject_r8_IEs_waitTime._const_val = ASN1Set(
        rv=[], rr=[ASN1RangeInt(lb=1, ub=16)], ev=None, er=[]
    )
    _RRCConnectionReject_r8_IEs_nonCriticalExtension = SEQ(
        name="nonCriticalExtension",
        mode=MODE_TYPE,
        tag=(1, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        opt=True,
    ...
    _RRCConnectionRelease_rrc_TransactionIdentifier = INT(
        name="rrc-TransactionIdentifier",
        mode=MODE_TYPE,
        tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "RRC-TransactionIdentifier")),
    )
    _RRCConnectionRelease_criticalExtensions = CHOICE(
        name="criticalExtensions",
        mode=MODE_TYPE,
        tag=(1, TAG_CONTEXT_SPEC, TAG_EXPLICIT),
    )
    __RRCConnectionRelease_criticalExtensions_c1 = CHOICE(
        name="c1", mode=MODE_TYPE, tag=(0, TAG_CONTEXT_SPEC, TAG_EXPLICIT)
    )
    ___RRCConnectionRelease_criticalExtensions_c1_rrcConnectionRelease_r8 = SEQ(
        name="rrcConnectionRelease-r8",
        mode=MODE_TYPE,
        tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "RRCConnectionRelease-r8-IEs")),
    )
    ___RRCConnectionRelease_criticalExtensions_c1_spare3 = NULL(
        name="spare3", mode=MODE_TYPE, tag=(1, TAG_CONTEXT_SPEC, TAG_IMPLICIT)
    )
    ___RRCConnectionRelease_criticalExtensions_c1_spare2 = NULL(
        name="spare2", mode=MODE_TYPE, tag=(2, TAG_CONTEXT_SPEC, TAG_IMPLICIT)
    )
    ___RRCConnectionRelease_criticalExtensions_c1_spare1 = NULL(
        name="spare1", mode=MODE_TYPE, tag=(3, TAG_CONTEXT_SPEC, TAG_IMPLICIT)
    )
    ...
    __RRCConnectionRelease_criticalExtensions_criticalExtensionsFuture = SEQ(
        name="criticalExtensionsFuture",
        mode=MODE_TYPE,
        tag=(1, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
    )
    ...
    # -----< RRCConnectionRelease-r8-IEs >-----#
    RRCConnectionRelease_r8_IEs = SEQ(
        name="RRCConnectionRelease-r8-IEs", mode=MODE_TYPE
    )
    _RRCConnectionRelease_r8_IEs_releaseCause = ENUM(
        name="releaseCause",
        mode=MODE_TYPE,
        tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "ReleaseCause")),
    )
    _RRCConnectionRelease_r8_IEs_redirectedCarrierInfo = CHOICE(
        name="redirectedCarrierInfo",
        mode=MODE_TYPE,
        tag=(1, TAG_CONTEXT_SPEC, TAG_EXPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "RedirectedCarrierInfo")),
        opt=True,
    )
    _RRCConnectionRelease_r8_IEs_idleModeMobilityControlInfo = SEQ(
        name="idleModeMobilityControlInfo",
        mode=MODE_TYPE,
        tag=(2, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "IdleModeMobilityControlInfo")),
        opt=True,
    )
    _RRCConnectionRelease_r8_IEs_nonCriticalExtension = SEQ(
        name="nonCriticalExtension",
        mode=MODE_TYPE,
        tag=(3, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        opt=True,
    ...
    ReleaseCause._cont = ASN1Dict(
        [("loadBalancingTAUrequired", 0), ("other", 1), ("spare2", 2), ("spare1", 3)]
    )
    ReleaseCause._ext = None

    # -----< RedirectedCarrierInfo >-----#
    RedirectedCarrierInfo = CHOICE(name="RedirectedCarrierInfo", mode=MODE_TYPE)
    _RedirectedCarrierInfo_eutra = INT(
        name="eutra",
        mode=MODE_TYPE,
        tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "ARFCN-ValueEUTRA")),
    )
    _RedirectedCarrierInfo_geran = SEQ(
        name="geran",
        mode=MODE_TYPE,
        tag=(1, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "CarrierFreqsGERAN")),
    )
    _RedirectedCarrierInfo_utra_FDD = INT(
        name="utra-FDD",
        mode=MODE_TYPE,
        tag=(2, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "ARFCN-ValueUTRA")),
    )
    _RedirectedCarrierInfo_utra_TDD = INT(
        name="utra-TDD",
        mode=MODE_TYPE,
        tag=(3, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "ARFCN-ValueUTRA")),
    )
    _RedirectedCarrierInfo_cdma2000_HRPD = SEQ(
        name="cdma2000-HRPD",
        mode=MODE_TYPE,
        tag=(4, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "CarrierFreqCDMA2000")),
    )
    _RedirectedCarrierInfo_cdma2000_1xRTT = SEQ(
        name="cdma2000-1xRTT",
        mode=MODE_TYPE,
        tag=(5, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "CarrierFreqCDMA2000")),
    ...
    # -----< IdleModeMobilityControlInfo >-----#
    IdleModeMobilityControlInfo = SEQ(
        name="IdleModeMobilityControlInfo", mode=MODE_TYPE
    )
    _IdleModeMobilityControlInfo_freqPriorityListEUTRA = SEQ_OF(
        name="freqPriorityListEUTRA",
        mode=MODE_TYPE,
        tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "FreqPriorityListEUTRA")),
        opt=True,
    )
    _IdleModeMobilityControlInfo_freqPriorityListGERAN = SEQ_OF(
        name="freqPriorityListGERAN",
        mode=MODE_TYPE,
        tag=(1, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "FreqsPriorityListGERAN")),
        opt=True,
    )
    _IdleModeMobilityControlInfo_freqPriorityListUTRA_FDD = SEQ_OF(
        name="freqPriorityListUTRA-FDD",
        mode=MODE_TYPE,
        tag=(2, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "FreqPriorityListUTRA-FDD")),
        opt=True,
    )
    _IdleModeMobilityControlInfo_freqPriorityListUTRA_TDD = SEQ_OF(
        name="freqPriorityListUTRA-TDD",
        mode=MODE_TYPE,
        tag=(3, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "FreqPriorityListUTRA-TDD")),
        opt=True,
    )
    _IdleModeMobilityControlInfo_bandClassPriorityListHRPD = SEQ_OF(
        name="bandClassPriorityListHRPD",
        mode=MODE_TYPE,
        tag=(4, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "BandClassPriorityListHRPD")),
        opt=True,
    )
    _IdleModeMobilityControlInfo_bandClassPriorityList1XRTT = SEQ_OF(
        name="bandClassPriorityList1XRTT",
        mode=MODE_TYPE,
        tag=(5, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "BandClassPriorityList1XRTT")),
        opt=True,
    )
    _IdleModeMobilityControlInfo_t320 = ENUM(
        name="t320", mode=MODE_TYPE, tag=(6, TAG_CONTEXT_SPEC, TAG_IMPLICIT), opt=True
    )
    _IdleModeMobilityControlInfo_t320._cont = ASN1Dict(
        [
            ("min5", 0),
            ("min10", 1),
            ("min20", 2),
    ...
    _FreqPriorityListEUTRA__item_ = SEQ(
        name="_item_",
        mode=MODE_TYPE,
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "FreqPriorityEUTRA")),
    )
    FreqPriorityListEUTRA._cont = _FreqPriorityListEUTRA__item_
    FreqPriorityListEUTRA._const_sz = ASN1Set(
        rv=[], rr=[ASN1RangeInt(lb=1, ub=8)], ev=None, er=[]
    )

    # -----< FreqPriorityEUTRA >-----#
    FreqPriorityEUTRA = SEQ(name="FreqPriorityEUTRA", mode=MODE_TYPE)
    _FreqPriorityEUTRA_carrierFreq = INT(
        name="carrierFreq",
        mode=MODE_TYPE,
        tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "ARFCN-ValueEUTRA")),
    )
    _FreqPriorityEUTRA_cellReselectionPriority = INT(
        name="cellReselectionPriority",
        mode=MODE_TYPE,
        tag=(1, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "CellReselectionPriority")),
    )
    ...
    _FreqsPriorityListGERAN__item_ = SEQ(
        name="_item_",
        mode=MODE_TYPE,
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "FreqsPriorityGERAN")),
    )
    FreqsPriorityListGERAN._cont = _FreqsPriorityListGERAN__item_
    FreqsPriorityListGERAN._const_sz = ASN1Set(
        rv=[], rr=[ASN1RangeInt(lb=1, ub=16)], ev=None, er=[]
    )

    # -----< FreqsPriorityGERAN >-----#
    FreqsPriorityGERAN = SEQ(name="FreqsPriorityGERAN", mode=MODE_TYPE)
    _FreqsPriorityGERAN_carrierFreqs = SEQ(
        name="carrierFreqs",
        mode=MODE_TYPE,
        tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "CarrierFreqsGERAN")),
    )
    _FreqsPriorityGERAN_cellReselectionPriority = INT(
        name="cellReselectionPriority",
        mode=MODE_TYPE,
        tag=(1, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "CellReselectionPriority")),
    ...
    _FreqPriorityListUTRA_FDD__item_ = SEQ(
        name="_item_",
        mode=MODE_TYPE,
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "FreqPriorityUTRA-FDD")),
    )
    FreqPriorityListUTRA_FDD._cont = _FreqPriorityListUTRA_FDD__item_
    FreqPriorityListUTRA_FDD._const_sz = ASN1Set(
        rv=[], rr=[ASN1RangeInt(lb=1, ub=16)], ev=None, er=[]
    )

    # -----< FreqPriorityUTRA-FDD >-----#
    FreqPriorityUTRA_FDD = SEQ(name="FreqPriorityUTRA-FDD", mode=MODE_TYPE)
    _FreqPriorityUTRA_FDD_carrierFreq = INT(
        name="carrierFreq",
        mode=MODE_TYPE,
        tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "ARFCN-ValueUTRA")),
    )
    _FreqPriorityUTRA_FDD_cellReselectionPriority = INT(
        name="cellReselectionPriority",
        mode=MODE_TYPE,
        tag=(1, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "CellReselectionPriority")),
    ...
    _FreqPriorityListUTRA_TDD__item_ = SEQ(
        name="_item_",
        mode=MODE_TYPE,
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "FreqPriorityUTRA-TDD")),
    )
    FreqPriorityListUTRA_TDD._cont = _FreqPriorityListUTRA_TDD__item_
    FreqPriorityListUTRA_TDD._const_sz = ASN1Set(
        rv=[], rr=[ASN1RangeInt(lb=1, ub=16)], ev=None, er=[]
    )

    # -----< FreqPriorityUTRA-TDD >-----#
    FreqPriorityUTRA_TDD = SEQ(name="FreqPriorityUTRA-TDD", mode=MODE_TYPE)
    _FreqPriorityUTRA_TDD_carrierFreq = INT(
        name="carrierFreq",
        mode=MODE_TYPE,
        tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "ARFCN-ValueUTRA")),
    )
    _FreqPriorityUTRA_TDD_cellReselectionPriority = INT(
        name="cellReselectionPriority",
        mode=MODE_TYPE,
        tag=(1, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "CellReselectionPriority")),
    ...
    _BandClassPriorityListHRPD__item_ = SEQ(
        name="_item_",
        mode=MODE_TYPE,
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "BandClassPriorityHRPD")),
    )
    BandClassPriorityListHRPD._cont = _BandClassPriorityListHRPD__item_
    BandClassPriorityListHRPD._const_sz = ASN1Set(
        rv=[], rr=[ASN1RangeInt(lb=1, ub=32)], ev=None, er=[]
    )

    # -----< BandClassPriorityHRPD >-----#
    BandClassPriorityHRPD = SEQ(name="BandClassPriorityHRPD", mode=MODE_TYPE)
    _BandClassPriorityHRPD_bandClass = ENUM(
        name="bandClass",
        mode=MODE_TYPE,
        tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "BandclassCDMA2000")),
    )
    _BandClassPriorityHRPD_cellReselectionPriority = INT(
        name="cellReselectionPriority",
        mode=MODE_TYPE,
        tag=(1, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "CellReselectionPriority")),
    ...
    # -----< BandClassPriorityList1XRTT >-----#
    BandClassPriorityList1XRTT = SEQ_OF(
        name="BandClassPriorityList1XRTT", mode=MODE_TYPE
    )
    _BandClassPriorityList1XRTT__item_ = SEQ(
        name="_item_",
        mode=MODE_TYPE,
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "BandClassPriority1XRTT")),
    )
    BandClassPriorityList1XRTT._cont = _BandClassPriorityList1XRTT__item_
    BandClassPriorityList1XRTT._const_sz = ASN1Set(
        rv=[], rr=[ASN1RangeInt(lb=1, ub=32)], ev=None, er=[]
    )

    # -----< BandClassPriority1XRTT >-----#
    BandClassPriority1XRTT = SEQ(name="BandClassPriority1XRTT", mode=MODE_TYPE)
    _BandClassPriority1XRTT_bandClass = ENUM(
        name="bandClass",
        mode=MODE_TYPE,
        tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "BandclassCDMA2000")),
    )
    _BandClassPriority1XRTT_cellReselectionPriority = INT(
        name="cellReselectionPriority",
        mode=MODE_TYPE,
        tag=(1, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "CellReselectionPriority")),
    ...
    _RRCConnectionRequest_criticalExtensions = CHOICE(
        name="criticalExtensions",
        mode=MODE_TYPE,
        tag=(0, TAG_CONTEXT_SPEC, TAG_EXPLICIT),
    )
    __RRCConnectionRequest_criticalExtensions_rrcConnectionRequest_r8 = SEQ(
        name="rrcConnectionRequest-r8",
        mode=MODE_TYPE,
        tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "RRCConnectionRequest-r8-IEs")),
    )
    __RRCConnectionRequest_criticalExtensions_criticalExtensionsFuture = SEQ(
        name="criticalExtensionsFuture",
        mode=MODE_TYPE,
        tag=(1, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
    )
    ...
    # -----< RRCConnectionRequest-r8-IEs >-----#
    RRCConnectionRequest_r8_IEs = SEQ(
        name="RRCConnectionRequest-r8-IEs", mode=MODE_TYPE
    )
    _RRCConnectionRequest_r8_IEs_ue_Identity = CHOICE(
        name="ue-Identity",
        mode=MODE_TYPE,
        tag=(0, TAG_CONTEXT_SPEC, TAG_EXPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "InitialUE-Identity")),
    )
    _RRCConnectionRequest_r8_IEs_establishmentCause = ENUM(
        name="establishmentCause",
        mode=MODE_TYPE,
        tag=(1, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "EstablishmentCause")),
    )
    _RRCConnectionRequest_r8_IEs_spare = BIT_STR(
        name="spare", mode=MODE_TYPE, tag=(2, TAG_CONTEXT_SPEC, TAG_IMPLICIT)
    )
    _RRCConnectionRequest_r8_IEs_spare._const_sz = ASN1Set(
        rv=[1], rr=[], ev=None, er=[]
    )
    ...
    _InitialUE_Identity_s_TMSI = SEQ(
        name="s-TMSI",
        mode=MODE_TYPE,
        tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "S-TMSI")),
    )
    _InitialUE_Identity_randomValue = BIT_STR(
        name="randomValue", mode=MODE_TYPE, tag=(1, TAG_CONTEXT_SPEC, TAG_IMPLICIT)
    )
    ...
    EstablishmentCause._cont = ASN1Dict(
        [
            ("emergency", 0),
    ...
    _RRCConnectionSetup_rrc_TransactionIdentifier = INT(
        name="rrc-TransactionIdentifier",
        mode=MODE_TYPE,
        tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "RRC-TransactionIdentifier")),
    )
    _RRCConnectionSetup_criticalExtensions = CHOICE(
        name="criticalExtensions",
        mode=MODE_TYPE,
        tag=(1, TAG_CONTEXT_SPEC, TAG_EXPLICIT),
    )
    __RRCConnectionSetup_criticalExtensions_c1 = CHOICE(
        name="c1", mode=MODE_TYPE, tag=(0, TAG_CONTEXT_SPEC, TAG_EXPLICIT)
    )
    ___RRCConnectionSetup_criticalExtensions_c1_rrcConnectionSetup_r8 = SEQ(
        name="rrcConnectionSetup-r8",
        mode=MODE_TYPE,
        tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "RRCConnectionSetup-r8-IEs")),
    )
    ___RRCConnectionSetup_criticalExtensions_c1_spare7 = NULL(
        name="spare7", mode=MODE_TYPE, tag=(1, TAG_CONTEXT_SPEC, TAG_IMPLICIT)
    )
    ___RRCConnectionSetup_criticalExtensions_c1_spare6 = NULL(
        name="spare6", mode=MODE_TYPE, tag=(2, TAG_CONTEXT_SPEC, TAG_IMPLICIT)
    )
    ___RRCConnectionSetup_criticalExtensions_c1_spare5 = NULL(
        name="spare5", mode=MODE_TYPE, tag=(3, TAG_CONTEXT_SPEC, TAG_IMPLICIT)
    )
    ___RRCConnectionSetup_criticalExtensions_c1_spare4 = NULL(
        name="spare4", mode=MODE_TYPE, tag=(4, TAG_CONTEXT_SPEC, TAG_IMPLICIT)
    )
    ___RRCConnectionSetup_criticalExtensions_c1_spare3 = NULL(
        name="spare3", mode=MODE_TYPE, tag=(5, TAG_CONTEXT_SPEC, TAG_IMPLICIT)
    )
    ___RRCConnectionSetup_criticalExtensions_c1_spare2 = NULL(
        name="spare2", mode=MODE_TYPE, tag=(6, TAG_CONTEXT_SPEC, TAG_IMPLICIT)
    )
    ___RRCConnectionSetup_criticalExtensions_c1_spare1 = NULL(
        name="spare1", mode=MODE_TYPE, tag=(7, TAG_CONTEXT_SPEC, TAG_IMPLICIT)
    )
    ...
    __RRCConnectionSetup_criticalExtensions_criticalExtensionsFuture = SEQ(
        name="criticalExtensionsFuture",
        mode=MODE_TYPE,
        tag=(1, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
    )
    ...
    _RRCConnectionSetup_r8_IEs_radioResourceConfigDedicated = SEQ(
        name="radioResourceConfigDedicated",
        mode=MODE_TYPE,
        tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "RadioResourceConfigDedicated")),
    )
    _RRCConnectionSetup_r8_IEs_nonCriticalExtension = SEQ(
        name="nonCriticalExtension",
        mode=MODE_TYPE,
        tag=(1, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        opt=True,
    ...
    _RRCConnectionSetupComplete_rrc_TransactionIdentifier = INT(
        name="rrc-TransactionIdentifier",
        mode=MODE_TYPE,
        tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "RRC-TransactionIdentifier")),
    )
    _RRCConnectionSetupComplete_criticalExtensions = CHOICE(
        name="criticalExtensions",
        mode=MODE_TYPE,
        tag=(1, TAG_CONTEXT_SPEC, TAG_EXPLICIT),
    )
    __RRCConnectionSetupComplete_criticalExtensions_c1 = CHOICE(
        name="c1", mode=MODE_TYPE, tag=(0, TAG_CONTEXT_SPEC, TAG_EXPLICIT)
    )
    ___RRCConnectionSetupComplete_criticalExtensions_c1_rrcConnectionSetupComplete_r8 = SEQ(
        name="rrcConnectionSetupComplete-r8",
        mode=MODE_TYPE,
        tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(
            ("EUTRA-RRC-Definitions", "RRCConnectionSetupComplete-r8-IEs")
        ),
    )
    ___RRCConnectionSetupComplete_criticalExtensions_c1_spare3 = NULL(
        name="spare3", mode=MODE_TYPE, tag=(1, TAG_CONTEXT_SPEC, TAG_IMPLICIT)
    )
    ___RRCConnectionSetupComplete_criticalExtensions_c1_spare2 = NULL(
        name="spare2", mode=MODE_TYPE, tag=(2, TAG_CONTEXT_SPEC, TAG_IMPLICIT)
    )
    ___RRCConnectionSetupComplete_criticalExtensions_c1_spare1 = NULL(
        name="spare1", mode=MODE_TYPE, tag=(3, TAG_CONTEXT_SPEC, TAG_IMPLICIT)
    )
    ...
    __RRCConnectionSetupComplete_criticalExtensions_criticalExtensionsFuture = SEQ(
        name="criticalExtensionsFuture",
        mode=MODE_TYPE,
        tag=(1, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
    )
    __RRCConnectionSetupComplete_criticalExtensions_criticalExtensionsFuture._cont = (
        ASN1Dict([])
    )
    ...
    # -----< RRCConnectionSetupComplete-r8-IEs >-----#
    RRCConnectionSetupComplete_r8_IEs = SEQ(
        name="RRCConnectionSetupComplete-r8-IEs", mode=MODE_TYPE
    )
    _RRCConnectionSetupComplete_r8_IEs_selectedPLMN_Identity = INT(
        name="selectedPLMN-Identity",
        mode=MODE_TYPE,
        tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
    )
    _RRCConnectionSetupComplete_r8_IEs_selectedPLMN_Identity._const_val = ASN1Set(
        rv=[], rr=[ASN1RangeInt(lb=1, ub=6)], ev=None, er=[]
    )
    _RRCConnectionSetupComplete_r8_IEs_registeredMME = SEQ(
        name="registeredMME",
        mode=MODE_TYPE,
        tag=(1, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "RegisteredMME")),
        opt=True,
    )
    _RRCConnectionSetupComplete_r8_IEs_dedicatedInfoNAS = OCT_STR(
        name="dedicatedInfoNAS",
        mode=MODE_TYPE,
        tag=(2, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "DedicatedInfoNAS")),
    )
    _RRCConnectionSetupComplete_r8_IEs_nonCriticalExtension = SEQ(
        name="nonCriticalExtension",
        mode=MODE_TYPE,
        tag=(3, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        opt=True,
    ...
    _RegisteredMME_plmn_Identity = SEQ(
        name="plmn-Identity",
        mode=MODE_TYPE,
        tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "PLMN-Identity")),
        opt=True,
    )
    _RegisteredMME_mmegi = BIT_STR(
        name="mmegi", mode=MODE_TYPE, tag=(1, TAG_CONTEXT_SPEC, TAG_IMPLICIT)
    )
    _RegisteredMME_mmegi._const_sz = ASN1Set(rv=[16], rr=[], ev=None, er=[])
    _RegisteredMME_mmec = BIT_STR(
        name="mmec",
        mode=MODE_TYPE,
        tag=(2, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "MMEC")),
    )
    ...
    _SecurityModeCommand_rrc_TransactionIdentifier = INT(
        name="rrc-TransactionIdentifier",
        mode=MODE_TYPE,
        tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "RRC-TransactionIdentifier")),
    )
    _SecurityModeCommand_criticalExtensions = CHOICE(
        name="criticalExtensions",
        mode=MODE_TYPE,
        tag=(1, TAG_CONTEXT_SPEC, TAG_EXPLICIT),
    )
    __SecurityModeCommand_criticalExtensions_c1 = CHOICE(
        name="c1", mode=MODE_TYPE, tag=(0, TAG_CONTEXT_SPEC, TAG_EXPLICIT)
    )
    ___SecurityModeCommand_criticalExtensions_c1_securityModeCommand_r8 = SEQ(
        name="securityModeCommand-r8",
        mode=MODE_TYPE,
        tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "SecurityModeCommand-r8-IEs")),
    )
    ___SecurityModeCommand_criticalExtensions_c1_spare3 = NULL(
        name="spare3", mode=MODE_TYPE, tag=(1, TAG_CONTEXT_SPEC, TAG_IMPLICIT)
    )
    ___SecurityModeCommand_criticalExtensions_c1_spare2 = NULL(
        name="spare2", mode=MODE_TYPE, tag=(2, TAG_CONTEXT_SPEC, TAG_IMPLICIT)
    )
    ___SecurityModeCommand_criticalExtensions_c1_spare1 = NULL(
        name="spare1", mode=MODE_TYPE, tag=(3, TAG_CONTEXT_SPEC, TAG_IMPLICIT)
    )
    ...
    __SecurityModeCommand_criticalExtensions_criticalExtensionsFuture = SEQ(
        name="criticalExtensionsFuture",
        mode=MODE_TYPE,
        tag=(1, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
    )
    ...
    _SecurityModeCommand_r8_IEs_securityConfigSMC = SEQ(
        name="securityConfigSMC",
        mode=MODE_TYPE,
        tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "SecurityConfigSMC")),
    )
    _SecurityModeCommand_r8_IEs_nonCriticalExtension = SEQ(
        name="nonCriticalExtension",
        mode=MODE_TYPE,
        tag=(1, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        opt=True,
    ...
    _SecurityConfigSMC_securityAlgorithmConfig = SEQ(
        name="securityAlgorithmConfig",
        mode=MODE_TYPE,
        tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "SecurityAlgorithmConfig")),
    ...
    _SecurityModeComplete_rrc_TransactionIdentifier = INT(
        name="rrc-TransactionIdentifier",
        mode=MODE_TYPE,
        tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "RRC-TransactionIdentifier")),
    )
    _SecurityModeComplete_criticalExtensions = CHOICE(
        name="criticalExtensions",
        mode=MODE_TYPE,
        tag=(1, TAG_CONTEXT_SPEC, TAG_EXPLICIT),
    )
    __SecurityModeComplete_criticalExtensions_securityModeComplete_r8 = SEQ(
        name="securityModeComplete-r8",
        mode=MODE_TYPE,
        tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "SecurityModeComplete-r8-IEs")),
    )
    __SecurityModeComplete_criticalExtensions_criticalExtensionsFuture = SEQ(
        name="criticalExtensionsFuture",
        mode=MODE_TYPE,
        tag=(1, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
    )
    ...
    # -----< SecurityModeComplete-r8-IEs >-----#
    SecurityModeComplete_r8_IEs = SEQ(
        name="SecurityModeComplete-r8-IEs", mode=MODE_TYPE
    )
    _SecurityModeComplete_r8_IEs_nonCriticalExtension = SEQ(
        name="nonCriticalExtension",
        mode=MODE_TYPE,
        tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        opt=True,
    ...
    _SecurityModeFailure_rrc_TransactionIdentifier = INT(
        name="rrc-TransactionIdentifier",
        mode=MODE_TYPE,
        tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "RRC-TransactionIdentifier")),
    )
    _SecurityModeFailure_criticalExtensions = CHOICE(
        name="criticalExtensions",
        mode=MODE_TYPE,
        tag=(1, TAG_CONTEXT_SPEC, TAG_EXPLICIT),
    )
    __SecurityModeFailure_criticalExtensions_securityModeFailure_r8 = SEQ(
        name="securityModeFailure-r8",
        mode=MODE_TYPE,
        tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "SecurityModeFailure-r8-IEs")),
    )
    __SecurityModeFailure_criticalExtensions_criticalExtensionsFuture = SEQ(
        name="criticalExtensionsFuture",
        mode=MODE_TYPE,
        tag=(1, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
    )
    ...
    _SecurityModeFailure_r8_IEs_nonCriticalExtension = SEQ(
        name="nonCriticalExtension",
        mode=MODE_TYPE,
        tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        opt=True,
    ...
    _SystemInformation_criticalExtensions = CHOICE(
        name="criticalExtensions",
        mode=MODE_TYPE,
        tag=(0, TAG_CONTEXT_SPEC, TAG_EXPLICIT),
    )
    __SystemInformation_criticalExtensions_systemInformation_r8 = SEQ(
        name="systemInformation-r8",
        mode=MODE_TYPE,
        tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "SystemInformation-r8-IEs")),
    )
    __SystemInformation_criticalExtensions_criticalExtensionsFuture = SEQ(
        name="criticalExtensionsFuture",
        mode=MODE_TYPE,
        tag=(1, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
    )
    ...
    _SystemInformation_r8_IEs_sib_TypeAndInfo = SEQ_OF(
        name="sib-TypeAndInfo", mode=MODE_TYPE, tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT)
    )
    __SystemInformation_r8_IEs_sib_TypeAndInfo__item_ = CHOICE(
        name="_item_", mode=MODE_TYPE
    )
    ___SystemInformation_r8_IEs_sib_TypeAndInfo__item__sib2 = SEQ(
        name="sib2",
        mode=MODE_TYPE,
        tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "SystemInformationBlockType2")),
    )
    ___SystemInformation_r8_IEs_sib_TypeAndInfo__item__sib3 = SEQ(
        name="sib3",
        mode=MODE_TYPE,
        tag=(1, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "SystemInformationBlockType3")),
    )
    ___SystemInformation_r8_IEs_sib_TypeAndInfo__item__sib4 = SEQ(
        name="sib4",
        mode=MODE_TYPE,
        tag=(2, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "SystemInformationBlockType4")),
    )
    ___SystemInformation_r8_IEs_sib_TypeAndInfo__item__sib5 = SEQ(
        name="sib5",
        mode=MODE_TYPE,
        tag=(3, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "SystemInformationBlockType5")),
    )
    ___SystemInformation_r8_IEs_sib_TypeAndInfo__item__sib6 = SEQ(
        name="sib6",
        mode=MODE_TYPE,
        tag=(4, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "SystemInformationBlockType6")),
    )
    ___SystemInformation_r8_IEs_sib_TypeAndInfo__item__sib7 = SEQ(
        name="sib7",
        mode=MODE_TYPE,
        tag=(5, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "SystemInformationBlockType7")),
    )
    ___SystemInformation_r8_IEs_sib_TypeAndInfo__item__sib8 = SEQ(
        name="sib8",
        mode=MODE_TYPE,
        tag=(6, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "SystemInformationBlockType8")),
    )
    ___SystemInformation_r8_IEs_sib_TypeAndInfo__item__sib9 = SEQ(
        name="sib9",
        mode=MODE_TYPE,
        tag=(7, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "SystemInformationBlockType9")),
    )
    ___SystemInformation_r8_IEs_sib_TypeAndInfo__item__sib10 = SEQ(
        name="sib10",
        mode=MODE_TYPE,
        tag=(8, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "SystemInformationBlockType10")),
    )
    ___SystemInformation_r8_IEs_sib_TypeAndInfo__item__sib11 = SEQ(
        name="sib11",
        mode=MODE_TYPE,
        tag=(9, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "SystemInformationBlockType11")),
    )
    ...
    _SystemInformation_r8_IEs_sib_TypeAndInfo._cont = (
        __SystemInformation_r8_IEs_sib_TypeAndInfo__item_
    )
    _SystemInformation_r8_IEs_sib_TypeAndInfo._const_sz = ASN1Set(
        rv=[], rr=[ASN1RangeInt(lb=1, ub=32)], ev=None, er=[]
    )
    _SystemInformation_r8_IEs_nonCriticalExtension = SEQ(
        name="nonCriticalExtension",
        mode=MODE_TYPE,
        tag=(1, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        opt=True,
    ...
    # -----< SystemInformationBlockType1 >-----#
    SystemInformationBlockType1 = SEQ(
        name="SystemInformationBlockType1", mode=MODE_TYPE
    )
    _SystemInformationBlockType1_cellAccessRelatedInfo = SEQ(
        name="cellAccessRelatedInfo",
        mode=MODE_TYPE,
        tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
    )
    __SystemInformationBlockType1_cellAccessRelatedInfo_plmn_IdentityList = SEQ_OF(
        name="plmn-IdentityList",
        mode=MODE_TYPE,
        tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "PLMN-IdentityList")),
    )
    __SystemInformationBlockType1_cellAccessRelatedInfo_trackingAreaCode = BIT_STR(
        name="trackingAreaCode",
        mode=MODE_TYPE,
        tag=(1, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "TrackingAreaCode")),
    )
    __SystemInformationBlockType1_cellAccessRelatedInfo_cellIdentity = BIT_STR(
        name="cellIdentity",
        mode=MODE_TYPE,
        tag=(2, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "CellIdentity")),
    )
    __SystemInformationBlockType1_cellAccessRelatedInfo_cellBarred = ENUM(
        name="cellBarred", mode=MODE_TYPE, tag=(3, TAG_CONTEXT_SPEC, TAG_IMPLICIT)
    )
    __SystemInformationBlockType1_cellAccessRelatedInfo_cellBarred._cont = ASN1Dict(
        [("barred", 0), ("notBarred", 1)]
    )
    __SystemInformationBlockType1_cellAccessRelatedInfo_cellBarred._ext = None
    __SystemInformationBlockType1_cellAccessRelatedInfo_intraFreqReselection = ENUM(
        name="intraFreqReselection",
        mode=MODE_TYPE,
        tag=(4, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
    )
    __SystemInformationBlockType1_cellAccessRelatedInfo_intraFreqReselection._cont = (
        ASN1Dict([("allowed", 0), ("notAllowed", 1)])
    )
    __SystemInformationBlockType1_cellAccessRelatedInfo_intraFreqReselection._ext = None
    __SystemInformationBlockType1_cellAccessRelatedInfo_csg_Indication = BOOL(
        name="csg-Indication", mode=MODE_TYPE, tag=(5, TAG_CONTEXT_SPEC, TAG_IMPLICIT)
    )
    __SystemInformationBlockType1_cellAccessRelatedInfo_csg_Identity = BIT_STR(
        name="csg-Identity",
        mode=MODE_TYPE,
        tag=(6, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        opt=True,
    )
    __SystemInformationBlockType1_cellAccessRelatedInfo_csg_Identity._const_sz = (
        ASN1Set(rv=[27], rr=[], ev=None, er=[])
    )
    ...
    _SystemInformationBlockType1_cellSelectionInfo = SEQ(
        name="cellSelectionInfo",
        mode=MODE_TYPE,
        tag=(1, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
    )
    __SystemInformationBlockType1_cellSelectionInfo_q_RxLevMin = INT(
        name="q-RxLevMin",
        mode=MODE_TYPE,
        tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "Q-RxLevMin")),
    )
    __SystemInformationBlockType1_cellSelectionInfo_q_RxLevMinOffset = INT(
        name="q-RxLevMinOffset",
        mode=MODE_TYPE,
        tag=(1, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        opt=True,
    )
    __SystemInformationBlockType1_cellSelectionInfo_q_RxLevMinOffset._const_val = (
        ASN1Set(rv=[], rr=[ASN1RangeInt(lb=1, ub=8)], ev=None, er=[])
    )
    ...
    _SystemInformationBlockType1_p_Max = INT(
        name="p-Max",
        mode=MODE_TYPE,
        tag=(2, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "P-Max")),
        opt=True,
    )
    _SystemInformationBlockType1_freqBandIndicator = INT(
        name="freqBandIndicator",
        mode=MODE_TYPE,
        tag=(3, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
    )
    _SystemInformationBlockType1_freqBandIndicator._const_val = ASN1Set(
        rv=[], rr=[ASN1RangeInt(lb=1, ub=64)], ev=None, er=[]
    )
    _SystemInformationBlockType1_schedulingInfoList = SEQ_OF(
        name="schedulingInfoList",
        mode=MODE_TYPE,
        tag=(4, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "SchedulingInfoList")),
    )
    _SystemInformationBlockType1_tdd_Config = SEQ(
        name="tdd-Config",
        mode=MODE_TYPE,
        tag=(5, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "TDD-Config")),
        opt=True,
    )
    _SystemInformationBlockType1_si_WindowLength = ENUM(
        name="si-WindowLength", mode=MODE_TYPE, tag=(6, TAG_CONTEXT_SPEC, TAG_IMPLICIT)
    )
    _SystemInformationBlockType1_si_WindowLength._cont = ASN1Dict(
        [
            ("ms1", 0),
            ("ms2", 1),
            ("ms5", 2),
    ...
    _SystemInformationBlockType1_systemInfoValueTag = INT(
        name="systemInfoValueTag",
        mode=MODE_TYPE,
        tag=(7, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
    )
    _SystemInformationBlockType1_systemInfoValueTag._const_val = ASN1Set(
        rv=[], rr=[ASN1RangeInt(lb=0, ub=31)], ev=None, er=[]
    )
    _SystemInformationBlockType1_nonCriticalExtension = SEQ(
        name="nonCriticalExtension",
        mode=MODE_TYPE,
        tag=(8, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        opt=True,
    ...
    _PLMN_IdentityList__item_ = SEQ(
        name="_item_",
        mode=MODE_TYPE,
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "PLMN-IdentityInfo")),
    )
    PLMN_IdentityList._cont = _PLMN_IdentityList__item_
    PLMN_IdentityList._const_sz = ASN1Set(
        rv=[], rr=[ASN1RangeInt(lb=1, ub=6)], ev=None, er=[]
    )

    # -----< PLMN-IdentityInfo >-----#
    PLMN_IdentityInfo = SEQ(name="PLMN-IdentityInfo", mode=MODE_TYPE)
    _PLMN_IdentityInfo_plmn_Identity = SEQ(
        name="plmn-Identity",
        mode=MODE_TYPE,
        tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "PLMN-Identity")),
    )
    _PLMN_IdentityInfo_cellReservedForOperatorUse = ENUM(
        name="cellReservedForOperatorUse",
        mode=MODE_TYPE,
        tag=(1, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
    )
    _PLMN_IdentityInfo_cellReservedForOperatorUse._cont = ASN1Dict(
        [("reserved", 0), ("notReserved", 1)]
    )
    ...
    _SchedulingInfoList__item_ = SEQ(
        name="_item_",
        mode=MODE_TYPE,
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "SchedulingInfo")),
    )
    SchedulingInfoList._cont = _SchedulingInfoList__item_
    SchedulingInfoList._const_sz = ASN1Set(
        rv=[], rr=[ASN1RangeInt(lb=1, ub=32)], ev=None, er=[]
    )

    # -----< SchedulingInfo >-----#
    SchedulingInfo = SEQ(name="SchedulingInfo", mode=MODE_TYPE)
    _SchedulingInfo_si_Periodicity = ENUM(
        name="si-Periodicity", mode=MODE_TYPE, tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT)
    )
    _SchedulingInfo_si_Periodicity._cont = ASN1Dict(
        [
            ("rf8", 0),
            ("rf16", 1),
            ("rf32", 2),
    ...
    _SchedulingInfo_sib_MappingInfo = SEQ_OF(
        name="sib-MappingInfo",
        mode=MODE_TYPE,
        tag=(1, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "SIB-MappingInfo")),
    )
    ...
    _SIB_MappingInfo__item_ = ENUM(
        name="_item_",
        mode=MODE_TYPE,
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "SIB-Type")),
    )
    SIB_MappingInfo._cont = _SIB_MappingInfo__item_
    SIB_MappingInfo._const_sz = ASN1Set(
        rv=[], rr=[ASN1RangeInt(lb=0, ub=31)], ev=None, er=[]
    )

    # -----< SIB-Type >-----#
    SIB_Type = ENUM(name="SIB-Type", mode=MODE_TYPE)
    SIB_Type._cont = ASN1Dict(
        [
            ("sibType3", 0),
            ("sibType4", 1),
            ("sibType5", 2),
    ...
    _UECapabilityEnquiry_rrc_TransactionIdentifier = INT(
        name="rrc-TransactionIdentifier",
        mode=MODE_TYPE,
        tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "RRC-TransactionIdentifier")),
    )
    _UECapabilityEnquiry_criticalExtensions = CHOICE(
        name="criticalExtensions",
        mode=MODE_TYPE,
        tag=(1, TAG_CONTEXT_SPEC, TAG_EXPLICIT),
    )
    __UECapabilityEnquiry_criticalExtensions_c1 = CHOICE(
        name="c1", mode=MODE_TYPE, tag=(0, TAG_CONTEXT_SPEC, TAG_EXPLICIT)
    )
    ___UECapabilityEnquiry_criticalExtensions_c1_ueCapabilityEnquiry_r8 = SEQ(
        name="ueCapabilityEnquiry-r8",
        mode=MODE_TYPE,
        tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "UECapabilityEnquiry-r8-IEs")),
    )
    ___UECapabilityEnquiry_criticalExtensions_c1_spare3 = NULL(
        name="spare3", mode=MODE_TYPE, tag=(1, TAG_CONTEXT_SPEC, TAG_IMPLICIT)
    )
    ___UECapabilityEnquiry_criticalExtensions_c1_spare2 = NULL(
        name="spare2", mode=MODE_TYPE, tag=(2, TAG_CONTEXT_SPEC, TAG_IMPLICIT)
    )
    ___UECapabilityEnquiry_criticalExtensions_c1_spare1 = NULL(
        name="spare1", mode=MODE_TYPE, tag=(3, TAG_CONTEXT_SPEC, TAG_IMPLICIT)
    )
    ...
    __UECapabilityEnquiry_criticalExtensions_criticalExtensionsFuture = SEQ(
        name="criticalExtensionsFuture",
        mode=MODE_TYPE,
        tag=(1, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
    )
    ...
    _UECapabilityEnquiry_r8_IEs_ue_CapabilityRequest = SEQ_OF(
        name="ue-CapabilityRequest",
        mode=MODE_TYPE,
        tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "UE-CapabilityRequest")),
    )
    _UECapabilityEnquiry_r8_IEs_nonCriticalExtension = SEQ(
        name="nonCriticalExtension",
        mode=MODE_TYPE,
        tag=(1, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        opt=True,
    ...
    _UE_CapabilityRequest__item_ = ENUM(
        name="_item_",
        mode=MODE_TYPE,
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "RAT-Type")),
    )
    UE_CapabilityRequest._cont = _UE_CapabilityRequest__item_
    UE_CapabilityRequest._const_sz = ASN1Set(
        rv=[], rr=[ASN1RangeInt(lb=1, ub=8)], ev=None, er=[]
    )

    # -----< UECapabilityInformation >-----#
    UECapabilityInformation = SEQ(name="UECapabilityInformation", mode=MODE_TYPE)
    _UECapabilityInformation_rrc_TransactionIdentifier = INT(
        name="rrc-TransactionIdentifier",
        mode=MODE_TYPE,
        tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "RRC-TransactionIdentifier")),
    )
    _UECapabilityInformation_criticalExtensions = CHOICE(
        name="criticalExtensions",
        mode=MODE_TYPE,
        tag=(1, TAG_CONTEXT_SPEC, TAG_EXPLICIT),
    )
    __UECapabilityInformation_criticalExtensions_c1 = CHOICE(
        name="c1", mode=MODE_TYPE, tag=(0, TAG_CONTEXT_SPEC, TAG_EXPLICIT)
    )
    ___UECapabilityInformation_criticalExtensions_c1_ueCapabilityInformation_r8 = SEQ(
        name="ueCapabilityInformation-r8",
        mode=MODE_TYPE,
        tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(
            ("EUTRA-RRC-Definitions", "UECapabilityInformation-r8-IEs")
        ),
    )
    ___UECapabilityInformation_criticalExtensions_c1_spare7 = NULL(
        name="spare7", mode=MODE_TYPE, tag=(1, TAG_CONTEXT_SPEC, TAG_IMPLICIT)
    )
    ___UECapabilityInformation_criticalExtensions_c1_spare6 = NULL(
        name="spare6", mode=MODE_TYPE, tag=(2, TAG_CONTEXT_SPEC, TAG_IMPLICIT)
    )
    ___UECapabilityInformation_criticalExtensions_c1_spare5 = NULL(
        name="spare5", mode=MODE_TYPE, tag=(3, TAG_CONTEXT_SPEC, TAG_IMPLICIT)
    )
    ___UECapabilityInformation_criticalExtensions_c1_spare4 = NULL(
        name="spare4", mode=MODE_TYPE, tag=(4, TAG_CONTEXT_SPEC, TAG_IMPLICIT)
    )
    ___UECapabilityInformation_criticalExtensions_c1_spare3 = NULL(
        name="spare3", mode=MODE_TYPE, tag=(5, TAG_CONTEXT_SPEC, TAG_IMPLICIT)
    )
    ___UECapabilityInformation_criticalExtensions_c1_spare2 = NULL(
        name="spare2", mode=MODE_TYPE, tag=(6, TAG_CONTEXT_SPEC, TAG_IMPLICIT)
    )
    ___UECapabilityInformation_criticalExtensions_c1_spare1 = NULL(
        name="spare1", mode=MODE_TYPE, tag=(7, TAG_CONTEXT_SPEC, TAG_IMPLICIT)
    )
    ...
    __UECapabilityInformation_criticalExtensions_criticalExtensionsFuture = SEQ(
        name="criticalExtensionsFuture",
        mode=MODE_TYPE,
        tag=(1, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
    )
    __UECapabilityInformation_criticalExtensions_criticalExtensionsFuture._cont = (
        ASN1Dict([])
    )
    ...
    # -----< UECapabilityInformation-r8-IEs >-----#
    UECapabilityInformation_r8_IEs = SEQ(
        name="UECapabilityInformation-r8-IEs", mode=MODE_TYPE
    )
    _UECapabilityInformation_r8_IEs_ue_CapabilityRAT_ContainerList = SEQ_OF(
        name="ue-CapabilityRAT-ContainerList",
        mode=MODE_TYPE,
        tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(
            ("EUTRA-RRC-Definitions", "UE-CapabilityRAT-ContainerList")
        ),
    )
    _UECapabilityInformation_r8_IEs_nonCriticalExtension = SEQ(
        name="nonCriticalExtension",
        mode=MODE_TYPE,
        tag=(1, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        opt=True,
    ...
    # -----< ULHandoverPreparationTransfer >-----#
    ULHandoverPreparationTransfer = SEQ(
        name="ULHandoverPreparationTransfer", mode=MODE_TYPE
    )
    _ULHandoverPreparationTransfer_criticalExtensions = CHOICE(
        name="criticalExtensions",
        mode=MODE_TYPE,
        tag=(0, TAG_CONTEXT_SPEC, TAG_EXPLICIT),
    )
    __ULHandoverPreparationTransfer_criticalExtensions_c1 = CHOICE(
        name="c1", mode=MODE_TYPE, tag=(0, TAG_CONTEXT_SPEC, TAG_EXPLICIT)
    )
    ___ULHandoverPreparationTransfer_criticalExtensions_c1_ulHandoverPreparationTransfer_r8 = SEQ(
        name="ulHandoverPreparationTransfer-r8",
        mode=MODE_TYPE,
        tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(
            ("EUTRA-RRC-Definitions", "ULHandoverPreparationTransfer-r8-IEs")
        ),
    )
    ___ULHandoverPreparationTransfer_criticalExtensions_c1_spare3 = NULL(
        name="spare3", mode=MODE_TYPE, tag=(1, TAG_CONTEXT_SPEC, TAG_IMPLICIT)
    )
    ___ULHandoverPreparationTransfer_criticalExtensions_c1_spare2 = NULL(
        name="spare2", mode=MODE_TYPE, tag=(2, TAG_CONTEXT_SPEC, TAG_IMPLICIT)
    )
    ___ULHandoverPreparationTransfer_criticalExtensions_c1_spare1 = NULL(
        name="spare1", mode=MODE_TYPE, tag=(3, TAG_CONTEXT_SPEC, TAG_IMPLICIT)
    )
    ...
    __ULHandoverPreparationTransfer_criticalExtensions_criticalExtensionsFuture = SEQ(
        name="criticalExtensionsFuture",
        mode=MODE_TYPE,
        tag=(1, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
    )
    ...
    __ULHandoverPreparationTransfer_criticalExtensions_criticalExtensionsFuture._ext = (
        None
    )
    ...
    # -----< ULHandoverPreparationTransfer-r8-IEs >-----#
    ULHandoverPreparationTransfer_r8_IEs = SEQ(
        name="ULHandoverPreparationTransfer-r8-IEs", mode=MODE_TYPE
    )
    _ULHandoverPreparationTransfer_r8_IEs_cdma2000_Type = ENUM(
        name="cdma2000-Type",
        mode=MODE_TYPE,
        tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "CDMA2000-Type")),
    )
    _ULHandoverPreparationTransfer_r8_IEs_meid = BIT_STR(
        name="meid", mode=MODE_TYPE, tag=(1, TAG_CONTEXT_SPEC, TAG_IMPLICIT), opt=True
    )
    _ULHandoverPreparationTransfer_r8_IEs_meid._const_sz = ASN1Set(
        rv=[56], rr=[], ev=None, er=[]
    )
    _ULHandoverPreparationTransfer_r8_IEs_dedicatedInfo = OCT_STR(
        name="dedicatedInfo",
        mode=MODE_TYPE,
        tag=(2, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "DedicatedInfoCDMA2000")),
    )
    _ULHandoverPreparationTransfer_r8_IEs_nonCriticalExtension = SEQ(
        name="nonCriticalExtension",
        mode=MODE_TYPE,
        tag=(3, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        opt=True,
    ...
    _ULInformationTransfer_criticalExtensions = CHOICE(
        name="criticalExtensions",
        mode=MODE_TYPE,
        tag=(0, TAG_CONTEXT_SPEC, TAG_EXPLICIT),
    )
    __ULInformationTransfer_criticalExtensions_c1 = CHOICE(
        name="c1", mode=MODE_TYPE, tag=(0, TAG_CONTEXT_SPEC, TAG_EXPLICIT)
    )
    ___ULInformationTransfer_criticalExtensions_c1_ulInformationTransfer_r8 = SEQ(
        name="ulInformationTransfer-r8",
        mode=MODE_TYPE,
        tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "ULInformationTransfer-r8-IEs")),
    )
    ___ULInformationTransfer_criticalExtensions_c1_spare3 = NULL(
        name="spare3", mode=MODE_TYPE, tag=(1, TAG_CONTEXT_SPEC, TAG_IMPLICIT)
    )
    ___ULInformationTransfer_criticalExtensions_c1_spare2 = NULL(
        name="spare2", mode=MODE_TYPE, tag=(2, TAG_CONTEXT_SPEC, TAG_IMPLICIT)
    )
    ___ULInformationTransfer_criticalExtensions_c1_spare1 = NULL(
        name="spare1", mode=MODE_TYPE, tag=(3, TAG_CONTEXT_SPEC, TAG_IMPLICIT)
    )
    ...
    __ULInformationTransfer_criticalExtensions_criticalExtensionsFuture = SEQ(
        name="criticalExtensionsFuture",
        mode=MODE_TYPE,
        tag=(1, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
    )
    __ULInformationTransfer_criticalExtensions_criticalExtensionsFuture._cont = (
        ASN1Dict([])
    )
    ...
    # -----< ULInformationTransfer-r8-IEs >-----#
    ULInformationTransfer_r8_IEs = SEQ(
        name="ULInformationTransfer-r8-IEs", mode=MODE_TYPE
    )
    _ULInformationTransfer_r8_IEs_dedicatedInfoType = CHOICE(
        name="dedicatedInfoType",
        mode=MODE_TYPE,
        tag=(0, TAG_CONTEXT_SPEC, TAG_EXPLICIT),
    )
    __ULInformationTransfer_r8_IEs_dedicatedInfoType_dedicatedInfoNAS = OCT_STR(
        name="dedicatedInfoNAS",
        mode=MODE_TYPE,
        tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "DedicatedInfoNAS")),
    ...
    _ULInformationTransfer_r8_IEs_nonCriticalExtension = SEQ(
        name="nonCriticalExtension",
        mode=MODE_TYPE,
        tag=(1, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        opt=True,
    ...
    # -----< SystemInformationBlockType2 >-----#
    SystemInformationBlockType2 = SEQ(
        name="SystemInformationBlockType2", mode=MODE_TYPE
    )
    _SystemInformationBlockType2_ac_BarringInfo = SEQ(
        name="ac-BarringInfo",
        mode=MODE_TYPE,
        tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        opt=True,
    )
    __SystemInformationBlockType2_ac_BarringInfo_ac_BarringForEmergency = BOOL(
        name="ac-BarringForEmergency",
        mode=MODE_TYPE,
        tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
    )
    __SystemInformationBlockType2_ac_BarringInfo_ac_BarringForMO_Signalling = SEQ(
        name="ac-BarringForMO-Signalling",
        mode=MODE_TYPE,
        tag=(1, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "AC-BarringConfig")),
        opt=True,
    )
    __SystemInformationBlockType2_ac_BarringInfo_ac_BarringForMO_Data = SEQ(
    ...
    _SystemInformationBlockType2_radioResourceConfigCommon = SEQ(
        name="radioResourceConfigCommon",
        mode=MODE_TYPE,
        tag=(1, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "RadioResourceConfigCommonSIB")),
    )
    _SystemInformationBlockType2_ue_TimersAndConstants = SEQ(
        name="ue-TimersAndConstants",
        mode=MODE_TYPE,
        tag=(2, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "UE-TimersAndConstants")),
    )
    _SystemInformationBlockType2_freqInfo = SEQ(
        name="freqInfo", mode=MODE_TYPE, tag=(3, TAG_CONTEXT_SPEC, TAG_IMPLICIT)
    )
    __SystemInformationBlockType2_freqInfo_ul_CarrierFreq = INT(
        name="ul-CarrierFreq",
        mode=MODE_TYPE,
        tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "ARFCN-ValueEUTRA")),
    ...
    __SystemInformationBlockType2_freqInfo_ul_Bandwidth = ENUM(
        name="ul-Bandwidth",
        mode=MODE_TYPE,
        tag=(1, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        opt=True,
    )
    __SystemInformationBlockType2_freqInfo_ul_Bandwidth._cont = ASN1Dict(
        [("n6", 0), ("n15", 1), ("n25", 2), ("n50", 3), ("n75", 4), ("n100", 5)]
    )
    __SystemInformationBlockType2_freqInfo_ul_Bandwidth._ext = None
    __SystemInformationBlockType2_freqInfo_additionalSpectrumEmission = INT(
        name="additionalSpectrumEmission",
        mode=MODE_TYPE,
        tag=(2, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "AdditionalSpectrumEmission")),
    )
    ...
    _SystemInformationBlockType2_mbsfn_SubframeConfigList = SEQ_OF(
        name="mbsfn-SubframeConfigList",
        mode=MODE_TYPE,
        tag=(4, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "MBSFN-SubframeConfigList")),
        opt=True,
    )
    _SystemInformationBlockType2_timeAlignmentTimerCommon = ENUM(
        name="timeAlignmentTimerCommon",
        mode=MODE_TYPE,
        tag=(5, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "TimeAlignmentTimer")),
    )
    ...
    _AC_BarringConfig_ac_BarringFactor = ENUM(
        name="ac-BarringFactor", mode=MODE_TYPE, tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT)
    )
    _AC_BarringConfig_ac_BarringFactor._cont = ASN1Dict(
        [
            ("p00", 0),
            ("p05", 1),
            ("p10", 2),
    ...
    _AC_BarringConfig_ac_BarringTime = ENUM(
        name="ac-BarringTime", mode=MODE_TYPE, tag=(1, TAG_CONTEXT_SPEC, TAG_IMPLICIT)
    )
    _AC_BarringConfig_ac_BarringTime._cont = ASN1Dict(
        [
            ("s4", 0),
            ("s8", 1),
            ("s16", 2),
    ...
    _AC_BarringConfig_ac_BarringForSpecialAC = BIT_STR(
        name="ac-BarringForSpecialAC",
        mode=MODE_TYPE,
        tag=(2, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
    )
    _AC_BarringConfig_ac_BarringForSpecialAC._const_sz = ASN1Set(
        rv=[5], rr=[], ev=None, er=[]
    )
    ...
    _MBSFN_SubframeConfigList__item_ = SEQ(
        name="_item_",
        mode=MODE_TYPE,
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "MBSFN-SubframeConfig")),
    )
    MBSFN_SubframeConfigList._cont = _MBSFN_SubframeConfigList__item_
    MBSFN_SubframeConfigList._const_sz = ASN1Set(
        rv=[], rr=[ASN1RangeInt(lb=1, ub=8)], ev=None, er=[]
    )

    # -----< MBSFN-SubframeConfig >-----#
    MBSFN_SubframeConfig = SEQ(name="MBSFN-SubframeConfig", mode=MODE_TYPE)
    _MBSFN_SubframeConfig_radioframeAllocationPeriod = ENUM(
        name="radioframeAllocationPeriod",
        mode=MODE_TYPE,
        tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
    )
    _MBSFN_SubframeConfig_radioframeAllocationPeriod._cont = ASN1Dict(
        [("n1", 0), ("n2", 1), ("n4", 2), ("n8", 3), ("n16", 4), ("n32", 5)]
    )
    _MBSFN_SubframeConfig_radioframeAllocationPeriod._ext = None
    _MBSFN_SubframeConfig_radioframeAllocationOffset = INT(
        name="radioframeAllocationOffset",
        mode=MODE_TYPE,
        tag=(1, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
    )
    _MBSFN_SubframeConfig_radioframeAllocationOffset._const_val = ASN1Set(
        rv=[], rr=[ASN1RangeInt(lb=0, ub=7)], ev=None, er=[]
    )
    _MBSFN_SubframeConfig_subframeAllocation = CHOICE(
        name="subframeAllocation",
        mode=MODE_TYPE,
        tag=(2, TAG_CONTEXT_SPEC, TAG_EXPLICIT),
    )
    __MBSFN_SubframeConfig_subframeAllocation_oneFrame = BIT_STR(
        name="oneFrame", mode=MODE_TYPE, tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT)
    )
    __MBSFN_SubframeConfig_subframeAllocation_oneFrame._const_sz = ASN1Set(
        rv=[6], rr=[], ev=None, er=[]
    )
    __MBSFN_SubframeConfig_subframeAllocation_fourFrames = BIT_STR(
        name="fourFrames", mode=MODE_TYPE, tag=(1, TAG_CONTEXT_SPEC, TAG_IMPLICIT)
    )
    __MBSFN_SubframeConfig_subframeAllocation_fourFrames._const_sz = ASN1Set(
        rv=[24], rr=[], ev=None, er=[]
    )
    ...
    # -----< SystemInformationBlockType3 >-----#
    SystemInformationBlockType3 = SEQ(
        name="SystemInformationBlockType3", mode=MODE_TYPE
    )
    _SystemInformationBlockType3_cellReselectionInfoCommon = SEQ(
        name="cellReselectionInfoCommon",
        mode=MODE_TYPE,
        tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
    )
    __SystemInformationBlockType3_cellReselectionInfoCommon_q_Hyst = ENUM(
        name="q-Hyst", mode=MODE_TYPE, tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT)
    )
    __SystemInformationBlockType3_cellReselectionInfoCommon_q_Hyst._cont = ASN1Dict(
        [
            ("dB0", 0),
            ("dB1", 1),
            ("dB2", 2),
    ...
    __SystemInformationBlockType3_cellReselectionInfoCommon_speedStateReselectionPars = SEQ(
        name="speedStateReselectionPars",
        mode=MODE_TYPE,
        tag=(1, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        opt=True,
    )
    ___SystemInformationBlockType3_cellReselectionInfoCommon_speedStateReselectionPars_mobilityStateParameters = SEQ(
        name="mobilityStateParameters",
        mode=MODE_TYPE,
        tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "MobilityStateParameters")),
    )
    ___SystemInformationBlockType3_cellReselectionInfoCommon_speedStateReselectionPars_q_HystSF = SEQ(
        name="q-HystSF", mode=MODE_TYPE, tag=(1, TAG_CONTEXT_SPEC, TAG_IMPLICIT)
    )
    ____SystemInformationBlockType3_cellReselectionInfoCommon_speedStateReselectionPars_q_HystSF_sf_Medium = ENUM(
        name="sf-Medium", mode=MODE_TYPE, tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT)
    )
    ...
    _SystemInformationBlockType3_cellReselectionServingFreqInfo = SEQ(
        name="cellReselectionServingFreqInfo",
        mode=MODE_TYPE,
        tag=(1, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
    )
    __SystemInformationBlockType3_cellReselectionServingFreqInfo_s_NonIntraSearch = INT(
        name="s-NonIntraSearch",
        mode=MODE_TYPE,
        tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "ReselectionThreshold")),
        opt=True,
    )
    __SystemInformationBlockType3_cellReselectionServingFreqInfo_threshServingLow = INT(
        name="threshServingLow",
        mode=MODE_TYPE,
        tag=(1, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "ReselectionThreshold")),
    )
    __SystemInformationBlockType3_cellReselectionServingFreqInfo_cellReselectionPriority = INT(
        name="cellReselectionPriority",
        mode=MODE_TYPE,
        tag=(2, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "CellReselectionPriority")),
    ...
    _SystemInformationBlockType3_intraFreqCellReselectionInfo = SEQ(
        name="intraFreqCellReselectionInfo",
        mode=MODE_TYPE,
        tag=(2, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
    )
    __SystemInformationBlockType3_intraFreqCellReselectionInfo_q_RxLevMin = INT(
        name="q-RxLevMin",
        mode=MODE_TYPE,
        tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "Q-RxLevMin")),
    )
    __SystemInformationBlockType3_intraFreqCellReselectionInfo_p_Max = INT(
        name="p-Max",
        mode=MODE_TYPE,
        tag=(1, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "P-Max")),
    ...
    __SystemInformationBlockType3_intraFreqCellReselectionInfo_s_IntraSearch = INT(
        name="s-IntraSearch",
        mode=MODE_TYPE,
        tag=(2, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "ReselectionThreshold")),
    ...
    __SystemInformationBlockType3_intraFreqCellReselectionInfo_allowedMeasBandwidth = (
        ENUM(
            ...
            mode=MODE_TYPE,
            tag=(3, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
            typeref=ASN1RefType(("EUTRA-RRC-Definitions", "AllowedMeasBandwidth")),
            opt=True,
        )
    )
    __SystemInformationBlockType3_intraFreqCellReselectionInfo_presenceAntennaPort1 = (
        BOOL(
            ...
            mode=MODE_TYPE,
            tag=(4, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
            typeref=ASN1RefType(("EUTRA-RRC-Definitions", "PresenceAntennaPort1")),
        )
    )
    __SystemInformationBlockType3_intraFreqCellReselectionInfo_neighCellConfig = (
        BIT_STR(
            ...
            mode=MODE_TYPE,
            tag=(5, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
            typeref=ASN1RefType(("EUTRA-RRC-Definitions", "NeighCellConfig")),
        )
    )
    __SystemInformationBlockType3_intraFreqCellReselectionInfo_t_ReselectionEUTRA = INT(
        name="t-ReselectionEUTRA",
        mode=MODE_TYPE,
        tag=(6, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "T-Reselection")),
    )
    __SystemInformationBlockType3_intraFreqCellReselectionInfo_t_ReselectionEUTRA_SF = (
        SEQ(
            ...
            mode=MODE_TYPE,
            tag=(7, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
            typeref=ASN1RefType(("EUTRA-RRC-Definitions", "SpeedStateScaleFactors")),
            opt=True,
        )
    )
    ...
    # -----< SystemInformationBlockType4 >-----#
    SystemInformationBlockType4 = SEQ(
        name="SystemInformationBlockType4", mode=MODE_TYPE
    )
    _SystemInformationBlockType4_intraFreqNeighCellList = SEQ_OF(
        name="intraFreqNeighCellList",
        mode=MODE_TYPE,
        tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "IntraFreqNeighCellList")),
        opt=True,
    )
    _SystemInformationBlockType4_intraFreqBlackCellList = SEQ_OF(
        name="intraFreqBlackCellList",
        mode=MODE_TYPE,
        tag=(1, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "IntraFreqBlackCellList")),
        opt=True,
    )
    _SystemInformationBlockType4_csg_PhysCellIdRange = SEQ(
        name="csg-PhysCellIdRange",
        mode=MODE_TYPE,
        tag=(2, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "PhysCellIdRange")),
        opt=True,
    )
    ...
    _IntraFreqNeighCellList__item_ = SEQ(
        name="_item_",
        mode=MODE_TYPE,
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "IntraFreqNeighCellInfo")),
    )
    IntraFreqNeighCellList._cont = _IntraFreqNeighCellList__item_
    IntraFreqNeighCellList._const_sz = ASN1Set(
        rv=[], rr=[ASN1RangeInt(lb=1, ub=16)], ev=None, er=[]
    )

    # -----< IntraFreqNeighCellInfo >-----#
    IntraFreqNeighCellInfo = SEQ(name="IntraFreqNeighCellInfo", mode=MODE_TYPE)
    _IntraFreqNeighCellInfo_physCellId = INT(
        name="physCellId",
        mode=MODE_TYPE,
        tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "PhysCellId")),
    )
    _IntraFreqNeighCellInfo_q_OffsetCell = ENUM(
        name="q-OffsetCell",
        mode=MODE_TYPE,
        tag=(1, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "Q-OffsetRange")),
    )
    ...
    _IntraFreqBlackCellList__item_ = SEQ(
        name="_item_",
        mode=MODE_TYPE,
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "PhysCellIdRange")),
    )
    IntraFreqBlackCellList._cont = _IntraFreqBlackCellList__item_
    IntraFreqBlackCellList._const_sz = ASN1Set(
        rv=[], rr=[ASN1RangeInt(lb=1, ub=16)], ev=None, er=[]
    )

    # -----< SystemInformationBlockType5 >-----#
    SystemInformationBlockType5 = SEQ(
        name="SystemInformationBlockType5", mode=MODE_TYPE
    )
    _SystemInformationBlockType5_interFreqCarrierFreqList = SEQ_OF(
        name="interFreqCarrierFreqList",
        mode=MODE_TYPE,
        tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "InterFreqCarrierFreqList")),
    )
    ...
    _InterFreqCarrierFreqList__item_ = SEQ(
        name="_item_",
        mode=MODE_TYPE,
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "InterFreqCarrierFreqInfo")),
    )
    InterFreqCarrierFreqList._cont = _InterFreqCarrierFreqList__item_
    InterFreqCarrierFreqList._const_sz = ASN1Set(
        rv=[], rr=[ASN1RangeInt(lb=1, ub=8)], ev=None, er=[]
    )

    # -----< InterFreqCarrierFreqInfo >-----#
    InterFreqCarrierFreqInfo = SEQ(name="InterFreqCarrierFreqInfo", mode=MODE_TYPE)
    _InterFreqCarrierFreqInfo_dl_CarrierFreq = INT(
        name="dl-CarrierFreq",
        mode=MODE_TYPE,
        tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "ARFCN-ValueEUTRA")),
    )
    _InterFreqCarrierFreqInfo_q_RxLevMin = INT(
        name="q-RxLevMin",
        mode=MODE_TYPE,
        tag=(1, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "Q-RxLevMin")),
    )
    _InterFreqCarrierFreqInfo_p_Max = INT(
        name="p-Max",
        mode=MODE_TYPE,
        tag=(2, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "P-Max")),
    ...
    _InterFreqCarrierFreqInfo_t_ReselectionEUTRA = INT(
        name="t-ReselectionEUTRA",
        mode=MODE_TYPE,
        tag=(3, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "T-Reselection")),
    )
    _InterFreqCarrierFreqInfo_t_ReselectionEUTRA_SF = SEQ(
        name="t-ReselectionEUTRA-SF",
        mode=MODE_TYPE,
        tag=(4, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "SpeedStateScaleFactors")),
    ...
    _InterFreqCarrierFreqInfo_threshX_High = INT(
        name="threshX-High",
        mode=MODE_TYPE,
        tag=(5, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "ReselectionThreshold")),
    )
    _InterFreqCarrierFreqInfo_threshX_Low = INT(
        name="threshX-Low",
        mode=MODE_TYPE,
        tag=(6, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "ReselectionThreshold")),
    )
    _InterFreqCarrierFreqInfo_allowedMeasBandwidth = ENUM(
        name="allowedMeasBandwidth",
        mode=MODE_TYPE,
        tag=(7, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "AllowedMeasBandwidth")),
    )
    _InterFreqCarrierFreqInfo_presenceAntennaPort1 = BOOL(
        name="presenceAntennaPort1",
        mode=MODE_TYPE,
        tag=(8, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "PresenceAntennaPort1")),
    )
    _InterFreqCarrierFreqInfo_cellReselectionPriority = INT(
        name="cellReselectionPriority",
        mode=MODE_TYPE,
        tag=(9, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "CellReselectionPriority")),
    ...
    _InterFreqCarrierFreqInfo_neighCellConfig = BIT_STR(
        name="neighCellConfig",
        mode=MODE_TYPE,
        tag=(10, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "NeighCellConfig")),
    )
    _InterFreqCarrierFreqInfo_q_OffsetFreq = ENUM(
        name="q-OffsetFreq",
        mode=MODE_TYPE,
        tag=(11, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "Q-OffsetRange")),
        default="dB0",
    )
    _InterFreqCarrierFreqInfo_interFreqNeighCellList = SEQ_OF(
        name="interFreqNeighCellList",
        mode=MODE_TYPE,
        tag=(12, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "InterFreqNeighCellList")),
        opt=True,
    )
    _InterFreqCarrierFreqInfo_interFreqBlackCellList = SEQ_OF(
        name="interFreqBlackCellList",
        mode=MODE_TYPE,
        tag=(13, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "InterFreqBlackCellList")),
        opt=True,
    )
    ...
    _InterFreqNeighCellList__item_ = SEQ(
        name="_item_",
        mode=MODE_TYPE,
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "InterFreqNeighCellInfo")),
    )
    InterFreqNeighCellList._cont = _InterFreqNeighCellList__item_
    InterFreqNeighCellList._const_sz = ASN1Set(
        rv=[], rr=[ASN1RangeInt(lb=1, ub=16)], ev=None, er=[]
    )

    # -----< InterFreqNeighCellInfo >-----#
    InterFreqNeighCellInfo = SEQ(name="InterFreqNeighCellInfo", mode=MODE_TYPE)
    _InterFreqNeighCellInfo_physCellId = INT(
        name="physCellId",
        mode=MODE_TYPE,
        tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "PhysCellId")),
    )
    _InterFreqNeighCellInfo_q_OffsetCell = ENUM(
        name="q-OffsetCell",
        mode=MODE_TYPE,
        tag=(1, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "Q-OffsetRange")),
    ...
    _InterFreqBlackCellList__item_ = SEQ(
        name="_item_",
        mode=MODE_TYPE,
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "PhysCellIdRange")),
    )
    InterFreqBlackCellList._cont = _InterFreqBlackCellList__item_
    InterFreqBlackCellList._const_sz = ASN1Set(
        rv=[], rr=[ASN1RangeInt(lb=1, ub=16)], ev=None, er=[]
    )

    # -----< SystemInformationBlockType6 >-----#
    SystemInformationBlockType6 = SEQ(
        name="SystemInformationBlockType6", mode=MODE_TYPE
    )
    _SystemInformationBlockType6_carrierFreqListUTRA_FDD = SEQ_OF(
        name="carrierFreqListUTRA-FDD",
        mode=MODE_TYPE,
        tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "CarrierFreqListUTRA-FDD")),
        opt=True,
    )
    _SystemInformationBlockType6_carrierFreqListUTRA_TDD = SEQ_OF(
        name="carrierFreqListUTRA-TDD",
        mode=MODE_TYPE,
        tag=(1, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "CarrierFreqListUTRA-TDD")),
        opt=True,
    )
    _SystemInformationBlockType6_t_ReselectionUTRA = INT(
        name="t-ReselectionUTRA",
        mode=MODE_TYPE,
        tag=(2, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "T-Reselection")),
    )
    _SystemInformationBlockType6_t_ReselectionUTRA_SF = SEQ(
    ...
    _CarrierFreqListUTRA_FDD__item_ = SEQ(
        name="_item_",
        mode=MODE_TYPE,
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "CarrierFreqUTRA-FDD")),
    )
    CarrierFreqListUTRA_FDD._cont = _CarrierFreqListUTRA_FDD__item_
    CarrierFreqListUTRA_FDD._const_sz = ASN1Set(
        rv=[], rr=[ASN1RangeInt(lb=1, ub=16)], ev=None, er=[]
    )

    # -----< CarrierFreqUTRA-FDD >-----#
    CarrierFreqUTRA_FDD = SEQ(name="CarrierFreqUTRA-FDD", mode=MODE_TYPE)
    _CarrierFreqUTRA_FDD_carrierFreq = INT(
        name="carrierFreq",
        mode=MODE_TYPE,
        tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "ARFCN-ValueUTRA")),
    )
    _CarrierFreqUTRA_FDD_cellReselectionPriority = INT(
        name="cellReselectionPriority",
        mode=MODE_TYPE,
        tag=(1, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "CellReselectionPriority")),
    ...
    _CarrierFreqUTRA_FDD_threshX_High = INT(
        name="threshX-High",
        mode=MODE_TYPE,
        tag=(2, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "ReselectionThreshold")),
    )
    _CarrierFreqUTRA_FDD_threshX_Low = INT(
        name="threshX-Low",
        mode=MODE_TYPE,
        tag=(3, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "ReselectionThreshold")),
    )
    _CarrierFreqUTRA_FDD_q_RxLevMin = INT(
        name="q-RxLevMin", mode=MODE_TYPE, tag=(4, TAG_CONTEXT_SPEC, TAG_IMPLICIT)
    )
    _CarrierFreqUTRA_FDD_q_RxLevMin._const_val = ASN1Set(
        rv=[], rr=[ASN1RangeInt(lb=-60, ub=-13)], ev=None, er=[]
    )
    _CarrierFreqUTRA_FDD_p_MaxUTRA = INT(
        name="p-MaxUTRA", mode=MODE_TYPE, tag=(5, TAG_CONTEXT_SPEC, TAG_IMPLICIT)
    )
    _CarrierFreqUTRA_FDD_p_MaxUTRA._const_val = ASN1Set(
        rv=[], rr=[ASN1RangeInt(lb=-50, ub=33)], ev=None, er=[]
    )
    _CarrierFreqUTRA_FDD_q_QualMin = INT(
        name="q-QualMin", mode=MODE_TYPE, tag=(6, TAG_CONTEXT_SPEC, TAG_IMPLICIT)
    )
    _CarrierFreqUTRA_FDD_q_QualMin._const_val = ASN1Set(
        rv=[], rr=[ASN1RangeInt(lb=-24, ub=0)], ev=None, er=[]
    )
    ...
    _CarrierFreqListUTRA_TDD__item_ = SEQ(
        name="_item_",
        mode=MODE_TYPE,
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "CarrierFreqUTRA-TDD")),
    )
    CarrierFreqListUTRA_TDD._cont = _CarrierFreqListUTRA_TDD__item_
    CarrierFreqListUTRA_TDD._const_sz = ASN1Set(
        rv=[], rr=[ASN1RangeInt(lb=1, ub=16)], ev=None, er=[]
    )

    # -----< CarrierFreqUTRA-TDD >-----#
    CarrierFreqUTRA_TDD = SEQ(name="CarrierFreqUTRA-TDD", mode=MODE_TYPE)
    _CarrierFreqUTRA_TDD_carrierFreq = INT(
        name="carrierFreq",
        mode=MODE_TYPE,
        tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "ARFCN-ValueUTRA")),
    )
    _CarrierFreqUTRA_TDD_cellReselectionPriority = INT(
        name="cellReselectionPriority",
        mode=MODE_TYPE,
        tag=(1, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "CellReselectionPriority")),
    ...
    _CarrierFreqUTRA_TDD_threshX_High = INT(
        name="threshX-High",
        mode=MODE_TYPE,
        tag=(2, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "ReselectionThreshold")),
    )
    _CarrierFreqUTRA_TDD_threshX_Low = INT(
        name="threshX-Low",
        mode=MODE_TYPE,
        tag=(3, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "ReselectionThreshold")),
    )
    _CarrierFreqUTRA_TDD_q_RxLevMin = INT(
        name="q-RxLevMin", mode=MODE_TYPE, tag=(4, TAG_CONTEXT_SPEC, TAG_IMPLICIT)
    )
    _CarrierFreqUTRA_TDD_q_RxLevMin._const_val = ASN1Set(
        rv=[], rr=[ASN1RangeInt(lb=-60, ub=-13)], ev=None, er=[]
    )
    _CarrierFreqUTRA_TDD_p_MaxUTRA = INT(
        name="p-MaxUTRA", mode=MODE_TYPE, tag=(5, TAG_CONTEXT_SPEC, TAG_IMPLICIT)
    )
    _CarrierFreqUTRA_TDD_p_MaxUTRA._const_val = ASN1Set(
        rv=[], rr=[ASN1RangeInt(lb=-50, ub=33)], ev=None, er=[]
    )
    ...
    # -----< SystemInformationBlockType7 >-----#
    SystemInformationBlockType7 = SEQ(
        name="SystemInformationBlockType7", mode=MODE_TYPE
    )
    _SystemInformationBlockType7_t_ReselectionGERAN = INT(
        name="t-ReselectionGERAN",
        mode=MODE_TYPE,
        tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "T-Reselection")),
    )
    _SystemInformationBlockType7_t_ReselectionGERAN_SF = SEQ(
    ...
    _SystemInformationBlockType7_carrierFreqsInfoList = SEQ_OF(
        name="carrierFreqsInfoList",
        mode=MODE_TYPE,
        tag=(2, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "CarrierFreqsInfoListGERAN")),
        opt=True,
    )
    ...
    _CarrierFreqsInfoListGERAN__item_ = SEQ(
        name="_item_",
        mode=MODE_TYPE,
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "CarrierFreqsInfoGERAN")),
    )
    CarrierFreqsInfoListGERAN._cont = _CarrierFreqsInfoListGERAN__item_
    CarrierFreqsInfoListGERAN._const_sz = ASN1Set(
        rv=[], rr=[ASN1RangeInt(lb=1, ub=16)], ev=None, er=[]
    )

    # -----< CarrierFreqsInfoGERAN >-----#
    CarrierFreqsInfoGERAN = SEQ(name="CarrierFreqsInfoGERAN", mode=MODE_TYPE)
    _CarrierFreqsInfoGERAN_carrierFreqs = SEQ(
        name="carrierFreqs",
        mode=MODE_TYPE,
        tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "CarrierFreqsGERAN")),
    )
    _CarrierFreqsInfoGERAN_commonInfo = SEQ(
        name="commonInfo", mode=MODE_TYPE, tag=(1, TAG_CONTEXT_SPEC, TAG_IMPLICIT)
    )
    __CarrierFreqsInfoGERAN_commonInfo_cellReselectionPriority = INT(
        name="cellReselectionPriority",
        mode=MODE_TYPE,
        tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "CellReselectionPriority")),
    ...
    __CarrierFreqsInfoGERAN_commonInfo_ncc_Permitted = BIT_STR(
        name="ncc-Permitted", mode=MODE_TYPE, tag=(1, TAG_CONTEXT_SPEC, TAG_IMPLICIT)
    )
    __CarrierFreqsInfoGERAN_commonInfo_ncc_Permitted._const_sz = ASN1Set(
        rv=[8], rr=[], ev=None, er=[]
    )
    __CarrierFreqsInfoGERAN_commonInfo_q_RxLevMin = INT(
        name="q-RxLevMin", mode=MODE_TYPE, tag=(2, TAG_CONTEXT_SPEC, TAG_IMPLICIT)
    )
    __CarrierFreqsInfoGERAN_commonInfo_q_RxLevMin._const_val = ASN1Set(
        rv=[], rr=[ASN1RangeInt(lb=0, ub=45)], ev=None, er=[]
    )
    __CarrierFreqsInfoGERAN_commonInfo_p_MaxGERAN = INT(
        name="p-MaxGERAN",
        mode=MODE_TYPE,
        tag=(3, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        opt=True,
    )
    __CarrierFreqsInfoGERAN_commonInfo_p_MaxGERAN._const_val = ASN1Set(
        rv=[], rr=[ASN1RangeInt(lb=0, ub=39)], ev=None, er=[]
    )
    __CarrierFreqsInfoGERAN_commonInfo_threshX_High = INT(
        name="threshX-High",
        mode=MODE_TYPE,
        tag=(4, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "ReselectionThreshold")),
    )
    __CarrierFreqsInfoGERAN_commonInfo_threshX_Low = INT(
        name="threshX-Low",
        mode=MODE_TYPE,
        tag=(5, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "ReselectionThreshold")),
    ...
    # -----< SystemInformationBlockType8 >-----#
    SystemInformationBlockType8 = SEQ(
        name="SystemInformationBlockType8", mode=MODE_TYPE
    )
    _SystemInformationBlockType8_systemTimeInfo = SEQ(
        name="systemTimeInfo",
        mode=MODE_TYPE,
        tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "SystemTimeInfoCDMA2000")),
        opt=True,
    )
    _SystemInformationBlockType8_searchWindowSize = INT(
        name="searchWindowSize",
        mode=MODE_TYPE,
        tag=(1, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        opt=True,
    )
    _SystemInformationBlockType8_searchWindowSize._const_val = ASN1Set(
        rv=[], rr=[ASN1RangeInt(lb=0, ub=15)], ev=None, er=[]
    )
    _SystemInformationBlockType8_parametersHRPD = SEQ(
        name="parametersHRPD",
        mode=MODE_TYPE,
        tag=(2, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        opt=True,
    )
    __SystemInformationBlockType8_parametersHRPD_preRegistrationInfoHRPD = SEQ(
        name="preRegistrationInfoHRPD",
        mode=MODE_TYPE,
        tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "PreRegistrationInfoHRPD")),
    )
    __SystemInformationBlockType8_parametersHRPD_cellReselectionParametersHRPD = SEQ(
        name="cellReselectionParametersHRPD",
        mode=MODE_TYPE,
        tag=(1, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(
            ("EUTRA-RRC-Definitions", "CellReselectionParametersCDMA2000")
        ),
        opt=True,
    )
    ...
    _SystemInformationBlockType8_parameters1XRTT = SEQ(
        name="parameters1XRTT",
        mode=MODE_TYPE,
        tag=(3, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        opt=True,
    )
    __SystemInformationBlockType8_parameters1XRTT_csfb_RegistrationParam1XRTT = SEQ(
        name="csfb-RegistrationParam1XRTT",
        mode=MODE_TYPE,
        tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "CSFB-RegistrationParam1XRTT")),
        opt=True,
    )
    __SystemInformationBlockType8_parameters1XRTT_longCodeState1XRTT = BIT_STR(
        name="longCodeState1XRTT",
        mode=MODE_TYPE,
        tag=(1, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        opt=True,
    )
    __SystemInformationBlockType8_parameters1XRTT_longCodeState1XRTT._const_sz = (
        ASN1Set(rv=[42], rr=[], ev=None, er=[])
    )
    __SystemInformationBlockType8_parameters1XRTT_cellReselectionParameters1XRTT = SEQ(
    ...
    # -----< CellReselectionParametersCDMA2000 >-----#
    CellReselectionParametersCDMA2000 = SEQ(
        name="CellReselectionParametersCDMA2000", mode=MODE_TYPE
    )
    _CellReselectionParametersCDMA2000_bandClassList = SEQ_OF(
        name="bandClassList",
        mode=MODE_TYPE,
        tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "BandClassListCDMA2000")),
    )
    _CellReselectionParametersCDMA2000_neighCellList = SEQ_OF(
        name="neighCellList",
        mode=MODE_TYPE,
        tag=(1, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "NeighCellListCDMA2000")),
    )
    _CellReselectionParametersCDMA2000_t_ReselectionCDMA2000 = INT(
        name="t-ReselectionCDMA2000",
        mode=MODE_TYPE,
        tag=(2, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "T-Reselection")),
    )
    _CellReselectionParametersCDMA2000_t_ReselectionCDMA2000_SF = SEQ(
    ...
    _NeighCellListCDMA2000__item_ = SEQ(
        name="_item_",
        mode=MODE_TYPE,
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "NeighCellCDMA2000")),
    )
    NeighCellListCDMA2000._cont = _NeighCellListCDMA2000__item_
    NeighCellListCDMA2000._const_sz = ASN1Set(
        rv=[], rr=[ASN1RangeInt(lb=1, ub=16)], ev=None, er=[]
    )

    # -----< NeighCellCDMA2000 >-----#
    NeighCellCDMA2000 = SEQ(name="NeighCellCDMA2000", mode=MODE_TYPE)
    _NeighCellCDMA2000_bandClass = ENUM(
        name="bandClass",
        mode=MODE_TYPE,
        tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "BandclassCDMA2000")),
    )
    _NeighCellCDMA2000_neighCellsPerFreqList = SEQ_OF(
        name="neighCellsPerFreqList",
        mode=MODE_TYPE,
        tag=(1, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(
            ("EUTRA-RRC-Definitions", "NeighCellsPerBandclassListCDMA2000")
        ),
    )
    ...
    # -----< NeighCellsPerBandclassListCDMA2000 >-----#
    NeighCellsPerBandclassListCDMA2000 = SEQ_OF(
        name="NeighCellsPerBandclassListCDMA2000", mode=MODE_TYPE
    )
    _NeighCellsPerBandclassListCDMA2000__item_ = SEQ(
        name="_item_",
        mode=MODE_TYPE,
        typeref=ASN1RefType(
            ("EUTRA-RRC-Definitions", "NeighCellsPerBandclassCDMA2000")
        ),
    )
    NeighCellsPerBandclassListCDMA2000._cont = (
        _NeighCellsPerBandclassListCDMA2000__item_
    )
    NeighCellsPerBandclassListCDMA2000._const_sz = ASN1Set(
        rv=[], rr=[ASN1RangeInt(lb=1, ub=16)], ev=None, er=[]
    )

    # -----< NeighCellsPerBandclassCDMA2000 >-----#
    NeighCellsPerBandclassCDMA2000 = SEQ(
        name="NeighCellsPerBandclassCDMA2000", mode=MODE_TYPE
    )
    _NeighCellsPerBandclassCDMA2000_arfcn = INT(
        name="arfcn",
        mode=MODE_TYPE,
        tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "ARFCN-ValueCDMA2000")),
    )
    _NeighCellsPerBandclassCDMA2000_physCellIdList = SEQ_OF(
        name="physCellIdList",
        mode=MODE_TYPE,
        tag=(1, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "PhysCellIdListCDMA2000")),
    )
    ...
    _PhysCellIdListCDMA2000__item_ = INT(
        name="_item_",
        mode=MODE_TYPE,
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "PhysCellIdCDMA2000")),
    )
    PhysCellIdListCDMA2000._cont = _PhysCellIdListCDMA2000__item_
    PhysCellIdListCDMA2000._const_sz = ASN1Set(
        rv=[], rr=[ASN1RangeInt(lb=1, ub=16)], ev=None, er=[]
    )

    # -----< BandClassListCDMA2000 >-----#
    BandClassListCDMA2000 = SEQ_OF(name="BandClassListCDMA2000", mode=MODE_TYPE)
    _BandClassListCDMA2000__item_ = SEQ(
        name="_item_",
        mode=MODE_TYPE,
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "BandClassInfoCDMA2000")),
    )
    BandClassListCDMA2000._cont = _BandClassListCDMA2000__item_
    BandClassListCDMA2000._const_sz = ASN1Set(
        rv=[], rr=[ASN1RangeInt(lb=1, ub=32)], ev=None, er=[]
    )

    # -----< BandClassInfoCDMA2000 >-----#
    BandClassInfoCDMA2000 = SEQ(name="BandClassInfoCDMA2000", mode=MODE_TYPE)
    _BandClassInfoCDMA2000_bandClass = ENUM(
        name="bandClass",
        mode=MODE_TYPE,
        tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "BandclassCDMA2000")),
    )
    _BandClassInfoCDMA2000_cellReselectionPriority = INT(
        name="cellReselectionPriority",
        mode=MODE_TYPE,
        tag=(1, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "CellReselectionPriority")),
    ...
    _BandClassInfoCDMA2000_threshX_High = INT(
        name="threshX-High", mode=MODE_TYPE, tag=(2, TAG_CONTEXT_SPEC, TAG_IMPLICIT)
    )
    _BandClassInfoCDMA2000_threshX_High._const_val = ASN1Set(
        rv=[], rr=[ASN1RangeInt(lb=0, ub=63)], ev=None, er=[]
    )
    _BandClassInfoCDMA2000_threshX_Low = INT(
        name="threshX-Low", mode=MODE_TYPE, tag=(3, TAG_CONTEXT_SPEC, TAG_IMPLICIT)
    )
    _BandClassInfoCDMA2000_threshX_Low._const_val = ASN1Set(
        rv=[], rr=[ASN1RangeInt(lb=0, ub=63)], ev=None, er=[]
    )
    ...
    # -----< SystemInformationBlockType9 >-----#
    SystemInformationBlockType9 = SEQ(
        name="SystemInformationBlockType9", mode=MODE_TYPE
    )
    _SystemInformationBlockType9_hnb_Name = OCT_STR(
        name="hnb-Name",
        mode=MODE_TYPE,
        tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        opt=True,
    )
    _SystemInformationBlockType9_hnb_Name._const_sz = ASN1Set(
        rv=[], rr=[ASN1RangeInt(lb=1, ub=48)], ev=None, er=[]
    )
    ...
    # -----< SystemInformationBlockType10 >-----#
    SystemInformationBlockType10 = SEQ(
        name="SystemInformationBlockType10", mode=MODE_TYPE
    )
    _SystemInformationBlockType10_messageIdentifier = BIT_STR(
        name="messageIdentifier",
        mode=MODE_TYPE,
        tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
    )
    _SystemInformationBlockType10_messageIdentifier._const_sz = ASN1Set(
        rv=[16], rr=[], ev=None, er=[]
    )
    _SystemInformationBlockType10_serialNumber = BIT_STR(
        name="serialNumber", mode=MODE_TYPE, tag=(1, TAG_CONTEXT_SPEC, TAG_IMPLICIT)
    )
    _SystemInformationBlockType10_serialNumber._const_sz = ASN1Set(
        rv=[16], rr=[], ev=None, er=[]
    )
    _SystemInformationBlockType10_warningType = OCT_STR(
        name="warningType", mode=MODE_TYPE, tag=(2, TAG_CONTEXT_SPEC, TAG_IMPLICIT)
    )
    _SystemInformationBlockType10_warningType._const_sz = ASN1Set(
        rv=[2], rr=[], ev=None, er=[]
    )
    _SystemInformationBlockType10_warningSecurityInfo = OCT_STR(
        name="warningSecurityInfo",
        mode=MODE_TYPE,
        tag=(3, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        opt=True,
    )
    _SystemInformationBlockType10_warningSecurityInfo._const_sz = ASN1Set(
        rv=[50], rr=[], ev=None, er=[]
    )
    ...
    # -----< SystemInformationBlockType11 >-----#
    SystemInformationBlockType11 = SEQ(
        name="SystemInformationBlockType11", mode=MODE_TYPE
    )
    _SystemInformationBlockType11_messageIdentifier = BIT_STR(
        name="messageIdentifier",
        mode=MODE_TYPE,
        tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
    )
    _SystemInformationBlockType11_messageIdentifier._const_sz = ASN1Set(
        rv=[16], rr=[], ev=None, er=[]
    )
    _SystemInformationBlockType11_serialNumber = BIT_STR(
        name="serialNumber", mode=MODE_TYPE, tag=(1, TAG_CONTEXT_SPEC, TAG_IMPLICIT)
    )
    _SystemInformationBlockType11_serialNumber._const_sz = ASN1Set(
        rv=[16], rr=[], ev=None, er=[]
    )
    _SystemInformationBlockType11_warningMessageSegmentType = ENUM(
        name="warningMessageSegmentType",
        mode=MODE_TYPE,
        tag=(2, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
    )
    _SystemInformationBlockType11_warningMessageSegmentType._cont = ASN1Dict(
        [("notLastSegment", 0), ("lastSegment", 1)]
    )
    _SystemInformationBlockType11_warningMessageSegmentType._ext = None
    _SystemInformationBlockType11_warningMessageSegmentNumber = INT(
        name="warningMessageSegmentNumber",
        mode=MODE_TYPE,
        tag=(3, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
    )
    _SystemInformationBlockType11_warningMessageSegmentNumber._const_val = ASN1Set(
        rv=[], rr=[ASN1RangeInt(lb=0, ub=63)], ev=None, er=[]
    )
    _SystemInformationBlockType11_warningMessageSegment = OCT_STR(
        name="warningMessageSegment",
        mode=MODE_TYPE,
        tag=(4, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
    )
    _SystemInformationBlockType11_dataCodingScheme = OCT_STR(
        name="dataCodingScheme",
        mode=MODE_TYPE,
        tag=(5, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        opt=True,
    )
    _SystemInformationBlockType11_dataCodingScheme._const_sz = ASN1Set(
        rv=[1], rr=[], ev=None, er=[]
    )
    ...
    _AntennaInfoCommon_antennaPortsCount = ENUM(
        name="antennaPortsCount",
        mode=MODE_TYPE,
        tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
    )
    _AntennaInfoCommon_antennaPortsCount._cont = ASN1Dict(
        [("an1", 0), ("an2", 1), ("an4", 2), ("spare1", 3)]
    )
    ...
    _AntennaInfoDedicated_transmissionMode = ENUM(
        name="transmissionMode", mode=MODE_TYPE, tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT)
    )
    _AntennaInfoDedicated_transmissionMode._cont = ASN1Dict(
        [
            ("tm1", 0),
            ("tm2", 1),
            ("tm3", 2),
    ...
    _AntennaInfoDedicated_codebookSubsetRestriction = CHOICE(
        name="codebookSubsetRestriction",
        mode=MODE_TYPE,
        tag=(1, TAG_CONTEXT_SPEC, TAG_EXPLICIT),
        opt=True,
    )
    __AntennaInfoDedicated_codebookSubsetRestriction_n2TxAntenna_tm3 = BIT_STR(
        name="n2TxAntenna-tm3", mode=MODE_TYPE, tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT)
    )
    __AntennaInfoDedicated_codebookSubsetRestriction_n2TxAntenna_tm3._const_sz = (
        ASN1Set(rv=[2], rr=[], ev=None, er=[])
    )
    __AntennaInfoDedicated_codebookSubsetRestriction_n4TxAntenna_tm3 = BIT_STR(
        name="n4TxAntenna-tm3", mode=MODE_TYPE, tag=(1, TAG_CONTEXT_SPEC, TAG_IMPLICIT)
    )
    __AntennaInfoDedicated_codebookSubsetRestriction_n4TxAntenna_tm3._const_sz = (
        ASN1Set(rv=[4], rr=[], ev=None, er=[])
    )
    __AntennaInfoDedicated_codebookSubsetRestriction_n2TxAntenna_tm4 = BIT_STR(
        name="n2TxAntenna-tm4", mode=MODE_TYPE, tag=(2, TAG_CONTEXT_SPEC, TAG_IMPLICIT)
    )
    __AntennaInfoDedicated_codebookSubsetRestriction_n2TxAntenna_tm4._const_sz = (
        ASN1Set(rv=[6], rr=[], ev=None, er=[])
    )
    __AntennaInfoDedicated_codebookSubsetRestriction_n4TxAntenna_tm4 = BIT_STR(
        name="n4TxAntenna-tm4", mode=MODE_TYPE, tag=(3, TAG_CONTEXT_SPEC, TAG_IMPLICIT)
    )
    __AntennaInfoDedicated_codebookSubsetRestriction_n4TxAntenna_tm4._const_sz = (
        ASN1Set(rv=[64], rr=[], ev=None, er=[])
    )
    __AntennaInfoDedicated_codebookSubsetRestriction_n2TxAntenna_tm5 = BIT_STR(
        name="n2TxAntenna-tm5", mode=MODE_TYPE, tag=(4, TAG_CONTEXT_SPEC, TAG_IMPLICIT)
    )
    __AntennaInfoDedicated_codebookSubsetRestriction_n2TxAntenna_tm5._const_sz = (
        ASN1Set(rv=[4], rr=[], ev=None, er=[])
    )
    __AntennaInfoDedicated_codebookSubsetRestriction_n4TxAntenna_tm5 = BIT_STR(
        name="n4TxAntenna-tm5", mode=MODE_TYPE, tag=(5, TAG_CONTEXT_SPEC, TAG_IMPLICIT)
    )
    __AntennaInfoDedicated_codebookSubsetRestriction_n4TxAntenna_tm5._const_sz = (
        ASN1Set(rv=[16], rr=[], ev=None, er=[])
    )
    __AntennaInfoDedicated_codebookSubsetRestriction_n2TxAntenna_tm6 = BIT_STR(
        name="n2TxAntenna-tm6", mode=MODE_TYPE, tag=(6, TAG_CONTEXT_SPEC, TAG_IMPLICIT)
    )
    __AntennaInfoDedicated_codebookSubsetRestriction_n2TxAntenna_tm6._const_sz = (
        ASN1Set(rv=[4], rr=[], ev=None, er=[])
    )
    __AntennaInfoDedicated_codebookSubsetRestriction_n4TxAntenna_tm6 = BIT_STR(
        name="n4TxAntenna-tm6", mode=MODE_TYPE, tag=(7, TAG_CONTEXT_SPEC, TAG_IMPLICIT)
    )
    __AntennaInfoDedicated_codebookSubsetRestriction_n4TxAntenna_tm6._const_sz = (
        ASN1Set(rv=[16], rr=[], ev=None, er=[])
    )
    ...
    _AntennaInfoDedicated_ue_TransmitAntennaSelection = CHOICE(
        name="ue-TransmitAntennaSelection",
        mode=MODE_TYPE,
        tag=(2, TAG_CONTEXT_SPEC, TAG_EXPLICIT),
    )
    __AntennaInfoDedicated_ue_TransmitAntennaSelection_release = NULL(
        name="release", mode=MODE_TYPE, tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT)
    )
    __AntennaInfoDedicated_ue_TransmitAntennaSelection_setup = ENUM(
        name="setup", mode=MODE_TYPE, tag=(1, TAG_CONTEXT_SPEC, TAG_IMPLICIT)
    )
    __AntennaInfoDedicated_ue_TransmitAntennaSelection_setup._cont = ASN1Dict(
        [("closedLoop", 0), ("openLoop", 1)]
    )
    ...
    _CQI_ReportConfig_cqi_ReportModeAperiodic = ENUM(
        name="cqi-ReportModeAperiodic",
        mode=MODE_TYPE,
        tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        opt=True,
    )
    _CQI_ReportConfig_cqi_ReportModeAperiodic._cont = ASN1Dict(
        [
            ("rm12", 0),
            ("rm20", 1),
            ("rm22", 2),
    ...
    _CQI_ReportConfig_nomPDSCH_RS_EPRE_Offset = INT(
        name="nomPDSCH-RS-EPRE-Offset",
        mode=MODE_TYPE,
        tag=(1, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
    )
    _CQI_ReportConfig_nomPDSCH_RS_EPRE_Offset._const_val = ASN1Set(
        rv=[], rr=[ASN1RangeInt(lb=-1, ub=6)], ev=None, er=[]
    )
    _CQI_ReportConfig_cqi_ReportPeriodic = CHOICE(
        name="cqi-ReportPeriodic",
        mode=MODE_TYPE,
        tag=(2, TAG_CONTEXT_SPEC, TAG_EXPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "CQI-ReportPeriodic")),
        opt=True,
    )
    ...
    _CQI_ReportPeriodic_release = NULL(
        name="release", mode=MODE_TYPE, tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT)
    )
    _CQI_ReportPeriodic_setup = SEQ(
        name="setup", mode=MODE_TYPE, tag=(1, TAG_CONTEXT_SPEC, TAG_IMPLICIT)
    )
    __CQI_ReportPeriodic_setup_cqi_PUCCH_ResourceIndex = INT(
        name="cqi-PUCCH-ResourceIndex",
        mode=MODE_TYPE,
        tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
    )
    __CQI_ReportPeriodic_setup_cqi_PUCCH_ResourceIndex._const_val = ASN1Set(
        rv=[], rr=[ASN1RangeInt(lb=0, ub=1185)], ev=None, er=[]
    )
    __CQI_ReportPeriodic_setup_cqi_pmi_ConfigIndex = INT(
        name="cqi-pmi-ConfigIndex",
        mode=MODE_TYPE,
        tag=(1, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
    )
    __CQI_ReportPeriodic_setup_cqi_pmi_ConfigIndex._const_val = ASN1Set(
        rv=[], rr=[ASN1RangeInt(lb=0, ub=1023)], ev=None, er=[]
    )
    __CQI_ReportPeriodic_setup_cqi_FormatIndicatorPeriodic = CHOICE(
        name="cqi-FormatIndicatorPeriodic",
        mode=MODE_TYPE,
        tag=(2, TAG_CONTEXT_SPEC, TAG_EXPLICIT),
    )
    ___CQI_ReportPeriodic_setup_cqi_FormatIndicatorPeriodic_widebandCQI = NULL(
        name="widebandCQI", mode=MODE_TYPE, tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT)
    )
    ___CQI_ReportPeriodic_setup_cqi_FormatIndicatorPeriodic_subbandCQI = SEQ(
        name="subbandCQI", mode=MODE_TYPE, tag=(1, TAG_CONTEXT_SPEC, TAG_IMPLICIT)
    )
    ____CQI_ReportPeriodic_setup_cqi_FormatIndicatorPeriodic_subbandCQI_k = INT(
        name="k", mode=MODE_TYPE, tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT)
    )
    ____CQI_ReportPeriodic_setup_cqi_FormatIndicatorPeriodic_subbandCQI_k._const_val = (
        ASN1Set(rv=[], rr=[ASN1RangeInt(lb=1, ub=4)], ev=None, er=[])
    )
    ...
    __CQI_ReportPeriodic_setup_ri_ConfigIndex = INT(
        name="ri-ConfigIndex",
        mode=MODE_TYPE,
        tag=(3, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        opt=True,
    )
    __CQI_ReportPeriodic_setup_ri_ConfigIndex._const_val = ASN1Set(
        rv=[], rr=[ASN1RangeInt(lb=0, ub=1023)], ev=None, er=[]
    )
    __CQI_ReportPeriodic_setup_simultaneousAckNackAndCQI = BOOL(
    ...
    DRB_Identity._const_val = ASN1Set(
        rv=[], rr=[ASN1RangeInt(lb=1, ub=32)], ev=None, er=[]
    )

    # -----< LogicalChannelConfig >-----#
    LogicalChannelConfig = SEQ(name="LogicalChannelConfig", mode=MODE_TYPE)
    _LogicalChannelConfig_ul_SpecificParameters = SEQ(
        name="ul-SpecificParameters",
        mode=MODE_TYPE,
        tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        opt=True,
    )
    __LogicalChannelConfig_ul_SpecificParameters_priority = INT(
        name="priority", mode=MODE_TYPE, tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT)
    )
    __LogicalChannelConfig_ul_SpecificParameters_priority._const_val = ASN1Set(
        rv=[], rr=[ASN1RangeInt(lb=1, ub=16)], ev=None, er=[]
    )
    __LogicalChannelConfig_ul_SpecificParameters_prioritisedBitRate = ENUM(
        name="prioritisedBitRate",
        mode=MODE_TYPE,
        tag=(1, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
    )
    __LogicalChannelConfig_ul_SpecificParameters_prioritisedBitRate._cont = ASN1Dict(
        [
            ("kBps0", 0),
            ("kBps8", 1),
            ("kBps16", 2),
    ...
    __LogicalChannelConfig_ul_SpecificParameters_bucketSizeDuration = ENUM(
        name="bucketSizeDuration",
        mode=MODE_TYPE,
        tag=(2, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
    )
    __LogicalChannelConfig_ul_SpecificParameters_bucketSizeDuration._cont = ASN1Dict(
        [
            ("ms50", 0),
            ("ms100", 1),
            ("ms150", 2),
    ...
    __LogicalChannelConfig_ul_SpecificParameters_logicalChannelGroup = INT(
        name="logicalChannelGroup",
        mode=MODE_TYPE,
        tag=(3, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        opt=True,
    )
    __LogicalChannelConfig_ul_SpecificParameters_logicalChannelGroup._const_val = (
        ASN1Set(rv=[], rr=[ASN1RangeInt(lb=0, ub=3)], ev=None, er=[])
    )
    ...
    _MAC_MainConfig_ul_SCH_Config = SEQ(
        name="ul-SCH-Config",
        mode=MODE_TYPE,
        tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        opt=True,
    )
    __MAC_MainConfig_ul_SCH_Config_maxHARQ_Tx = ENUM(
        name="maxHARQ-Tx",
        mode=MODE_TYPE,
        tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        opt=True,
    )
    __MAC_MainConfig_ul_SCH_Config_maxHARQ_Tx._cont = ASN1Dict(
        [
            ("n1", 0),
            ("n2", 1),
            ("n3", 2),
    ...
    __MAC_MainConfig_ul_SCH_Config_periodicBSR_Timer = ENUM(
        name="periodicBSR-Timer",
        mode=MODE_TYPE,
        tag=(1, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        opt=True,
    )
    __MAC_MainConfig_ul_SCH_Config_periodicBSR_Timer._cont = ASN1Dict(
        [
            ("sf5", 0),
            ("sf10", 1),
            ("sf16", 2),
    ...
    __MAC_MainConfig_ul_SCH_Config_retxBSR_Timer = ENUM(
        name="retxBSR-Timer", mode=MODE_TYPE, tag=(2, TAG_CONTEXT_SPEC, TAG_IMPLICIT)
    )
    __MAC_MainConfig_ul_SCH_Config_retxBSR_Timer._cont = ASN1Dict(
        [
            ("sf320", 0),
            ("sf640", 1),
            ("sf1280", 2),
    ...
    __MAC_MainConfig_ul_SCH_Config_ttiBundling = BOOL(
        name="ttiBundling", mode=MODE_TYPE, tag=(3, TAG_CONTEXT_SPEC, TAG_IMPLICIT)
    )
    ...
    _MAC_MainConfig_drx_Config = CHOICE(
        name="drx-Config",
        mode=MODE_TYPE,
        tag=(1, TAG_CONTEXT_SPEC, TAG_EXPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "DRX-Config")),
        opt=True,
    )
    _MAC_MainConfig_timeAlignmentTimerDedicated = ENUM(
        name="timeAlignmentTimerDedicated",
        mode=MODE_TYPE,
        tag=(2, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "TimeAlignmentTimer")),
    )
    _MAC_MainConfig_phr_Config = CHOICE(
        name="phr-Config",
        mode=MODE_TYPE,
        tag=(3, TAG_CONTEXT_SPEC, TAG_EXPLICIT),
        opt=True,
    )
    __MAC_MainConfig_phr_Config_release = NULL(
        name="release", mode=MODE_TYPE, tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT)
    )
    __MAC_MainConfig_phr_Config_setup = SEQ(
        name="setup", mode=MODE_TYPE, tag=(1, TAG_CONTEXT_SPEC, TAG_IMPLICIT)
    )
    ___MAC_MainConfig_phr_Config_setup_periodicPHR_Timer = ENUM(
        name="periodicPHR-Timer",
        mode=MODE_TYPE,
        tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
    )
    ___MAC_MainConfig_phr_Config_setup_periodicPHR_Timer._cont = ASN1Dict(
        [
            ("sf10", 0),
            ("sf20", 1),
            ("sf50", 2),
    ...
    ___MAC_MainConfig_phr_Config_setup_prohibitPHR_Timer = ENUM(
        name="prohibitPHR-Timer",
        mode=MODE_TYPE,
        tag=(1, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
    )
    ___MAC_MainConfig_phr_Config_setup_prohibitPHR_Timer._cont = ASN1Dict(
        [
            ("sf0", 0),
            ("sf10", 1),
            ("sf20", 2),
    ...
    ___MAC_MainConfig_phr_Config_setup_dl_PathlossChange = ENUM(
        name="dl-PathlossChange",
        mode=MODE_TYPE,
        tag=(2, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
    )
    ___MAC_MainConfig_phr_Config_setup_dl_PathlossChange._cont = ASN1Dict(
        [("dB1", 0), ("dB3", 1), ("dB6", 2), ("infinity", 3)]
    )
    ...
    _DRX_Config_release = NULL(
        name="release", mode=MODE_TYPE, tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT)
    )
    _DRX_Config_setup = SEQ(
        name="setup", mode=MODE_TYPE, tag=(1, TAG_CONTEXT_SPEC, TAG_IMPLICIT)
    )
    __DRX_Config_setup_onDurationTimer = ENUM(
        name="onDurationTimer", mode=MODE_TYPE, tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT)
    )
    __DRX_Config_setup_onDurationTimer._cont = ASN1Dict(
        [
            ("psf1", 0),
            ("psf2", 1),
            ("psf3", 2),
    ...
    __DRX_Config_setup_drx_InactivityTimer = ENUM(
        name="drx-InactivityTimer",
        mode=MODE_TYPE,
        tag=(1, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
    )
    __DRX_Config_setup_drx_InactivityTimer._cont = ASN1Dict(
        [
            ("psf1", 0),
            ("psf2", 1),
            ("psf3", 2),
    ...
    __DRX_Config_setup_drx_RetransmissionTimer = ENUM(
        name="drx-RetransmissionTimer",
        mode=MODE_TYPE,
        tag=(2, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
    )
    __DRX_Config_setup_drx_RetransmissionTimer._cont = ASN1Dict(
        [
            ("psf1", 0),
            ("psf2", 1),
            ("psf4", 2),
    ...
    __DRX_Config_setup_longDRX_CycleStartOffset = CHOICE(
        name="longDRX-CycleStartOffset",
        mode=MODE_TYPE,
        tag=(3, TAG_CONTEXT_SPEC, TAG_EXPLICIT),
    )
    ___DRX_Config_setup_longDRX_CycleStartOffset_sf10 = INT(
        name="sf10", mode=MODE_TYPE, tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT)
    )
    ___DRX_Config_setup_longDRX_CycleStartOffset_sf10._const_val = ASN1Set(
        rv=[], rr=[ASN1RangeInt(lb=0, ub=9)], ev=None, er=[]
    )
    ___DRX_Config_setup_longDRX_CycleStartOffset_sf20 = INT(
        name="sf20", mode=MODE_TYPE, tag=(1, TAG_CONTEXT_SPEC, TAG_IMPLICIT)
    )
    ___DRX_Config_setup_longDRX_CycleStartOffset_sf20._const_val = ASN1Set(
        rv=[], rr=[ASN1RangeInt(lb=0, ub=19)], ev=None, er=[]
    )
    ___DRX_Config_setup_longDRX_CycleStartOffset_sf32 = INT(
        name="sf32", mode=MODE_TYPE, tag=(2, TAG_CONTEXT_SPEC, TAG_IMPLICIT)
    )
    ___DRX_Config_setup_longDRX_CycleStartOffset_sf32._const_val = ASN1Set(
        rv=[], rr=[ASN1RangeInt(lb=0, ub=31)], ev=None, er=[]
    )
    ___DRX_Config_setup_longDRX_CycleStartOffset_sf40 = INT(
        name="sf40", mode=MODE_TYPE, tag=(3, TAG_CONTEXT_SPEC, TAG_IMPLICIT)
    )
    ___DRX_Config_setup_longDRX_CycleStartOffset_sf40._const_val = ASN1Set(
        rv=[], rr=[ASN1RangeInt(lb=0, ub=39)], ev=None, er=[]
    )
    ___DRX_Config_setup_longDRX_CycleStartOffset_sf64 = INT(
        name="sf64", mode=MODE_TYPE, tag=(4, TAG_CONTEXT_SPEC, TAG_IMPLICIT)
    )
    ___DRX_Config_setup_longDRX_CycleStartOffset_sf64._const_val = ASN1Set(
        rv=[], rr=[ASN1RangeInt(lb=0, ub=63)], ev=None, er=[]
    )
    ___DRX_Config_setup_longDRX_CycleStartOffset_sf80 = INT(
        name="sf80", mode=MODE_TYPE, tag=(5, TAG_CONTEXT_SPEC, TAG_IMPLICIT)
    )
    ___DRX_Config_setup_longDRX_CycleStartOffset_sf80._const_val = ASN1Set(
        rv=[], rr=[ASN1RangeInt(lb=0, ub=79)], ev=None, er=[]
    )
    ___DRX_Config_setup_longDRX_CycleStartOffset_sf128 = INT(
        name="sf128", mode=MODE_TYPE, tag=(6, TAG_CONTEXT_SPEC, TAG_IMPLICIT)
    )
    ___DRX_Config_setup_longDRX_CycleStartOffset_sf128._const_val = ASN1Set(
        rv=[], rr=[ASN1RangeInt(lb=0, ub=127)], ev=None, er=[]
    )
    ___DRX_Config_setup_longDRX_CycleStartOffset_sf160 = INT(
        name="sf160", mode=MODE_TYPE, tag=(7, TAG_CONTEXT_SPEC, TAG_IMPLICIT)
    )
    ___DRX_Config_setup_longDRX_CycleStartOffset_sf160._const_val = ASN1Set(
        rv=[], rr=[ASN1RangeInt(lb=0, ub=159)], ev=None, er=[]
    )
    ___DRX_Config_setup_longDRX_CycleStartOffset_sf256 = INT(
        name="sf256", mode=MODE_TYPE, tag=(8, TAG_CONTEXT_SPEC, TAG_IMPLICIT)
    )
    ___DRX_Config_setup_longDRX_CycleStartOffset_sf256._const_val = ASN1Set(
        rv=[], rr=[ASN1RangeInt(lb=0, ub=255)], ev=None, er=[]
    )
    ___DRX_Config_setup_longDRX_CycleStartOffset_sf320 = INT(
        name="sf320", mode=MODE_TYPE, tag=(9, TAG_CONTEXT_SPEC, TAG_IMPLICIT)
    )
    ___DRX_Config_setup_longDRX_CycleStartOffset_sf320._const_val = ASN1Set(
        rv=[], rr=[ASN1RangeInt(lb=0, ub=319)], ev=None, er=[]
    )
    ___DRX_Config_setup_longDRX_CycleStartOffset_sf512 = INT(
        name="sf512", mode=MODE_TYPE, tag=(10, TAG_CONTEXT_SPEC, TAG_IMPLICIT)
    )
    ___DRX_Config_setup_longDRX_CycleStartOffset_sf512._const_val = ASN1Set(
        rv=[], rr=[ASN1RangeInt(lb=0, ub=511)], ev=None, er=[]
    )
    ___DRX_Config_setup_longDRX_CycleStartOffset_sf640 = INT(
        name="sf640", mode=MODE_TYPE, tag=(11, TAG_CONTEXT_SPEC, TAG_IMPLICIT)
    )
    ___DRX_Config_setup_longDRX_CycleStartOffset_sf640._const_val = ASN1Set(
        rv=[], rr=[ASN1RangeInt(lb=0, ub=639)], ev=None, er=[]
    )
    ___DRX_Config_setup_longDRX_CycleStartOffset_sf1024 = INT(
        name="sf1024", mode=MODE_TYPE, tag=(12, TAG_CONTEXT_SPEC, TAG_IMPLICIT)
    )
    ___DRX_Config_setup_longDRX_CycleStartOffset_sf1024._const_val = ASN1Set(
        rv=[], rr=[ASN1RangeInt(lb=0, ub=1023)], ev=None, er=[]
    )
    ___DRX_Config_setup_longDRX_CycleStartOffset_sf1280 = INT(
        name="sf1280", mode=MODE_TYPE, tag=(13, TAG_CONTEXT_SPEC, TAG_IMPLICIT)
    )
    ___DRX_Config_setup_longDRX_CycleStartOffset_sf1280._const_val = ASN1Set(
        rv=[], rr=[ASN1RangeInt(lb=0, ub=1279)], ev=None, er=[]
    )
    ___DRX_Config_setup_longDRX_CycleStartOffset_sf2048 = INT(
        name="sf2048", mode=MODE_TYPE, tag=(14, TAG_CONTEXT_SPEC, TAG_IMPLICIT)
    )
    ___DRX_Config_setup_longDRX_CycleStartOffset_sf2048._const_val = ASN1Set(
        rv=[], rr=[ASN1RangeInt(lb=0, ub=2047)], ev=None, er=[]
    )
    ___DRX_Config_setup_longDRX_CycleStartOffset_sf2560 = INT(
        name="sf2560", mode=MODE_TYPE, tag=(15, TAG_CONTEXT_SPEC, TAG_IMPLICIT)
    )
    ___DRX_Config_setup_longDRX_CycleStartOffset_sf2560._const_val = ASN1Set(
        rv=[], rr=[ASN1RangeInt(lb=0, ub=2559)], ev=None, er=[]
    )
    ...
    __DRX_Config_setup_shortDRX = SEQ(
        name="shortDRX",
        mode=MODE_TYPE,
        tag=(4, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        opt=True,
    )
    ___DRX_Config_setup_shortDRX_shortDRX_Cycle = ENUM(
        name="shortDRX-Cycle", mode=MODE_TYPE, tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT)
    )
    ___DRX_Config_setup_shortDRX_shortDRX_Cycle._cont = ASN1Dict(
        [
            ("sf2", 0),
            ("sf5", 1),
            ("sf8", 2),
    ...
    ___DRX_Config_setup_shortDRX_drxShortCycleTimer = INT(
        name="drxShortCycleTimer",
        mode=MODE_TYPE,
        tag=(1, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
    )
    ___DRX_Config_setup_shortDRX_drxShortCycleTimer._const_val = ASN1Set(
        rv=[], rr=[ASN1RangeInt(lb=1, ub=16)], ev=None, er=[]
    )
    ...
    _PDCP_Config_discardTimer = ENUM(
        name="discardTimer",
        mode=MODE_TYPE,
        tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        opt=True,
    )
    _PDCP_Config_discardTimer._cont = ASN1Dict(
        [
            ("ms50", 0),
            ("ms100", 1),
            ("ms150", 2),
    ...
    _PDCP_Config_rlc_AM = SEQ(
        name="rlc-AM", mode=MODE_TYPE, tag=(1, TAG_CONTEXT_SPEC, TAG_IMPLICIT), opt=True
    )
    __PDCP_Config_rlc_AM_statusReportRequired = BOOL(
    ...
    _PDCP_Config_rlc_UM = SEQ(
        name="rlc-UM", mode=MODE_TYPE, tag=(2, TAG_CONTEXT_SPEC, TAG_IMPLICIT), opt=True
    )
    __PDCP_Config_rlc_UM_pdcp_SN_Size = ENUM(
        name="pdcp-SN-Size", mode=MODE_TYPE, tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT)
    )
    __PDCP_Config_rlc_UM_pdcp_SN_Size._cont = ASN1Dict(
        [("len7bits", 0), ("len12bits", 1)]
    )
    ...
    _PDCP_Config_headerCompression = CHOICE(
        name="headerCompression",
        mode=MODE_TYPE,
        tag=(3, TAG_CONTEXT_SPEC, TAG_EXPLICIT),
    )
    __PDCP_Config_headerCompression_notUsed = NULL(
        name="notUsed", mode=MODE_TYPE, tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT)
    )
    __PDCP_Config_headerCompression_rohc = SEQ(
        name="rohc", mode=MODE_TYPE, tag=(1, TAG_CONTEXT_SPEC, TAG_IMPLICIT)
    )
    ___PDCP_Config_headerCompression_rohc_maxCID = INT(
        name="maxCID",
        mode=MODE_TYPE,
        tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        default=15,
    )
    ___PDCP_Config_headerCompression_rohc_maxCID._const_val = ASN1Set(
        rv=[], rr=[ASN1RangeInt(lb=1, ub=16383)], ev=None, er=[]
    )
    ___PDCP_Config_headerCompression_rohc_profiles = SEQ(
        name="profiles", mode=MODE_TYPE, tag=(1, TAG_CONTEXT_SPEC, TAG_IMPLICIT)
    )
    ____PDCP_Config_headerCompression_rohc_profiles_profile0x0001 = BOOL(
        name="profile0x0001", mode=MODE_TYPE, tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT)
    )
    ____PDCP_Config_headerCompression_rohc_profiles_profile0x0002 = BOOL(
        name="profile0x0002", mode=MODE_TYPE, tag=(1, TAG_CONTEXT_SPEC, TAG_IMPLICIT)
    )
    ____PDCP_Config_headerCompression_rohc_profiles_profile0x0003 = BOOL(
        name="profile0x0003", mode=MODE_TYPE, tag=(2, TAG_CONTEXT_SPEC, TAG_IMPLICIT)
    )
    ____PDCP_Config_headerCompression_rohc_profiles_profile0x0004 = BOOL(
        name="profile0x0004", mode=MODE_TYPE, tag=(3, TAG_CONTEXT_SPEC, TAG_IMPLICIT)
    )
    ____PDCP_Config_headerCompression_rohc_profiles_profile0x0006 = BOOL(
        name="profile0x0006", mode=MODE_TYPE, tag=(4, TAG_CONTEXT_SPEC, TAG_IMPLICIT)
    )
    ____PDCP_Config_headerCompression_rohc_profiles_profile0x0101 = BOOL(
        name="profile0x0101", mode=MODE_TYPE, tag=(5, TAG_CONTEXT_SPEC, TAG_IMPLICIT)
    )
    ____PDCP_Config_headerCompression_rohc_profiles_profile0x0102 = BOOL(
        name="profile0x0102", mode=MODE_TYPE, tag=(6, TAG_CONTEXT_SPEC, TAG_IMPLICIT)
    )
    ____PDCP_Config_headerCompression_rohc_profiles_profile0x0103 = BOOL(
        name="profile0x0103", mode=MODE_TYPE, tag=(7, TAG_CONTEXT_SPEC, TAG_IMPLICIT)
    )
    ____PDCP_Config_headerCompression_rohc_profiles_profile0x0104 = BOOL(
        name="profile0x0104", mode=MODE_TYPE, tag=(8, TAG_CONTEXT_SPEC, TAG_IMPLICIT)
    )
    ...
    _PDSCH_ConfigCommon_referenceSignalPower = INT(
        name="referenceSignalPower",
        mode=MODE_TYPE,
        tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
    )
    _PDSCH_ConfigCommon_referenceSignalPower._const_val = ASN1Set(
        rv=[], rr=[ASN1RangeInt(lb=-60, ub=50)], ev=None, er=[]
    )
    _PDSCH_ConfigCommon_p_b = INT(
        name="p-b", mode=MODE_TYPE, tag=(1, TAG_CONTEXT_SPEC, TAG_IMPLICIT)
    )
    _PDSCH_ConfigCommon_p_b._const_val = ASN1Set(
        rv=[], rr=[ASN1RangeInt(lb=0, ub=3)], ev=None, er=[]
    )
    ...
    _PDSCH_ConfigDedicated_p_a = ENUM(
        name="p-a", mode=MODE_TYPE, tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT)
    )
    _PDSCH_ConfigDedicated_p_a._cont = ASN1Dict(
        [
            ("dB-6", 0),
            ("dB-4dot77", 1),
            ("dB-3", 2),
    ...
    _PHICH_Config_phich_Duration = ENUM(
        name="phich-Duration", mode=MODE_TYPE, tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT)
    )
    _PHICH_Config_phich_Duration._cont = ASN1Dict([("normal", 0), ("extended", 1)])
    _PHICH_Config_phich_Duration._ext = None
    _PHICH_Config_phich_Resource = ENUM(
        name="phich-Resource", mode=MODE_TYPE, tag=(1, TAG_CONTEXT_SPEC, TAG_IMPLICIT)
    )
    _PHICH_Config_phich_Resource._cont = ASN1Dict(
        [("oneSixth", 0), ("half", 1), ("one", 2), ("two", 3)]
    )
    ...
    _PhysicalConfigDedicated_pdsch_ConfigDedicated = SEQ(
        name="pdsch-ConfigDedicated",
        mode=MODE_TYPE,
        tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "PDSCH-ConfigDedicated")),
        opt=True,
    )
    _PhysicalConfigDedicated_pucch_ConfigDedicated = SEQ(
        name="pucch-ConfigDedicated",
        mode=MODE_TYPE,
        tag=(1, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "PUCCH-ConfigDedicated")),
        opt=True,
    )
    _PhysicalConfigDedicated_pusch_ConfigDedicated = SEQ(
        name="pusch-ConfigDedicated",
        mode=MODE_TYPE,
        tag=(2, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "PUSCH-ConfigDedicated")),
        opt=True,
    )
    _PhysicalConfigDedicated_uplinkPowerControlDedicated = SEQ(
        name="uplinkPowerControlDedicated",
        mode=MODE_TYPE,
        tag=(3, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "UplinkPowerControlDedicated")),
        opt=True,
    )
    _PhysicalConfigDedicated_tpc_PDCCH_ConfigPUCCH = CHOICE(
        name="tpc-PDCCH-ConfigPUCCH",
        mode=MODE_TYPE,
        tag=(4, TAG_CONTEXT_SPEC, TAG_EXPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "TPC-PDCCH-Config")),
        opt=True,
    )
    _PhysicalConfigDedicated_tpc_PDCCH_ConfigPUSCH = CHOICE(
        name="tpc-PDCCH-ConfigPUSCH",
        mode=MODE_TYPE,
        tag=(5, TAG_CONTEXT_SPEC, TAG_EXPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "TPC-PDCCH-Config")),
        opt=True,
    )
    _PhysicalConfigDedicated_cqi_ReportConfig = SEQ(
        name="cqi-ReportConfig",
        mode=MODE_TYPE,
        tag=(6, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "CQI-ReportConfig")),
        opt=True,
    )
    _PhysicalConfigDedicated_soundingRS_UL_ConfigDedicated = CHOICE(
        name="soundingRS-UL-ConfigDedicated",
        mode=MODE_TYPE,
        tag=(7, TAG_CONTEXT_SPEC, TAG_EXPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "SoundingRS-UL-ConfigDedicated")),
        opt=True,
    )
    _PhysicalConfigDedicated_antennaInfo = CHOICE(
        name="antennaInfo",
        mode=MODE_TYPE,
        tag=(8, TAG_CONTEXT_SPEC, TAG_EXPLICIT),
        opt=True,
    )
    __PhysicalConfigDedicated_antennaInfo_explicitValue = SEQ(
        name="explicitValue",
        mode=MODE_TYPE,
        tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "AntennaInfoDedicated")),
    )
    __PhysicalConfigDedicated_antennaInfo_defaultValue = NULL(
        name="defaultValue", mode=MODE_TYPE, tag=(1, TAG_CONTEXT_SPEC, TAG_IMPLICIT)
    )
    ...
    _PhysicalConfigDedicated_schedulingRequestConfig = CHOICE(
        name="schedulingRequestConfig",
        mode=MODE_TYPE,
        tag=(9, TAG_CONTEXT_SPEC, TAG_EXPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "SchedulingRequestConfig")),
        opt=True,
    )
    ...
    _PRACH_ConfigSIB_rootSequenceIndex = INT(
        name="rootSequenceIndex",
        mode=MODE_TYPE,
        tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
    )
    _PRACH_ConfigSIB_rootSequenceIndex._const_val = ASN1Set(
        rv=[], rr=[ASN1RangeInt(lb=0, ub=837)], ev=None, er=[]
    )
    _PRACH_ConfigSIB_prach_ConfigInfo = SEQ(
        name="prach-ConfigInfo",
        mode=MODE_TYPE,
        tag=(1, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "PRACH-ConfigInfo")),
    )
    ...
    _PRACH_Config_rootSequenceIndex = INT(
        name="rootSequenceIndex",
        mode=MODE_TYPE,
        tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
    )
    _PRACH_Config_rootSequenceIndex._const_val = ASN1Set(
        rv=[], rr=[ASN1RangeInt(lb=0, ub=837)], ev=None, er=[]
    )
    _PRACH_Config_prach_ConfigInfo = SEQ(
        name="prach-ConfigInfo",
        mode=MODE_TYPE,
        tag=(1, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "PRACH-ConfigInfo")),
    ...
    _PRACH_ConfigInfo_prach_ConfigIndex = INT(
        name="prach-ConfigIndex",
        mode=MODE_TYPE,
        tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
    )
    _PRACH_ConfigInfo_prach_ConfigIndex._const_val = ASN1Set(
        rv=[], rr=[ASN1RangeInt(lb=0, ub=63)], ev=None, er=[]
    )
    _PRACH_ConfigInfo_highSpeedFlag = BOOL(
        name="highSpeedFlag", mode=MODE_TYPE, tag=(1, TAG_CONTEXT_SPEC, TAG_IMPLICIT)
    )
    _PRACH_ConfigInfo_zeroCorrelationZoneConfig = INT(
        name="zeroCorrelationZoneConfig",
        mode=MODE_TYPE,
        tag=(2, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
    )
    _PRACH_ConfigInfo_zeroCorrelationZoneConfig._const_val = ASN1Set(
        rv=[], rr=[ASN1RangeInt(lb=0, ub=15)], ev=None, er=[]
    )
    _PRACH_ConfigInfo_prach_FreqOffset = INT(
        name="prach-FreqOffset", mode=MODE_TYPE, tag=(3, TAG_CONTEXT_SPEC, TAG_IMPLICIT)
    )
    _PRACH_ConfigInfo_prach_FreqOffset._const_val = ASN1Set(
        rv=[], rr=[ASN1RangeInt(lb=0, ub=94)], ev=None, er=[]
    )
    ...
    _PUCCH_ConfigCommon_deltaPUCCH_Shift = ENUM(
        name="deltaPUCCH-Shift", mode=MODE_TYPE, tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT)
    )
    _PUCCH_ConfigCommon_deltaPUCCH_Shift._cont = ASN1Dict(
        [("ds1", 0), ("ds2", 1), ("ds3", 2)]
    )
    _PUCCH_ConfigCommon_deltaPUCCH_Shift._ext = None
    _PUCCH_ConfigCommon_nRB_CQI = INT(
        name="nRB-CQI", mode=MODE_TYPE, tag=(1, TAG_CONTEXT_SPEC, TAG_IMPLICIT)
    )
    _PUCCH_ConfigCommon_nRB_CQI._const_val = ASN1Set(
        rv=[], rr=[ASN1RangeInt(lb=0, ub=98)], ev=None, er=[]
    )
    _PUCCH_ConfigCommon_nCS_AN = INT(
        name="nCS-AN", mode=MODE_TYPE, tag=(2, TAG_CONTEXT_SPEC, TAG_IMPLICIT)
    )
    _PUCCH_ConfigCommon_nCS_AN._const_val = ASN1Set(
        rv=[], rr=[ASN1RangeInt(lb=0, ub=7)], ev=None, er=[]
    )
    _PUCCH_ConfigCommon_n1PUCCH_AN = INT(
        name="n1PUCCH-AN", mode=MODE_TYPE, tag=(3, TAG_CONTEXT_SPEC, TAG_IMPLICIT)
    )
    _PUCCH_ConfigCommon_n1PUCCH_AN._const_val = ASN1Set(
        rv=[], rr=[ASN1RangeInt(lb=0, ub=2047)], ev=None, er=[]
    )
    ...
    _PUCCH_ConfigDedicated_ackNackRepetition = CHOICE(
        name="ackNackRepetition",
        mode=MODE_TYPE,
        tag=(0, TAG_CONTEXT_SPEC, TAG_EXPLICIT),
    )
    __PUCCH_ConfigDedicated_ackNackRepetition_release = NULL(
        name="release", mode=MODE_TYPE, tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT)
    )
    __PUCCH_ConfigDedicated_ackNackRepetition_setup = SEQ(
        name="setup", mode=MODE_TYPE, tag=(1, TAG_CONTEXT_SPEC, TAG_IMPLICIT)
    )
    ___PUCCH_ConfigDedicated_ackNackRepetition_setup_repetitionFactor = ENUM(
        name="repetitionFactor", mode=MODE_TYPE, tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT)
    )
    ___PUCCH_ConfigDedicated_ackNackRepetition_setup_repetitionFactor._cont = ASN1Dict(
        [("n2", 0), ("n4", 1), ("n6", 2), ("spare1", 3)]
    )
    ___PUCCH_ConfigDedicated_ackNackRepetition_setup_repetitionFactor._ext = None
    ___PUCCH_ConfigDedicated_ackNackRepetition_setup_n1PUCCH_AN_Rep = INT(
        name="n1PUCCH-AN-Rep", mode=MODE_TYPE, tag=(1, TAG_CONTEXT_SPEC, TAG_IMPLICIT)
    )
    ___PUCCH_ConfigDedicated_ackNackRepetition_setup_n1PUCCH_AN_Rep._const_val = (
        ASN1Set(rv=[], rr=[ASN1RangeInt(lb=0, ub=2047)], ev=None, er=[])
    )
    ...
    _PUCCH_ConfigDedicated_tdd_AckNackFeedbackMode = ENUM(
        name="tdd-AckNackFeedbackMode",
        mode=MODE_TYPE,
        tag=(1, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        opt=True,
    )
    _PUCCH_ConfigDedicated_tdd_AckNackFeedbackMode._cont = ASN1Dict(
        [("bundling", 0), ("multiplexing", 1)]
    )
    ...
    _PUSCH_ConfigCommon_pusch_ConfigBasic = SEQ(
        name="pusch-ConfigBasic",
        mode=MODE_TYPE,
        tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
    )
    __PUSCH_ConfigCommon_pusch_ConfigBasic_n_SB = INT(
        name="n-SB", mode=MODE_TYPE, tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT)
    )
    __PUSCH_ConfigCommon_pusch_ConfigBasic_n_SB._const_val = ASN1Set(
        rv=[], rr=[ASN1RangeInt(lb=1, ub=4)], ev=None, er=[]
    )
    __PUSCH_ConfigCommon_pusch_ConfigBasic_hoppingMode = ENUM(
        name="hoppingMode", mode=MODE_TYPE, tag=(1, TAG_CONTEXT_SPEC, TAG_IMPLICIT)
    )
    __PUSCH_ConfigCommon_pusch_ConfigBasic_hoppingMode._cont = ASN1Dict(
        [("interSubFrame", 0), ("intraAndInterSubFrame", 1)]
    )
    __PUSCH_ConfigCommon_pusch_ConfigBasic_hoppingMode._ext = None
    __PUSCH_ConfigCommon_pusch_ConfigBasic_pusch_HoppingOffset = INT(
        name="pusch-HoppingOffset",
        mode=MODE_TYPE,
        tag=(2, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
    )
    __PUSCH_ConfigCommon_pusch_ConfigBasic_pusch_HoppingOffset._const_val = ASN1Set(
        rv=[], rr=[ASN1RangeInt(lb=0, ub=98)], ev=None, er=[]
    )
    __PUSCH_ConfigCommon_pusch_ConfigBasic_enable64QAM = BOOL(
        name="enable64QAM", mode=MODE_TYPE, tag=(3, TAG_CONTEXT_SPEC, TAG_IMPLICIT)
    )
    ...
    _PUSCH_ConfigCommon_ul_ReferenceSignalsPUSCH = SEQ(
        name="ul-ReferenceSignalsPUSCH",
        mode=MODE_TYPE,
        tag=(1, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "UL-ReferenceSignalsPUSCH")),
    )
    ...
    _PUSCH_ConfigDedicated_betaOffset_ACK_Index = INT(
        name="betaOffset-ACK-Index",
        mode=MODE_TYPE,
        tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
    )
    _PUSCH_ConfigDedicated_betaOffset_ACK_Index._const_val = ASN1Set(
        rv=[], rr=[ASN1RangeInt(lb=0, ub=15)], ev=None, er=[]
    )
    _PUSCH_ConfigDedicated_betaOffset_RI_Index = INT(
        name="betaOffset-RI-Index",
        mode=MODE_TYPE,
        tag=(1, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
    )
    _PUSCH_ConfigDedicated_betaOffset_RI_Index._const_val = ASN1Set(
        rv=[], rr=[ASN1RangeInt(lb=0, ub=15)], ev=None, er=[]
    )
    _PUSCH_ConfigDedicated_betaOffset_CQI_Index = INT(
        name="betaOffset-CQI-Index",
        mode=MODE_TYPE,
        tag=(2, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
    )
    _PUSCH_ConfigDedicated_betaOffset_CQI_Index._const_val = ASN1Set(
        rv=[], rr=[ASN1RangeInt(lb=0, ub=15)], ev=None, er=[]
    )
    ...
    _UL_ReferenceSignalsPUSCH_groupHoppingEnabled = BOOL(
        name="groupHoppingEnabled",
        mode=MODE_TYPE,
        tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
    )
    _UL_ReferenceSignalsPUSCH_groupAssignmentPUSCH = INT(
        name="groupAssignmentPUSCH",
        mode=MODE_TYPE,
        tag=(1, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
    )
    _UL_ReferenceSignalsPUSCH_groupAssignmentPUSCH._const_val = ASN1Set(
        rv=[], rr=[ASN1RangeInt(lb=0, ub=29)], ev=None, er=[]
    )
    _UL_ReferenceSignalsPUSCH_sequenceHoppingEnabled = BOOL(
        name="sequenceHoppingEnabled",
        mode=MODE_TYPE,
        tag=(2, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
    )
    _UL_ReferenceSignalsPUSCH_cyclicShift = INT(
        name="cyclicShift", mode=MODE_TYPE, tag=(3, TAG_CONTEXT_SPEC, TAG_IMPLICIT)
    )
    _UL_ReferenceSignalsPUSCH_cyclicShift._const_val = ASN1Set(
        rv=[], rr=[ASN1RangeInt(lb=0, ub=7)], ev=None, er=[]
    )
    ...
    _RACH_ConfigCommon_preambleInfo = SEQ(
        name="preambleInfo", mode=MODE_TYPE, tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT)
    )
    __RACH_ConfigCommon_preambleInfo_numberOfRA_Preambles = ENUM(
        name="numberOfRA-Preambles",
        mode=MODE_TYPE,
        tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
    )
    __RACH_ConfigCommon_preambleInfo_numberOfRA_Preambles._cont = ASN1Dict(
        [
            ("n4", 0),
            ("n8", 1),
            ("n12", 2),
    ...
    __RACH_ConfigCommon_preambleInfo_preamblesGroupAConfig = SEQ(
    ...
    ___RACH_ConfigCommon_preambleInfo_preamblesGroupAConfig_sizeOfRA_PreamblesGroupA._cont = ASN1Dict(
        [
            ("n4", 0),
            ("n8", 1),
            ("n12", 2),
    ...
    ___RACH_ConfigCommon_preambleInfo_preamblesGroupAConfig_messageSizeGroupA._cont = (
        ASN1Dict([("b56", 0), ("b144", 1), ("b208", 2), ("b256", 3)])
    )
    ___RACH_ConfigCommon_preambleInfo_preamblesGroupAConfig_messageSizeGroupA._ext = (
        None
    )
    ...
    ___RACH_ConfigCommon_preambleInfo_preamblesGroupAConfig_messagePowerOffsetGroupB._cont = ASN1Dict(
        [
            ("minusinfinity", 0),
            ("dB0", 1),
            ("dB5", 2),
    ...
    _RACH_ConfigCommon_powerRampingParameters = SEQ(
        name="powerRampingParameters",
        mode=MODE_TYPE,
        tag=(1, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
    )
    __RACH_ConfigCommon_powerRampingParameters_powerRampingStep = ENUM(
        name="powerRampingStep", mode=MODE_TYPE, tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT)
    )
    __RACH_ConfigCommon_powerRampingParameters_powerRampingStep._cont = ASN1Dict(
        [("dB0", 0), ("dB2", 1), ("dB4", 2), ("dB6", 3)]
    )
    ...
    __RACH_ConfigCommon_powerRampingParameters_preambleInitialReceivedTargetPower._cont = ASN1Dict(
        [
            ("dBm-120", 0),
            ("dBm-118", 1),
            ("dBm-116", 2),
    ...
    _RACH_ConfigCommon_ra_SupervisionInfo = SEQ(
        name="ra-SupervisionInfo",
        mode=MODE_TYPE,
        tag=(2, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
    )
    __RACH_ConfigCommon_ra_SupervisionInfo_preambleTransMax = ENUM(
        name="preambleTransMax", mode=MODE_TYPE, tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT)
    )
    __RACH_ConfigCommon_ra_SupervisionInfo_preambleTransMax._cont = ASN1Dict(
        [
            ("n3", 0),
            ("n4", 1),
            ("n5", 2),
    ...
    __RACH_ConfigCommon_ra_SupervisionInfo_ra_ResponseWindowSize = ENUM(
        name="ra-ResponseWindowSize",
        mode=MODE_TYPE,
        tag=(1, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
    )
    __RACH_ConfigCommon_ra_SupervisionInfo_ra_ResponseWindowSize._cont = ASN1Dict(
        [
            ("sf2", 0),
            ("sf3", 1),
            ("sf4", 2),
    ...
    __RACH_ConfigCommon_ra_SupervisionInfo_mac_ContentionResolutionTimer = ENUM(
        name="mac-ContentionResolutionTimer",
        mode=MODE_TYPE,
        tag=(2, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
    )
    __RACH_ConfigCommon_ra_SupervisionInfo_mac_ContentionResolutionTimer._cont = (
        ASN1Dict(
            [
                ("sf8", 0),
                ("sf16", 1),
    ...
    _RACH_ConfigCommon_maxHARQ_Msg3Tx = INT(
        name="maxHARQ-Msg3Tx", mode=MODE_TYPE, tag=(3, TAG_CONTEXT_SPEC, TAG_IMPLICIT)
    )
    _RACH_ConfigCommon_maxHARQ_Msg3Tx._const_val = ASN1Set(
        rv=[], rr=[ASN1RangeInt(lb=1, ub=8)], ev=None, er=[]
    )
    ...
    _RACH_ConfigDedicated_ra_PreambleIndex = INT(
        name="ra-PreambleIndex", mode=MODE_TYPE, tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT)
    )
    _RACH_ConfigDedicated_ra_PreambleIndex._const_val = ASN1Set(
        rv=[], rr=[ASN1RangeInt(lb=0, ub=63)], ev=None, er=[]
    )
    _RACH_ConfigDedicated_ra_PRACH_MaskIndex = INT(
        name="ra-PRACH-MaskIndex",
        mode=MODE_TYPE,
        tag=(1, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
    )
    _RACH_ConfigDedicated_ra_PRACH_MaskIndex._const_val = ASN1Set(
        rv=[], rr=[ASN1RangeInt(lb=0, ub=15)], ev=None, er=[]
    )
    ...
    # -----< RadioResourceConfigCommonSIB >-----#
    RadioResourceConfigCommonSIB = SEQ(
        name="RadioResourceConfigCommonSIB", mode=MODE_TYPE
    )
    _RadioResourceConfigCommonSIB_rach_ConfigCommon = SEQ(
        name="rach-ConfigCommon",
        mode=MODE_TYPE,
        tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "RACH-ConfigCommon")),
    )
    _RadioResourceConfigCommonSIB_bcch_Config = SEQ(
        name="bcch-Config",
        mode=MODE_TYPE,
        tag=(1, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "BCCH-Config")),
    )
    _RadioResourceConfigCommonSIB_pcch_Config = SEQ(
        name="pcch-Config",
        mode=MODE_TYPE,
        tag=(2, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "PCCH-Config")),
    )
    _RadioResourceConfigCommonSIB_prach_Config = SEQ(
        name="prach-Config",
        mode=MODE_TYPE,
        tag=(3, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "PRACH-ConfigSIB")),
    )
    _RadioResourceConfigCommonSIB_pdsch_ConfigCommon = SEQ(
        name="pdsch-ConfigCommon",
        mode=MODE_TYPE,
        tag=(4, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "PDSCH-ConfigCommon")),
    )
    _RadioResourceConfigCommonSIB_pusch_ConfigCommon = SEQ(
        name="pusch-ConfigCommon",
        mode=MODE_TYPE,
        tag=(5, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "PUSCH-ConfigCommon")),
    )
    _RadioResourceConfigCommonSIB_pucch_ConfigCommon = SEQ(
        name="pucch-ConfigCommon",
        mode=MODE_TYPE,
        tag=(6, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "PUCCH-ConfigCommon")),
    )
    _RadioResourceConfigCommonSIB_soundingRS_UL_ConfigCommon = CHOICE(
        name="soundingRS-UL-ConfigCommon",
        mode=MODE_TYPE,
        tag=(7, TAG_CONTEXT_SPEC, TAG_EXPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "SoundingRS-UL-ConfigCommon")),
    )
    _RadioResourceConfigCommonSIB_uplinkPowerControlCommon = SEQ(
        name="uplinkPowerControlCommon",
        mode=MODE_TYPE,
        tag=(8, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "UplinkPowerControlCommon")),
    )
    _RadioResourceConfigCommonSIB_ul_CyclicPrefixLength = ENUM(
        name="ul-CyclicPrefixLength",
        mode=MODE_TYPE,
        tag=(9, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "UL-CyclicPrefixLength")),
    )
    ...
    _RadioResourceConfigCommon_rach_ConfigCommon = SEQ(
        name="rach-ConfigCommon",
        mode=MODE_TYPE,
        tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "RACH-ConfigCommon")),
    ...
    _RadioResourceConfigCommon_prach_Config = SEQ(
        name="prach-Config",
        mode=MODE_TYPE,
        tag=(1, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "PRACH-Config")),
    )
    _RadioResourceConfigCommon_pdsch_ConfigCommon = SEQ(
        name="pdsch-ConfigCommon",
        mode=MODE_TYPE,
        tag=(2, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "PDSCH-ConfigCommon")),
    ...
    _RadioResourceConfigCommon_pusch_ConfigCommon = SEQ(
        name="pusch-ConfigCommon",
        mode=MODE_TYPE,
        tag=(3, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "PUSCH-ConfigCommon")),
    )
    _RadioResourceConfigCommon_phich_Config = SEQ(
        name="phich-Config",
        mode=MODE_TYPE,
        tag=(4, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "PHICH-Config")),
    ...
    _RadioResourceConfigCommon_pucch_ConfigCommon = SEQ(
        name="pucch-ConfigCommon",
        mode=MODE_TYPE,
        tag=(5, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "PUCCH-ConfigCommon")),
    ...
    _RadioResourceConfigCommon_soundingRS_UL_ConfigCommon = CHOICE(
        name="soundingRS-UL-ConfigCommon",
        mode=MODE_TYPE,
        tag=(6, TAG_CONTEXT_SPEC, TAG_EXPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "SoundingRS-UL-ConfigCommon")),
        opt=True,
    )
    _RadioResourceConfigCommon_uplinkPowerControlCommon = SEQ(
        name="uplinkPowerControlCommon",
        mode=MODE_TYPE,
        tag=(7, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "UplinkPowerControlCommon")),
    ...
    _RadioResourceConfigCommon_antennaInfoCommon = SEQ(
        name="antennaInfoCommon",
        mode=MODE_TYPE,
        tag=(8, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "AntennaInfoCommon")),
        opt=True,
    )
    _RadioResourceConfigCommon_p_Max = INT(
        name="p-Max",
        mode=MODE_TYPE,
        tag=(9, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "P-Max")),
    ...
    _RadioResourceConfigCommon_tdd_Config = SEQ(
        name="tdd-Config",
        mode=MODE_TYPE,
        tag=(10, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "TDD-Config")),
    ...
    _RadioResourceConfigCommon_ul_CyclicPrefixLength = ENUM(
        name="ul-CyclicPrefixLength",
        mode=MODE_TYPE,
        tag=(11, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "UL-CyclicPrefixLength")),
    ...
    _BCCH_Config_modificationPeriodCoeff = ENUM(
        name="modificationPeriodCoeff",
        mode=MODE_TYPE,
        tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
    )
    _BCCH_Config_modificationPeriodCoeff._cont = ASN1Dict(
        [("n2", 0), ("n4", 1), ("n8", 2), ("n16", 3)]
    )
    ...
    _PCCH_Config_defaultPagingCycle = ENUM(
        name="defaultPagingCycle",
        mode=MODE_TYPE,
        tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
    )
    _PCCH_Config_defaultPagingCycle._cont = ASN1Dict(
        [("rf32", 0), ("rf64", 1), ("rf128", 2), ("rf256", 3)]
    )
    _PCCH_Config_defaultPagingCycle._ext = None
    _PCCH_Config_nB = ENUM(
        name="nB", mode=MODE_TYPE, tag=(1, TAG_CONTEXT_SPEC, TAG_IMPLICIT)
    )
    _PCCH_Config_nB._cont = ASN1Dict(
        [
            ("fourT", 0),
            ("twoT", 1),
            ("oneT", 2),
    ...
    # -----< RadioResourceConfigDedicated >-----#
    RadioResourceConfigDedicated = SEQ(
        name="RadioResourceConfigDedicated", mode=MODE_TYPE
    )
    _RadioResourceConfigDedicated_srb_ToAddModList = SEQ_OF(
        name="srb-ToAddModList",
        mode=MODE_TYPE,
        tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "SRB-ToAddModList")),
        opt=True,
    )
    _RadioResourceConfigDedicated_drb_ToAddModList = SEQ_OF(
        name="drb-ToAddModList",
        mode=MODE_TYPE,
        tag=(1, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "DRB-ToAddModList")),
        opt=True,
    )
    _RadioResourceConfigDedicated_drb_ToReleaseList = SEQ_OF(
        name="drb-ToReleaseList",
        mode=MODE_TYPE,
        tag=(2, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "DRB-ToReleaseList")),
        opt=True,
    )
    _RadioResourceConfigDedicated_mac_MainConfig = CHOICE(
        name="mac-MainConfig",
        mode=MODE_TYPE,
        tag=(3, TAG_CONTEXT_SPEC, TAG_EXPLICIT),
        opt=True,
    )
    __RadioResourceConfigDedicated_mac_MainConfig_explicitValue = SEQ(
        name="explicitValue",
        mode=MODE_TYPE,
        tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "MAC-MainConfig")),
    )
    __RadioResourceConfigDedicated_mac_MainConfig_defaultValue = NULL(
        name="defaultValue", mode=MODE_TYPE, tag=(1, TAG_CONTEXT_SPEC, TAG_IMPLICIT)
    )
    ...
    _RadioResourceConfigDedicated_sps_Config = SEQ(
        name="sps-Config",
        mode=MODE_TYPE,
        tag=(4, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "SPS-Config")),
        opt=True,
    )
    _RadioResourceConfigDedicated_physicalConfigDedicated = SEQ(
        name="physicalConfigDedicated",
        mode=MODE_TYPE,
        tag=(5, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "PhysicalConfigDedicated")),
        opt=True,
    )
    ...
    _SRB_ToAddModList__item_ = SEQ(
        name="_item_",
        mode=MODE_TYPE,
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "SRB-ToAddMod")),
    )
    SRB_ToAddModList._cont = _SRB_ToAddModList__item_
    SRB_ToAddModList._const_sz = ASN1Set(
        rv=[], rr=[ASN1RangeInt(lb=1, ub=2)], ev=None, er=[]
    )

    # -----< SRB-ToAddMod >-----#
    SRB_ToAddMod = SEQ(name="SRB-ToAddMod", mode=MODE_TYPE)
    _SRB_ToAddMod_srb_Identity = INT(
        name="srb-Identity", mode=MODE_TYPE, tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT)
    )
    _SRB_ToAddMod_srb_Identity._const_val = ASN1Set(
        rv=[], rr=[ASN1RangeInt(lb=1, ub=2)], ev=None, er=[]
    )
    _SRB_ToAddMod_rlc_Config = CHOICE(
        name="rlc-Config",
        mode=MODE_TYPE,
        tag=(1, TAG_CONTEXT_SPEC, TAG_EXPLICIT),
        opt=True,
    )
    __SRB_ToAddMod_rlc_Config_explicitValue = CHOICE(
        name="explicitValue",
        mode=MODE_TYPE,
        tag=(0, TAG_CONTEXT_SPEC, TAG_EXPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "RLC-Config")),
    )
    __SRB_ToAddMod_rlc_Config_defaultValue = NULL(
        name="defaultValue", mode=MODE_TYPE, tag=(1, TAG_CONTEXT_SPEC, TAG_IMPLICIT)
    )
    ...
    _SRB_ToAddMod_logicalChannelConfig = CHOICE(
        name="logicalChannelConfig",
        mode=MODE_TYPE,
        tag=(2, TAG_CONTEXT_SPEC, TAG_EXPLICIT),
        opt=True,
    )
    __SRB_ToAddMod_logicalChannelConfig_explicitValue = SEQ(
        name="explicitValue",
        mode=MODE_TYPE,
        tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "LogicalChannelConfig")),
    )
    __SRB_ToAddMod_logicalChannelConfig_defaultValue = NULL(
        name="defaultValue", mode=MODE_TYPE, tag=(1, TAG_CONTEXT_SPEC, TAG_IMPLICIT)
    )
    ...
    _DRB_ToAddModList__item_ = SEQ(
        name="_item_",
        mode=MODE_TYPE,
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "DRB-ToAddMod")),
    )
    DRB_ToAddModList._cont = _DRB_ToAddModList__item_
    DRB_ToAddModList._const_sz = ASN1Set(
        rv=[], rr=[ASN1RangeInt(lb=1, ub=11)], ev=None, er=[]
    )

    # -----< DRB-ToAddMod >-----#
    DRB_ToAddMod = SEQ(name="DRB-ToAddMod", mode=MODE_TYPE)
    _DRB_ToAddMod_eps_BearerIdentity = INT(
        name="eps-BearerIdentity",
        mode=MODE_TYPE,
        tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        opt=True,
    )
    _DRB_ToAddMod_eps_BearerIdentity._const_val = ASN1Set(
        rv=[], rr=[ASN1RangeInt(lb=0, ub=15)], ev=None, er=[]
    )
    _DRB_ToAddMod_drb_Identity = INT(
        name="drb-Identity",
        mode=MODE_TYPE,
        tag=(1, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "DRB-Identity")),
    )
    _DRB_ToAddMod_pdcp_Config = SEQ(
        name="pdcp-Config",
        mode=MODE_TYPE,
        tag=(2, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "PDCP-Config")),
        opt=True,
    )
    _DRB_ToAddMod_rlc_Config = CHOICE(
        name="rlc-Config",
        mode=MODE_TYPE,
        tag=(3, TAG_CONTEXT_SPEC, TAG_EXPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "RLC-Config")),
    ...
    _DRB_ToAddMod_logicalChannelIdentity = INT(
        name="logicalChannelIdentity",
        mode=MODE_TYPE,
        tag=(4, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        opt=True,
    )
    _DRB_ToAddMod_logicalChannelIdentity._const_val = ASN1Set(
        rv=[], rr=[ASN1RangeInt(lb=3, ub=10)], ev=None, er=[]
    )
    _DRB_ToAddMod_logicalChannelConfig = SEQ(
        name="logicalChannelConfig",
        mode=MODE_TYPE,
        tag=(5, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "LogicalChannelConfig")),
    ...
    _DRB_ToReleaseList__item_ = INT(
        name="_item_",
        mode=MODE_TYPE,
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "DRB-Identity")),
    )
    DRB_ToReleaseList._cont = _DRB_ToReleaseList__item_
    DRB_ToReleaseList._const_sz = ASN1Set(
        rv=[], rr=[ASN1RangeInt(lb=1, ub=11)], ev=None, er=[]
    )
    ...
    _RLC_Config_am = SEQ(
        name="am", mode=MODE_TYPE, tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT)
    )
    __RLC_Config_am_ul_AM_RLC = SEQ(
        name="ul-AM-RLC",
        mode=MODE_TYPE,
        tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "UL-AM-RLC")),
    )
    __RLC_Config_am_dl_AM_RLC = SEQ(
        name="dl-AM-RLC",
        mode=MODE_TYPE,
        tag=(1, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "DL-AM-RLC")),
    )
    ...
    _RLC_Config_um_Bi_Directional = SEQ(
        name="um-Bi-Directional",
        mode=MODE_TYPE,
        tag=(1, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
    )
    __RLC_Config_um_Bi_Directional_ul_UM_RLC = SEQ(
        name="ul-UM-RLC",
        mode=MODE_TYPE,
        tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "UL-UM-RLC")),
    )
    __RLC_Config_um_Bi_Directional_dl_UM_RLC = SEQ(
        name="dl-UM-RLC",
        mode=MODE_TYPE,
        tag=(1, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "DL-UM-RLC")),
    )
    ...
    _RLC_Config_um_Uni_Directional_UL = SEQ(
        name="um-Uni-Directional-UL",
        mode=MODE_TYPE,
        tag=(2, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
    )
    __RLC_Config_um_Uni_Directional_UL_ul_UM_RLC = SEQ(
        name="ul-UM-RLC",
        mode=MODE_TYPE,
        tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "UL-UM-RLC")),
    ...
    _RLC_Config_um_Uni_Directional_DL = SEQ(
        name="um-Uni-Directional-DL",
        mode=MODE_TYPE,
        tag=(3, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
    )
    __RLC_Config_um_Uni_Directional_DL_dl_UM_RLC = SEQ(
        name="dl-UM-RLC",
        mode=MODE_TYPE,
        tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "DL-UM-RLC")),
    ...
    _UL_AM_RLC_t_PollRetransmit = ENUM(
        name="t-PollRetransmit",
        mode=MODE_TYPE,
        tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "T-PollRetransmit")),
    )
    _UL_AM_RLC_pollPDU = ENUM(
        name="pollPDU",
        mode=MODE_TYPE,
        tag=(1, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "PollPDU")),
    )
    _UL_AM_RLC_pollByte = ENUM(
        name="pollByte",
        mode=MODE_TYPE,
        tag=(2, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "PollByte")),
    )
    _UL_AM_RLC_maxRetxThreshold = ENUM(
        name="maxRetxThreshold", mode=MODE_TYPE, tag=(3, TAG_CONTEXT_SPEC, TAG_IMPLICIT)
    )
    _UL_AM_RLC_maxRetxThreshold._cont = ASN1Dict(
        [
            ("t1", 0),
            ("t2", 1),
            ("t3", 2),
    ...
    _DL_AM_RLC_t_Reordering = ENUM(
        name="t-Reordering",
        mode=MODE_TYPE,
        tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "T-Reordering")),
    )
    _DL_AM_RLC_t_StatusProhibit = ENUM(
        name="t-StatusProhibit",
        mode=MODE_TYPE,
        tag=(1, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "T-StatusProhibit")),
    )
    ...
    _UL_UM_RLC_sn_FieldLength = ENUM(
        name="sn-FieldLength",
        mode=MODE_TYPE,
        tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "SN-FieldLength")),
    )
    ...
    _DL_UM_RLC_sn_FieldLength = ENUM(
        name="sn-FieldLength",
        mode=MODE_TYPE,
        tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "SN-FieldLength")),
    )
    _DL_UM_RLC_t_Reordering = ENUM(
        name="t-Reordering",
        mode=MODE_TYPE,
        tag=(1, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "T-Reordering")),
    ...
    T_PollRetransmit._cont = ASN1Dict(
        [
            ("ms5", 0),
            ("ms10", 1),
            ("ms15", 2),
    ...
    T_StatusProhibit._cont = ASN1Dict(
        [
            ("ms0", 0),
            ("ms5", 1),
            ("ms10", 2),
    ...
    _SchedulingRequestConfig_release = NULL(
        name="release", mode=MODE_TYPE, tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT)
    )
    _SchedulingRequestConfig_setup = SEQ(
        name="setup", mode=MODE_TYPE, tag=(1, TAG_CONTEXT_SPEC, TAG_IMPLICIT)
    )
    __SchedulingRequestConfig_setup_sr_PUCCH_ResourceIndex = INT(
        name="sr-PUCCH-ResourceIndex",
        mode=MODE_TYPE,
        tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
    )
    __SchedulingRequestConfig_setup_sr_PUCCH_ResourceIndex._const_val = ASN1Set(
        rv=[], rr=[ASN1RangeInt(lb=0, ub=2047)], ev=None, er=[]
    )
    __SchedulingRequestConfig_setup_sr_ConfigIndex = INT(
        name="sr-ConfigIndex", mode=MODE_TYPE, tag=(1, TAG_CONTEXT_SPEC, TAG_IMPLICIT)
    )
    __SchedulingRequestConfig_setup_sr_ConfigIndex._const_val = ASN1Set(
        rv=[], rr=[ASN1RangeInt(lb=0, ub=155)], ev=None, er=[]
    )
    __SchedulingRequestConfig_setup_dsr_TransMax = ENUM(
        name="dsr-TransMax", mode=MODE_TYPE, tag=(2, TAG_CONTEXT_SPEC, TAG_IMPLICIT)
    )
    __SchedulingRequestConfig_setup_dsr_TransMax._cont = ASN1Dict(
        [
            ("n4", 0),
            ("n8", 1),
            ("n16", 2),
    ...
    # -----< SoundingRS-UL-ConfigCommon >-----#
    SoundingRS_UL_ConfigCommon = CHOICE(
        name="SoundingRS-UL-ConfigCommon", mode=MODE_TYPE
    )
    _SoundingRS_UL_ConfigCommon_release = NULL(
        name="release", mode=MODE_TYPE, tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT)
    )
    _SoundingRS_UL_ConfigCommon_setup = SEQ(
        name="setup", mode=MODE_TYPE, tag=(1, TAG_CONTEXT_SPEC, TAG_IMPLICIT)
    )
    __SoundingRS_UL_ConfigCommon_setup_srs_BandwidthConfig = ENUM(
        name="srs-BandwidthConfig",
        mode=MODE_TYPE,
        tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
    )
    __SoundingRS_UL_ConfigCommon_setup_srs_BandwidthConfig._cont = ASN1Dict(
        [
            ("bw0", 0),
            ("bw1", 1),
            ("bw2", 2),
    ...
    __SoundingRS_UL_ConfigCommon_setup_srs_SubframeConfig = ENUM(
        name="srs-SubframeConfig",
        mode=MODE_TYPE,
        tag=(1, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
    )
    __SoundingRS_UL_ConfigCommon_setup_srs_SubframeConfig._cont = ASN1Dict(
        [
            ("sc0", 0),
            ("sc1", 1),
            ("sc2", 2),
    ...
    __SoundingRS_UL_ConfigCommon_setup_ackNackSRS_SimultaneousTransmission = BOOL(
        name="ackNackSRS-SimultaneousTransmission",
        mode=MODE_TYPE,
        tag=(2, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
    )
    __SoundingRS_UL_ConfigCommon_setup_srs_MaxUpPts = ENUM(
        name="srs-MaxUpPts",
        mode=MODE_TYPE,
        tag=(3, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        opt=True,
    ...
    SoundingRS_UL_ConfigDedicated = CHOICE(
        name="SoundingRS-UL-ConfigDedicated", mode=MODE_TYPE
    )
    _SoundingRS_UL_ConfigDedicated_release = NULL(
        name="release", mode=MODE_TYPE, tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT)
    )
    _SoundingRS_UL_ConfigDedicated_setup = SEQ(
        name="setup", mode=MODE_TYPE, tag=(1, TAG_CONTEXT_SPEC, TAG_IMPLICIT)
    )
    __SoundingRS_UL_ConfigDedicated_setup_srs_Bandwidth = ENUM(
        name="srs-Bandwidth", mode=MODE_TYPE, tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT)
    )
    __SoundingRS_UL_ConfigDedicated_setup_srs_Bandwidth._cont = ASN1Dict(
        [("bw0", 0), ("bw1", 1), ("bw2", 2), ("bw3", 3)]
    )
    __SoundingRS_UL_ConfigDedicated_setup_srs_Bandwidth._ext = None
    __SoundingRS_UL_ConfigDedicated_setup_srs_HoppingBandwidth = ENUM(
        name="srs-HoppingBandwidth",
        mode=MODE_TYPE,
        tag=(1, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
    )
    __SoundingRS_UL_ConfigDedicated_setup_srs_HoppingBandwidth._cont = ASN1Dict(
        [("hbw0", 0), ("hbw1", 1), ("hbw2", 2), ("hbw3", 3)]
    )
    __SoundingRS_UL_ConfigDedicated_setup_srs_HoppingBandwidth._ext = None
    __SoundingRS_UL_ConfigDedicated_setup_freqDomainPosition = INT(
        name="freqDomainPosition",
        mode=MODE_TYPE,
        tag=(2, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
    )
    __SoundingRS_UL_ConfigDedicated_setup_freqDomainPosition._const_val = ASN1Set(
        rv=[], rr=[ASN1RangeInt(lb=0, ub=23)], ev=None, er=[]
    )
    __SoundingRS_UL_ConfigDedicated_setup_duration = BOOL(
        name="duration", mode=MODE_TYPE, tag=(3, TAG_CONTEXT_SPEC, TAG_IMPLICIT)
    )
    __SoundingRS_UL_ConfigDedicated_setup_srs_ConfigIndex = INT(
        name="srs-ConfigIndex", mode=MODE_TYPE, tag=(4, TAG_CONTEXT_SPEC, TAG_IMPLICIT)
    )
    __SoundingRS_UL_ConfigDedicated_setup_srs_ConfigIndex._const_val = ASN1Set(
        rv=[], rr=[ASN1RangeInt(lb=0, ub=1023)], ev=None, er=[]
    )
    __SoundingRS_UL_ConfigDedicated_setup_transmissionComb = INT(
        name="transmissionComb", mode=MODE_TYPE, tag=(5, TAG_CONTEXT_SPEC, TAG_IMPLICIT)
    )
    __SoundingRS_UL_ConfigDedicated_setup_transmissionComb._const_val = ASN1Set(
        rv=[], rr=[ASN1RangeInt(lb=0, ub=1)], ev=None, er=[]
    )
    __SoundingRS_UL_ConfigDedicated_setup_cyclicShift = ENUM(
        name="cyclicShift", mode=MODE_TYPE, tag=(6, TAG_CONTEXT_SPEC, TAG_IMPLICIT)
    )
    __SoundingRS_UL_ConfigDedicated_setup_cyclicShift._cont = ASN1Dict(
        [
            ("cs0", 0),
            ("cs1", 1),
            ("cs2", 2),
    ...
    _SPS_Config_semiPersistSchedC_RNTI = BIT_STR(
    ...
    _SPS_Config_sps_ConfigDL = CHOICE(
        name="sps-ConfigDL",
        mode=MODE_TYPE,
        tag=(1, TAG_CONTEXT_SPEC, TAG_EXPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "SPS-ConfigDL")),
        opt=True,
    )
    _SPS_Config_sps_ConfigUL = CHOICE(
        name="sps-ConfigUL",
        mode=MODE_TYPE,
        tag=(2, TAG_CONTEXT_SPEC, TAG_EXPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "SPS-ConfigUL")),
        opt=True,
    )
    ...
    _SPS_ConfigDL_release = NULL(
        name="release", mode=MODE_TYPE, tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT)
    )
    _SPS_ConfigDL_setup = SEQ(
        name="setup", mode=MODE_TYPE, tag=(1, TAG_CONTEXT_SPEC, TAG_IMPLICIT)
    )
    __SPS_ConfigDL_setup_semiPersistSchedIntervalDL = ENUM(
        name="semiPersistSchedIntervalDL",
        mode=MODE_TYPE,
        tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
    )
    __SPS_ConfigDL_setup_semiPersistSchedIntervalDL._cont = ASN1Dict(
        [
            ("sf10", 0),
            ("sf20", 1),
            ("sf32", 2),
    ...
    __SPS_ConfigDL_setup_numberOfConfSPS_Processes = INT(
        name="numberOfConfSPS-Processes",
        mode=MODE_TYPE,
        tag=(1, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
    )
    __SPS_ConfigDL_setup_numberOfConfSPS_Processes._const_val = ASN1Set(
        rv=[], rr=[ASN1RangeInt(lb=1, ub=8)], ev=None, er=[]
    )
    __SPS_ConfigDL_setup_n1_PUCCH_AN_PersistentList = SEQ_OF(
        name="n1-PUCCH-AN-PersistentList",
        mode=MODE_TYPE,
        tag=(2, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "N1-PUCCH-AN-PersistentList")),
    )
    ...
    _SPS_ConfigUL_release = NULL(
        name="release", mode=MODE_TYPE, tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT)
    )
    _SPS_ConfigUL_setup = SEQ(
        name="setup", mode=MODE_TYPE, tag=(1, TAG_CONTEXT_SPEC, TAG_IMPLICIT)
    )
    __SPS_ConfigUL_setup_semiPersistSchedIntervalUL = ENUM(
        name="semiPersistSchedIntervalUL",
        mode=MODE_TYPE,
        tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
    )
    __SPS_ConfigUL_setup_semiPersistSchedIntervalUL._cont = ASN1Dict(
        [
            ("sf10", 0),
            ("sf20", 1),
            ("sf32", 2),
    ...
    __SPS_ConfigUL_setup_implicitReleaseAfter = ENUM(
        name="implicitReleaseAfter",
        mode=MODE_TYPE,
        tag=(1, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
    )
    __SPS_ConfigUL_setup_implicitReleaseAfter._cont = ASN1Dict(
        [("e2", 0), ("e3", 1), ("e4", 2), ("e8", 3)]
    )
    __SPS_ConfigUL_setup_implicitReleaseAfter._ext = None
    __SPS_ConfigUL_setup_p0_Persistent = SEQ(
        name="p0-Persistent",
        mode=MODE_TYPE,
        tag=(2, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        opt=True,
    )
    ___SPS_ConfigUL_setup_p0_Persistent_p0_NominalPUSCH_Persistent = INT(
        name="p0-NominalPUSCH-Persistent",
        mode=MODE_TYPE,
        tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
    )
    ___SPS_ConfigUL_setup_p0_Persistent_p0_NominalPUSCH_Persistent._const_val = ASN1Set(
        rv=[], rr=[ASN1RangeInt(lb=-126, ub=24)], ev=None, er=[]
    )
    ___SPS_ConfigUL_setup_p0_Persistent_p0_UE_PUSCH_Persistent = INT(
        name="p0-UE-PUSCH-Persistent",
        mode=MODE_TYPE,
        tag=(1, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
    )
    ___SPS_ConfigUL_setup_p0_Persistent_p0_UE_PUSCH_Persistent._const_val = ASN1Set(
        rv=[], rr=[ASN1RangeInt(lb=-8, ub=7)], ev=None, er=[]
    )
    ...
    __SPS_ConfigUL_setup_twoIntervalsConfig = ENUM(
    ...
    # -----< N1-PUCCH-AN-PersistentList >-----#
    N1_PUCCH_AN_PersistentList = SEQ_OF(
        name="N1-PUCCH-AN-PersistentList", mode=MODE_TYPE
    )
    _N1_PUCCH_AN_PersistentList__item_ = INT(name="_item_", mode=MODE_TYPE)
    _N1_PUCCH_AN_PersistentList__item_._const_val = ASN1Set(
        rv=[], rr=[ASN1RangeInt(lb=0, ub=2047)], ev=None, er=[]
    )
    N1_PUCCH_AN_PersistentList._cont = _N1_PUCCH_AN_PersistentList__item_
    N1_PUCCH_AN_PersistentList._const_sz = ASN1Set(
        rv=[], rr=[ASN1RangeInt(lb=1, ub=4)], ev=None, er=[]
    )

    # -----< TDD-Config >-----#
    TDD_Config = SEQ(name="TDD-Config", mode=MODE_TYPE)
    _TDD_Config_subframeAssignment = ENUM(
        name="subframeAssignment",
        mode=MODE_TYPE,
        tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
    )
    _TDD_Config_subframeAssignment._cont = ASN1Dict(
        [
            ("sa0", 0),
            ("sa1", 1),
            ("sa2", 2),
    ...
    _TDD_Config_specialSubframePatterns = ENUM(
        name="specialSubframePatterns",
        mode=MODE_TYPE,
        tag=(1, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
    )
    _TDD_Config_specialSubframePatterns._cont = ASN1Dict(
        [
            ("ssp0", 0),
            ("ssp1", 1),
            ("ssp2", 2),
    ...
    TimeAlignmentTimer._cont = ASN1Dict(
        [
            ("sf500", 0),
            ("sf750", 1),
            ("sf1280", 2),
    ...
    _TPC_PDCCH_Config_release = NULL(
        name="release", mode=MODE_TYPE, tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT)
    )
    _TPC_PDCCH_Config_setup = SEQ(
        name="setup", mode=MODE_TYPE, tag=(1, TAG_CONTEXT_SPEC, TAG_IMPLICIT)
    )
    __TPC_PDCCH_Config_setup_tpc_RNTI = BIT_STR(
        name="tpc-RNTI", mode=MODE_TYPE, tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT)
    )
    __TPC_PDCCH_Config_setup_tpc_RNTI._const_sz = ASN1Set(
        rv=[16], rr=[], ev=None, er=[]
    )
    __TPC_PDCCH_Config_setup_tpc_Index = CHOICE(
        name="tpc-Index",
        mode=MODE_TYPE,
        tag=(1, TAG_CONTEXT_SPEC, TAG_EXPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "TPC-Index")),
    )
    ...
    _TPC_Index_indexOfFormat3 = INT(
        name="indexOfFormat3", mode=MODE_TYPE, tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT)
    )
    _TPC_Index_indexOfFormat3._const_val = ASN1Set(
        rv=[], rr=[ASN1RangeInt(lb=1, ub=15)], ev=None, er=[]
    )
    _TPC_Index_indexOfFormat3A = INT(
        name="indexOfFormat3A", mode=MODE_TYPE, tag=(1, TAG_CONTEXT_SPEC, TAG_IMPLICIT)
    )
    _TPC_Index_indexOfFormat3A._const_val = ASN1Set(
        rv=[], rr=[ASN1RangeInt(lb=1, ub=31)], ev=None, er=[]
    )
    ...
    _UplinkPowerControlCommon_p0_NominalPUSCH = INT(
        name="p0-NominalPUSCH", mode=MODE_TYPE, tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT)
    )
    _UplinkPowerControlCommon_p0_NominalPUSCH._const_val = ASN1Set(
        rv=[], rr=[ASN1RangeInt(lb=-126, ub=24)], ev=None, er=[]
    )
    _UplinkPowerControlCommon_alpha = ENUM(
        name="alpha", mode=MODE_TYPE, tag=(1, TAG_CONTEXT_SPEC, TAG_IMPLICIT)
    )
    _UplinkPowerControlCommon_alpha._cont = ASN1Dict(
        [
            ("al0", 0),
            ("al04", 1),
            ("al05", 2),
    ...
    _UplinkPowerControlCommon_p0_NominalPUCCH = INT(
        name="p0-NominalPUCCH", mode=MODE_TYPE, tag=(2, TAG_CONTEXT_SPEC, TAG_IMPLICIT)
    )
    _UplinkPowerControlCommon_p0_NominalPUCCH._const_val = ASN1Set(
        rv=[], rr=[ASN1RangeInt(lb=-127, ub=-96)], ev=None, er=[]
    )
    _UplinkPowerControlCommon_deltaFList_PUCCH = SEQ(
        name="deltaFList-PUCCH",
        mode=MODE_TYPE,
        tag=(3, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "DeltaFList-PUCCH")),
    )
    _UplinkPowerControlCommon_deltaPreambleMsg3 = INT(
        name="deltaPreambleMsg3",
        mode=MODE_TYPE,
        tag=(4, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
    )
    _UplinkPowerControlCommon_deltaPreambleMsg3._const_val = ASN1Set(
        rv=[], rr=[ASN1RangeInt(lb=-1, ub=6)], ev=None, er=[]
    )
    ...
    # -----< UplinkPowerControlDedicated >-----#
    UplinkPowerControlDedicated = SEQ(
        name="UplinkPowerControlDedicated", mode=MODE_TYPE
    )
    _UplinkPowerControlDedicated_p0_UE_PUSCH = INT(
        name="p0-UE-PUSCH", mode=MODE_TYPE, tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT)
    )
    _UplinkPowerControlDedicated_p0_UE_PUSCH._const_val = ASN1Set(
        rv=[], rr=[ASN1RangeInt(lb=-8, ub=7)], ev=None, er=[]
    )
    _UplinkPowerControlDedicated_deltaMCS_Enabled = ENUM(
        name="deltaMCS-Enabled", mode=MODE_TYPE, tag=(1, TAG_CONTEXT_SPEC, TAG_IMPLICIT)
    )
    _UplinkPowerControlDedicated_deltaMCS_Enabled._cont = ASN1Dict(
        [("en0", 0), ("en1", 1)]
    )
    _UplinkPowerControlDedicated_deltaMCS_Enabled._ext = None
    _UplinkPowerControlDedicated_accumulationEnabled = BOOL(
        name="accumulationEnabled",
        mode=MODE_TYPE,
        tag=(2, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
    )
    _UplinkPowerControlDedicated_p0_UE_PUCCH = INT(
        name="p0-UE-PUCCH", mode=MODE_TYPE, tag=(3, TAG_CONTEXT_SPEC, TAG_IMPLICIT)
    )
    _UplinkPowerControlDedicated_p0_UE_PUCCH._const_val = ASN1Set(
        rv=[], rr=[ASN1RangeInt(lb=-8, ub=7)], ev=None, er=[]
    )
    _UplinkPowerControlDedicated_pSRS_Offset = INT(
        name="pSRS-Offset", mode=MODE_TYPE, tag=(4, TAG_CONTEXT_SPEC, TAG_IMPLICIT)
    )
    _UplinkPowerControlDedicated_pSRS_Offset._const_val = ASN1Set(
        rv=[], rr=[ASN1RangeInt(lb=0, ub=15)], ev=None, er=[]
    )
    _UplinkPowerControlDedicated_filterCoefficient = ENUM(
        name="filterCoefficient",
        mode=MODE_TYPE,
        tag=(5, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "FilterCoefficient")),
        default="fc4",
    )
    ...
    _DeltaFList_PUCCH_deltaF_PUCCH_Format1 = ENUM(
        name="deltaF-PUCCH-Format1",
        mode=MODE_TYPE,
        tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
    )
    _DeltaFList_PUCCH_deltaF_PUCCH_Format1._cont = ASN1Dict(
        [("deltaF-2", 0), ("deltaF0", 1), ("deltaF2", 2)]
    )
    _DeltaFList_PUCCH_deltaF_PUCCH_Format1._ext = None
    _DeltaFList_PUCCH_deltaF_PUCCH_Format1b = ENUM(
        name="deltaF-PUCCH-Format1b",
        mode=MODE_TYPE,
        tag=(1, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
    )
    _DeltaFList_PUCCH_deltaF_PUCCH_Format1b._cont = ASN1Dict(
        [("deltaF1", 0), ("deltaF3", 1), ("deltaF5", 2)]
    )
    _DeltaFList_PUCCH_deltaF_PUCCH_Format1b._ext = None
    _DeltaFList_PUCCH_deltaF_PUCCH_Format2 = ENUM(
        name="deltaF-PUCCH-Format2",
        mode=MODE_TYPE,
        tag=(2, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
    )
    _DeltaFList_PUCCH_deltaF_PUCCH_Format2._cont = ASN1Dict(
        [("deltaF-2", 0), ("deltaF0", 1), ("deltaF1", 2), ("deltaF2", 3)]
    )
    _DeltaFList_PUCCH_deltaF_PUCCH_Format2._ext = None
    _DeltaFList_PUCCH_deltaF_PUCCH_Format2a = ENUM(
        name="deltaF-PUCCH-Format2a",
        mode=MODE_TYPE,
        tag=(3, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
    )
    _DeltaFList_PUCCH_deltaF_PUCCH_Format2a._cont = ASN1Dict(
        [("deltaF-2", 0), ("deltaF0", 1), ("deltaF2", 2)]
    )
    _DeltaFList_PUCCH_deltaF_PUCCH_Format2a._ext = None
    _DeltaFList_PUCCH_deltaF_PUCCH_Format2b = ENUM(
        name="deltaF-PUCCH-Format2b",
        mode=MODE_TYPE,
        tag=(4, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
    )
    _DeltaFList_PUCCH_deltaF_PUCCH_Format2b._cont = ASN1Dict(
        [("deltaF-2", 0), ("deltaF0", 1), ("deltaF2", 2)]
    )
    ...
    NextHopChainingCount._const_val = ASN1Set(
        rv=[], rr=[ASN1RangeInt(lb=0, ub=7)], ev=None, er=[]
    )

    # -----< SecurityAlgorithmConfig >-----#
    SecurityAlgorithmConfig = SEQ(name="SecurityAlgorithmConfig", mode=MODE_TYPE)
    _SecurityAlgorithmConfig_cipheringAlgorithm = ENUM(
        name="cipheringAlgorithm",
        mode=MODE_TYPE,
        tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
    )
    _SecurityAlgorithmConfig_cipheringAlgorithm._cont = ASN1Dict(
        [
            ("eea0", 0),
            ("eea1", 1),
            ("eea2", 2),
    ...
    _SecurityAlgorithmConfig_integrityProtAlgorithm = ENUM(
        name="integrityProtAlgorithm",
        mode=MODE_TYPE,
        tag=(1, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
    )
    _SecurityAlgorithmConfig_integrityProtAlgorithm._cont = ASN1Dict(
        [
            ("reserved", 0),
            ("eia1", 1),
            ("eia2", 2),
    ...
    AdditionalSpectrumEmission._const_val = ASN1Set(
        rv=[], rr=[ASN1RangeInt(lb=1, ub=32)], ev=None, er=[]
    )

    # -----< ARFCN-ValueCDMA2000 >-----#
    ARFCN_ValueCDMA2000 = INT(name="ARFCN-ValueCDMA2000", mode=MODE_TYPE)
    ARFCN_ValueCDMA2000._const_val = ASN1Set(
        rv=[], rr=[ASN1RangeInt(lb=0, ub=2047)], ev=None, er=[]
    )

    # -----< ARFCN-ValueEUTRA >-----#
    ARFCN_ValueEUTRA = INT(name="ARFCN-ValueEUTRA", mode=MODE_TYPE)
    ARFCN_ValueEUTRA._const_val = ASN1Set(
        rv=[], rr=[ASN1RangeInt(lb=0, ub=65535)], ev=None, er=[]
    )

    # -----< ARFCN-ValueGERAN >-----#
    ARFCN_ValueGERAN = INT(name="ARFCN-ValueGERAN", mode=MODE_TYPE)
    ARFCN_ValueGERAN._const_val = ASN1Set(
        rv=[], rr=[ASN1RangeInt(lb=0, ub=1023)], ev=None, er=[]
    )

    # -----< ARFCN-ValueUTRA >-----#
    ARFCN_ValueUTRA = INT(name="ARFCN-ValueUTRA", mode=MODE_TYPE)
    ARFCN_ValueUTRA._const_val = ASN1Set(
        rv=[], rr=[ASN1RangeInt(lb=0, ub=16383)], ev=None, er=[]
    )

    # -----< BandclassCDMA2000 >-----#
    BandclassCDMA2000 = ENUM(name="BandclassCDMA2000", mode=MODE_TYPE)
    BandclassCDMA2000._cont = ASN1Dict(
        [
            ("bc0", 0),
            ("bc1", 1),
            ("bc2", 2),
    ...
    _CarrierFreqCDMA2000_bandClass = ENUM(
        name="bandClass",
        mode=MODE_TYPE,
        tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "BandclassCDMA2000")),
    )
    _CarrierFreqCDMA2000_arfcn = INT(
        name="arfcn",
        mode=MODE_TYPE,
        tag=(1, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "ARFCN-ValueCDMA2000")),
    ...
    _CarrierFreqGERAN_arfcn = INT(
        name="arfcn",
        mode=MODE_TYPE,
        tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "ARFCN-ValueGERAN")),
    )
    _CarrierFreqGERAN_bandIndicator = ENUM(
        name="bandIndicator",
        mode=MODE_TYPE,
        tag=(1, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "BandIndicatorGERAN")),
    )
    ...
    _CarrierFreqsGERAN_startingARFCN = INT(
        name="startingARFCN",
        mode=MODE_TYPE,
        tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "ARFCN-ValueGERAN")),
    )
    _CarrierFreqsGERAN_bandIndicator = ENUM(
        name="bandIndicator",
        mode=MODE_TYPE,
        tag=(1, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "BandIndicatorGERAN")),
    )
    _CarrierFreqsGERAN_followingARFCNs = CHOICE(
        name="followingARFCNs", mode=MODE_TYPE, tag=(2, TAG_CONTEXT_SPEC, TAG_EXPLICIT)
    )
    __CarrierFreqsGERAN_followingARFCNs_explicitListOfARFCNs = SEQ_OF(
        name="explicitListOfARFCNs",
        mode=MODE_TYPE,
        tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "ExplicitListOfARFCNs")),
    )
    __CarrierFreqsGERAN_followingARFCNs_equallySpacedARFCNs = SEQ(
        name="equallySpacedARFCNs",
        mode=MODE_TYPE,
        tag=(1, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
    )
    ___CarrierFreqsGERAN_followingARFCNs_equallySpacedARFCNs_arfcn_Spacing = INT(
        name="arfcn-Spacing", mode=MODE_TYPE, tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT)
    )
    ___CarrierFreqsGERAN_followingARFCNs_equallySpacedARFCNs_arfcn_Spacing._const_val = ASN1Set(
        rv=[], rr=[ASN1RangeInt(lb=1, ub=8)], ev=None, er=[]
    )
    ...
    ___CarrierFreqsGERAN_followingARFCNs_equallySpacedARFCNs_numberOfFollowingARFCNs._const_val = ASN1Set(
        rv=[], rr=[ASN1RangeInt(lb=0, ub=31)], ev=None, er=[]
    )
    ...
    __CarrierFreqsGERAN_followingARFCNs_variableBitMapOfARFCNs = OCT_STR(
        name="variableBitMapOfARFCNs",
        mode=MODE_TYPE,
        tag=(2, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
    )
    __CarrierFreqsGERAN_followingARFCNs_variableBitMapOfARFCNs._const_sz = ASN1Set(
        rv=[], rr=[ASN1RangeInt(lb=1, ub=16)], ev=None, er=[]
    )
    ...
    _ExplicitListOfARFCNs__item_ = INT(
        name="_item_",
        mode=MODE_TYPE,
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "ARFCN-ValueGERAN")),
    )
    ExplicitListOfARFCNs._cont = _ExplicitListOfARFCNs__item_
    ExplicitListOfARFCNs._const_sz = ASN1Set(
        rv=[], rr=[ASN1RangeInt(lb=0, ub=31)], ev=None, er=[]
    )
    ...
    _CellIndexList__item_ = INT(
        name="_item_",
        mode=MODE_TYPE,
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "CellIndex")),
    )
    CellIndexList._cont = _CellIndexList__item_
    CellIndexList._const_sz = ASN1Set(
        rv=[], rr=[ASN1RangeInt(lb=1, ub=32)], ev=None, er=[]
    )

    # -----< CellIndex >-----#
    CellIndex = INT(name="CellIndex", mode=MODE_TYPE)
    CellIndex._const_val = ASN1Set(
        rv=[], rr=[ASN1RangeInt(lb=1, ub=32)], ev=None, er=[]
    )

    # -----< CellReselectionPriority >-----#
    CellReselectionPriority = INT(name="CellReselectionPriority", mode=MODE_TYPE)
    CellReselectionPriority._const_val = ASN1Set(
        rv=[], rr=[ASN1RangeInt(lb=0, ub=7)], ev=None, er=[]
    )

    # -----< CSFB-RegistrationParam1XRTT >-----#
    CSFB_RegistrationParam1XRTT = SEQ(
        name="CSFB-RegistrationParam1XRTT", mode=MODE_TYPE
    )
    _CSFB_RegistrationParam1XRTT_sid = BIT_STR(
        name="sid", mode=MODE_TYPE, tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT)
    )
    _CSFB_RegistrationParam1XRTT_sid._const_sz = ASN1Set(rv=[15], rr=[], ev=None, er=[])
    _CSFB_RegistrationParam1XRTT_nid = BIT_STR(
        name="nid", mode=MODE_TYPE, tag=(1, TAG_CONTEXT_SPEC, TAG_IMPLICIT)
    )
    _CSFB_RegistrationParam1XRTT_nid._const_sz = ASN1Set(rv=[16], rr=[], ev=None, er=[])
    _CSFB_RegistrationParam1XRTT_multipleSID = BOOL(
        name="multipleSID", mode=MODE_TYPE, tag=(2, TAG_CONTEXT_SPEC, TAG_IMPLICIT)
    )
    _CSFB_RegistrationParam1XRTT_multipleNID = BOOL(
        name="multipleNID", mode=MODE_TYPE, tag=(3, TAG_CONTEXT_SPEC, TAG_IMPLICIT)
    )
    _CSFB_RegistrationParam1XRTT_homeReg = BOOL(
        name="homeReg", mode=MODE_TYPE, tag=(4, TAG_CONTEXT_SPEC, TAG_IMPLICIT)
    )
    _CSFB_RegistrationParam1XRTT_foreignSIDReg = BOOL(
        name="foreignSIDReg", mode=MODE_TYPE, tag=(5, TAG_CONTEXT_SPEC, TAG_IMPLICIT)
    )
    _CSFB_RegistrationParam1XRTT_foreignNIDReg = BOOL(
        name="foreignNIDReg", mode=MODE_TYPE, tag=(6, TAG_CONTEXT_SPEC, TAG_IMPLICIT)
    )
    _CSFB_RegistrationParam1XRTT_parameterReg = BOOL(
        name="parameterReg", mode=MODE_TYPE, tag=(7, TAG_CONTEXT_SPEC, TAG_IMPLICIT)
    )
    _CSFB_RegistrationParam1XRTT_powerUpReg = BOOL(
        name="powerUpReg", mode=MODE_TYPE, tag=(8, TAG_CONTEXT_SPEC, TAG_IMPLICIT)
    )
    _CSFB_RegistrationParam1XRTT_registrationPeriod = BIT_STR(
        name="registrationPeriod",
        mode=MODE_TYPE,
        tag=(9, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
    )
    _CSFB_RegistrationParam1XRTT_registrationPeriod._const_sz = ASN1Set(
        rv=[7], rr=[], ev=None, er=[]
    )
    _CSFB_RegistrationParam1XRTT_registrationZone = BIT_STR(
        name="registrationZone",
        mode=MODE_TYPE,
        tag=(10, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
    )
    _CSFB_RegistrationParam1XRTT_registrationZone._const_sz = ASN1Set(
        rv=[12], rr=[], ev=None, er=[]
    )
    _CSFB_RegistrationParam1XRTT_totalZone = BIT_STR(
        name="totalZone", mode=MODE_TYPE, tag=(11, TAG_CONTEXT_SPEC, TAG_IMPLICIT)
    )
    _CSFB_RegistrationParam1XRTT_totalZone._const_sz = ASN1Set(
        rv=[3], rr=[], ev=None, er=[]
    )
    _CSFB_RegistrationParam1XRTT_zoneTimer = BIT_STR(
        name="zoneTimer", mode=MODE_TYPE, tag=(12, TAG_CONTEXT_SPEC, TAG_IMPLICIT)
    )
    _CSFB_RegistrationParam1XRTT_zoneTimer._const_sz = ASN1Set(
        rv=[3], rr=[], ev=None, er=[]
    )
    ...
    _CellGlobalIdEUTRA_plmn_Identity = SEQ(
        name="plmn-Identity",
        mode=MODE_TYPE,
        tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "PLMN-Identity")),
    )
    _CellGlobalIdEUTRA_cellIdentity = BIT_STR(
        name="cellIdentity",
        mode=MODE_TYPE,
        tag=(1, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "CellIdentity")),
    ...
    _CellGlobalIdUTRA_plmn_Identity = SEQ(
        name="plmn-Identity",
        mode=MODE_TYPE,
        tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "PLMN-Identity")),
    )
    _CellGlobalIdUTRA_cellIdentity = BIT_STR(
        name="cellIdentity", mode=MODE_TYPE, tag=(1, TAG_CONTEXT_SPEC, TAG_IMPLICIT)
    )
    ...
    _CellGlobalIdGERAN_plmn_Identity = SEQ(
        name="plmn-Identity",
        mode=MODE_TYPE,
        tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "PLMN-Identity")),
    )
    _CellGlobalIdGERAN_locationAreaCode = BIT_STR(
        name="locationAreaCode", mode=MODE_TYPE, tag=(1, TAG_CONTEXT_SPEC, TAG_IMPLICIT)
    )
    _CellGlobalIdGERAN_locationAreaCode._const_sz = ASN1Set(
        rv=[16], rr=[], ev=None, er=[]
    )
    _CellGlobalIdGERAN_cellIdentity = BIT_STR(
        name="cellIdentity", mode=MODE_TYPE, tag=(2, TAG_CONTEXT_SPEC, TAG_IMPLICIT)
    )
    ...
    _CellGlobalIdCDMA2000_cellGlobalId1XRTT = BIT_STR(
        name="cellGlobalId1XRTT",
        mode=MODE_TYPE,
        tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
    )
    _CellGlobalIdCDMA2000_cellGlobalId1XRTT._const_sz = ASN1Set(
        rv=[47], rr=[], ev=None, er=[]
    )
    _CellGlobalIdCDMA2000_cellGlobalIdHRPD = BIT_STR(
        name="cellGlobalIdHRPD", mode=MODE_TYPE, tag=(1, TAG_CONTEXT_SPEC, TAG_IMPLICIT)
    )
    _CellGlobalIdCDMA2000_cellGlobalIdHRPD._const_sz = ASN1Set(
        rv=[128], rr=[], ev=None, er=[]
    )
    ...
    _MobilityControlInfo_targetPhysCellId = INT(
        name="targetPhysCellId",
        mode=MODE_TYPE,
        tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "PhysCellId")),
    )
    _MobilityControlInfo_carrierFreq = SEQ(
        name="carrierFreq",
        mode=MODE_TYPE,
        tag=(1, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "CarrierFreqEUTRA")),
        opt=True,
    )
    _MobilityControlInfo_carrierBandwidth = SEQ(
        name="carrierBandwidth",
        mode=MODE_TYPE,
        tag=(2, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "CarrierBandwidthEUTRA")),
        opt=True,
    )
    _MobilityControlInfo_additionalSpectrumEmission = INT(
        name="additionalSpectrumEmission",
        mode=MODE_TYPE,
        tag=(3, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "AdditionalSpectrumEmission")),
    ...
    _MobilityControlInfo_t304 = ENUM(
        name="t304", mode=MODE_TYPE, tag=(4, TAG_CONTEXT_SPEC, TAG_IMPLICIT)
    )
    _MobilityControlInfo_t304._cont = ASN1Dict(
        [
            ("ms50", 0),
            ("ms100", 1),
            ("ms150", 2),
    ...
    _MobilityControlInfo_newUE_Identity = BIT_STR(
        name="newUE-Identity",
        mode=MODE_TYPE,
        tag=(5, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "C-RNTI")),
    )
    _MobilityControlInfo_radioResourceConfigCommon = SEQ(
        name="radioResourceConfigCommon",
        mode=MODE_TYPE,
        tag=(6, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "RadioResourceConfigCommon")),
    )
    _MobilityControlInfo_rach_ConfigDedicated = SEQ(
        name="rach-ConfigDedicated",
        mode=MODE_TYPE,
        tag=(7, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "RACH-ConfigDedicated")),
        opt=True,
    )
    ...
    _CarrierBandwidthEUTRA_dl_Bandwidth = ENUM(
        name="dl-Bandwidth", mode=MODE_TYPE, tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT)
    )
    _CarrierBandwidthEUTRA_dl_Bandwidth._cont = ASN1Dict(
        [
            ("n6", 0),
            ("n15", 1),
            ("n25", 2),
    ...
    _CarrierBandwidthEUTRA_ul_Bandwidth = ENUM(
        name="ul-Bandwidth",
        mode=MODE_TYPE,
        tag=(1, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        opt=True,
    )
    _CarrierBandwidthEUTRA_ul_Bandwidth._cont = ASN1Dict(
        [
            ("n6", 0),
            ("n15", 1),
            ("n25", 2),
    ...
    _CarrierFreqEUTRA_dl_CarrierFreq = INT(
        name="dl-CarrierFreq",
        mode=MODE_TYPE,
        tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "ARFCN-ValueEUTRA")),
    )
    _CarrierFreqEUTRA_ul_CarrierFreq = INT(
        name="ul-CarrierFreq",
        mode=MODE_TYPE,
        tag=(1, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "ARFCN-ValueEUTRA")),
    ...
    # -----< MobilityParametersCDMA2000 >-----#
    MobilityParametersCDMA2000 = OCT_STR(
        name="MobilityParametersCDMA2000", mode=MODE_TYPE
    )

    # -----< MobilityStateParameters >-----#
    MobilityStateParameters = SEQ(name="MobilityStateParameters", mode=MODE_TYPE)
    _MobilityStateParameters_t_Evaluation = ENUM(
        name="t-Evaluation", mode=MODE_TYPE, tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT)
    )
    _MobilityStateParameters_t_Evaluation._cont = ASN1Dict(
        [
            ("s30", 0),
            ("s60", 1),
            ("s120", 2),
    ...
    _MobilityStateParameters_t_HystNormal = ENUM(
        name="t-HystNormal", mode=MODE_TYPE, tag=(1, TAG_CONTEXT_SPEC, TAG_IMPLICIT)
    )
    _MobilityStateParameters_t_HystNormal._cont = ASN1Dict(
        [
            ("s30", 0),
            ("s60", 1),
            ("s120", 2),
    ...
    _MobilityStateParameters_n_CellChangeMedium = INT(
        name="n-CellChangeMedium",
        mode=MODE_TYPE,
        tag=(2, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
    )
    _MobilityStateParameters_n_CellChangeMedium._const_val = ASN1Set(
        rv=[], rr=[ASN1RangeInt(lb=1, ub=16)], ev=None, er=[]
    )
    _MobilityStateParameters_n_CellChangeHigh = INT(
        name="n-CellChangeHigh", mode=MODE_TYPE, tag=(3, TAG_CONTEXT_SPEC, TAG_IMPLICIT)
    )
    _MobilityStateParameters_n_CellChangeHigh._const_val = ASN1Set(
        rv=[], rr=[ASN1RangeInt(lb=1, ub=16)], ev=None, er=[]
    )
    ...
    PhysCellId._const_val = ASN1Set(
        rv=[], rr=[ASN1RangeInt(lb=0, ub=503)], ev=None, er=[]
    )

    # -----< PhysCellIdRange >-----#
    PhysCellIdRange = SEQ(name="PhysCellIdRange", mode=MODE_TYPE)
    _PhysCellIdRange_start = INT(
        name="start",
        mode=MODE_TYPE,
        tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "PhysCellId")),
    )
    _PhysCellIdRange_range = ENUM(
        name="range", mode=MODE_TYPE, tag=(1, TAG_CONTEXT_SPEC, TAG_IMPLICIT), opt=True
    )
    _PhysCellIdRange_range._cont = ASN1Dict(
        [
            ("n4", 0),
            ("n8", 1),
            ("n12", 2),
    ...
    PhysCellIdCDMA2000._const_val = ASN1Set(
        rv=[], rr=[ASN1RangeInt(lb=0, ub=511)], ev=None, er=[]
    )

    # -----< PhysCellIdGERAN >-----#
    PhysCellIdGERAN = SEQ(name="PhysCellIdGERAN", mode=MODE_TYPE)
    _PhysCellIdGERAN_networkColourCode = BIT_STR(
        name="networkColourCode",
        mode=MODE_TYPE,
        tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
    )
    _PhysCellIdGERAN_networkColourCode._const_sz = ASN1Set(
        rv=[3], rr=[], ev=None, er=[]
    )
    _PhysCellIdGERAN_baseStationColourCode = BIT_STR(
        name="baseStationColourCode",
        mode=MODE_TYPE,
        tag=(1, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
    )
    _PhysCellIdGERAN_baseStationColourCode._const_sz = ASN1Set(
        rv=[3], rr=[], ev=None, er=[]
    )
    ...
    PhysCellIdUTRA_FDD._const_val = ASN1Set(
        rv=[], rr=[ASN1RangeInt(lb=0, ub=511)], ev=None, er=[]
    )

    # -----< PhysCellIdUTRA-TDD >-----#
    PhysCellIdUTRA_TDD = INT(name="PhysCellIdUTRA-TDD", mode=MODE_TYPE)
    PhysCellIdUTRA_TDD._const_val = ASN1Set(
        rv=[], rr=[ASN1RangeInt(lb=0, ub=127)], ev=None, er=[]
    )

    # -----< PLMN-Identity >-----#
    PLMN_Identity = SEQ(name="PLMN-Identity", mode=MODE_TYPE)
    _PLMN_Identity_mcc = SEQ_OF(
        name="mcc",
        mode=MODE_TYPE,
        tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "MCC")),
        opt=True,
    )
    _PLMN_Identity_mnc = SEQ_OF(
        name="mnc",
        mode=MODE_TYPE,
        tag=(1, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "MNC")),
    )
    ...
    _MCC__item_ = INT(
        name="_item_",
        mode=MODE_TYPE,
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "MCC-MNC-Digit")),
    )
    ...
    MCC_MNC_Digit._const_val = ASN1Set(
        rv=[], rr=[ASN1RangeInt(lb=0, ub=9)], ev=None, er=[]
    )

    # -----< PreRegistrationInfoHRPD >-----#
    PreRegistrationInfoHRPD = SEQ(name="PreRegistrationInfoHRPD", mode=MODE_TYPE)
    _PreRegistrationInfoHRPD_preRegistrationAllowed = BOOL(
        name="preRegistrationAllowed",
        mode=MODE_TYPE,
        tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
    )
    _PreRegistrationInfoHRPD_preRegistrationZoneId = INT(
        name="preRegistrationZoneId",
        mode=MODE_TYPE,
        tag=(1, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "PreRegistrationZoneIdHRPD")),
        opt=True,
    )
    _PreRegistrationInfoHRPD_secondaryPreRegistrationZoneIdList = SEQ_OF(
        name="secondaryPreRegistrationZoneIdList",
        mode=MODE_TYPE,
        tag=(2, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(
            ("EUTRA-RRC-Definitions", "SecondaryPreRegistrationZoneIdListHRPD")
        ),
        opt=True,
    )
    ...
    # -----< SecondaryPreRegistrationZoneIdListHRPD >-----#
    SecondaryPreRegistrationZoneIdListHRPD = SEQ_OF(
        name="SecondaryPreRegistrationZoneIdListHRPD", mode=MODE_TYPE
    )
    _SecondaryPreRegistrationZoneIdListHRPD__item_ = INT(
        name="_item_",
        mode=MODE_TYPE,
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "PreRegistrationZoneIdHRPD")),
    )
    SecondaryPreRegistrationZoneIdListHRPD._cont = (
        _SecondaryPreRegistrationZoneIdListHRPD__item_
    )
    SecondaryPreRegistrationZoneIdListHRPD._const_sz = ASN1Set(
        rv=[], rr=[ASN1RangeInt(lb=1, ub=2)], ev=None, er=[]
    )

    # -----< PreRegistrationZoneIdHRPD >-----#
    PreRegistrationZoneIdHRPD = INT(name="PreRegistrationZoneIdHRPD", mode=MODE_TYPE)
    PreRegistrationZoneIdHRPD._const_val = ASN1Set(
        rv=[], rr=[ASN1RangeInt(lb=0, ub=255)], ev=None, er=[]
    )

    # -----< Q-RxLevMin >-----#
    Q_RxLevMin = INT(name="Q-RxLevMin", mode=MODE_TYPE)
    Q_RxLevMin._const_val = ASN1Set(
        rv=[], rr=[ASN1RangeInt(lb=-70, ub=-22)], ev=None, er=[]
    )

    # -----< Q-OffsetRange >-----#
    Q_OffsetRange = ENUM(name="Q-OffsetRange", mode=MODE_TYPE)
    Q_OffsetRange._cont = ASN1Dict(
        [
            ("dB-24", 0),
            ("dB-22", 1),
            ("dB-20", 2),
    ...
    Q_OffsetRangeInterRAT._const_val = ASN1Set(
        rv=[], rr=[ASN1RangeInt(lb=-15, ub=15)], ev=None, er=[]
    )

    # -----< ReselectionThreshold >-----#
    ReselectionThreshold = INT(name="ReselectionThreshold", mode=MODE_TYPE)
    ReselectionThreshold._const_val = ASN1Set(
        rv=[], rr=[ASN1RangeInt(lb=0, ub=31)], ev=None, er=[]
    )

    # -----< SpeedStateScaleFactors >-----#
    SpeedStateScaleFactors = SEQ(name="SpeedStateScaleFactors", mode=MODE_TYPE)
    _SpeedStateScaleFactors_sf_Medium = ENUM(
        name="sf-Medium", mode=MODE_TYPE, tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT)
    )
    _SpeedStateScaleFactors_sf_Medium._cont = ASN1Dict(
        [("oDot25", 0), ("oDot5", 1), ("oDot75", 2), ("lDot0", 3)]
    )
    _SpeedStateScaleFactors_sf_Medium._ext = None
    _SpeedStateScaleFactors_sf_High = ENUM(
        name="sf-High", mode=MODE_TYPE, tag=(1, TAG_CONTEXT_SPEC, TAG_IMPLICIT)
    )
    _SpeedStateScaleFactors_sf_High._cont = ASN1Dict(
        [("oDot25", 0), ("oDot5", 1), ("oDot75", 2), ("lDot0", 3)]
    )
    ...
    _SystemTimeInfoCDMA2000_cdma_EUTRA_Synchronisation = BOOL(
        name="cdma-EUTRA-Synchronisation",
        mode=MODE_TYPE,
        tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
    )
    _SystemTimeInfoCDMA2000_cdma_SystemTime = CHOICE(
        name="cdma-SystemTime", mode=MODE_TYPE, tag=(1, TAG_CONTEXT_SPEC, TAG_EXPLICIT)
    )
    __SystemTimeInfoCDMA2000_cdma_SystemTime_synchronousSystemTime = BIT_STR(
        name="synchronousSystemTime",
        mode=MODE_TYPE,
        tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
    )
    __SystemTimeInfoCDMA2000_cdma_SystemTime_synchronousSystemTime._const_sz = ASN1Set(
        rv=[39], rr=[], ev=None, er=[]
    )
    __SystemTimeInfoCDMA2000_cdma_SystemTime_asynchronousSystemTime = BIT_STR(
        name="asynchronousSystemTime",
        mode=MODE_TYPE,
        tag=(1, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
    )
    __SystemTimeInfoCDMA2000_cdma_SystemTime_asynchronousSystemTime._const_sz = ASN1Set(
        rv=[49], rr=[], ev=None, er=[]
    )
    ...
    T_Reselection._const_val = ASN1Set(
        rv=[], rr=[ASN1RangeInt(lb=0, ub=7)], ev=None, er=[]
    )

    # -----< AllowedMeasBandwidth >-----#
    AllowedMeasBandwidth = ENUM(name="AllowedMeasBandwidth", mode=MODE_TYPE)
    AllowedMeasBandwidth._cont = ASN1Dict(
        [
            ("mbw6", 0),
            ("mbw15", 1),
            ("mbw25", 2),
    ...
    Hysteresis._const_val = ASN1Set(
        rv=[], rr=[ASN1RangeInt(lb=0, ub=30)], ev=None, er=[]
    )

    # -----< MeasConfig >-----#
    MeasConfig = SEQ(name="MeasConfig", mode=MODE_TYPE)
    _MeasConfig_measObjectToRemoveList = SEQ_OF(
        name="measObjectToRemoveList",
        mode=MODE_TYPE,
        tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "MeasObjectToRemoveList")),
        opt=True,
    )
    _MeasConfig_measObjectToAddModList = SEQ_OF(
        name="measObjectToAddModList",
        mode=MODE_TYPE,
        tag=(1, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "MeasObjectToAddModList")),
        opt=True,
    )
    _MeasConfig_reportConfigToRemoveList = SEQ_OF(
        name="reportConfigToRemoveList",
        mode=MODE_TYPE,
        tag=(2, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "ReportConfigToRemoveList")),
        opt=True,
    )
    _MeasConfig_reportConfigToAddModList = SEQ_OF(
        name="reportConfigToAddModList",
        mode=MODE_TYPE,
        tag=(3, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "ReportConfigToAddModList")),
        opt=True,
    )
    _MeasConfig_measIdToRemoveList = SEQ_OF(
        name="measIdToRemoveList",
        mode=MODE_TYPE,
        tag=(4, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "MeasIdToRemoveList")),
        opt=True,
    )
    _MeasConfig_measIdToAddModList = SEQ_OF(
        name="measIdToAddModList",
        mode=MODE_TYPE,
        tag=(5, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "MeasIdToAddModList")),
        opt=True,
    )
    _MeasConfig_quantityConfig = SEQ(
        name="quantityConfig",
        mode=MODE_TYPE,
        tag=(6, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "QuantityConfig")),
        opt=True,
    )
    _MeasConfig_measGapConfig = CHOICE(
        name="measGapConfig",
        mode=MODE_TYPE,
        tag=(7, TAG_CONTEXT_SPEC, TAG_EXPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "MeasGapConfig")),
        opt=True,
    )
    _MeasConfig_s_Measure = INT(
        name="s-Measure",
        mode=MODE_TYPE,
        tag=(8, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "RSRP-Range")),
        opt=True,
    )
    _MeasConfig_preRegistrationInfoHRPD = SEQ(
        name="preRegistrationInfoHRPD",
        mode=MODE_TYPE,
        tag=(9, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "PreRegistrationInfoHRPD")),
    ...
    _MeasConfig_speedStatePars = CHOICE(
        name="speedStatePars",
        mode=MODE_TYPE,
        tag=(10, TAG_CONTEXT_SPEC, TAG_EXPLICIT),
        opt=True,
    )
    __MeasConfig_speedStatePars_release = NULL(
        name="release", mode=MODE_TYPE, tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT)
    )
    __MeasConfig_speedStatePars_setup = SEQ(
        name="setup", mode=MODE_TYPE, tag=(1, TAG_CONTEXT_SPEC, TAG_IMPLICIT)
    )
    ___MeasConfig_speedStatePars_setup_mobilityStateParameters = SEQ(
        name="mobilityStateParameters",
        mode=MODE_TYPE,
        tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "MobilityStateParameters")),
    )
    ___MeasConfig_speedStatePars_setup_timeToTrigger_SF = SEQ(
    ...
    _MeasIdToRemoveList__item_ = INT(
        name="_item_",
        mode=MODE_TYPE,
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "MeasId")),
    )
    MeasIdToRemoveList._cont = _MeasIdToRemoveList__item_
    MeasIdToRemoveList._const_sz = ASN1Set(
        rv=[], rr=[ASN1RangeInt(lb=1, ub=32)], ev=None, er=[]
    )

    # -----< MeasObjectToRemoveList >-----#
    MeasObjectToRemoveList = SEQ_OF(name="MeasObjectToRemoveList", mode=MODE_TYPE)
    _MeasObjectToRemoveList__item_ = INT(
        name="_item_",
        mode=MODE_TYPE,
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "MeasObjectId")),
    )
    MeasObjectToRemoveList._cont = _MeasObjectToRemoveList__item_
    MeasObjectToRemoveList._const_sz = ASN1Set(
        rv=[], rr=[ASN1RangeInt(lb=1, ub=32)], ev=None, er=[]
    )

    # -----< ReportConfigToRemoveList >-----#
    ReportConfigToRemoveList = SEQ_OF(name="ReportConfigToRemoveList", mode=MODE_TYPE)
    _ReportConfigToRemoveList__item_ = INT(
        name="_item_",
        mode=MODE_TYPE,
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "ReportConfigId")),
    )
    ReportConfigToRemoveList._cont = _ReportConfigToRemoveList__item_
    ReportConfigToRemoveList._const_sz = ASN1Set(
        rv=[], rr=[ASN1RangeInt(lb=1, ub=32)], ev=None, er=[]
    )

    # -----< MeasGapConfig >-----#
    MeasGapConfig = CHOICE(name="MeasGapConfig", mode=MODE_TYPE)
    _MeasGapConfig_release = NULL(
        name="release", mode=MODE_TYPE, tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT)
    )
    _MeasGapConfig_setup = SEQ(
        name="setup", mode=MODE_TYPE, tag=(1, TAG_CONTEXT_SPEC, TAG_IMPLICIT)
    )
    __MeasGapConfig_setup_gapOffset = CHOICE(
        name="gapOffset", mode=MODE_TYPE, tag=(0, TAG_CONTEXT_SPEC, TAG_EXPLICIT)
    )
    ___MeasGapConfig_setup_gapOffset_gp0 = INT(
        name="gp0", mode=MODE_TYPE, tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT)
    )
    ___MeasGapConfig_setup_gapOffset_gp0._const_val = ASN1Set(
        rv=[], rr=[ASN1RangeInt(lb=0, ub=39)], ev=None, er=[]
    )
    ___MeasGapConfig_setup_gapOffset_gp1 = INT(
        name="gp1", mode=MODE_TYPE, tag=(1, TAG_CONTEXT_SPEC, TAG_IMPLICIT)
    )
    ___MeasGapConfig_setup_gapOffset_gp1._const_val = ASN1Set(
        rv=[], rr=[ASN1RangeInt(lb=0, ub=79)], ev=None, er=[]
    )
    ...
    _MeasIdToAddModList__item_ = SEQ(
        name="_item_",
        mode=MODE_TYPE,
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "MeasIdToAddMod")),
    )
    MeasIdToAddModList._cont = _MeasIdToAddModList__item_
    MeasIdToAddModList._const_sz = ASN1Set(
        rv=[], rr=[ASN1RangeInt(lb=1, ub=32)], ev=None, er=[]
    )

    # -----< MeasIdToAddMod >-----#
    MeasIdToAddMod = SEQ(name="MeasIdToAddMod", mode=MODE_TYPE)
    _MeasIdToAddMod_measId = INT(
        name="measId",
        mode=MODE_TYPE,
        tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "MeasId")),
    )
    _MeasIdToAddMod_measObjectId = INT(
        name="measObjectId",
        mode=MODE_TYPE,
        tag=(1, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "MeasObjectId")),
    )
    _MeasIdToAddMod_reportConfigId = INT(
        name="reportConfigId",
        mode=MODE_TYPE,
        tag=(2, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "ReportConfigId")),
    ...
    _MeasObjectCDMA2000_cdma2000_Type = ENUM(
        name="cdma2000-Type",
        mode=MODE_TYPE,
        tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "CDMA2000-Type")),
    )
    _MeasObjectCDMA2000_carrierFreq = SEQ(
        name="carrierFreq",
        mode=MODE_TYPE,
        tag=(1, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "CarrierFreqCDMA2000")),
    )
    _MeasObjectCDMA2000_searchWindowSize = INT(
        name="searchWindowSize",
        mode=MODE_TYPE,
        tag=(2, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        opt=True,
    )
    _MeasObjectCDMA2000_searchWindowSize._const_val = ASN1Set(
        rv=[], rr=[ASN1RangeInt(lb=0, ub=15)], ev=None, er=[]
    )
    _MeasObjectCDMA2000_offsetFreq = INT(
        name="offsetFreq",
        mode=MODE_TYPE,
        tag=(3, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "Q-OffsetRangeInterRAT")),
        default=0,
    )
    _MeasObjectCDMA2000_cellsToRemoveList = SEQ_OF(
        name="cellsToRemoveList",
        mode=MODE_TYPE,
        tag=(4, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "CellIndexList")),
        opt=True,
    )
    _MeasObjectCDMA2000_cellsToAddModList = SEQ_OF(
        name="cellsToAddModList",
        mode=MODE_TYPE,
        tag=(5, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "CellsToAddModListCDMA2000")),
        opt=True,
    )
    _MeasObjectCDMA2000_cellForWhichToReportCGI = INT(
    ...
    _CellsToAddModListCDMA2000__item_ = SEQ(
        name="_item_",
        mode=MODE_TYPE,
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "CellsToAddModCDMA2000")),
    )
    CellsToAddModListCDMA2000._cont = _CellsToAddModListCDMA2000__item_
    CellsToAddModListCDMA2000._const_sz = ASN1Set(
        rv=[], rr=[ASN1RangeInt(lb=1, ub=32)], ev=None, er=[]
    )

    # -----< CellsToAddModCDMA2000 >-----#
    CellsToAddModCDMA2000 = SEQ(name="CellsToAddModCDMA2000", mode=MODE_TYPE)
    _CellsToAddModCDMA2000_cellIndex = INT(
        name="cellIndex", mode=MODE_TYPE, tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT)
    )
    _CellsToAddModCDMA2000_cellIndex._const_val = ASN1Set(
        rv=[], rr=[ASN1RangeInt(lb=1, ub=32)], ev=None, er=[]
    )
    _CellsToAddModCDMA2000_physCellId = INT(
        name="physCellId",
        mode=MODE_TYPE,
        tag=(1, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "PhysCellIdCDMA2000")),
    ...
    _MeasObjectEUTRA_carrierFreq = INT(
        name="carrierFreq",
        mode=MODE_TYPE,
        tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "ARFCN-ValueEUTRA")),
    )
    _MeasObjectEUTRA_allowedMeasBandwidth = ENUM(
        name="allowedMeasBandwidth",
        mode=MODE_TYPE,
        tag=(1, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "AllowedMeasBandwidth")),
    )
    _MeasObjectEUTRA_presenceAntennaPort1 = BOOL(
        name="presenceAntennaPort1",
        mode=MODE_TYPE,
        tag=(2, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "PresenceAntennaPort1")),
    )
    _MeasObjectEUTRA_neighCellConfig = BIT_STR(
        name="neighCellConfig",
        mode=MODE_TYPE,
        tag=(3, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "NeighCellConfig")),
    )
    _MeasObjectEUTRA_offsetFreq = ENUM(
        name="offsetFreq",
        mode=MODE_TYPE,
        tag=(4, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "Q-OffsetRange")),
    ...
    _MeasObjectEUTRA_cellsToRemoveList = SEQ_OF(
        name="cellsToRemoveList",
        mode=MODE_TYPE,
        tag=(5, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "CellIndexList")),
    ...
    _MeasObjectEUTRA_cellsToAddModList = SEQ_OF(
        name="cellsToAddModList",
        mode=MODE_TYPE,
        tag=(6, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "CellsToAddModList")),
        opt=True,
    )
    _MeasObjectEUTRA_blackCellsToRemoveList = SEQ_OF(
    ...
    _MeasObjectEUTRA_blackCellsToAddModList = SEQ_OF(
        name="blackCellsToAddModList",
        mode=MODE_TYPE,
        tag=(8, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "BlackCellsToAddModList")),
        opt=True,
    )
    _MeasObjectEUTRA_cellForWhichToReportCGI = INT(
        name="cellForWhichToReportCGI",
        mode=MODE_TYPE,
        tag=(9, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "PhysCellId")),
    ...
    _CellsToAddModList__item_ = SEQ(
        name="_item_",
        mode=MODE_TYPE,
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "CellsToAddMod")),
    )
    CellsToAddModList._cont = _CellsToAddModList__item_
    CellsToAddModList._const_sz = ASN1Set(
        rv=[], rr=[ASN1RangeInt(lb=1, ub=32)], ev=None, er=[]
    )

    # -----< CellsToAddMod >-----#
    CellsToAddMod = SEQ(name="CellsToAddMod", mode=MODE_TYPE)
    _CellsToAddMod_cellIndex = INT(
        name="cellIndex", mode=MODE_TYPE, tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT)
    )
    _CellsToAddMod_cellIndex._const_val = ASN1Set(
        rv=[], rr=[ASN1RangeInt(lb=1, ub=32)], ev=None, er=[]
    )
    _CellsToAddMod_physCellId = INT(
        name="physCellId",
        mode=MODE_TYPE,
        tag=(1, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "PhysCellId")),
    )
    _CellsToAddMod_cellIndividualOffset = ENUM(
    ...
    _BlackCellsToAddModList__item_ = SEQ(
        name="_item_",
        mode=MODE_TYPE,
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "BlackCellsToAddMod")),
    )
    BlackCellsToAddModList._cont = _BlackCellsToAddModList__item_
    BlackCellsToAddModList._const_sz = ASN1Set(
        rv=[], rr=[ASN1RangeInt(lb=1, ub=32)], ev=None, er=[]
    )

    # -----< BlackCellsToAddMod >-----#
    BlackCellsToAddMod = SEQ(name="BlackCellsToAddMod", mode=MODE_TYPE)
    _BlackCellsToAddMod_cellIndex = INT(
        name="cellIndex", mode=MODE_TYPE, tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT)
    )
    _BlackCellsToAddMod_cellIndex._const_val = ASN1Set(
        rv=[], rr=[ASN1RangeInt(lb=1, ub=32)], ev=None, er=[]
    )
    _BlackCellsToAddMod_physCellIdRange = SEQ(
    ...
    _MeasObjectGERAN_carrierFreqs = SEQ(
        name="carrierFreqs",
        mode=MODE_TYPE,
        tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "CarrierFreqsGERAN")),
    )
    _MeasObjectGERAN_offsetFreq = INT(
        name="offsetFreq",
        mode=MODE_TYPE,
        tag=(1, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "Q-OffsetRangeInterRAT")),
    ...
    _MeasObjectGERAN_ncc_Permitted = BIT_STR(
        name="ncc-Permitted",
        mode=MODE_TYPE,
        tag=(2, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        default=(255, 8),
    ...
    _MeasObjectGERAN_cellForWhichToReportCGI = SEQ(
        name="cellForWhichToReportCGI",
        mode=MODE_TYPE,
        tag=(3, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "PhysCellIdGERAN")),
    ...
    MeasObjectId._const_val = ASN1Set(
        rv=[], rr=[ASN1RangeInt(lb=1, ub=32)], ev=None, er=[]
    )

    # -----< MeasObjectToAddModList >-----#
    MeasObjectToAddModList = SEQ_OF(name="MeasObjectToAddModList", mode=MODE_TYPE)
    _MeasObjectToAddModList__item_ = SEQ(
        name="_item_",
        mode=MODE_TYPE,
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "MeasObjectToAddMod")),
    )
    MeasObjectToAddModList._cont = _MeasObjectToAddModList__item_
    MeasObjectToAddModList._const_sz = ASN1Set(
        rv=[], rr=[ASN1RangeInt(lb=1, ub=32)], ev=None, er=[]
    )

    # -----< MeasObjectToAddMod >-----#
    MeasObjectToAddMod = SEQ(name="MeasObjectToAddMod", mode=MODE_TYPE)
    _MeasObjectToAddMod_measObjectId = INT(
        name="measObjectId",
        mode=MODE_TYPE,
        tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "MeasObjectId")),
    )
    _MeasObjectToAddMod_measObject = CHOICE(
        name="measObject", mode=MODE_TYPE, tag=(1, TAG_CONTEXT_SPEC, TAG_EXPLICIT)
    )
    __MeasObjectToAddMod_measObject_measObjectEUTRA = SEQ(
        name="measObjectEUTRA",
        mode=MODE_TYPE,
        tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "MeasObjectEUTRA")),
    )
    __MeasObjectToAddMod_measObject_measObjectUTRA = SEQ(
        name="measObjectUTRA",
        mode=MODE_TYPE,
        tag=(1, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "MeasObjectUTRA")),
    )
    __MeasObjectToAddMod_measObject_measObjectGERAN = SEQ(
        name="measObjectGERAN",
        mode=MODE_TYPE,
        tag=(2, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "MeasObjectGERAN")),
    )
    __MeasObjectToAddMod_measObject_measObjectCDMA2000 = SEQ(
        name="measObjectCDMA2000",
        mode=MODE_TYPE,
        tag=(3, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "MeasObjectCDMA2000")),
    )
    ...
    _MeasObjectUTRA_carrierFreq = INT(
        name="carrierFreq",
        mode=MODE_TYPE,
        tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "ARFCN-ValueUTRA")),
    )
    _MeasObjectUTRA_offsetFreq = INT(
        name="offsetFreq",
        mode=MODE_TYPE,
        tag=(1, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "Q-OffsetRangeInterRAT")),
    ...
    _MeasObjectUTRA_cellsToRemoveList = SEQ_OF(
        name="cellsToRemoveList",
        mode=MODE_TYPE,
        tag=(2, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "CellIndexList")),
    ...
    _MeasObjectUTRA_cellsToAddModList = CHOICE(
        name="cellsToAddModList",
        mode=MODE_TYPE,
        tag=(3, TAG_CONTEXT_SPEC, TAG_EXPLICIT),
        opt=True,
    )
    __MeasObjectUTRA_cellsToAddModList_cellsToAddModListUTRA_FDD = SEQ_OF(
        name="cellsToAddModListUTRA-FDD",
        mode=MODE_TYPE,
        tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "CellsToAddModListUTRA-FDD")),
    )
    __MeasObjectUTRA_cellsToAddModList_cellsToAddModListUTRA_TDD = SEQ_OF(
        name="cellsToAddModListUTRA-TDD",
        mode=MODE_TYPE,
        tag=(1, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "CellsToAddModListUTRA-TDD")),
    )
    ...
    _MeasObjectUTRA_cellForWhichToReportCGI = CHOICE(
        name="cellForWhichToReportCGI",
        mode=MODE_TYPE,
        tag=(4, TAG_CONTEXT_SPEC, TAG_EXPLICIT),
        opt=True,
    )
    __MeasObjectUTRA_cellForWhichToReportCGI_utra_FDD = INT(
        name="utra-FDD",
        mode=MODE_TYPE,
        tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "PhysCellIdUTRA-FDD")),
    )
    __MeasObjectUTRA_cellForWhichToReportCGI_utra_TDD = INT(
        name="utra-TDD",
        mode=MODE_TYPE,
        tag=(1, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "PhysCellIdUTRA-TDD")),
    )
    ...
    _CellsToAddModListUTRA_FDD__item_ = SEQ(
        name="_item_",
        mode=MODE_TYPE,
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "CellsToAddModUTRA-FDD")),
    )
    CellsToAddModListUTRA_FDD._cont = _CellsToAddModListUTRA_FDD__item_
    CellsToAddModListUTRA_FDD._const_sz = ASN1Set(
        rv=[], rr=[ASN1RangeInt(lb=1, ub=32)], ev=None, er=[]
    )

    # -----< CellsToAddModUTRA-FDD >-----#
    CellsToAddModUTRA_FDD = SEQ(name="CellsToAddModUTRA-FDD", mode=MODE_TYPE)
    _CellsToAddModUTRA_FDD_cellIndex = INT(
        name="cellIndex", mode=MODE_TYPE, tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT)
    )
    _CellsToAddModUTRA_FDD_cellIndex._const_val = ASN1Set(
        rv=[], rr=[ASN1RangeInt(lb=1, ub=32)], ev=None, er=[]
    )
    _CellsToAddModUTRA_FDD_physCellId = INT(
        name="physCellId",
        mode=MODE_TYPE,
        tag=(1, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "PhysCellIdUTRA-FDD")),
    ...
    _CellsToAddModListUTRA_TDD__item_ = SEQ(
        name="_item_",
        mode=MODE_TYPE,
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "CellsToAddModUTRA-TDD")),
    )
    CellsToAddModListUTRA_TDD._cont = _CellsToAddModListUTRA_TDD__item_
    CellsToAddModListUTRA_TDD._const_sz = ASN1Set(
        rv=[], rr=[ASN1RangeInt(lb=1, ub=32)], ev=None, er=[]
    )

    # -----< CellsToAddModUTRA-TDD >-----#
    CellsToAddModUTRA_TDD = SEQ(name="CellsToAddModUTRA-TDD", mode=MODE_TYPE)
    _CellsToAddModUTRA_TDD_cellIndex = INT(
        name="cellIndex", mode=MODE_TYPE, tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT)
    )
    _CellsToAddModUTRA_TDD_cellIndex._const_val = ASN1Set(
        rv=[], rr=[ASN1RangeInt(lb=1, ub=32)], ev=None, er=[]
    )
    _CellsToAddModUTRA_TDD_physCellId = INT(
        name="physCellId",
        mode=MODE_TYPE,
        tag=(1, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "PhysCellIdUTRA-TDD")),
    ...
    _MeasResults_measId = INT(
        name="measId",
        mode=MODE_TYPE,
        tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "MeasId")),
    )
    _MeasResults_measResultServCell = SEQ(
        name="measResultServCell",
        mode=MODE_TYPE,
        tag=(1, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
    )
    __MeasResults_measResultServCell_rsrpResult = INT(
        name="rsrpResult",
        mode=MODE_TYPE,
        tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "RSRP-Range")),
    )
    __MeasResults_measResultServCell_rsrqResult = INT(
        name="rsrqResult",
        mode=MODE_TYPE,
        tag=(1, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "RSRQ-Range")),
    )
    ...
    _MeasResults_measResultNeighCells = CHOICE(
        name="measResultNeighCells",
        mode=MODE_TYPE,
        tag=(2, TAG_CONTEXT_SPEC, TAG_EXPLICIT),
        opt=True,
    )
    __MeasResults_measResultNeighCells_measResultListEUTRA = SEQ_OF(
        name="measResultListEUTRA",
        mode=MODE_TYPE,
        tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "MeasResultListEUTRA")),
    )
    __MeasResults_measResultNeighCells_measResultListUTRA = SEQ_OF(
        name="measResultListUTRA",
        mode=MODE_TYPE,
        tag=(1, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "MeasResultListUTRA")),
    )
    __MeasResults_measResultNeighCells_measResultListGERAN = SEQ_OF(
        name="measResultListGERAN",
        mode=MODE_TYPE,
        tag=(2, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "MeasResultListGERAN")),
    )
    __MeasResults_measResultNeighCells_measResultsCDMA2000 = SEQ(
        name="measResultsCDMA2000",
        mode=MODE_TYPE,
        tag=(3, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "MeasResultsCDMA2000")),
    )
    ...
    _MeasResultListEUTRA__item_ = SEQ(
        name="_item_",
        mode=MODE_TYPE,
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "MeasResultEUTRA")),
    )
    MeasResultListEUTRA._cont = _MeasResultListEUTRA__item_
    MeasResultListEUTRA._const_sz = ASN1Set(
        rv=[], rr=[ASN1RangeInt(lb=1, ub=8)], ev=None, er=[]
    )

    # -----< MeasResultEUTRA >-----#
    MeasResultEUTRA = SEQ(name="MeasResultEUTRA", mode=MODE_TYPE)
    _MeasResultEUTRA_physCellId = INT(
        name="physCellId",
        mode=MODE_TYPE,
        tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "PhysCellId")),
    )
    _MeasResultEUTRA_cgi_Info = SEQ(
        name="cgi-Info",
        mode=MODE_TYPE,
        tag=(1, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        opt=True,
    )
    __MeasResultEUTRA_cgi_Info_cellGlobalId = SEQ(
        name="cellGlobalId",
        mode=MODE_TYPE,
        tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "CellGlobalIdEUTRA")),
    )
    __MeasResultEUTRA_cgi_Info_trackingAreaCode = BIT_STR(
        name="trackingAreaCode",
        mode=MODE_TYPE,
        tag=(1, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "TrackingAreaCode")),
    )
    __MeasResultEUTRA_cgi_Info_plmn_IdentityList = SEQ_OF(
        name="plmn-IdentityList",
        mode=MODE_TYPE,
        tag=(2, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "PLMN-IdentityList2")),
        opt=True,
    )
    ...
    _MeasResultEUTRA_measResult = SEQ(
        name="measResult", mode=MODE_TYPE, tag=(2, TAG_CONTEXT_SPEC, TAG_IMPLICIT)
    )
    __MeasResultEUTRA_measResult_rsrpResult = INT(
        name="rsrpResult",
        mode=MODE_TYPE,
        tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "RSRP-Range")),
    ...
    __MeasResultEUTRA_measResult_rsrqResult = INT(
        name="rsrqResult",
        mode=MODE_TYPE,
        tag=(1, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "RSRQ-Range")),
    ...
    _MeasResultListUTRA__item_ = SEQ(
        name="_item_",
        mode=MODE_TYPE,
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "MeasResultUTRA")),
    )
    MeasResultListUTRA._cont = _MeasResultListUTRA__item_
    MeasResultListUTRA._const_sz = ASN1Set(
        rv=[], rr=[ASN1RangeInt(lb=1, ub=8)], ev=None, er=[]
    )

    # -----< MeasResultUTRA >-----#
    MeasResultUTRA = SEQ(name="MeasResultUTRA", mode=MODE_TYPE)
    _MeasResultUTRA_physCellId = CHOICE(
        name="physCellId", mode=MODE_TYPE, tag=(0, TAG_CONTEXT_SPEC, TAG_EXPLICIT)
    )
    __MeasResultUTRA_physCellId_fdd = INT(
        name="fdd",
        mode=MODE_TYPE,
        tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "PhysCellIdUTRA-FDD")),
    )
    __MeasResultUTRA_physCellId_tdd = INT(
        name="tdd",
        mode=MODE_TYPE,
        tag=(1, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "PhysCellIdUTRA-TDD")),
    ...
    _MeasResultUTRA_cgi_Info = SEQ(
        name="cgi-Info",
        mode=MODE_TYPE,
        tag=(1, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        opt=True,
    )
    __MeasResultUTRA_cgi_Info_cellGlobalId = SEQ(
        name="cellGlobalId",
        mode=MODE_TYPE,
        tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "CellGlobalIdUTRA")),
    )
    __MeasResultUTRA_cgi_Info_locationAreaCode = BIT_STR(
        name="locationAreaCode",
        mode=MODE_TYPE,
        tag=(1, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        opt=True,
    )
    __MeasResultUTRA_cgi_Info_locationAreaCode._const_sz = ASN1Set(
        rv=[16], rr=[], ev=None, er=[]
    )
    __MeasResultUTRA_cgi_Info_routingAreaCode = BIT_STR(
        name="routingAreaCode",
        mode=MODE_TYPE,
        tag=(2, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        opt=True,
    )
    __MeasResultUTRA_cgi_Info_routingAreaCode._const_sz = ASN1Set(
        rv=[8], rr=[], ev=None, er=[]
    )
    __MeasResultUTRA_cgi_Info_plmn_IdentityList = SEQ_OF(
        name="plmn-IdentityList",
        mode=MODE_TYPE,
        tag=(3, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "PLMN-IdentityList2")),
    ...
    _MeasResultUTRA_measResult = SEQ(
        name="measResult", mode=MODE_TYPE, tag=(2, TAG_CONTEXT_SPEC, TAG_IMPLICIT)
    )
    __MeasResultUTRA_measResult_utra_RSCP = INT(
        name="utra-RSCP",
        mode=MODE_TYPE,
        tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        opt=True,
    )
    __MeasResultUTRA_measResult_utra_RSCP._const_val = ASN1Set(
        rv=[], rr=[ASN1RangeInt(lb=-5, ub=91)], ev=None, er=[]
    )
    __MeasResultUTRA_measResult_utra_EcN0 = INT(
        name="utra-EcN0",
        mode=MODE_TYPE,
        tag=(1, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        opt=True,
    )
    __MeasResultUTRA_measResult_utra_EcN0._const_val = ASN1Set(
        rv=[], rr=[ASN1RangeInt(lb=0, ub=49)], ev=None, er=[]
    )
    ...
    _MeasResultListGERAN__item_ = SEQ(
        name="_item_",
        mode=MODE_TYPE,
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "MeasResultGERAN")),
    )
    MeasResultListGERAN._cont = _MeasResultListGERAN__item_
    MeasResultListGERAN._const_sz = ASN1Set(
        rv=[], rr=[ASN1RangeInt(lb=1, ub=8)], ev=None, er=[]
    )

    # -----< MeasResultGERAN >-----#
    MeasResultGERAN = SEQ(name="MeasResultGERAN", mode=MODE_TYPE)
    _MeasResultGERAN_carrierFreq = SEQ(
        name="carrierFreq",
        mode=MODE_TYPE,
        tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "CarrierFreqGERAN")),
    )
    _MeasResultGERAN_physCellId = SEQ(
        name="physCellId",
        mode=MODE_TYPE,
        tag=(1, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "PhysCellIdGERAN")),
    )
    _MeasResultGERAN_cgi_Info = SEQ(
        name="cgi-Info",
        mode=MODE_TYPE,
        tag=(2, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        opt=True,
    )
    __MeasResultGERAN_cgi_Info_cellGlobalId = SEQ(
        name="cellGlobalId",
        mode=MODE_TYPE,
        tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "CellGlobalIdGERAN")),
    )
    __MeasResultGERAN_cgi_Info_routingAreaCode = BIT_STR(
        name="routingAreaCode",
        mode=MODE_TYPE,
        tag=(1, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        opt=True,
    )
    __MeasResultGERAN_cgi_Info_routingAreaCode._const_sz = ASN1Set(
        rv=[8], rr=[], ev=None, er=[]
    )
    ...
    _MeasResultGERAN_measResult = SEQ(
        name="measResult", mode=MODE_TYPE, tag=(3, TAG_CONTEXT_SPEC, TAG_IMPLICIT)
    )
    __MeasResultGERAN_measResult_rssi = INT(
        name="rssi", mode=MODE_TYPE, tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT)
    )
    __MeasResultGERAN_measResult_rssi._const_val = ASN1Set(
        rv=[], rr=[ASN1RangeInt(lb=0, ub=63)], ev=None, er=[]
    )
    ...
    _MeasResultsCDMA2000_preRegistrationStatusHRPD = BOOL(
        name="preRegistrationStatusHRPD",
        mode=MODE_TYPE,
        tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
    )
    _MeasResultsCDMA2000_measResultListCDMA2000 = SEQ_OF(
        name="measResultListCDMA2000",
        mode=MODE_TYPE,
        tag=(1, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "MeasResultListCDMA2000")),
    )
    ...
    _MeasResultListCDMA2000__item_ = SEQ(
        name="_item_",
        mode=MODE_TYPE,
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "MeasResultCDMA2000")),
    )
    MeasResultListCDMA2000._cont = _MeasResultListCDMA2000__item_
    MeasResultListCDMA2000._const_sz = ASN1Set(
        rv=[], rr=[ASN1RangeInt(lb=1, ub=8)], ev=None, er=[]
    )

    # -----< MeasResultCDMA2000 >-----#
    MeasResultCDMA2000 = SEQ(name="MeasResultCDMA2000", mode=MODE_TYPE)
    _MeasResultCDMA2000_physCellId = INT(
        name="physCellId",
        mode=MODE_TYPE,
        tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "PhysCellIdCDMA2000")),
    )
    _MeasResultCDMA2000_cgi_Info = CHOICE(
        name="cgi-Info",
        mode=MODE_TYPE,
        tag=(1, TAG_CONTEXT_SPEC, TAG_EXPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "CellGlobalIdCDMA2000")),
        opt=True,
    )
    _MeasResultCDMA2000_measResult = SEQ(
        name="measResult", mode=MODE_TYPE, tag=(2, TAG_CONTEXT_SPEC, TAG_IMPLICIT)
    )
    __MeasResultCDMA2000_measResult_pilotPnPhase = INT(
        name="pilotPnPhase",
        mode=MODE_TYPE,
        tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        opt=True,
    )
    __MeasResultCDMA2000_measResult_pilotPnPhase._const_val = ASN1Set(
        rv=[], rr=[ASN1RangeInt(lb=0, ub=32767)], ev=None, er=[]
    )
    __MeasResultCDMA2000_measResult_pilotStrength = INT(
        name="pilotStrength", mode=MODE_TYPE, tag=(1, TAG_CONTEXT_SPEC, TAG_IMPLICIT)
    )
    __MeasResultCDMA2000_measResult_pilotStrength._const_val = ASN1Set(
        rv=[], rr=[ASN1RangeInt(lb=0, ub=63)], ev=None, er=[]
    )
    ...
    _PLMN_IdentityList2__item_ = SEQ(
        name="_item_",
        mode=MODE_TYPE,
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "PLMN-Identity")),
    )
    PLMN_IdentityList2._cont = _PLMN_IdentityList2__item_
    PLMN_IdentityList2._const_sz = ASN1Set(
        rv=[], rr=[ASN1RangeInt(lb=1, ub=5)], ev=None, er=[]
    )

    # -----< QuantityConfig >-----#
    QuantityConfig = SEQ(name="QuantityConfig", mode=MODE_TYPE)
    _QuantityConfig_quantityConfigEUTRA = SEQ(
        name="quantityConfigEUTRA",
        mode=MODE_TYPE,
        tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "QuantityConfigEUTRA")),
        opt=True,
    )
    _QuantityConfig_quantityConfigUTRA = SEQ(
        name="quantityConfigUTRA",
        mode=MODE_TYPE,
        tag=(1, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "QuantityConfigUTRA")),
        opt=True,
    )
    _QuantityConfig_quantityConfigGERAN = SEQ(
        name="quantityConfigGERAN",
        mode=MODE_TYPE,
        tag=(2, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "QuantityConfigGERAN")),
        opt=True,
    )
    _QuantityConfig_quantityConfigCDMA2000 = SEQ(
        name="quantityConfigCDMA2000",
        mode=MODE_TYPE,
        tag=(3, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "QuantityConfigCDMA2000")),
        opt=True,
    )
    ...
    _QuantityConfigEUTRA_filterCoefficientRSRP = ENUM(
    ...
    _QuantityConfigEUTRA_filterCoefficientRSRQ = ENUM(
    ...
    _QuantityConfigUTRA_measQuantityUTRA_FDD = ENUM(
        name="measQuantityUTRA-FDD",
        mode=MODE_TYPE,
        tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
    )
    _QuantityConfigUTRA_measQuantityUTRA_FDD._cont = ASN1Dict(
        [("cpich-RSCP", 0), ("cpich-EcN0", 1)]
    )
    _QuantityConfigUTRA_measQuantityUTRA_FDD._ext = None
    _QuantityConfigUTRA_measQuantityUTRA_TDD = ENUM(
    ...
    _QuantityConfigUTRA_filterCoefficient = ENUM(
        name="filterCoefficient",
        mode=MODE_TYPE,
        tag=(2, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "FilterCoefficient")),
    ...
    _QuantityConfigGERAN_measQuantityGERAN = ENUM(
    ...
    _QuantityConfigGERAN_filterCoefficient = ENUM(
        name="filterCoefficient",
        mode=MODE_TYPE,
        tag=(1, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "FilterCoefficient")),
    ...
    _QuantityConfigCDMA2000_measQuantityCDMA2000 = ENUM(
        name="measQuantityCDMA2000",
        mode=MODE_TYPE,
        tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
    )
    _QuantityConfigCDMA2000_measQuantityCDMA2000._cont = ASN1Dict(
        [("pilotStrength", 0), ("pilotPnPhaseAndPilotStrength", 1)]
    )
    ...
    _ReportConfigEUTRA_triggerType = CHOICE(
        name="triggerType", mode=MODE_TYPE, tag=(0, TAG_CONTEXT_SPEC, TAG_EXPLICIT)
    )
    __ReportConfigEUTRA_triggerType_event = SEQ(
        name="event", mode=MODE_TYPE, tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT)
    )
    ___ReportConfigEUTRA_triggerType_event_eventId = CHOICE(
        name="eventId", mode=MODE_TYPE, tag=(0, TAG_CONTEXT_SPEC, TAG_EXPLICIT)
    )
    ____ReportConfigEUTRA_triggerType_event_eventId_eventA1 = SEQ(
        name="eventA1", mode=MODE_TYPE, tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT)
    )
    _____ReportConfigEUTRA_triggerType_event_eventId_eventA1_a1_Threshold = CHOICE(
        name="a1-Threshold",
        mode=MODE_TYPE,
        tag=(0, TAG_CONTEXT_SPEC, TAG_EXPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "ThresholdEUTRA")),
    )
    ...
    ____ReportConfigEUTRA_triggerType_event_eventId_eventA2 = SEQ(
        name="eventA2", mode=MODE_TYPE, tag=(1, TAG_CONTEXT_SPEC, TAG_IMPLICIT)
    )
    _____ReportConfigEUTRA_triggerType_event_eventId_eventA2_a2_Threshold = CHOICE(
        name="a2-Threshold",
        mode=MODE_TYPE,
        tag=(0, TAG_CONTEXT_SPEC, TAG_EXPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "ThresholdEUTRA")),
    ...
    ____ReportConfigEUTRA_triggerType_event_eventId_eventA3 = SEQ(
        name="eventA3", mode=MODE_TYPE, tag=(2, TAG_CONTEXT_SPEC, TAG_IMPLICIT)
    )
    _____ReportConfigEUTRA_triggerType_event_eventId_eventA3_a3_Offset = INT(
        name="a3-Offset", mode=MODE_TYPE, tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT)
    )
    _____ReportConfigEUTRA_triggerType_event_eventId_eventA3_a3_Offset._const_val = (
        ASN1Set(rv=[], rr=[ASN1RangeInt(lb=-30, ub=30)], ev=None, er=[])
    )
    _____ReportConfigEUTRA_triggerType_event_eventId_eventA3_reportOnLeave = BOOL(
        name="reportOnLeave", mode=MODE_TYPE, tag=(1, TAG_CONTEXT_SPEC, TAG_IMPLICIT)
    )
    ...
    ____ReportConfigEUTRA_triggerType_event_eventId_eventA4 = SEQ(
        name="eventA4", mode=MODE_TYPE, tag=(3, TAG_CONTEXT_SPEC, TAG_IMPLICIT)
    )
    _____ReportConfigEUTRA_triggerType_event_eventId_eventA4_a4_Threshold = CHOICE(
        name="a4-Threshold",
        mode=MODE_TYPE,
        tag=(0, TAG_CONTEXT_SPEC, TAG_EXPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "ThresholdEUTRA")),
    ...
    ____ReportConfigEUTRA_triggerType_event_eventId_eventA5 = SEQ(
        name="eventA5", mode=MODE_TYPE, tag=(4, TAG_CONTEXT_SPEC, TAG_IMPLICIT)
    )
    _____ReportConfigEUTRA_triggerType_event_eventId_eventA5_a5_Threshold1 = CHOICE(
        name="a5-Threshold1",
        mode=MODE_TYPE,
        tag=(0, TAG_CONTEXT_SPEC, TAG_EXPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "ThresholdEUTRA")),
    )
    _____ReportConfigEUTRA_triggerType_event_eventId_eventA5_a5_Threshold2 = CHOICE(
        name="a5-Threshold2",
        mode=MODE_TYPE,
        tag=(1, TAG_CONTEXT_SPEC, TAG_EXPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "ThresholdEUTRA")),
    ...
    ___ReportConfigEUTRA_triggerType_event_hysteresis = INT(
        name="hysteresis",
        mode=MODE_TYPE,
        tag=(1, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "Hysteresis")),
    )
    ___ReportConfigEUTRA_triggerType_event_timeToTrigger = ENUM(
        name="timeToTrigger",
        mode=MODE_TYPE,
        tag=(2, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "TimeToTrigger")),
    )
    ...
    __ReportConfigEUTRA_triggerType_periodical = SEQ(
        name="periodical", mode=MODE_TYPE, tag=(1, TAG_CONTEXT_SPEC, TAG_IMPLICIT)
    )
    ___ReportConfigEUTRA_triggerType_periodical_purpose = ENUM(
        name="purpose", mode=MODE_TYPE, tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT)
    )
    ___ReportConfigEUTRA_triggerType_periodical_purpose._cont = ASN1Dict(
        [("reportStrongestCells", 0), ("reportCGI", 1)]
    )
    ...
    _ReportConfigEUTRA_triggerQuantity = ENUM(
        name="triggerQuantity", mode=MODE_TYPE, tag=(1, TAG_CONTEXT_SPEC, TAG_IMPLICIT)
    )
    _ReportConfigEUTRA_triggerQuantity._cont = ASN1Dict([("rsrp", 0), ("rsrq", 1)])
    _ReportConfigEUTRA_triggerQuantity._ext = None
    _ReportConfigEUTRA_reportQuantity = ENUM(
        name="reportQuantity", mode=MODE_TYPE, tag=(2, TAG_CONTEXT_SPEC, TAG_IMPLICIT)
    )
    _ReportConfigEUTRA_reportQuantity._cont = ASN1Dict(
        [("sameAsTriggerQuantity", 0), ("both", 1)]
    )
    _ReportConfigEUTRA_reportQuantity._ext = None
    _ReportConfigEUTRA_maxReportCells = INT(
        name="maxReportCells", mode=MODE_TYPE, tag=(3, TAG_CONTEXT_SPEC, TAG_IMPLICIT)
    )
    _ReportConfigEUTRA_maxReportCells._const_val = ASN1Set(
        rv=[], rr=[ASN1RangeInt(lb=1, ub=8)], ev=None, er=[]
    )
    _ReportConfigEUTRA_reportInterval = ENUM(
        name="reportInterval",
        mode=MODE_TYPE,
        tag=(4, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "ReportInterval")),
    )
    _ReportConfigEUTRA_reportAmount = ENUM(
        name="reportAmount", mode=MODE_TYPE, tag=(5, TAG_CONTEXT_SPEC, TAG_IMPLICIT)
    )
    _ReportConfigEUTRA_reportAmount._cont = ASN1Dict(
        [
            ("r1", 0),
            ("r2", 1),
            ("r4", 2),
    ...
    _ThresholdEUTRA_threshold_RSRP = INT(
        name="threshold-RSRP",
        mode=MODE_TYPE,
        tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "RSRP-Range")),
    )
    _ThresholdEUTRA_threshold_RSRQ = INT(
        name="threshold-RSRQ",
        mode=MODE_TYPE,
        tag=(1, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "RSRQ-Range")),
    ...
    ReportConfigId._const_val = ASN1Set(
        rv=[], rr=[ASN1RangeInt(lb=1, ub=32)], ev=None, er=[]
    )

    # -----< ReportConfigInterRAT >-----#
    ReportConfigInterRAT = SEQ(name="ReportConfigInterRAT", mode=MODE_TYPE)
    _ReportConfigInterRAT_triggerType = CHOICE(
        name="triggerType", mode=MODE_TYPE, tag=(0, TAG_CONTEXT_SPEC, TAG_EXPLICIT)
    )
    __ReportConfigInterRAT_triggerType_event = SEQ(
        name="event", mode=MODE_TYPE, tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT)
    )
    ___ReportConfigInterRAT_triggerType_event_eventId = CHOICE(
        name="eventId", mode=MODE_TYPE, tag=(0, TAG_CONTEXT_SPEC, TAG_EXPLICIT)
    )
    ____ReportConfigInterRAT_triggerType_event_eventId_eventB1 = SEQ(
        name="eventB1", mode=MODE_TYPE, tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT)
    )
    _____ReportConfigInterRAT_triggerType_event_eventId_eventB1_b1_Threshold = CHOICE(
        name="b1-Threshold", mode=MODE_TYPE, tag=(0, TAG_CONTEXT_SPEC, TAG_EXPLICIT)
    )
    ______ReportConfigInterRAT_triggerType_event_eventId_eventB1_b1_Threshold_b1_ThresholdUTRA = CHOICE(
        name="b1-ThresholdUTRA",
        mode=MODE_TYPE,
        tag=(0, TAG_CONTEXT_SPEC, TAG_EXPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "ThresholdUTRA")),
    )
    ______ReportConfigInterRAT_triggerType_event_eventId_eventB1_b1_Threshold_b1_ThresholdGERAN = INT(
        name="b1-ThresholdGERAN",
        mode=MODE_TYPE,
        tag=(1, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "ThresholdGERAN")),
    )
    ______ReportConfigInterRAT_triggerType_event_eventId_eventB1_b1_Threshold_b1_ThresholdCDMA2000 = INT(
        name="b1-ThresholdCDMA2000",
        mode=MODE_TYPE,
        tag=(2, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "ThresholdCDMA2000")),
    )
    ...
    ____ReportConfigInterRAT_triggerType_event_eventId_eventB2 = SEQ(
        name="eventB2", mode=MODE_TYPE, tag=(1, TAG_CONTEXT_SPEC, TAG_IMPLICIT)
    )
    _____ReportConfigInterRAT_triggerType_event_eventId_eventB2_b2_Threshold1 = CHOICE(
        name="b2-Threshold1",
        mode=MODE_TYPE,
        tag=(0, TAG_CONTEXT_SPEC, TAG_EXPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "ThresholdEUTRA")),
    )
    _____ReportConfigInterRAT_triggerType_event_eventId_eventB2_b2_Threshold2 = CHOICE(
        name="b2-Threshold2", mode=MODE_TYPE, tag=(1, TAG_CONTEXT_SPEC, TAG_EXPLICIT)
    )
    ______ReportConfigInterRAT_triggerType_event_eventId_eventB2_b2_Threshold2_b2_Threshold2UTRA = CHOICE(
        name="b2-Threshold2UTRA",
        mode=MODE_TYPE,
        tag=(0, TAG_CONTEXT_SPEC, TAG_EXPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "ThresholdUTRA")),
    )
    ______ReportConfigInterRAT_triggerType_event_eventId_eventB2_b2_Threshold2_b2_Threshold2GERAN = INT(
        name="b2-Threshold2GERAN",
        mode=MODE_TYPE,
        tag=(1, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "ThresholdGERAN")),
    )
    ______ReportConfigInterRAT_triggerType_event_eventId_eventB2_b2_Threshold2_b2_Threshold2CDMA2000 = INT(
    ...
    _____ReportConfigInterRAT_triggerType_event_eventId_eventB2_b2_Threshold2._ext = (
        None
    )
    ...
    ___ReportConfigInterRAT_triggerType_event_hysteresis = INT(
        name="hysteresis",
        mode=MODE_TYPE,
        tag=(1, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "Hysteresis")),
    )
    ___ReportConfigInterRAT_triggerType_event_timeToTrigger = ENUM(
        name="timeToTrigger",
        mode=MODE_TYPE,
        tag=(2, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "TimeToTrigger")),
    ...
    __ReportConfigInterRAT_triggerType_periodical = SEQ(
        name="periodical", mode=MODE_TYPE, tag=(1, TAG_CONTEXT_SPEC, TAG_IMPLICIT)
    )
    ___ReportConfigInterRAT_triggerType_periodical_purpose = ENUM(
        name="purpose", mode=MODE_TYPE, tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT)
    )
    ___ReportConfigInterRAT_triggerType_periodical_purpose._cont = ASN1Dict(
        [
    ...
    _ReportConfigInterRAT_maxReportCells = INT(
        name="maxReportCells", mode=MODE_TYPE, tag=(1, TAG_CONTEXT_SPEC, TAG_IMPLICIT)
    )
    _ReportConfigInterRAT_maxReportCells._const_val = ASN1Set(
        rv=[], rr=[ASN1RangeInt(lb=1, ub=8)], ev=None, er=[]
    )
    _ReportConfigInterRAT_reportInterval = ENUM(
        name="reportInterval",
        mode=MODE_TYPE,
        tag=(2, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "ReportInterval")),
    )
    _ReportConfigInterRAT_reportAmount = ENUM(
        name="reportAmount", mode=MODE_TYPE, tag=(3, TAG_CONTEXT_SPEC, TAG_IMPLICIT)
    )
    _ReportConfigInterRAT_reportAmount._cont = ASN1Dict(
        [
            ("r1", 0),
            ("r2", 1),
            ("r4", 2),
    ...
    _ThresholdUTRA_utra_RSCP = INT(
        name="utra-RSCP", mode=MODE_TYPE, tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT)
    )
    _ThresholdUTRA_utra_RSCP._const_val = ASN1Set(
        rv=[], rr=[ASN1RangeInt(lb=-5, ub=91)], ev=None, er=[]
    )
    _ThresholdUTRA_utra_EcN0 = INT(
        name="utra-EcN0", mode=MODE_TYPE, tag=(1, TAG_CONTEXT_SPEC, TAG_IMPLICIT)
    )
    _ThresholdUTRA_utra_EcN0._const_val = ASN1Set(
        rv=[], rr=[ASN1RangeInt(lb=0, ub=49)], ev=None, er=[]
    )
    ...
    ThresholdGERAN._const_val = ASN1Set(
        rv=[], rr=[ASN1RangeInt(lb=0, ub=63)], ev=None, er=[]
    )

    # -----< ThresholdCDMA2000 >-----#
    ThresholdCDMA2000 = INT(name="ThresholdCDMA2000", mode=MODE_TYPE)
    ThresholdCDMA2000._const_val = ASN1Set(
        rv=[], rr=[ASN1RangeInt(lb=0, ub=63)], ev=None, er=[]
    )

    # -----< ReportConfigToAddModList >-----#
    ReportConfigToAddModList = SEQ_OF(name="ReportConfigToAddModList", mode=MODE_TYPE)
    _ReportConfigToAddModList__item_ = SEQ(
        name="_item_",
        mode=MODE_TYPE,
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "ReportConfigToAddMod")),
    )
    ReportConfigToAddModList._cont = _ReportConfigToAddModList__item_
    ReportConfigToAddModList._const_sz = ASN1Set(
        rv=[], rr=[ASN1RangeInt(lb=1, ub=32)], ev=None, er=[]
    )

    # -----< ReportConfigToAddMod >-----#
    ReportConfigToAddMod = SEQ(name="ReportConfigToAddMod", mode=MODE_TYPE)
    _ReportConfigToAddMod_reportConfigId = INT(
        name="reportConfigId",
        mode=MODE_TYPE,
        tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "ReportConfigId")),
    )
    _ReportConfigToAddMod_reportConfig = CHOICE(
        name="reportConfig", mode=MODE_TYPE, tag=(1, TAG_CONTEXT_SPEC, TAG_EXPLICIT)
    )
    __ReportConfigToAddMod_reportConfig_reportConfigEUTRA = SEQ(
        name="reportConfigEUTRA",
        mode=MODE_TYPE,
        tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "ReportConfigEUTRA")),
    )
    __ReportConfigToAddMod_reportConfig_reportConfigInterRAT = SEQ(
        name="reportConfigInterRAT",
        mode=MODE_TYPE,
        tag=(1, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "ReportConfigInterRAT")),
    )
    ...
    RSRP_Range._const_val = ASN1Set(
        rv=[], rr=[ASN1RangeInt(lb=0, ub=97)], ev=None, er=[]
    )

    # -----< RSRQ-Range >-----#
    RSRQ_Range = INT(name="RSRQ-Range", mode=MODE_TYPE)
    RSRQ_Range._const_val = ASN1Set(
        rv=[], rr=[ASN1RangeInt(lb=0, ub=34)], ev=None, er=[]
    )

    # -----< TimeToTrigger >-----#
    TimeToTrigger = ENUM(name="TimeToTrigger", mode=MODE_TYPE)
    TimeToTrigger._cont = ASN1Dict(
        [
            ("ms0", 0),
            ("ms40", 1),
            ("ms64", 2),
    ...
    FilterCoefficient._cont = ASN1Dict(
        [
            ("fc0", 0),
            ("fc1", 1),
            ("fc2", 2),
    ...
    RRC_TransactionIdentifier._const_val = ASN1Set(
        rv=[], rr=[ASN1RangeInt(lb=0, ub=3)], ev=None, er=[]
    )

    # -----< S-TMSI >-----#
    S_TMSI = SEQ(name="S-TMSI", mode=MODE_TYPE)
    _S_TMSI_mmec = BIT_STR(
        name="mmec",
        mode=MODE_TYPE,
        tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "MMEC")),
    )
    _S_TMSI_m_TMSI = BIT_STR(
        name="m-TMSI", mode=MODE_TYPE, tag=(1, TAG_CONTEXT_SPEC, TAG_IMPLICIT)
    )
    ...
    # -----< UE-CapabilityRAT-ContainerList >-----#
    UE_CapabilityRAT_ContainerList = SEQ_OF(
        name="UE-CapabilityRAT-ContainerList", mode=MODE_TYPE
    )
    _UE_CapabilityRAT_ContainerList__item_ = SEQ(
        name="_item_",
        mode=MODE_TYPE,
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "UE-CapabilityRAT-Container")),
    )
    UE_CapabilityRAT_ContainerList._cont = _UE_CapabilityRAT_ContainerList__item_
    UE_CapabilityRAT_ContainerList._const_sz = ASN1Set(
        rv=[], rr=[ASN1RangeInt(lb=0, ub=8)], ev=None, er=[]
    )

    # -----< UE-CapabilityRAT-Container >-----#
    UE_CapabilityRAT_Container = SEQ(name="UE-CapabilityRAT-Container", mode=MODE_TYPE)
    _UE_CapabilityRAT_Container_rat_Type = ENUM(
        name="rat-Type",
        mode=MODE_TYPE,
        tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "RAT-Type")),
    )
    _UE_CapabilityRAT_Container_ueCapabilityRAT_Container = OCT_STR(
    ...
    _UE_EUTRA_Capability_accessStratumRelease = ENUM(
        name="accessStratumRelease",
        mode=MODE_TYPE,
        tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "AccessStratumRelease")),
    )
    _UE_EUTRA_Capability_ue_Category = INT(
        name="ue-Category", mode=MODE_TYPE, tag=(1, TAG_CONTEXT_SPEC, TAG_IMPLICIT)
    )
    _UE_EUTRA_Capability_ue_Category._const_val = ASN1Set(
        rv=[], rr=[ASN1RangeInt(lb=1, ub=5)], ev=None, er=[]
    )
    _UE_EUTRA_Capability_pdcp_Parameters = SEQ(
        name="pdcp-Parameters",
        mode=MODE_TYPE,
        tag=(2, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "PDCP-Parameters")),
    )
    _UE_EUTRA_Capability_phyLayerParameters = SEQ(
        name="phyLayerParameters",
        mode=MODE_TYPE,
        tag=(3, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "PhyLayerParameters")),
    )
    _UE_EUTRA_Capability_rf_Parameters = SEQ(
        name="rf-Parameters",
        mode=MODE_TYPE,
        tag=(4, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "RF-Parameters")),
    )
    _UE_EUTRA_Capability_measParameters = SEQ(
        name="measParameters",
        mode=MODE_TYPE,
        tag=(5, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "MeasParameters")),
    )
    _UE_EUTRA_Capability_featureGroupIndicators = BIT_STR(
        name="featureGroupIndicators",
        mode=MODE_TYPE,
        tag=(6, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        opt=True,
    )
    _UE_EUTRA_Capability_featureGroupIndicators._const_sz = ASN1Set(
        rv=[32], rr=[], ev=None, er=[]
    )
    _UE_EUTRA_Capability_interRAT_Parameters = SEQ(
        name="interRAT-Parameters",
        mode=MODE_TYPE,
        tag=(7, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
    )
    __UE_EUTRA_Capability_interRAT_Parameters_utraFDD = SEQ(
        name="utraFDD",
        mode=MODE_TYPE,
        tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "IRAT-ParametersUTRA-FDD")),
        opt=True,
    )
    __UE_EUTRA_Capability_interRAT_Parameters_utraTDD128 = SEQ(
        name="utraTDD128",
        mode=MODE_TYPE,
        tag=(1, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "IRAT-ParametersUTRA-TDD128")),
        opt=True,
    )
    __UE_EUTRA_Capability_interRAT_Parameters_utraTDD384 = SEQ(
        name="utraTDD384",
        mode=MODE_TYPE,
        tag=(2, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "IRAT-ParametersUTRA-TDD384")),
        opt=True,
    )
    __UE_EUTRA_Capability_interRAT_Parameters_utraTDD768 = SEQ(
        name="utraTDD768",
        mode=MODE_TYPE,
        tag=(3, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "IRAT-ParametersUTRA-TDD768")),
        opt=True,
    )
    __UE_EUTRA_Capability_interRAT_Parameters_geran = SEQ(
        name="geran",
        mode=MODE_TYPE,
        tag=(4, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "IRAT-ParametersGERAN")),
        opt=True,
    )
    __UE_EUTRA_Capability_interRAT_Parameters_cdma2000_HRPD = SEQ(
        name="cdma2000-HRPD",
        mode=MODE_TYPE,
        tag=(5, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "IRAT-ParametersCDMA2000-HRPD")),
        opt=True,
    )
    __UE_EUTRA_Capability_interRAT_Parameters_cdma2000_1xRTT = SEQ(
        name="cdma2000-1xRTT",
        mode=MODE_TYPE,
        tag=(6, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "IRAT-ParametersCDMA2000-1XRTT")),
        opt=True,
    )
    ...
    _UE_EUTRA_Capability_nonCriticalExtension = SEQ(
        name="nonCriticalExtension",
        mode=MODE_TYPE,
        tag=(8, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        opt=True,
    ...
    AccessStratumRelease._cont = ASN1Dict(
        [
            ("rel8", 0),
            ("spare7", 1),
            ("spare6", 2),
    ...
    _PDCP_Parameters_supportedROHC_Profiles = SEQ(
        name="supportedROHC-Profiles",
        mode=MODE_TYPE,
        tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
    )
    __PDCP_Parameters_supportedROHC_Profiles_profile0x0001 = BOOL(
        name="profile0x0001", mode=MODE_TYPE, tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT)
    )
    __PDCP_Parameters_supportedROHC_Profiles_profile0x0002 = BOOL(
        name="profile0x0002", mode=MODE_TYPE, tag=(1, TAG_CONTEXT_SPEC, TAG_IMPLICIT)
    )
    __PDCP_Parameters_supportedROHC_Profiles_profile0x0003 = BOOL(
        name="profile0x0003", mode=MODE_TYPE, tag=(2, TAG_CONTEXT_SPEC, TAG_IMPLICIT)
    )
    __PDCP_Parameters_supportedROHC_Profiles_profile0x0004 = BOOL(
        name="profile0x0004", mode=MODE_TYPE, tag=(3, TAG_CONTEXT_SPEC, TAG_IMPLICIT)
    )
    __PDCP_Parameters_supportedROHC_Profiles_profile0x0006 = BOOL(
        name="profile0x0006", mode=MODE_TYPE, tag=(4, TAG_CONTEXT_SPEC, TAG_IMPLICIT)
    )
    __PDCP_Parameters_supportedROHC_Profiles_profile0x0101 = BOOL(
        name="profile0x0101", mode=MODE_TYPE, tag=(5, TAG_CONTEXT_SPEC, TAG_IMPLICIT)
    )
    __PDCP_Parameters_supportedROHC_Profiles_profile0x0102 = BOOL(
        name="profile0x0102", mode=MODE_TYPE, tag=(6, TAG_CONTEXT_SPEC, TAG_IMPLICIT)
    )
    __PDCP_Parameters_supportedROHC_Profiles_profile0x0103 = BOOL(
        name="profile0x0103", mode=MODE_TYPE, tag=(7, TAG_CONTEXT_SPEC, TAG_IMPLICIT)
    )
    __PDCP_Parameters_supportedROHC_Profiles_profile0x0104 = BOOL(
        name="profile0x0104", mode=MODE_TYPE, tag=(8, TAG_CONTEXT_SPEC, TAG_IMPLICIT)
    )
    ...
    _PDCP_Parameters_maxNumberROHC_ContextSessions = ENUM(
        name="maxNumberROHC-ContextSessions",
        mode=MODE_TYPE,
        tag=(1, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        default="cs16",
    )
    _PDCP_Parameters_maxNumberROHC_ContextSessions._cont = ASN1Dict(
        [
            ("cs2", 0),
            ("cs4", 1),
            ("cs8", 2),
    ...
    _PhyLayerParameters_ue_TxAntennaSelectionSupported = BOOL(
        name="ue-TxAntennaSelectionSupported",
        mode=MODE_TYPE,
        tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
    )
    _PhyLayerParameters_ue_SpecificRefSigsSupported = BOOL(
    ...
    _RF_Parameters_supportedBandListEUTRA = SEQ_OF(
        name="supportedBandListEUTRA",
        mode=MODE_TYPE,
        tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "SupportedBandListEUTRA")),
    )
    ...
    _SupportedBandListEUTRA__item_ = SEQ(
        name="_item_",
        mode=MODE_TYPE,
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "SupportedBandEUTRA")),
    )
    SupportedBandListEUTRA._cont = _SupportedBandListEUTRA__item_
    SupportedBandListEUTRA._const_sz = ASN1Set(
        rv=[], rr=[ASN1RangeInt(lb=1, ub=64)], ev=None, er=[]
    )

    # -----< SupportedBandEUTRA >-----#
    SupportedBandEUTRA = SEQ(name="SupportedBandEUTRA", mode=MODE_TYPE)
    _SupportedBandEUTRA_bandEUTRA = INT(
        name="bandEUTRA", mode=MODE_TYPE, tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT)
    )
    _SupportedBandEUTRA_bandEUTRA._const_val = ASN1Set(
        rv=[], rr=[ASN1RangeInt(lb=1, ub=64)], ev=None, er=[]
    )
    _SupportedBandEUTRA_halfDuplex = BOOL(
        name="halfDuplex", mode=MODE_TYPE, tag=(1, TAG_CONTEXT_SPEC, TAG_IMPLICIT)
    )
    ...
    _MeasParameters_bandListEUTRA = SEQ_OF(
        name="bandListEUTRA",
        mode=MODE_TYPE,
        tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "BandListEUTRA")),
    )
    ...
    _BandListEUTRA__item_ = SEQ(
        name="_item_",
        mode=MODE_TYPE,
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "BandInfoEUTRA")),
    )
    BandListEUTRA._cont = _BandListEUTRA__item_
    BandListEUTRA._const_sz = ASN1Set(
        rv=[], rr=[ASN1RangeInt(lb=1, ub=64)], ev=None, er=[]
    )

    # -----< BandInfoEUTRA >-----#
    BandInfoEUTRA = SEQ(name="BandInfoEUTRA", mode=MODE_TYPE)
    _BandInfoEUTRA_interFreqBandList = SEQ_OF(
        name="interFreqBandList",
        mode=MODE_TYPE,
        tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "InterFreqBandList")),
    )
    _BandInfoEUTRA_interRAT_BandList = SEQ_OF(
        name="interRAT-BandList",
        mode=MODE_TYPE,
        tag=(1, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "InterRAT-BandList")),
        opt=True,
    )
    ...
    _InterFreqBandList__item_ = SEQ(
        name="_item_",
        mode=MODE_TYPE,
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "InterFreqBandInfo")),
    )
    InterFreqBandList._cont = _InterFreqBandList__item_
    InterFreqBandList._const_sz = ASN1Set(
        rv=[], rr=[ASN1RangeInt(lb=1, ub=64)], ev=None, er=[]
    )

    # -----< InterFreqBandInfo >-----#
    InterFreqBandInfo = SEQ(name="InterFreqBandInfo", mode=MODE_TYPE)
    _InterFreqBandInfo_interFreqNeedForGaps = BOOL(
        name="interFreqNeedForGaps",
        mode=MODE_TYPE,
        tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
    )
    ...
    _InterRAT_BandList__item_ = SEQ(
        name="_item_",
        mode=MODE_TYPE,
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "InterRAT-BandInfo")),
    )
    InterRAT_BandList._cont = _InterRAT_BandList__item_
    InterRAT_BandList._const_sz = ASN1Set(
        rv=[], rr=[ASN1RangeInt(lb=1, ub=64)], ev=None, er=[]
    )

    # -----< InterRAT-BandInfo >-----#
    InterRAT_BandInfo = SEQ(name="InterRAT-BandInfo", mode=MODE_TYPE)
    _InterRAT_BandInfo_interRAT_NeedForGaps = BOOL(
        name="interRAT-NeedForGaps",
        mode=MODE_TYPE,
        tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
    )
    ...
    _IRAT_ParametersUTRA_FDD_supportedBandListUTRA_FDD = SEQ_OF(
        name="supportedBandListUTRA-FDD",
        mode=MODE_TYPE,
        tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "SupportedBandListUTRA-FDD")),
    )
    ...
    _SupportedBandListUTRA_FDD__item_ = ENUM(
        name="_item_",
        mode=MODE_TYPE,
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "SupportedBandUTRA-FDD")),
    )
    SupportedBandListUTRA_FDD._cont = _SupportedBandListUTRA_FDD__item_
    SupportedBandListUTRA_FDD._const_sz = ASN1Set(
        rv=[], rr=[ASN1RangeInt(lb=1, ub=64)], ev=None, er=[]
    )

    # -----< SupportedBandUTRA-FDD >-----#
    SupportedBandUTRA_FDD = ENUM(name="SupportedBandUTRA-FDD", mode=MODE_TYPE)
    SupportedBandUTRA_FDD._cont = ASN1Dict(
        [
            ("bandI", 0),
            ("bandII", 1),
            ("bandIII", 2),
    ...
    _IRAT_ParametersUTRA_TDD128_supportedBandListUTRA_TDD128 = SEQ_OF(
        name="supportedBandListUTRA-TDD128",
        mode=MODE_TYPE,
        tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "SupportedBandListUTRA-TDD128")),
    )
    ...
    # -----< SupportedBandListUTRA-TDD128 >-----#
    SupportedBandListUTRA_TDD128 = SEQ_OF(
        name="SupportedBandListUTRA-TDD128", mode=MODE_TYPE
    )
    _SupportedBandListUTRA_TDD128__item_ = ENUM(
        name="_item_",
        mode=MODE_TYPE,
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "SupportedBandUTRA-TDD128")),
    )
    SupportedBandListUTRA_TDD128._cont = _SupportedBandListUTRA_TDD128__item_
    SupportedBandListUTRA_TDD128._const_sz = ASN1Set(
        rv=[], rr=[ASN1RangeInt(lb=1, ub=64)], ev=None, er=[]
    )

    # -----< SupportedBandUTRA-TDD128 >-----#
    SupportedBandUTRA_TDD128 = ENUM(name="SupportedBandUTRA-TDD128", mode=MODE_TYPE)
    SupportedBandUTRA_TDD128._cont = ASN1Dict(
        [
            ("a", 0),
            ("b", 1),
            ("c", 2),
    ...
    _IRAT_ParametersUTRA_TDD384_supportedBandListUTRA_TDD384 = SEQ_OF(
        name="supportedBandListUTRA-TDD384",
        mode=MODE_TYPE,
        tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "SupportedBandListUTRA-TDD384")),
    )
    ...
    # -----< SupportedBandListUTRA-TDD384 >-----#
    SupportedBandListUTRA_TDD384 = SEQ_OF(
        name="SupportedBandListUTRA-TDD384", mode=MODE_TYPE
    )
    _SupportedBandListUTRA_TDD384__item_ = ENUM(
        name="_item_",
        mode=MODE_TYPE,
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "SupportedBandUTRA-TDD384")),
    )
    SupportedBandListUTRA_TDD384._cont = _SupportedBandListUTRA_TDD384__item_
    SupportedBandListUTRA_TDD384._const_sz = ASN1Set(
        rv=[], rr=[ASN1RangeInt(lb=1, ub=64)], ev=None, er=[]
    )

    # -----< SupportedBandUTRA-TDD384 >-----#
    SupportedBandUTRA_TDD384 = ENUM(name="SupportedBandUTRA-TDD384", mode=MODE_TYPE)
    SupportedBandUTRA_TDD384._cont = ASN1Dict(
        [
            ("a", 0),
            ("b", 1),
            ("c", 2),
    ...
    _IRAT_ParametersUTRA_TDD768_supportedBandListUTRA_TDD768 = SEQ_OF(
        name="supportedBandListUTRA-TDD768",
        mode=MODE_TYPE,
        tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "SupportedBandListUTRA-TDD768")),
    )
    ...
    # -----< SupportedBandListUTRA-TDD768 >-----#
    SupportedBandListUTRA_TDD768 = SEQ_OF(
        name="SupportedBandListUTRA-TDD768", mode=MODE_TYPE
    )
    _SupportedBandListUTRA_TDD768__item_ = ENUM(
        name="_item_",
        mode=MODE_TYPE,
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "SupportedBandUTRA-TDD768")),
    )
    SupportedBandListUTRA_TDD768._cont = _SupportedBandListUTRA_TDD768__item_
    SupportedBandListUTRA_TDD768._const_sz = ASN1Set(
        rv=[], rr=[ASN1RangeInt(lb=1, ub=64)], ev=None, er=[]
    )

    # -----< SupportedBandUTRA-TDD768 >-----#
    SupportedBandUTRA_TDD768 = ENUM(name="SupportedBandUTRA-TDD768", mode=MODE_TYPE)
    SupportedBandUTRA_TDD768._cont = ASN1Dict(
        [
            ("a", 0),
            ("b", 1),
            ("c", 2),
    ...
    _IRAT_ParametersGERAN_supportedBandListGERAN = SEQ_OF(
        name="supportedBandListGERAN",
        mode=MODE_TYPE,
        tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "SupportedBandListGERAN")),
    )
    _IRAT_ParametersGERAN_interRAT_PS_HO_ToGERAN = BOOL(
    ...
    _SupportedBandListGERAN__item_ = ENUM(
        name="_item_",
        mode=MODE_TYPE,
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "SupportedBandGERAN")),
    )
    SupportedBandListGERAN._cont = _SupportedBandListGERAN__item_
    SupportedBandListGERAN._const_sz = ASN1Set(
        rv=[], rr=[ASN1RangeInt(lb=1, ub=64)], ev=None, er=[]
    )

    # -----< SupportedBandGERAN >-----#
    SupportedBandGERAN = ENUM(name="SupportedBandGERAN", mode=MODE_TYPE)
    SupportedBandGERAN._cont = ASN1Dict(
        [
            ("gsm450", 0),
            ("gsm480", 1),
            ("gsm710", 2),
    ...
    # -----< IRAT-ParametersCDMA2000-HRPD >-----#
    IRAT_ParametersCDMA2000_HRPD = SEQ(
        name="IRAT-ParametersCDMA2000-HRPD", mode=MODE_TYPE
    )
    _IRAT_ParametersCDMA2000_HRPD_supportedBandListHRPD = SEQ_OF(
        name="supportedBandListHRPD",
        mode=MODE_TYPE,
        tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "SupportedBandListHRPD")),
    )
    _IRAT_ParametersCDMA2000_HRPD_tx_ConfigHRPD = ENUM(
        name="tx-ConfigHRPD", mode=MODE_TYPE, tag=(1, TAG_CONTEXT_SPEC, TAG_IMPLICIT)
    )
    _IRAT_ParametersCDMA2000_HRPD_tx_ConfigHRPD._cont = ASN1Dict(
        [("single", 0), ("dual", 1)]
    )
    _IRAT_ParametersCDMA2000_HRPD_tx_ConfigHRPD._ext = None
    _IRAT_ParametersCDMA2000_HRPD_rx_ConfigHRPD = ENUM(
        name="rx-ConfigHRPD", mode=MODE_TYPE, tag=(2, TAG_CONTEXT_SPEC, TAG_IMPLICIT)
    )
    _IRAT_ParametersCDMA2000_HRPD_rx_ConfigHRPD._cont = ASN1Dict(
        [("single", 0), ("dual", 1)]
    )
    ...
    _SupportedBandListHRPD__item_ = ENUM(
        name="_item_",
        mode=MODE_TYPE,
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "BandclassCDMA2000")),
    )
    SupportedBandListHRPD._cont = _SupportedBandListHRPD__item_
    SupportedBandListHRPD._const_sz = ASN1Set(
        rv=[], rr=[ASN1RangeInt(lb=1, ub=32)], ev=None, er=[]
    )

    # -----< IRAT-ParametersCDMA2000-1XRTT >-----#
    IRAT_ParametersCDMA2000_1XRTT = SEQ(
        name="IRAT-ParametersCDMA2000-1XRTT", mode=MODE_TYPE
    )
    _IRAT_ParametersCDMA2000_1XRTT_supportedBandList1XRTT = SEQ_OF(
        name="supportedBandList1XRTT",
        mode=MODE_TYPE,
        tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "SupportedBandList1XRTT")),
    )
    _IRAT_ParametersCDMA2000_1XRTT_tx_Config1XRTT = ENUM(
        name="tx-Config1XRTT", mode=MODE_TYPE, tag=(1, TAG_CONTEXT_SPEC, TAG_IMPLICIT)
    )
    _IRAT_ParametersCDMA2000_1XRTT_tx_Config1XRTT._cont = ASN1Dict(
        [("single", 0), ("dual", 1)]
    )
    _IRAT_ParametersCDMA2000_1XRTT_tx_Config1XRTT._ext = None
    _IRAT_ParametersCDMA2000_1XRTT_rx_Config1XRTT = ENUM(
        name="rx-Config1XRTT", mode=MODE_TYPE, tag=(2, TAG_CONTEXT_SPEC, TAG_IMPLICIT)
    )
    _IRAT_ParametersCDMA2000_1XRTT_rx_Config1XRTT._cont = ASN1Dict(
        [("single", 0), ("dual", 1)]
    )
    ...
    _SupportedBandList1XRTT__item_ = ENUM(
        name="_item_",
        mode=MODE_TYPE,
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "BandclassCDMA2000")),
    )
    SupportedBandList1XRTT._cont = _SupportedBandList1XRTT__item_
    SupportedBandList1XRTT._const_sz = ASN1Set(
        rv=[], rr=[ASN1RangeInt(lb=1, ub=32)], ev=None, er=[]
    )

    # -----< UE-TimersAndConstants >-----#
    UE_TimersAndConstants = SEQ(name="UE-TimersAndConstants", mode=MODE_TYPE)
    _UE_TimersAndConstants_t300 = ENUM(
        name="t300", mode=MODE_TYPE, tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT)
    )
    _UE_TimersAndConstants_t300._cont = ASN1Dict(
        [
            ("ms100", 0),
            ("ms200", 1),
            ("ms300", 2),
    ...
    _UE_TimersAndConstants_t301 = ENUM(
        name="t301", mode=MODE_TYPE, tag=(1, TAG_CONTEXT_SPEC, TAG_IMPLICIT)
    )
    _UE_TimersAndConstants_t301._cont = ASN1Dict(
        [
            ("ms100", 0),
            ("ms200", 1),
            ("ms300", 2),
    ...
    _UE_TimersAndConstants_t310 = ENUM(
        name="t310", mode=MODE_TYPE, tag=(2, TAG_CONTEXT_SPEC, TAG_IMPLICIT)
    )
    _UE_TimersAndConstants_t310._cont = ASN1Dict(
        [
            ("ms0", 0),
            ("ms50", 1),
            ("ms100", 2),
    ...
    _UE_TimersAndConstants_n310 = ENUM(
        name="n310", mode=MODE_TYPE, tag=(3, TAG_CONTEXT_SPEC, TAG_IMPLICIT)
    )
    _UE_TimersAndConstants_n310._cont = ASN1Dict(
        [
            ("n1", 0),
            ("n2", 1),
            ("n3", 2),
    ...
    _UE_TimersAndConstants_t311 = ENUM(
        name="t311", mode=MODE_TYPE, tag=(4, TAG_CONTEXT_SPEC, TAG_IMPLICIT)
    )
    _UE_TimersAndConstants_t311._cont = ASN1Dict(
        [
            ("ms1000", 0),
            ("ms3000", 1),
            ("ms5000", 2),
    ...
    _UE_TimersAndConstants_n311 = ENUM(
        name="n311", mode=MODE_TYPE, tag=(5, TAG_CONTEXT_SPEC, TAG_IMPLICIT)
    )
    _UE_TimersAndConstants_n311._cont = ASN1Dict(
        [
            ("n1", 0),
            ("n2", 1),
            ("n3", 2),
...
class EUTRA_UE_Variables:
    ...
    _VarMeasConfig_measIdList = SEQ_OF(
        name="measIdList",
        mode=MODE_TYPE,
        tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "MeasIdToAddModList")),
    ...
    _VarMeasConfig_measObjectList = SEQ_OF(
        name="measObjectList",
        mode=MODE_TYPE,
        tag=(1, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "MeasObjectToAddModList")),
    ...
    _VarMeasConfig_reportConfigList = SEQ_OF(
    ...
    _VarMeasConfig_quantityConfig = SEQ(
        name="quantityConfig",
        mode=MODE_TYPE,
        tag=(3, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "QuantityConfig")),
    ...
    _VarMeasConfig_speedStatePars = CHOICE(
        name="speedStatePars",
        mode=MODE_TYPE,
        tag=(5, TAG_CONTEXT_SPEC, TAG_EXPLICIT),
        opt=True,
    )
    __VarMeasConfig_speedStatePars_release = NULL(
        name="release", mode=MODE_TYPE, tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT)
    )
    __VarMeasConfig_speedStatePars_setup = SEQ(
        name="setup", mode=MODE_TYPE, tag=(1, TAG_CONTEXT_SPEC, TAG_IMPLICIT)
    )
    ___VarMeasConfig_speedStatePars_setup_mobilityStateParameters = SEQ(
        name="mobilityStateParameters",
        mode=MODE_TYPE,
        tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "MobilityStateParameters")),
    )
    ___VarMeasConfig_speedStatePars_setup_timeToTrigger_SF = SEQ(
        name="timeToTrigger-SF",
        mode=MODE_TYPE,
        tag=(1, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "SpeedStateScaleFactors")),
    ...
    _VarMeasReportList__item_ = SEQ(
        name="_item_",
        mode=MODE_TYPE,
        typeref=ASN1RefType(("EUTRA-UE-Variables", "VarMeasReport")),
    )
    VarMeasReportList._cont = _VarMeasReportList__item_
    VarMeasReportList._const_sz = ASN1Set(
        rv=[], rr=[ASN1RangeInt(lb=1, ub=32)], ev=None, er=[]
    )

    # -----< VarMeasReport >-----#
    VarMeasReport = SEQ(name="VarMeasReport", mode=MODE_TYPE)
    _VarMeasReport_measId = INT(
        name="measId",
        mode=MODE_TYPE,
        tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "MeasId")),
    )
    _VarMeasReport_cellsTriggeredList = SEQ_OF(
        name="cellsTriggeredList",
        mode=MODE_TYPE,
        tag=(1, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(("EUTRA-UE-Variables", "CellsTriggeredList")),
        opt=True,
    )
    _VarMeasReport_numberOfReportsSent = INT(
    ...
    _CellsTriggeredList__item_ = INT(
        name="_item_",
        mode=MODE_TYPE,
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "PhysCellId")),
    )
    CellsTriggeredList._cont = _CellsTriggeredList__item_
    CellsTriggeredList._const_sz = ASN1Set(
        rv=[], rr=[ASN1RangeInt(lb=1, ub=32)], ev=None, er=[]
    )

    # -----< VarShortMAC-Input >-----#
    VarShortMAC_Input = SEQ(name="VarShortMAC-Input", mode=MODE_TYPE)
    _VarShortMAC_Input_cellIdentity = BIT_STR(
        name="cellIdentity",
        mode=MODE_TYPE,
        tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "CellIdentity")),
    )
    _VarShortMAC_Input_physCellId = INT(
        name="physCellId",
        mode=MODE_TYPE,
        tag=(1, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "PhysCellId")),
    )
    _VarShortMAC_Input_c_RNTI = BIT_STR(
        name="c-RNTI",
        mode=MODE_TYPE,
        tag=(2, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "C-RNTI")),
...
class EUTRA_InterNodeDefinitions:
    ...
    _HandoverCommand_criticalExtensions = CHOICE(
        name="criticalExtensions",
        mode=MODE_TYPE,
        tag=(0, TAG_CONTEXT_SPEC, TAG_EXPLICIT),
    )
    __HandoverCommand_criticalExtensions_c1 = CHOICE(
        name="c1", mode=MODE_TYPE, tag=(0, TAG_CONTEXT_SPEC, TAG_EXPLICIT)
    )
    ___HandoverCommand_criticalExtensions_c1_handoverCommand_r8 = SEQ(
        name="handoverCommand-r8",
        mode=MODE_TYPE,
        tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(("EUTRA-InterNodeDefinitions", "HandoverCommand-r8-IEs")),
    )
    ___HandoverCommand_criticalExtensions_c1_spare7 = NULL(
        name="spare7", mode=MODE_TYPE, tag=(1, TAG_CONTEXT_SPEC, TAG_IMPLICIT)
    )
    ___HandoverCommand_criticalExtensions_c1_spare6 = NULL(
        name="spare6", mode=MODE_TYPE, tag=(2, TAG_CONTEXT_SPEC, TAG_IMPLICIT)
    )
    ___HandoverCommand_criticalExtensions_c1_spare5 = NULL(
        name="spare5", mode=MODE_TYPE, tag=(3, TAG_CONTEXT_SPEC, TAG_IMPLICIT)
    )
    ___HandoverCommand_criticalExtensions_c1_spare4 = NULL(
        name="spare4", mode=MODE_TYPE, tag=(4, TAG_CONTEXT_SPEC, TAG_IMPLICIT)
    )
    ___HandoverCommand_criticalExtensions_c1_spare3 = NULL(
        name="spare3", mode=MODE_TYPE, tag=(5, TAG_CONTEXT_SPEC, TAG_IMPLICIT)
    )
    ___HandoverCommand_criticalExtensions_c1_spare2 = NULL(
        name="spare2", mode=MODE_TYPE, tag=(6, TAG_CONTEXT_SPEC, TAG_IMPLICIT)
    )
    ___HandoverCommand_criticalExtensions_c1_spare1 = NULL(
        name="spare1", mode=MODE_TYPE, tag=(7, TAG_CONTEXT_SPEC, TAG_IMPLICIT)
    )
    ...
    __HandoverCommand_criticalExtensions_criticalExtensionsFuture = SEQ(
        name="criticalExtensionsFuture",
        mode=MODE_TYPE,
        tag=(1, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
    )
    ...
    _HandoverCommand_r8_IEs_handoverCommandMessage = OCT_STR(
        name="handoverCommandMessage",
        mode=MODE_TYPE,
        tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
    )
    __HandoverCommand_r8_IEs_handoverCommandMessage_contain = SEQ(
        name="_cont_handoverCommandMessage",
        mode=MODE_TYPE,
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "DL-DCCH-Message")),
    )
    _HandoverCommand_r8_IEs_handoverCommandMessage._const_cont = (
        __HandoverCommand_r8_IEs_handoverCommandMessage_contain
    )
    _HandoverCommand_r8_IEs_nonCriticalExtension = SEQ(
        name="nonCriticalExtension",
        mode=MODE_TYPE,
        tag=(1, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        opt=True,
    ...
    # -----< HandoverPreparationInformation >-----#
    HandoverPreparationInformation = SEQ(
        name="HandoverPreparationInformation", mode=MODE_TYPE
    )
    _HandoverPreparationInformation_criticalExtensions = CHOICE(
        name="criticalExtensions",
        mode=MODE_TYPE,
        tag=(0, TAG_CONTEXT_SPEC, TAG_EXPLICIT),
    )
    __HandoverPreparationInformation_criticalExtensions_c1 = CHOICE(
        name="c1", mode=MODE_TYPE, tag=(0, TAG_CONTEXT_SPEC, TAG_EXPLICIT)
    )
    ___HandoverPreparationInformation_criticalExtensions_c1_handoverPreparationInformation_r8 = SEQ(
        name="handoverPreparationInformation-r8",
        mode=MODE_TYPE,
        tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(
            ("EUTRA-InterNodeDefinitions", "HandoverPreparationInformation-r8-IEs")
        ),
    )
    ___HandoverPreparationInformation_criticalExtensions_c1_spare7 = NULL(
        name="spare7", mode=MODE_TYPE, tag=(1, TAG_CONTEXT_SPEC, TAG_IMPLICIT)
    )
    ___HandoverPreparationInformation_criticalExtensions_c1_spare6 = NULL(
        name="spare6", mode=MODE_TYPE, tag=(2, TAG_CONTEXT_SPEC, TAG_IMPLICIT)
    )
    ___HandoverPreparationInformation_criticalExtensions_c1_spare5 = NULL(
        name="spare5", mode=MODE_TYPE, tag=(3, TAG_CONTEXT_SPEC, TAG_IMPLICIT)
    )
    ___HandoverPreparationInformation_criticalExtensions_c1_spare4 = NULL(
        name="spare4", mode=MODE_TYPE, tag=(4, TAG_CONTEXT_SPEC, TAG_IMPLICIT)
    )
    ___HandoverPreparationInformation_criticalExtensions_c1_spare3 = NULL(
        name="spare3", mode=MODE_TYPE, tag=(5, TAG_CONTEXT_SPEC, TAG_IMPLICIT)
    )
    ___HandoverPreparationInformation_criticalExtensions_c1_spare2 = NULL(
        name="spare2", mode=MODE_TYPE, tag=(6, TAG_CONTEXT_SPEC, TAG_IMPLICIT)
    )
    ___HandoverPreparationInformation_criticalExtensions_c1_spare1 = NULL(
        name="spare1", mode=MODE_TYPE, tag=(7, TAG_CONTEXT_SPEC, TAG_IMPLICIT)
    )
    ...
    __HandoverPreparationInformation_criticalExtensions_criticalExtensionsFuture = SEQ(
        name="criticalExtensionsFuture",
        mode=MODE_TYPE,
        tag=(1, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
    )
    ...
    # -----< HandoverPreparationInformation-r8-IEs >-----#
    HandoverPreparationInformation_r8_IEs = SEQ(
        name="HandoverPreparationInformation-r8-IEs", mode=MODE_TYPE
    )
    _HandoverPreparationInformation_r8_IEs_ue_RadioAccessCapabilityInfo = SEQ_OF(
    ...
    _HandoverPreparationInformation_r8_IEs_as_Config = SEQ(
        name="as-Config",
        mode=MODE_TYPE,
        tag=(1, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(("EUTRA-InterNodeDefinitions", "AS-Config")),
        opt=True,
    )
    _HandoverPreparationInformation_r8_IEs_rrm_Config = SEQ(
        name="rrm-Config",
        mode=MODE_TYPE,
        tag=(2, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(("EUTRA-InterNodeDefinitions", "RRM-Config")),
        opt=True,
    )
    _HandoverPreparationInformation_r8_IEs_as_Context = SEQ(
        name="as-Context",
        mode=MODE_TYPE,
        tag=(3, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(("EUTRA-InterNodeDefinitions", "AS-Context")),
        opt=True,
    )
    _HandoverPreparationInformation_r8_IEs_nonCriticalExtension = SEQ(
        name="nonCriticalExtension",
        mode=MODE_TYPE,
        tag=(4, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        opt=True,
    ...
    # -----< UERadioAccessCapabilityInformation >-----#
    UERadioAccessCapabilityInformation = SEQ(
        name="UERadioAccessCapabilityInformation", mode=MODE_TYPE
    )
    _UERadioAccessCapabilityInformation_criticalExtensions = CHOICE(
        name="criticalExtensions",
        mode=MODE_TYPE,
        tag=(0, TAG_CONTEXT_SPEC, TAG_EXPLICIT),
    )
    __UERadioAccessCapabilityInformation_criticalExtensions_c1 = CHOICE(
        name="c1", mode=MODE_TYPE, tag=(0, TAG_CONTEXT_SPEC, TAG_EXPLICIT)
    )
    ___UERadioAccessCapabilityInformation_criticalExtensions_c1_ueRadioAccessCapabilityInformation_r8 = SEQ(
        name="ueRadioAccessCapabilityInformation-r8",
        mode=MODE_TYPE,
        tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(
            ("EUTRA-InterNodeDefinitions", "UERadioAccessCapabilityInformation-r8-IEs")
        ),
    )
    ___UERadioAccessCapabilityInformation_criticalExtensions_c1_spare7 = NULL(
        name="spare7", mode=MODE_TYPE, tag=(1, TAG_CONTEXT_SPEC, TAG_IMPLICIT)
    )
    ___UERadioAccessCapabilityInformation_criticalExtensions_c1_spare6 = NULL(
        name="spare6", mode=MODE_TYPE, tag=(2, TAG_CONTEXT_SPEC, TAG_IMPLICIT)
    )
    ___UERadioAccessCapabilityInformation_criticalExtensions_c1_spare5 = NULL(
        name="spare5", mode=MODE_TYPE, tag=(3, TAG_CONTEXT_SPEC, TAG_IMPLICIT)
    )
    ___UERadioAccessCapabilityInformation_criticalExtensions_c1_spare4 = NULL(
        name="spare4", mode=MODE_TYPE, tag=(4, TAG_CONTEXT_SPEC, TAG_IMPLICIT)
    )
    ___UERadioAccessCapabilityInformation_criticalExtensions_c1_spare3 = NULL(
        name="spare3", mode=MODE_TYPE, tag=(5, TAG_CONTEXT_SPEC, TAG_IMPLICIT)
    )
    ___UERadioAccessCapabilityInformation_criticalExtensions_c1_spare2 = NULL(
        name="spare2", mode=MODE_TYPE, tag=(6, TAG_CONTEXT_SPEC, TAG_IMPLICIT)
    )
    ___UERadioAccessCapabilityInformation_criticalExtensions_c1_spare1 = NULL(
        name="spare1", mode=MODE_TYPE, tag=(7, TAG_CONTEXT_SPEC, TAG_IMPLICIT)
    )
    ...
    # -----< UERadioAccessCapabilityInformation-r8-IEs >-----#
    UERadioAccessCapabilityInformation_r8_IEs = SEQ(
        name="UERadioAccessCapabilityInformation-r8-IEs", mode=MODE_TYPE
    )
    _UERadioAccessCapabilityInformation_r8_IEs_ue_RadioAccessCapabilityInfo = OCT_STR(
        name="ue-RadioAccessCapabilityInfo",
        mode=MODE_TYPE,
        tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
    )
    __UERadioAccessCapabilityInformation_r8_IEs_ue_RadioAccessCapabilityInfo_contain = (
        SEQ(
            name="_cont_ue-RadioAccessCapabilityInfo",
            mode=MODE_TYPE,
            typeref=ASN1RefType(("EUTRA-RRC-Definitions", "UECapabilityInformation")),
        )
    )
    ...
    _AS_Config_sourceMeasConfig = SEQ(
        name="sourceMeasConfig",
        mode=MODE_TYPE,
        tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "MeasConfig")),
    )
    _AS_Config_sourceRadioResourceConfig = SEQ(
        name="sourceRadioResourceConfig",
        mode=MODE_TYPE,
        tag=(1, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "RadioResourceConfigDedicated")),
    )
    _AS_Config_sourceSecurityAlgorithmConfig = SEQ(
        name="sourceSecurityAlgorithmConfig",
        mode=MODE_TYPE,
        tag=(2, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "SecurityAlgorithmConfig")),
    )
    _AS_Config_sourceUE_Identity = BIT_STR(
        name="sourceUE-Identity",
        mode=MODE_TYPE,
        tag=(3, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "C-RNTI")),
    )
    _AS_Config_sourceMasterInformationBlock = SEQ(
        name="sourceMasterInformationBlock",
        mode=MODE_TYPE,
        tag=(4, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "MasterInformationBlock")),
    )
    _AS_Config_sourceSystemInformationBlockType1 = SEQ(
        name="sourceSystemInformationBlockType1",
        mode=MODE_TYPE,
        tag=(5, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "SystemInformationBlockType1")),
    )
    _AS_Config_sourceSystemInformationBlockType2 = SEQ(
        name="sourceSystemInformationBlockType2",
        mode=MODE_TYPE,
        tag=(6, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "SystemInformationBlockType2")),
    )
    _AS_Config_antennaInfoCommon = SEQ(
        name="antennaInfoCommon",
        mode=MODE_TYPE,
        tag=(7, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "AntennaInfoCommon")),
    )
    _AS_Config_sourceDl_CarrierFreq = INT(
    ...
    _AS_Context_reestablishmentInfo = SEQ(
        name="reestablishmentInfo",
        mode=MODE_TYPE,
        tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(("EUTRA-InterNodeDefinitions", "ReestablishmentInfo")),
        opt=True,
    )
    ...
    _ReestablishmentInfo_sourcePhysCellId = INT(
        name="sourcePhysCellId",
        mode=MODE_TYPE,
        tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "PhysCellId")),
    )
    _ReestablishmentInfo_targetCellShortMAC_I = BIT_STR(
        name="targetCellShortMAC-I",
        mode=MODE_TYPE,
        tag=(1, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "ShortMAC-I")),
    )
    _ReestablishmentInfo_additionalReestabInfoList = SEQ_OF(
        name="additionalReestabInfoList",
        mode=MODE_TYPE,
        tag=(2, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(
            ("EUTRA-InterNodeDefinitions", "AdditionalReestabInfoList")
        ),
        opt=True,
    )
    ...
    _AdditionalReestabInfoList__item_ = SEQ(
        name="_item_",
        mode=MODE_TYPE,
        typeref=ASN1RefType(("EUTRA-InterNodeDefinitions", "AdditionalReestabInfo")),
    )
    AdditionalReestabInfoList._cont = _AdditionalReestabInfoList__item_
    AdditionalReestabInfoList._const_sz = ASN1Set(
        rv=[], rr=[ASN1RangeInt(lb=1, ub=32)], ev=None, er=[]
    )

    # -----< AdditionalReestabInfo >-----#
    AdditionalReestabInfo = SEQ(name="AdditionalReestabInfo", mode=MODE_TYPE)
    _AdditionalReestabInfo_cellIdentity = BIT_STR(
        name="cellIdentity",
        mode=MODE_TYPE,
        tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "CellIdentity")),
    )
    _AdditionalReestabInfo_key_eNodeB_Star = BIT_STR(
        name="key-eNodeB-Star",
        mode=MODE_TYPE,
        tag=(1, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(("EUTRA-InterNodeDefinitions", "Key-eNodeB-Star")),
    )
    _AdditionalReestabInfo_shortMAC_I = BIT_STR(
        name="shortMAC-I",
        mode=MODE_TYPE,
        tag=(2, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        typeref=ASN1RefType(("EUTRA-RRC-Definitions", "ShortMAC-I")),
    ...
    _RRM_Config_ue_InactiveTime = ENUM(
        name="ue-InactiveTime",
        mode=MODE_TYPE,
        tag=(0, TAG_CONTEXT_SPEC, TAG_IMPLICIT),
        opt=True,
    )
    _RRM_Config_ue_InactiveTime._cont = ASN1Dict(
        [
            ("s1", 0),
            ("s2", 1),
            ("s3", 2),
