...
RRC_8_6_0_ASN_PATH = os.path.join(
    SCRIPT_DIR, "..", "..", "..", "tests", "files", "3gpp", "rrc_8_6_0.asn"
)
                        ...
                        "sib-TypeAndInfo": [
                            (
                                "sib2",
                                {
                                    ...
                                    "freqInfo": {"additionalSpectrumEmission": 3},
...
def asn1tools_encode_decode():
    ...
    def encode():
        rrc.encode("BCCH-DL-SCH-Message", DECODED_MESSAGE_ASN1TOOLS, check_types=False)
...
measurements = [("asn1tools", asn1tools_encode_time), ("pycrate", pycrate_encode_time)]
...
measurements = [("asn1tools", asn1tools_decode_time), ("pycrate", pycrate_decode_time)]
