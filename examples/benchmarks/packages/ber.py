...
SNMP_V1_ASN_PATHS = [
    os.path.join(SCRIPT_DIR, "..", "..", "..", "tests", "files", "ietf", filename)
            ...
            "variable-bindings": [
                {
                    ...
                    "value": (
                        ...
                        (
                            "string",
                            (b"\x31\x37\x32\x2e\x33\x31\x2e\x31\x39\x2e\x37\x33"),
                        ),
                    ),
                },
                {
                ...
                },
                {
                    ...
                    "value": (
                        ...
                        (
                            "string",
                            (b"\x32\x35\x35\x2e\x32\x35\x35\x2e\x32\x35\x35\x2e\x30"),
                        ),
                    ),
                },
                {
                    ...
                    "value": (
                        "simple",
                        ("string", (b"\x31\x37\x32\x2e\x33\x31\x2e\x31\x39\x2e\x32")),
                    ),
                },
            ],
        },
    ...
    "data": (
        "set-request",
        {
            ...
            "variable-bindings": [
                {
                    "name": (1, 3, 6, 1, 4, 1, 253, 8, 51, 10, 2, 1, 7, 10, 14130101),
                    "value": ("simple", ("string", b"172.31.19.73")),
                },
                {
                    "name": (1, 3, 6, 1, 4, 1, 253, 8, 51, 10, 2, 1, 5, 10, 14130400),
                    "value": ("simple", ("number", 2)),
