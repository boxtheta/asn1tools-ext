...
class RFC1155_SMI:
    ...
    _ObjectSyntax_simple = CHOICE(
        name="simple",
        mode=MODE_TYPE,
        typeref=ASN1RefType(("RFC1155-SMI", "SimpleSyntax")),
    )
    _ObjectSyntax_application_wide = CHOICE(
        name="application-wide",
        mode=MODE_TYPE,
        typeref=ASN1RefType(("RFC1155-SMI", "ApplicationSyntax")),
    )
    ...
    _ApplicationSyntax_address = CHOICE(
        name="address",
        mode=MODE_TYPE,
        typeref=ASN1RefType(("RFC1155-SMI", "NetworkAddress")),
    )
    _ApplicationSyntax_counter = INT(
        name="counter", mode=MODE_TYPE, typeref=ASN1RefType(("RFC1155-SMI", "Counter"))
    )
    _ApplicationSyntax_gauge = INT(
        name="gauge", mode=MODE_TYPE, typeref=ASN1RefType(("RFC1155-SMI", "Gauge"))
    )
    _ApplicationSyntax_ticks = INT(
        name="ticks", mode=MODE_TYPE, typeref=ASN1RefType(("RFC1155-SMI", "TimeTicks"))
    )
    _ApplicationSyntax_arbitrary = OCT_STR(
        name="arbitrary", mode=MODE_TYPE, typeref=ASN1RefType(("RFC1155-SMI", "Opaque"))
    )
    ...
    _NetworkAddress_internet = OCT_STR(
        name="internet",
        mode=MODE_TYPE,
        typeref=ASN1RefType(("RFC1155-SMI", "IpAddress")),
    )
    ...
    # -----< IpAddress >-----#
    IpAddress = OCT_STR(
        name="IpAddress", mode=MODE_TYPE, tag=(0, TAG_APPLICATION, TAG_IMPLICIT)
    )
    IpAddress._const_sz = ASN1Set(rv=[4], rr=[], ev=None, er=[])

    # -----< Counter >-----#
    Counter = INT(
        name="Counter", mode=MODE_TYPE, tag=(1, TAG_APPLICATION, TAG_IMPLICIT)
    )
    Counter._const_val = ASN1Set(
        rv=[], rr=[ASN1RangeInt(lb=0, ub=4294967295)], ev=None, er=[]
    )

    # -----< Gauge >-----#
    Gauge = INT(name="Gauge", mode=MODE_TYPE, tag=(2, TAG_APPLICATION, TAG_IMPLICIT))
    Gauge._const_val = ASN1Set(
        rv=[], rr=[ASN1RangeInt(lb=0, ub=4294967295)], ev=None, er=[]
    )

    # -----< TimeTicks >-----#
    TimeTicks = INT(
        name="TimeTicks", mode=MODE_TYPE, tag=(3, TAG_APPLICATION, TAG_IMPLICIT)
    )
    TimeTicks._const_val = ASN1Set(
        rv=[], rr=[ASN1RangeInt(lb=0, ub=4294967295)], ev=None, er=[]
    )

    # -----< Opaque >-----#
    Opaque = OCT_STR(
        name="Opaque", mode=MODE_TYPE, tag=(4, TAG_APPLICATION, TAG_IMPLICIT)
    )
...
class RFC1157_SNMP:
    ...
    _Message_data = CHOICE(
        name="data", mode=MODE_TYPE, typeref=ASN1RefType(("RFC1157-SNMP", "PDUs"))
    )
    ...
    _PDUs_get_request = SEQ(
        name="get-request",
        mode=MODE_TYPE,
        typeref=ASN1RefType(("RFC1157-SNMP", "GetRequest-PDU")),
    )
    _PDUs_get_next_request = SEQ(
        name="get-next-request",
        mode=MODE_TYPE,
        typeref=ASN1RefType(("RFC1157-SNMP", "GetNextRequest-PDU")),
    )
    _PDUs_get_response = SEQ(
        name="get-response",
        mode=MODE_TYPE,
        typeref=ASN1RefType(("RFC1157-SNMP", "GetResponse-PDU")),
    )
    _PDUs_set_request = SEQ(
        name="set-request",
        mode=MODE_TYPE,
        typeref=ASN1RefType(("RFC1157-SNMP", "SetRequest-PDU")),
    )
    _PDUs_trap = SEQ(
        name="trap", mode=MODE_TYPE, typeref=ASN1RefType(("RFC1157-SNMP", "Trap-PDU"))
    )
    PDUs._cont = ASN1Dict(
        [
    ...
    GetRequest_PDU = SEQ(
        ...
        typeref=ASN1RefType(("RFC1157-SNMP", "PDU")),
    )

    # -----< GetNextRequest-PDU >-----#
    GetNextRequest_PDU = SEQ(
        name="GetNextRequest-PDU",
        mode=MODE_TYPE,
    ...
    _PDU_error_status._cont = ASN1Dict(
        [
            ("noError", 0),
            ("tooBig", 1),
            ("noSuchName", 2),
    ...
    _PDU_variable_bindings = SEQ_OF(
        name="variable-bindings",
        mode=MODE_TYPE,
        typeref=ASN1RefType(("RFC1157-SNMP", "VarBindList")),
    )
    PDU._cont = ASN1Dict(
        [
    ...
    # -----< Trap-PDU >-----#
    Trap_PDU = SEQ(
        name="Trap-PDU", mode=MODE_TYPE, tag=(4, TAG_CONTEXT_SPEC, TAG_IMPLICIT)
    )
    _Trap_PDU_enterprise = OID(name="enterprise", mode=MODE_TYPE)
    _Trap_PDU_agent_addr = CHOICE(
        name="agent-addr",
        mode=MODE_TYPE,
        typeref=ASN1RefType(("RFC1155-SMI", "NetworkAddress")),
    )
    _Trap_PDU_generic_trap = INT(name="generic-trap", mode=MODE_TYPE)
    _Trap_PDU_generic_trap._cont = ASN1Dict(
        [
            ("coldStart", 0),
            ("warmStart", 1),
            ("linkDown", 2),
    ...
    _Trap_PDU_time_stamp = INT(
        name="time-stamp",
        mode=MODE_TYPE,
        typeref=ASN1RefType(("RFC1155-SMI", "TimeTicks")),
    )
    _Trap_PDU_variable_bindings = SEQ_OF(
        name="variable-bindings",
        mode=MODE_TYPE,
        typeref=ASN1RefType(("RFC1157-SNMP", "VarBindList")),
    )
    ...
    _VarBind_name = OID(
        name="name", mode=MODE_TYPE, typeref=ASN1RefType(("RFC1155-SMI", "ObjectName"))
    )
    _VarBind_value = CHOICE(
        name="value",
        mode=MODE_TYPE,
        typeref=ASN1RefType(("RFC1155-SMI", "ObjectSyntax")),
    )
    ...
    _VarBindList__item_ = SEQ(
        name="_item_", mode=MODE_TYPE, typeref=ASN1RefType(("RFC1157-SNMP", "VarBind"))
    )
