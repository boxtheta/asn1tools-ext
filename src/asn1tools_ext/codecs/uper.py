...
class KnownMultiplierStringType(per.KnownMultiplierStringType):
    ...
    def __init__(
        ...
        self.bits_per_character = integer_as_number_of_bits(len(permitted_alphabet) - 1)
    ...
    def encode(self, data, encoder):
        ...
        if self.number_of_bits is None:
            ...
            encoder.append_non_negative_binary_integer(
                len(data) - self.minimum, self.number_of_bits
            )
...
class Integer(Type):
    ...
    def encode(self, data, encoder):
        ...
        if self.number_of_bits is None:
            ...
            encoder.append_non_negative_binary_integer(
                data - self.minimum, self.number_of_bits
            )
...
class BitString(per.BitString):
    def encode(self, data, encoder):
        ...
        if self.number_of_bits is None:
            ...
            encoder.append_non_negative_binary_integer(
                number_of_bits - self.minimum, self.number_of_bits
            )
