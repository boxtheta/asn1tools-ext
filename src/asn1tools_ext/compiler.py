...
class Specification(object):
    ...
    def __init__(self, modules, decode_length, type_checkers, constraints_checkers):
    ...
    def encode(self, name, data, check_types=True, check_constraints=False, **kwargs):
        ...
        try:
            ...
            raise EncodeError("Type '{}' not found in types dictionary.".format(name))
    ...
    def decode(self, name, data, check_constraints=False):
        ...
        try:
            ...
            raise DecodeError("Type '{}' not found in types dictionary.".format(name))
...
def _compile_any_defined_by_choices(specification, any_defined_by_choices):
...
def compile_string(
    ...
    return compile_dict(
        parse_string(string), codec, any_defined_by_choices, numeric_enums
    )
...
def compile_files(
    ...
    return compile_dict(
        parse_files(filenames, encoding),
        codec,
